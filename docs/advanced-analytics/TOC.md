...
### [R: SQL 開発者向けのデータベース内分析](tutorials/sqldev-in-database-r-for-sql-developers.md)
...
### [Python: SQL 開発者向けのデータベース内分析](tutorials/sqldev-in-database-python-for-sql-developers.md)
