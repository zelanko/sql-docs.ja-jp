...
1. インストールスクリプトをダウンロードします。
  ...
  + [https://aka.ms/mls-py](https://aka.ms/mls-py)Microsoft Python パッケージのバージョン9.2.1 をインストールします。 このバージョンは、既定の SQL Server 2017 インスタンスに対応します。 

  + [https://aka.ms/mls93-py](https://aka.ms/mls93-py)Microsoft Python パッケージのバージョン9.3 をインストールします。 このバージョンは、リモート SQL Server 2017 インスタンスが[Machine Learning Server 9.3 にバインド](../install/upgrade-r-and-python.md)されている場合に適しています。
