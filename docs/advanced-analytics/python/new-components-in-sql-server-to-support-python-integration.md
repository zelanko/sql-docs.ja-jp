---
title: SQL Server の Machine Learning Python 統合コンポーネント |Microsoft ドキュメント
ms.prod: sql
...
詳細については、次を参照してください。[インストール SQL Server 2017 Machine Learning Services (In-database)](../install/sql-machine-learning-services-windows-install.md)です。
