...
1. 既にインストールされているベースライン インスタンスを開始: SQL Server 2016 の初期リリース、SQL Server 2016 SP 1、または SQL Server 2016 SP 2。

2. 累積更新プログラムの一覧に: [SQL Server 2016 の更新](https://sqlserverupdates.com/sql-server-2016-updates/)
