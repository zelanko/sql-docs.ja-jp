---
title: SQL Server の Machine Learning のサービスで使用するための R コードを変換 |Microsoft ドキュメント"
ms.prod: sql
...
ms.locfileid: "31203584"
---
# <a name="convert-r-code-for-execution-in-sql-server-in-database-instances"></a>SQL Server (In-database) のインスタンスで実行するための R コードを変換します。
