...
---
# <a name="how-to-create-mdx-queries-using-olapr"></a>olapR を使って MDX クエリを作成する方法
...
+ WHERE 句は _スライサー軸_です。 スライサーは、SalesTerritory ディメンションのメンバーを使って、オーストラリアからの販売のみが計算で使われるようにクエリをフィルターします。
