---
title: SQL Server の機械学習用リソース プールを作成 |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "31203504"
---
# <a name="create-a-resource-pool-for-machine-learning-in-sql-server"></a>SQL Server で、機械学習用リソース プールを作成します。
