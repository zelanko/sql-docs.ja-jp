...
ms.topic: "article"
helpviewer_keywords: 
  - "属性 [マスター データ サービス], 数値属性の作成"
  - "数値属性の作成 [マスター データ サービス]"
...
> [!NOTE]  
>  数値属性には制限があります。 詳細については、「[ドメインベースの属性 (マスター データ サービス)](../master-data-services/attributes-master-data-services.md)」を参照してください。  
