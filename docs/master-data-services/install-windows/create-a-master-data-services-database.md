---
title: "マスター データ サービス データベースを作成 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
# <a name="create-a-master-data-services-database"></a>マスター データ サービス データベースの作成
  [!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)] Web アプリケーションと [!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)] Web サービスをサポートする新しいデータベースが必要な場合は、[!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)] データベースを作成します。  
