---
title: "リーフ メンバー ステージング テーブル (Master Data Services) |Microsoft ドキュメント"
ms.custom: 
ms.date: 04/01/2016
...
## <a name="see-also"></a>参照  
 ...
 [ステージング処理のエラー & #40 です。マスター データ サービス &#41;](../master-data-services/staging-process-errors-master-data-services.md)  
