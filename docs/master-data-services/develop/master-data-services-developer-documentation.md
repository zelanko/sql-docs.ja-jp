---
title: "Master Data Services 開発者向けドキュメント |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/17/2017
...
### <a name="web-service-content"></a>Web サービスに関するコンテンツ  
 [マスター データ マネージャー Web サービス プロキシ クラスを作成します。](../../master-data-services/develop/create-master-data-manager-web-service-proxy-classes.md)  
