...
ms.topic: "article"
helpviewer_keywords: 
  - "ユーザー [Master Data Services]"
  - "グループ [Master Data Services]"
  - "ユーザー [マスター データ サービス]、ユーザーについて"
  - "グループ [マスター データ サービス]、グループについて"
...
## 参照  
 ...
 [ユーザーの権限のテスト (マスター データ サービス)](../master-data-services/test-a-user-s-permissions-master-data-services.md)  
