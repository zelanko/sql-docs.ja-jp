---
title: ".NET Framework 更新後の SQLCLR アセンブリのアップグレード |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="see-also"></a>参照  
 ...
 [SQL Server 更新プログラムのインストール後の DQS データベース スキーマをアップグレードします。](../../data-quality-services/install-windows/upgrade-dqs-databases-schema-after-installing-sql-server-update.md)  
