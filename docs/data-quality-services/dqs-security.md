...
|タスクの説明|トピック|  
|----------------------|-----------|  
|SQL Server Management Studio を使用してユーザーを作成し、DQS ロールを付与する方法について説明します。|[SSMS で DQS ユーザーを管理する](https://msdn.microsoft.com/library/955af01d-00da-4c51-9311-f3848749df54)|  
