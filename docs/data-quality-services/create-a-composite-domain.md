...
1.  [!INCLUDE[ssDQSInitialStep](../includes/ssdqsinitialstep-md.md)][データ品質クライアント アプリケーションを実行](../data-quality-services/run-the-data-quality-client-application.md)します。  
