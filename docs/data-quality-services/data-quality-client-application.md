...
## <a name="installing-the-data-quality-client-application"></a>Data Quality Client アプリケーションのインストール  
  ...
  [!INCLUDE[ssDQSClient](../includes/ssdqsclient-md.md)] アプリケーションのインストールについて詳しくは、「[Data Quality Services のインストール](../data-quality-services/install-windows/install-data-quality-services.md)」をご覧ください。  
