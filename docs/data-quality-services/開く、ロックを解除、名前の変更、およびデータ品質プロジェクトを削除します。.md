---
title: "開く、ロックを解除、名前の変更、およびデータ品質プロジェクトを削除します。 | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
manager: "jhubbard"
---
# 開く、ロックを解除、名前の変更、およびデータ品質プロジェクトを削除します。
...
4.  最後に閉じられたときと同じアクティビティの状態でデータ品質プロジェクトが開きます。 データ品質プロジェクトには次の状態があります。  
    ...
    -    **クレンジング** アクティビティ、データ品質プロジェクトには、次の状態があります: **クレンジング - マップ**, 、**クレンジング - クレンジング**, 、**クレンジング-結果の表示の管理と**, 、および **クレンジング-エクスポート**します。  
  
    -    **照合** アクティビティ、データ品質プロジェクトには、次の状態があります: **照合 - マップ**, 、**照合 - 照合**, 、**照合-サバイバーシップ**, 、および **照合-エクスポート**します。  
...
3.   **プロジェクトを開く** 画面で、ユーザーによって作成されるロックされたデータ品質プロジェクトを右クリックをクリックし、 **Unlock** のショートカット メニューにします。 緑のチェック マークがプロジェクトに表示され、ロックされていないことが示されます。  
...
3.   **プロジェクトを開く** 画面で、ユーザーによって作成されるデータ品質プロジェクトを右クリックをクリックし、 **の名前を変更** のショートカット メニューにします。  
...
3.   **プロジェクトを開く** 画面で、ユーザーによって作成されるロックされていないデータ品質プロジェクトを右クリックをクリックし、 **削除** のショートカット メニューにします。  
