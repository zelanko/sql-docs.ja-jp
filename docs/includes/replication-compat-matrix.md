...
ms.locfileid: "75692560"
---
### <a name="transactional-replication-matrix"></a>トランザクション レプリケーションのマトリックス 
...
### <a name="merge-replication-support-matrix"></a>マージ レプリケーション サポートのマトリックス
| **発行元**   | **ディストリビューター** | **サブスクライバー** |
| :------------   | :-------------- | :------------- |
