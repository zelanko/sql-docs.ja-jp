---
title: ADOMD.NET サーバー オブジェクト のアーキテクチャ |マイクロソフトドキュメント
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="adomdnet-server-object-architecture"></a>ADOMD.NET サーバー オブジェクト アーキテクチャ
  ADOMD.NET サーバー オブジェクトは、ユーザー定義関数 (UDF) または ストアド プロシージャを で[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)][!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]作成するために使用できるヘルパー オブジェクトです。  
