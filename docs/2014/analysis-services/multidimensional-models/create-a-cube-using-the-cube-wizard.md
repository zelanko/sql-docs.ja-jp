...
1.  
  **ソリューション エクスプローラー**で **[キューブ]** を右クリックし、 **[新しいキューブ]** をクリックします。  
...
7.  
  **[欠落したディメンション キーの選択]** ページで、ディメンションのキーを選択し、 **[次へ]** をクリックします。  
...
8.  
  **[ウィザードの完了]** ページで、新しいキューブの名前を入力し、キューブ構造を確認します。 変更が必要な場合は **[戻る]** をクリックします。変更が必要ない場合は **[完了]** をクリックします。  
