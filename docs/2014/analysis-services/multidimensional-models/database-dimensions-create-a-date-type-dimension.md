...
## <a name="dimension-structure"></a>[ディメンション構造]  
 ...
 サーバー時間ディメンションの属性には、特殊な時間属性バインドが含まれています。 
  [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] では、Year、Month、Day など、日付に関係する属性の型を使用して、時間ディメンションの属性のメンバーを定義します。  
