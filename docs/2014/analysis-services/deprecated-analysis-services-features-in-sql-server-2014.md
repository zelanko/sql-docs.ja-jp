---
title: 非推奨の Analysis Services の SQL Server 2014 における機能 |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
|その他|CELL_EVALUATION_LIST intrinsic セル プロパティ|以前は、セルに適用する評価された数式の一覧を提供していました。 このリリースの Analysis Services では、このプロパティは空白です。  解決順序は MDX スクリプトで指定されるようになりました。 詳細については、次を参照してください[について理解を渡す順序と解決順序&#40;MDX。&#41;](multidimensional-models/mdx/mdx-data-manipulation-understanding-pass-order-and-solve-order.md)|  
...
|カテゴリ|非推奨の機能|代替|  
|--------------|------------------------|-----------------|  
|多次元モデル|リモート パーティション|[なし] : 代わりにローカル パーティションを使用します。 参照してください[を作成し、ローカル パーティションを管理&#40;Analysis Services&#41; ](multidimensional-models/create-and-manage-a-local-partition-analysis-services.md)詳細についてはします。|  
