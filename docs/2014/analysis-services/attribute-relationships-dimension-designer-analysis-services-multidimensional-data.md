---
title: 属性リレーションシップ (ディメンション デザイナー) (Analysis Services - 多次元データ) |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
 ...
 **[属性リレーションシップ]** ページには、次のペインがあります。  
 ...
 [ツールバー](toolbar-attribute-relationship-dimension-designer-analysis-services-multidimensional-data.md)  
