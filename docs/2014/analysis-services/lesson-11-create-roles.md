...
-   販売アナリストの米国-このロールには、米国での売上に関連するデータのみを参照できるようにする組織内のユーザーを含めることができます (米国)。 このロールに対しては DAX 式を使用して､メンバーを米国のみのデータ参照に制限する *Row Filter* を定義します｡  
...
6.  
  **Select Users また Groups** ダイアログ ボックスでこのロールに含める社内 Windows ユーザーまたはグループを入力します｡  
