...
|**メジャーを表示します。**|クリックして次のオプションを切り替えるかまたは次のいずれかのオプションを選択して、 **[メジャー]** ペインの外観を表示します。<br /><br /> **ツリー**: メジャー グループを表示し、ツリー ビュー内のメジャー。<br /><br /> **グリッド**: メジャー グループを表示し、メジャーをグリッドにします。|  
...
|**[表示]**|クリックして次のオプションを切り替えるか、次のいずれかのオプションを選択して、 **[データ ソース ビュー]** ペインの外観を表示します。<br /><br /> **ツリー ビュー**: クエリ、列、名前付き計算、およびツリー ビューのリレーションシップをという名前のテーブルを表示します。<br /><br /> **ダイアグラム ビュー**: という名前のクエリ、列、名前付き計算、およびリレーションシップをデータベース ダイアグラムのテーブルを表示します。|  
