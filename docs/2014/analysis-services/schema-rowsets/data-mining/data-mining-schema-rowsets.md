...
## <a name="see-also"></a>参照  
 ...
 [SQL Server システム カタログに対するクエリ](https://technet.microsoft.com/en-us/library/ms189082\(v=sql.110\).aspx)   
