...
|`CONNECTION_IMPERSONATED_USER_NAME`|`DBTYPE_WSTR`|はい|将来使用するために予約されています。 Analysis Services は、CONNECTION_IMPERSONATED_USER_NAME の値に対しては常に NULL を返します。|  
