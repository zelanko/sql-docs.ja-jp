...
-   [メジャーグリッドを使用したメジャーの定義](#bkmk_def_mg)  
...
##  <a name="bkmk_def_mg"></a>メジャーグリッドを使用したメジャーの定義  
...
|トピック|[説明]|  
|-----------|-----------------|  
|[SSAS 表形式&#41;&#40;のメジャーの作成と管理](measures-ssas-tabular.md)|モデル デザイナーのメジャー グリッドを使用してメジャーを作成および管理する方法について説明します。|  
