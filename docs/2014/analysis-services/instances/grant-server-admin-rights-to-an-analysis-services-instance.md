---
title: サーバーの管理者アクセス許可の付与 (Analysis Services) |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
