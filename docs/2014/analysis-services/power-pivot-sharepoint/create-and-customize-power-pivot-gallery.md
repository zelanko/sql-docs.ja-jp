---
title: 作成し、PowerPivot ギャラリーのカスタマイズ |Microsoft Docs
ms.custom: ''
ms.date: 09/01/2015
...
## <a name="see-also"></a>参照  
 ...
 [PowerPivot ギャラリーを使用します。](use-power-pivot-gallery.md)   
