---
title: 処理およびストレージの場所 (パーティション ウィザード) |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>参照  
 [ウィザードの F1 ヘルプをパーティション分割&#40;Analysis Services - 多次元データ&#41;](partition-wizard-f1-help-analysis-services-multidimensional-data.md)   
