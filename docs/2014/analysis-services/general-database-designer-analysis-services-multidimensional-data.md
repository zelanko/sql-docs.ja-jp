...
2.  
  **ソリューション エクスプローラー**で [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] プロジェクトを右クリックし、 **[データベースの編集]** をクリックして、 **[全般]** タブをクリックします。  
 ...
 **Language**  
 ...
 新しい翻訳をグリッドに追加するには、[ ** \<新しい翻訳>の追加**] をクリックします。  
 ...
 **名前**  
 ...
 新しいアカウントの種類を追加するには、[ ** \<新しいアカウントの種類の追加**] をクリックし>ます。  
