---
title: データ マイニングの監視する SQL Server Profiler の使用 (Analysis Services - データ マイニング) |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/06/2017
