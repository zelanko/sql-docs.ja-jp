...
-   [SQL Server Data Tools でのデータ定義クエリ](#bkmk_ssdt)  
...
###  <a name="bkmk_ssdt"></a>SQL Server Data Tools でのデータ定義クエリ  
...
|
  [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]で提供されるスクリプト言語やプログラム言語の詳細|[XML for Analysis &#40;XMLA&#41; リファレンス](https://docs.microsoft.com/bi-reference/xmla/xml-for-analysis-xmla-reference)<br /><br /> [分析管理オブジェクト &#40;AMO&#41;を使用した開発](https://docs.microsoft.com/bi-reference/amo/developing-with-analysis-management-objects-amo)|  
|
  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] および [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]でのモデルの管理の詳細。|[データ マイニング オブジェクトのエクスポートおよびインポート](export-and-import-data-mining-objects.md)<br /><br /> [DMX&#41;のエクスポート &#40;](/sql/dmx/export-dmx)<br /><br /> [DMX&#41;のインポート &#40;](/sql/dmx/import-dmx)|  
|OPENROWSET、および外部データへのクエリのための他の方法の詳細|[&#60;ソースデータクエリ&#62;](/sql/dmx/source-data-query)。|  
