...
## <a name="making-predictions-using-the-model"></a>モデルを使用して予測を行う  
 ...
 DMX を使用して予測クエリを作成する方法の詳細については、[データ マイニング クエリ インターフェイス](data-mining-query-tools.md)を参照してください。  
...
|-|-|  
|予測関数|使用方法|  
|[クラスター &#40;DMX&#41;](/sql/dmx/cluster-dmx)|入力ケースを含んでいる可能性が最も高いクラスターを返します。|  
...
## <a name="see-also"></a>参照  
 ...
 [Microsoft クラスタ リング アルゴリズム テクニカル リファレンス](microsoft-clustering-algorithm-technical-reference.md)   
