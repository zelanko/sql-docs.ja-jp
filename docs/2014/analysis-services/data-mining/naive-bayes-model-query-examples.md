 ...
 **コンテンツ クエリ**  
 ...
 [トレーニングデータの概要を取得する](#bkmk_Query2)  
  
 [属性に関する詳細情報の検索](#bkmk_Query3)  
 ...
 **予測クエリ**  
 ...
 [確率とサポートの値を使用して予測を取得する](#bkmk_Query6)  
...
###  <a name="bkmk_Query2"></a>サンプルクエリ 2: トレーニングデータの概要を取得する  
...
|-----------------|-----------------------|------------------------|---------------|-------------------|-----------------|  
|TM_NaiveBayes|Bike Buyer|Missing|0|0|1 で保護されたプロセスとして起動されました|  
|TM_NaiveBayes|Bike Buyer|0|8869|0.507263784|4|  
|TM_NaiveBayes|Bike Buyer|1 で保護されたプロセスとして起動されました|8615|0.492736216|4|  
|TM_NaiveBayes|性別|Missing|0|0|1 で保護されたプロセスとして起動されました|  
...
###  <a name="bkmk_Query3"></a>サンプルクエリ 3: 属性に関する詳細情報を検索する  
...
|----------------|-------------------|-----------------------|-------------------|-------------------------|----------------|  
|10|Bike Buyer -> Region|1 で保護されたプロセスとして起動されました|17484|84.51555875|10|  
...
###  <a name="bkmk_Query4"></a>サンプルクエリ 4: システムストアドプロシージャを使用する  
...
###  <a name="bkmk_Query5"></a>サンプルクエリ 5: 単一クエリを使用して結果を予測する  
...
###  <a name="bkmk_Query6"></a>サンプルクエリ 6: 確率およびサポートの値を使用して予測を取得する  
...
|[DMX&#41;の予測 &#40;](/sql/dmx/predict-dmx)|指定された列に対して、予測された値、または値のセットを返します。|  
...
## <a name="see-also"></a>参照  
 ...
 [Naive Bayes モデルのマイニングモデルコンテンツ &#40;Analysis Services データマイニング&#41;](mining-model-content-for-naive-bayes-models-analysis-services-data-mining.md)  
