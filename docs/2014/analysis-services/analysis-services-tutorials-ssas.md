---
title: 分析サービスのチュートリアル (SSAS) |マイクロソフトドキュメント
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="analysis-services-tutorials-ssas"></a>Analysis Services チュートリアル (SSAS)
 ...
 [GitHub のアドベンチャーワークスサンプルデータベース](https://github.com/Microsoft/sql-server-samples/releases/tag/adventureworks)  
 このリンクをクリックすると、AdventureWorks のサンプル データベースがある GitHub[!INCLUDE[ssSQL14](../includes/sssql14-md.md)]ダウンロード ページに移動します。  
...
## <a name="see-also"></a>参照  
 [テクニカル ネット WIKI: SQL Server 2012 サンプル](https://go.microsoft.com/fwlink/?linkID=220734)   
 [ピクニック データセット (サンプル データ)](https://go.microsoft.com/fwlink/?linkID=219108)  
