---
title: Perspectives 要素 (ASSL) |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "48171482"
---
# <a name="perspectives-element-assl"></a>Perspectives 要素 (ASSL)
  コレクションを格納[パースペクティブ](../objects/perspective-element-assl.md)要素に関連付けられた、[キューブ](../objects/cube-element-assl.md)要素。  
...
|子要素|[パースペクティブ](../objects/perspective-element-assl.md)|  
