...
|子要素|[[エイリアス]](../properties/alias-element-assl.md)|  
  
## <a name="remarks"></a>コメント  
 親に対応する要素`Aliases`分析管理オブジェクト (AMO) オブジェクト モデルは<xref:Microsoft.AnalysisServices.Account>します。  
  
## <a name="see-also"></a>参照  
 [要素をアカウント&#40;ASSL&#41;](accounts-element-assl.md)   
