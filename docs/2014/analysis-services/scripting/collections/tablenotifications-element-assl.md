...
ms.locfileid: "36084402"
---
# <a name="tablenotifications-element-assl"></a>TableNotifications 要素 (ASSL)
  コレクションを格納[TableNotification](../objects/tablenotification-element-assl.md)要素に情報を提供する、 [ProactiveCaching](../objects/proactivecaching-element-assl.md)テーブルまたは変更されているデータ ソース内のビューについての要素。  
