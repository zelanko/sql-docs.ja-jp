...
|------------------|-------------|  
|親要素|なし|  
|子要素|[注釈](../collections/annotations-element-assl.md)、[名前](../properties/name-element-assl.md)、[型](../properties/type-element-perspectivecalculation-assl.md)|  
|派生要素|[計算](../objects/calculation-element-assl.md)([計算](../collections/calculations-element-assl.md)のコレクション[パースペクティブ](../objects/perspective-element-assl.md))|  
