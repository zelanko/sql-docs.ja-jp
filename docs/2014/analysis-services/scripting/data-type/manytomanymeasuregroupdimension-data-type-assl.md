---
title: ManyToManyMeasureGroupDimension データ型 (ASSL) |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|------------------|-------------|  
|親要素|なし|  
|子要素|[DefaultMember](../objects/member-element-assl.md)、 [MeasureGroupID](../properties/id-element-assl.md)|  
|派生要素|なし|  
