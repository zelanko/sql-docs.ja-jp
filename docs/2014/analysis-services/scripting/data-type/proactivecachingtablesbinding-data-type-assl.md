...
## <a name="remarks"></a>コメント  
 詳細については、`ProactiveCachingBinding`の継承階層のテーブルを含む型`ProactiveCachingBinding`型を参照してください[ProactiveCachingBinding データ型&#40;ASSL&#41;](proactivecachingbinding-data-type-assl.md)です。  
