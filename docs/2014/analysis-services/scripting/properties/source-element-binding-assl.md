...
|[DataItem](../data-type/dataitem-data-type-assl.md)|派生した任意のデータ型[バインド](../data-type/binding-data-type-assl.md)の親に応じて、`DataItem`です。 詳細については、「解説」を参照してください。|  
...
|[MeasureGroupAttribute](../data-type/measuregroupattribute-data-type-assl.md)|[AttributeBinding](../data-type/attributebinding-data-type-assl.md)、 [ColumnBinding](../data-type/columnbinding-data-type-assl.md)、 [InheritedBinding](../data-type/inheritedbinding-data-type-assl.md)です。|  
|[ScalarMiningStructureColumn](../data-type/miningstructurecolumn-data-type-assl.md)|[ColumnBinding](../data-type/columnbinding-data-type-assl.md)|  
 ...
 ASSL でのデータ バインドの詳細については、次を参照してください。[データ ソースとバインド&#40;SSAS 多次元&#41;](../../multidimensional-models/data-sources-and-bindings-ssas-multidimensional.md)です。  
