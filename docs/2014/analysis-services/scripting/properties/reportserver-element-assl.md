...
ms.locfileid: "36165337"
---
# <a name="reportserver-element-assl"></a>ReportServer 要素 (ASSL)
  名前を含む、 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)]インスタンスによって使用される、 [ReportAction](../data-type/action-data-type-assl.md)です。  
