...
ms.locfileid: "36084877"
---
# <a name="version-element-assl"></a>Version 要素 (ASSL)
  インスタンスの読み取り専用のバージョン番号を含む[!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]によって表される、[サーバー](../objects/server-element-assl.md)要素。  
