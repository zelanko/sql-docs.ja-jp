...
|**[上へ移動]**|**[スクリプト オーガナイザー]** ペインで選択されている計算をフォーム ビュー内で 1 つ下に移動します。|  
|**フォームビュー**|フォーム ビューで **[計算]** タブを使用する場合に選択します。|  
|**スクリプトビュー**|スクリプト ビューで **[計算]** タブを使用する場合に選択します。|  
|**[構文の確認]**|キューブ スクリプト内の構文を確認できます。|  
|**Font**|**[フォント]** ダイアログ ボックスを表示し、フォントに関連するセル プロパティの有効なセットをキューブ スクリプト内の選択ポイントに挿入する場合にクリックします。 このオプションは、スクリプト ビューでのみ有効です。|  
