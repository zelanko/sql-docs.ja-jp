...
# <a name="showplan-xml-for-query-compile-event-class"></a>Showplan XML For Query Compile イベント クラス
  Showplan XML For Query Compile イベントクラスは、で[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQL ステートメントがコンパイルされたときに発生します。 含めクラスをインクルードして、で[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Showplan 操作を識別します。  
