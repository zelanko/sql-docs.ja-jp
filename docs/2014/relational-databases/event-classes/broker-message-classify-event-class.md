...
|**EventSubClass**|**nvarchar**|イベント サブクラスの種類です。各イベント クラスについての詳細な情報を提供します。 この列には次の値が含まれます。<br /><br /> **ローカル**:選択されるルートは、ローカル アドレスを持ちます。<br /><br /> **リモート**:選択されるルートは、LOCAL 以外のアドレスです。<br /><br /> **遅延**:転送が無効か存在する一致するルートがないため、メッセージが遅延します。|21|はい|  
