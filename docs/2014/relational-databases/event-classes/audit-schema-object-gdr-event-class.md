...
ms.locfileid: "63012192"
---
# <a name="audit-schema-object-gdr-event-class"></a>Audit Schema Object GDR イベント クラス
  **Audit Schema OBJECT GDR**イベントクラスは、の[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]任意のユーザーによって、スキーマオブジェクト権限に対して GRANT、REVOKE、または DENY が実行されるたびに発生します。  
