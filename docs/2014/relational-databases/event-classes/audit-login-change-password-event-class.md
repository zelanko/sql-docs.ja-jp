...
# <a name="audit-login-change-password-event-class"></a>Audit Login Change Password イベント クラス
  **Audit login Change password**イベントクラスは、ユーザーが[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]ログインパスワードを変更するたびに発生します。  
