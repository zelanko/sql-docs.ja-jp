...
# <a name="finding-more-sql-server-native-client-information"></a>SQL Server Native Client に関する詳細情報
 ...
 に関する追加情報[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Native Client を検索して見つかんだことができます、[マイクロソフト サポート技術情報](http://go.microsoft.com/fwlink?linkid=5757)します。  
