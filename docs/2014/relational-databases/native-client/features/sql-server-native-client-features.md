...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [サービス プリンシパル名&#40;SPN&#41;クライアント接続でのサポート](service-principal-name-spn-support-in-client-connections.md)  
...
## <a name="see-also"></a>参照  
 ...
 [OLE DB の操作方法に関するトピック](../../native-client-ole-db-how-to/ole-db-how-to-topics.md)   
