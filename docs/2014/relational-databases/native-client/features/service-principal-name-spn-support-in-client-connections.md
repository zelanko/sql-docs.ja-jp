...
|*MachineName*$@*Domain*|コンピューター アカウントの直接指定。<br /><br /> (接続先のサーバーがローカルシステムまたはネットワークサービスアカウントで実行されている場合、Kerberos 認証`ServerSPN`を使用するには、を*MachineName*$@*ドメイン*形式にすることができます)。|  
