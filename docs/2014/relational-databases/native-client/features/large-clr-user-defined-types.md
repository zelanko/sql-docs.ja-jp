...
# <a name="large-clr-user-defined-types"></a>大きな CLR ユーザー定義型
 ...
 詳細については、[Large CLR User-Defined 型&#40;OLE DB&#41; ](../ole-db/large-clr-user-defined-types-ole-db.md)と[Large CLR User-Defined 型&#40;ODBC&#41;](../odbc/large-clr-user-defined-types-odbc.md)を参照してください。  
