...
-   `DataTypeCompatibility=80`  
 ...
 Native Client で[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]サポートされている ADO 接続文字列キーワードの詳細については、「 [SQL Server Native Client での接続文字列キーワードの使用](using-connection-string-keywords-with-sql-server-native-client.md)」を参照してください。  
