...
-   `DataTypeCompatibility=80`  
 ...
 詳細については、ADO 接続文字列でサポートされるキーワード[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]Native Client を参照してください[使用した Connection String Keywords with SQL Server Native Client を使用して](using-connection-string-keywords-with-sql-server-native-client.md)です。  
