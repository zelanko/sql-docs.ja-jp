...
1.  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]ツールバーの [**クエリのデータベースエンジン**] をクリックします。 また、ツール バーの **[ファイルを開く]** をクリックして既存のクエリを参照することにより、既存のクエリを開き、推定実行プランを表示することもできます。  
