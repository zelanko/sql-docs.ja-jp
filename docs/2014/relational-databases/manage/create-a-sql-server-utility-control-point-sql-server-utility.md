...
-   SQL Server のマネージド インスタンスをすべて UCP から削除する必要があります。 UCP は、SQL Server のマネージド インスタンスの 1 つです。 詳細については、次を参照してください。[方法。SQL Server ユーティリティから SQL Server のインスタンスを削除](https://go.microsoft.com/fwlink/?LinkId=169392)します。  
