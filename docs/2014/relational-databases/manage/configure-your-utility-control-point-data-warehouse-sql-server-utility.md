...
-   コレクション セットのアップロード頻度。15 分ごとにします。  
 ...
 UMDW ディレクトリは構成できます。\<システム ドライブ >: \Program Files\Microsoft SQL server \mssql10_50. < UCP_Name > \MSSQL\Data\\ここで、\<システム ドライブ > は、通常、C:\ ドライブ。 ログ ファイル Sysutility_mdw_\<GUID>_LOG は同じディレクトリにあります。  
