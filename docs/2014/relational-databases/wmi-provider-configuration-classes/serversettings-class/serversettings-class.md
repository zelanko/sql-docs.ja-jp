...
# <a name="serversettings-class"></a>ServerSettings クラス
  [ServerSettings クラス] serversettings-class.md) は、の[!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]インスタンス上のサーバー設定を表します。  
