...
```  
 ...
 XML インデックスの作成に次の例で、`xml`型の列です。 詳細については、「 [型指定された XML と型指定されていない XML の比較](../xml/compare-typed-xml-to-untyped-xml.md)」を参照してください。  
