...
## <a name="example-combining-full-text-search-with-xml-querying"></a>例:XML クエリを実行すると、フルテキスト検索を組み合わせること  
...
## <a name="example-full-text-search-on-xml-values-using-stemming"></a>例:語幹検索を使用して XML 値で、フルテキスト検索  
