...
3.  **[ログイン - 新規作成]** ダイアログ ボックスの **[全般]** ページで、**[ログイン名]** ボックスにユーザーの名前を入力します。 または、**[検索]** をクリックして **[ユーザーまたはグループの選択]** ダイアログ ボックスを開きます。  
    ...
    1.  **このオブジェクトの種類を選択します**、 をクリック**オブジェクトの種類.。** を開く、**オブジェクトの種類** ダイアログ ボックスし、次の一部またはすべてを選択します。**ビルトイン セキュリティ プリンシパル**、**グループ**、および**ユーザー**します。 **[ビルトイン セキュリティ プリンシパル]** と **[ユーザー]** が既定で選択されます。 完了したら、 **[OK]** をクリックします。  
 ...
 **ログイン - 新規**ダイアログ ボックスでは、次の 4 つのページのオプションも提供されます。**サーバーの役割**、**ユーザー マッピング**、**セキュリティ保護可能な**、および**状態**します。  
...
2.  **オブジェクトの追加**ダイアログ ボックスで、次のオプションのいずれかを選択します。**特定のオブジェクト.**、**型のすべてのオブジェクト。**、または**サーバー**_server_name_します。 [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
...
3.  **[特定のオブジェクト]** を選択した場合:  
    ...
    2.  **[オブジェクトの種類**] ダイアログ ボックスで、いずれかまたはすべてのオブジェクトの種類を選択します。**エンドポイント**、**ログイン**、**サーバー**、**可用性グループ**、および**サーバーの役割**します。 [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
...
4.  選択した場合**型のすべてのオブジェクト。** で、 **[オブジェクトの種類**] ダイアログ ボックスで、いずれかまたはすべてのオブジェクトの種類を選択します。**エンドポイント**、**ログイン**、**サーバー**、**可用性グループ**、および**サーバーの役割**します。 [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
...
##  <a name="FollowUp"></a> フォローしてください：ログインの作成後に実行する手順  
