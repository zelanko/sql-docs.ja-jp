 ...
 **データベース ユーザー - 新規**ダイアログ ボックスでは、次の 4 つのページのオプションも提供されます。**スキーマを所有している**、**メンバーシップ**、**セキュリティ保護可能な**、および**拡張プロパティ**します。  
