...
## <a name="benefits-of-using-the-azure-blob-service-for-ssnoversion-backups"></a>バックアップに[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Azure Blob サービスを使用する利点  
