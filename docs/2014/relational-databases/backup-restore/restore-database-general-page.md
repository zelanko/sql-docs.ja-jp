...
> [!NOTE]  
>  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] を使用して復元タスクを指定する場合、**[スクリプト]** をクリックしてスクリプトの保存先を選択することにより、対応する [!INCLUDE[tsql](../../includes/tsql-md.md)][RESTORE](/sql/t-sql/statements/restore-statements-transact-sql) スクリプトを生成できます。  
...
|**[データベース]**|ドロップダウン リストから、バックアップを復元するデータベース名を選択します。<br /><br /> 注: この一覧は、**デバイス**が選択されている場合にのみ使用できます。 選択されたデバイスにバックアップを持つデータベースのみが使用できるようになります。|  
