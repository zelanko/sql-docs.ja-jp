...
-   [新しい場所にファイルを復元する &#40;SQL Server&#41;](restore-files-to-a-new-location-sql-server.md)  
  
-   [Transact-sql&#41;&#40;master データベースを復元する](restore-the-master-database-transact-sql.md)  
...
-   [Transact-sql&#41;&#40;中断された復元操作を再開する](restart-an-interrupted-restore-operation-transact-sql.md)  
...
## <a name="see-also"></a>参照  
 ...
 [フルテキストカタログとフルテキストインデックスのバックアップと復元](../search/back-up-and-restore-full-text-catalogs-and-indexes.md)   
