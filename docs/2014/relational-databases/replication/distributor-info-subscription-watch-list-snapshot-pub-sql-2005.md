---
title: ディストリビューター情報、サブスクリプション ウォッチ リスト (スナップショット パブリケーション、SQL Server 2005 以降) |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "36084537"
---
# <a name="distributor-information-subscription-watch-list-snapshot-publication-sql-server-2005-and-later"></a>ディストリビューター情報、[サブスクリプション ウォッチ リスト] (スナップショット パブリケーション、SQL Server 2005 以降)
