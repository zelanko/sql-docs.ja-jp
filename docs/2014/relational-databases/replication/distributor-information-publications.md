---
title: SQL Server レプリケーション ディストリビューター ' 情報 ダイアログ ボックス |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
---
# <a name="distributor-information-dialog-box"></a>ディストリビューター情報 ダイアログ ボックス 
このトピックの情報を提供する、**ディストリビューター**  ダイアログ ボックス 
