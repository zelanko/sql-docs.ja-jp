...
|プッシュ サブスクリプションに対するディストリビューション エージェント|**\<\<\<パブリッシャー>-パブリケーションデータベース>-パブリケーション>-サブスクライバー>-\<整数>1 \<** <sup>1</sup>|  
|プル サブスクリプションに対するディストリビューション エージェント|**\<\<\<\<パブリッシャー>-\<パブリケーションデータベース>>-サブスクライバー>-subscriptiondatabase>-GUID>2 \<** <sup>2</sup>|  
