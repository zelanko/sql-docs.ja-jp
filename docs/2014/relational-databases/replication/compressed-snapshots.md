...
-   [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]:[スナップショット ファイルの圧縮 (SQL Server Management Studio)](snapshot-options.md#compress-snapshot-files)  
