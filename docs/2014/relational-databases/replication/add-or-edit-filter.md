...
# <a name="add-or-edit-filter"></a>フィルターの追加または編集
  [**フィルターの追加**] および [**フィルターの編集**] ダイアログボックスを使用すると、静的行フィルターおよびパラメーター化された行フィルターを追加および編集できます。  
...
1.  **フィルター処理するテーブルを選択します**  
    ...
    1.  
  **[フィルターの追加]** ダイアログ ボックスで **[キャンセル]** をクリックします。  
  
    2.  
  **[テーブル行のフィルター選択]** ページのフィルター ペインでテーブルを選択し、 **[編集]** をクリックします。  
  
    3.  
  **[フィルターの編集]** ダイアログ ボックスの既存のフィルターを編集します。  
  
2.  **フィルターステートメントを完了して、サブスクライバーが受け取るテーブル行を指定します。**  
  
     新しいフィルター ステートメントを定義するか、既存のステートメントを編集します。 
  **[列]** リスト ボックスには、 **[フィルターを適用するテーブルを選択します。]** で選択したテーブルからパブリッシュするすべての列が一覧表示されます。 
