...
-   すべてのサポートされる唯一の制約以外[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]サブスクライバーします。NULL および NOT NULL します。 主キーの制約は一意なインデックスとしてレプリケートされます。  
