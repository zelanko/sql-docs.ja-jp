...
-   **レプリケーション:サブスクリプションの検証の失敗後、再初期化**  
  
-   **レプリケーション:サブスクライバーのデータの検証に失敗しました**  
  
-   **レプリケーション:サブスクライバーがデータ検証に合格しました。**  
