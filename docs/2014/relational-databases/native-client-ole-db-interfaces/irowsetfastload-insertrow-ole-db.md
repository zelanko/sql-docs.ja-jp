 ...
 *PData*引数が NULL ポインターに設定されました。  
 ...
 E_UNEXPECTED  
 によって以前に無効にする一括コピー行セットに対してメソッドが呼び出された、 [irowsetfastload::commit](irowsetfastload-commit-ole-db.md)メソッド。  
