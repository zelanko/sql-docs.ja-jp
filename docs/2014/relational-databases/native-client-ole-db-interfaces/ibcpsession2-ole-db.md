...
ms.locfileid: "37431601"
---
# <a name="ibcpsession2-ole-db"></a>IBCPSession2 (OLE DB)
  IBCPSession2 インターフェイスでは、代わりに、各列に対して ibcpsession::bcpcolfmt を呼び出すことであるメンバー関数は、IBCPSession の拡張機能です。  IBCPSession2 IBCPSession から継承し、1 つの新しいメソッドを追加します: [ibcpsession 2::bcpsetbulkmode](ibcpsession2-bcpsetbulkmode.md)します。  
