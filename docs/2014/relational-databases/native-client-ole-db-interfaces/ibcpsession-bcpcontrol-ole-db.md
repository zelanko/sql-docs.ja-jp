...
|BCP_OPTION_FILECP|*iValue* 引数には、データ ファイルのコード ページ番号が含まれます。 1252 や 850 などのコード ページ番号を指定するか、次のいずれかの値を指定できます。<br /><br /> -BCP_FILECP_ACP ファイル内のデータは、クライアントの Microsoft Windows® コード ページ。<br />-BCP_FILECP_OEMCP ファイル内のデータは、(既定値) のクライアントの OEM コード ページです。<br />-BCP_FILECP_RAW ファイル内のデータは、コード ページの[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]します。|  
