...
|BCP_OPTION_FILECP|*iValue* 引数には、データ ファイルのコード ページ番号が含まれます。 1252 や 850 などのコード ページ番号を指定するか、次のいずれかの値を指定できます。<br /><br /> -BCP_FILECP_ACP: ファイル内のデータは Microsoft Windows にありますか? クライアントのコードページ。<br />-BCP_FILECP_OEMCP: ファイル内のデータは、クライアントの OEM コードページ (既定) に含まれています。<br />-BCP_FILECP_RAW: ファイル内のデータは、の[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]コードページにあります。|  
