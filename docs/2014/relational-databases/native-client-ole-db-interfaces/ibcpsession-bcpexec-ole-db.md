 ...
 **BCPExec**メソッドでは、データベース テーブルまたはその逆の場合、ユーザー ファイルからデータをコピーの値に応じて、 *eDirection*で使用するパラメーター、 [ibcpsession::bcpinit](ibcpsession-bcpinit-ole-db.md)メソッドです。  
