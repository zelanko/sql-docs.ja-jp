...
> [!NOTE]  
>  
  [BCPColFmt](ibcpsession-bcpcolumns-ole-db.md) を呼び出す前に、**IBCPSession::BCPColumns** メソッドを呼び出す必要があります。 
 ...
 **メモ**[Ibcpsession:: BCPWriteFmt](ibcpsession-bcpwritefmt-ole-db.md)関数を使用すると、 **Bcpcolfmt**によって提供される形式指定を永続化できます。  
