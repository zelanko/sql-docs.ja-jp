...
###  <a name="DesignRecs"></a>設計に関する推奨事項  
...
6.  
  **[インデックス キー列]** タブで、**[追加...]** をクリックします。  
  
7.  [Table_name**から列を選択**__ ] ダイアログボックスで、インデックスに追加するテーブル列のチェックボックスをオンにします。  
...
10. [Table_name**から列を選択**__ ] ダイアログボックスで、非キー列としてインデックスに追加するテーブル列のチェックボックスをオンにします。  
