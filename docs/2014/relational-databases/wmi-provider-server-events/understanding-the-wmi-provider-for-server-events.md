...
```  
 ...
 この例では、`SQLWEP_76CF38C1_18BB_42DD_A7DC_C8820155B0E9` は、プレフィックス [!INCLUDE[tsql](../../includes/tsql-md.md)] と GUID から構成される `SQLWEP_` 識別子です。 
  `SQLWEP` は、各識別子に対して新しい GUID を作成します。 句の`A7E5521A-1CA6-4741-865D-826F804E5135`値は、msdb データベース内のブローカーインスタンスを識別する GUID です。 **** `TO SERVICE`  
