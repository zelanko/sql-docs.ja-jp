 ...
 **データ定義言語イベントおよびイベント グループ**  
 ...
 ![WMI Provider for Server イベントのイベント ツリー](../../../2014/database-engine/dev-guide/media/sql-wmi-ddl-events-ktm.gif "サーバー イベントのイベント ツリーの WMI プロバイダー")  
