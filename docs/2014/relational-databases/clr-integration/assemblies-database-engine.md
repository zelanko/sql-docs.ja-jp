...
-   CLR ストアド プロシージャ。 詳細については、次を参照してください。 [CLR ストアド プロシージャ](../../database-engine/dev-guide/clr-stored-procedures.md)です。  
  
-   CLR トリガー。 詳細については、次を参照してください。 [CLR トリガーを作成する](../triggers/create-clr-triggers.md)です。  
  
-   ユーザー定義集計関数。 詳細については、次を参照してください。[作成するユーザー定義集計](../user-defined-functions/create-user-defined-aggregates.md)です。  
  
-   ユーザー定義型。 詳細については、次を参照してください。[ユーザー種類](../native-client/features/using-user-defined-types.md)です。  
