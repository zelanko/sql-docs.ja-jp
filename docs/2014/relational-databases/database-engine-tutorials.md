...
# <a name="database-engine-tutorials"></a>データベース エンジンのチュートリアル
 ...
 [チュートリアル:証明書を使用したストアド プロシージャの署名](tutorial-signing-stored-procedures-with-a-certificate.md)  
 ...
 [チュートリアル:ポリシー ベースの管理を使用してサーバーを管理します。](policy-based-management/tutorial-administering-servers-by-using-policy-based-management.md)  
