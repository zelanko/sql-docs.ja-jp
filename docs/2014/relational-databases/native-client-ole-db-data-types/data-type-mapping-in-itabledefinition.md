...
|DBTYPE_UDT|**UDT**|次の情報が使用される`DBCOLUMNDESC`構造体**itabledefinition::createtable** UDT 列が必要な場合。<br /><br /> -   *pwSzTypeName*は無視されます。<br />-   *rgPropertySets*含める必要があります、`DBPROPSET_SQLSERVERCOLUMN`プロパティに関するセクションで説明したように設定`DBPROPSET_SQLSERVERCOLUMN`の[ユーザー種類](../native-client/features/using-user-defined-types.md)です。|  
|DBTYPE_UI1|**tinyint**||  
