...
|新しいデータ型|戻り値のデータ長|  
|--------------------|------------------------|  
|`BITN`|**NULL:** *len* = 0、DATA = IG、RET = 0<br /><br /> **0:** 該当なし<br /><br /> **>= 255:** 該当なし<br /><br /> **<255:** 該当なし|  
|`BIGVARCHAR`|**NULL:** *len* = 0、DATA = IG、RET = 1<br /><br /> **0:** *len* = IG、DATA = ig、RET = 0<br /><br /> **>= 255:** *len* = valid、DATA = valid、RET = 0<br /><br /> **<255:** *len* = <8k、DATA = valid、RET = 1|  
|`BIGCHAR`|**NULL:** *len* = 0、DATA = IG、RET = 1<br /><br /> **0:** *len* = IG、DATA = ig、RET = 0<br /><br /> **>= 255:** *len* = valid、DATA = valid、RET = 0<br /><br /> **<255:** *len* = <8k、DATA = valid、RET = 1|  
|`BIGBINARY`|**NULL:** *len* = 0、DATA = IG、RET = 1<br /><br /> **0:** *len* = IG、DATA = ig、RET = 0<br /><br /> **>= 255:** *len* = valid、DATA = valid、RET = 0<br /><br /> **<255:** *len* = <8k、DATA = valid、RET = 1|  
|`BIGVARBINARY`|**NULL:** *len* = 0、DATA = IG、RET = 1<br /><br /> **0:** *len* = IG、DATA = ig、RET = 0<br /><br /> **>= 255:** *len* = valid、DATA = valid、RET = 0<br /><br /> **<255:** *len* = <8k、DATA = valid、RET = 1|  
|NCHAR|**NULL:** *len* = 0、DATA = IG、RET = 1<br /><br /> **0:** *len* = IG、DATA = ig、RET = 0<br /><br /> **>= 255:** *len* = valid、DATA = valid、RET = 0<br /><br /> **<255:** *len* = <8k、DATA = valid、RET = 1|  
|NVARCHAR|**NULL:** *len* = 0、DATA = IG、RET = 1<br /><br /> **0:** *len* = IG、DATA = ig、RET = 0<br /><br /> **>= 255:** *len* = valid、DATA = valid、RET = 0<br /><br /> **<255:** *len* = <8k、DATA = valid、RET = 1|  
...
## <a name="see-also"></a>参照  
 [srv_paramsetoutput &#40;拡張ストアドプロシージャ API&#41;](srv-paramsetoutput-extended-stored-procedure-api.md)  
