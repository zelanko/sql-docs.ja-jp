---
title: レッスン 2:作成して、階層テーブルでデータを管理する |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "52760904"
---
# <a name="lesson-2-creating-and-managing-data-in-a-hierarchical-table"></a>レッスン 2:作成して、階層テーブルでデータを管理します。
