---
title: 有効な ID、IDREF、および IDREFS 型属性を使用して sql:prefix (SQLXML 4.0) を作成 |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/06/2017
...
-   ID、IDREF、および IDREFS 型の属性は、型の列にマップすることはできません`text`、 `ntext`、または`image`またはその他のバイナリ データ型 (たとえば、 `timestamp`)。  
