...
-   SQLXML マネージ クラス  
     ...
     [!INCLUDE[msCoName](../../../includes/msconame-md.md)] .NET Framework 内で SQLXML の機能へのアクセスを提供します。 詳細については、次を参照してください。 [SQLXML マネージ クラス](../net-framework-classes/sqlxml-4-0-net-framework-support-managed-classes.md)です。  
