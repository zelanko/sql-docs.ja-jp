...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 SQLXML マネージ クラスとそのプロパティおよびメソッドについて説明します。  
  
 [SQLXML マネージ クラスの使用](sqlxml-4-0-net-framework-support-managed-classes.md)  
