...
> [!NOTE]  
>  SQLXML 4.0 の XPath クエリを理解するには、XML ビューと、それに関連するテンプレートやマッピング スキーマなどの概念について理解している必要があります。 詳細については、次を参照してください。[注釈付き XSD スキーマの概要&#40;SQLXML 4.0&#41;](../sqlxml/annotated-xsd-schemas/introduction-to-annotated-xsd-schemas-sqlxml-4-0.md)です。 XPath の詳細についてを参照してください、World Wide Web コンソーシアム (W3C) によって定義されている XPath 標準http://www.w3.org/TR/xpathです。  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [ロケーション パスを指定する&#40;SQLXML 4.0&#41;](location-path/specifying-a-location-path-sqlxml-4-0.md)  
