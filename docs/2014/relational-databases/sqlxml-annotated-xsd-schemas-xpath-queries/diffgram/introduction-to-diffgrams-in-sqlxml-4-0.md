 ...
 **ID**  
 この属性は、>と** \< datainstance>** ブロックの** \< 前**にある要素をペアにするために使用されます。  
 ...
 **parentID**  
 この属性は、DiffGram の要素間の親子リレーションシップを指定するときに使用します。 この属性は、before> ブロックにのみ表示され \< ます。 この属性は更新の適用時に SQLXML で使用されます。 親子リレーションシップは、DiffGram の要素の処理順序を決定するために使用されます。  
