...
|||  
|-|-|  
|**キャッシュしない - データを同じスケジュールで収集およびアップロードします。**|選択した場合、次のいずれかを指定します。<br /><br /> **オンデマンド**。 データは要求時に収集およびアップロードされます。<br /><br /> **スケジュール**。 データはスケジュールに従って収集およびアップロードされます。 **[選択]** をクリックしてスケジュールを定義済み一覧から選択するか、 **[新規作成]** をクリックして新しいスケジュールを作成します。|  
