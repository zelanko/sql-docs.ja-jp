---
title: SQL Server、ブローカーと DBM トランスポート オブジェクト |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "36177500"
---
# <a name="sql-server-broker-and-dbm-transport-object"></a>SQL Server、ブローカーと DBM トランスポート オブジェクト
