...
##  <a name="sql-server-agent-performance-objects"></a><a name="SQLServerAgentPOs"></a>パフォーマンスオブジェクトの SQL Server エージェント  
...
##  <a name="service-broker-performance-objects"></a><a name="ServiceBrokerPOs"></a>パフォーマンスオブジェクトの Service Broker  
...
##  <a name="sql-server-performance-objects"></a><a name="SQLServerPOs"></a>パフォーマンスオブジェクトの SQL Server  
...
##  <a name="sql-server-replication-performance-objects"></a><a name="SQLServerReplicationPOs"></a>パフォーマンスオブジェクトの SQL Server レプリケーション  
...
##  <a name="ssis-pipeline-counters"></a><a name="SsisPipelineCounters"></a>SSIS パイプラインカウンター  
 **SSIS Pipeline** カウンターの詳細については、「 [パフォーマンス カウンター](../../integration-services/performance/performance-counters.md)」を参照してください。  
  
##  <a name="required-permissions"></a><a name="RequiredPermissions"></a>必要なアクセス許可  
