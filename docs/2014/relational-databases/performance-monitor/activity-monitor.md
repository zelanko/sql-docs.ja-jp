...
## <a name="benefits-of-activity-monitor"></a>利用状況モニターの利点  
 利用状況モニターでは、次の展開と折りたたみ可能なペインを含むタブ付きドキュメント ウィンドウです。**概要**、**アクティブなユーザー タスク**、**リソース待機**、**データ ファイル I/O**、および**最近コストの高いクエリ**します。 ペインを展開すると、利用状況モニターによってインスタンスに対して情報のクエリが実行されます。 ペインを折りたたむと、そのペインのすべての利用状況クエリが停止します。 また、1 つ以上のペインを同時に展開し、インスタンスのさまざまな利用状況を表示することもできます。  
