...
##  <a name="structure"></a>フルテキストインデックスの構造  
...
|DocumentID|タイトル|  
|----------------|-----------|  
|1 で保護されたプロセスとして起動されました|Crank Arm and Tire Maintenance|  
...
|-------------|-----------|-----------|----------------|  
|Crank|1 で保護されたプロセスとして起動されました|1 で保護されたプロセスとして起動されました|1 で保護されたプロセスとして起動されました|  
|Arm|1 で保護されたプロセスとして起動されました|1 で保護されたプロセスとして起動されました|2|  
|Tire|1 で保護されたプロセスとして起動されました|1 で保護されたプロセスとして起動されました|4|  
|メンテナンス |1 で保護されたプロセスとして起動されました|1 で保護されたプロセスとして起動されました|5|  
|Front|1 で保護されたプロセスとして起動されました|2|1 で保護されたプロセスとして起動されました|  
|Front|1 で保護されたプロセスとして起動されました|3|1 で保護されたプロセスとして起動されました|  
|Reflector|1 で保護されたプロセスとして起動されました|2|2|  
|Reflector|1 で保護されたプロセスとして起動されました|2|5|  
|Reflector|1 で保護されたプロセスとして起動されました|3|2|  
|Bracket|1 で保護されたプロセスとして起動されました|2|3|  
|Bracket|1 で保護されたプロセスとして起動されました|3|3|  
|アセンブリ|1 で保護されたプロセスとして起動されました|2|6|  
|3|1 で保護されたプロセスとして起動されました|2|7|  
|インストール|1 で保護されたプロセスとして起動されました|3|4|  
...
##  <a name="fragments"></a>フルテキストインデックスフラグメント  
...
|-------------|-----------|-----------|---------|  
|Rear|1 で保護されたプロセスとして起動されました|3|1 で保護されたプロセスとして起動されました|  
|Reflector|1 で保護されたプロセスとして起動されました|3|2|  
