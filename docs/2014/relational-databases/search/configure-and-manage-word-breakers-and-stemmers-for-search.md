...
##  <a name="impact"></a> 新しいワード ブレーカーの影響を理解します。  
 ...
 すべてのワード ブレーカーの一覧については、[sys.fulltext_languages &#40;TRANSACT-SQL&#41;](/sql/relational-databases/system-catalog-views/sys-fulltext-languages-transact-sql)を参照してください。  
