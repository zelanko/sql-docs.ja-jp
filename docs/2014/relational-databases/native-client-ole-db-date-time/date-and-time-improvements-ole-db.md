...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [新しい日付と時刻の機能を以前のバージョンの SQL Server &#40;OLE DB&#41;](new-date-and-time-features-with-previous-sql-server-versions-ole-db.md)  
