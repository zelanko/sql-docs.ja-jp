---
title: 'レッスン 5: レポート定義、レポート サーバーにパブリッシュ |Microsoft ドキュメント'
ms.custom: ''
ms.date: 03/06/2017
...
1.  コードを置き換える、 `PublishReportDefinition()` 、Program.cs ファイル内のメソッド (の場合は Module1.vb [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]) を次のコード。  
...
## <a name="next-lesson"></a>次のレッスン  
 次のレッスンでがコンパイルされ、実行、`SampleRDLSchema`アプリケーションです。 参照してください[レッスン 6: RDL スキーマ アプリケーションを実行&#40;VB C&#35;&#41;](../../2014/tutorials/lesson-6-run-the-rdl-schema-application-vb-csharp.md)です。  
