---
title: レッスン 1:準備、Analysis Services Database (基本的なデータ マイニング チュートリアル) |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="lesson-1-preparing-the-analysis-services-database-basic-data-mining-tutorial"></a>レッスン 1:Analysis Services データベース (基本的なデータ マイニング チュートリアル) を準備します。
 ...
 このアプリケーションを設計[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]を作成開始[!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]の[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)][!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]プロジェクトに基づいて、[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]多次元モデリングとデータ マイニング プロジェクト テンプレート。 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] プロジェクトを作成したら、データ ソースを 1 つ以上定義します。 呼ばれる、メタデータのビューを定義し、*データ ソース ビュー*、データ ソースから選択したテーブルとビューから。  
