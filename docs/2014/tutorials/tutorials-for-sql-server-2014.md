---
title: SQL Server 2014 チュートリアル |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
-   ダウンロードする[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]には、チュートリアルで使用するサンプル[SQL Server のサンプル](http://social.technet.microsoft.com/wiki/contents/articles/3735.sql-server-samples-readme.aspx#About_Crescent_Sample_Images)CodePlex で公開します。  
  
-   ダウンロードする、[!INCLUDE[ssGemini](../includes/ssgemini-md.md)]ブックと[!INCLUDE[ssCrescent](../includes/sscrescent-md.md)]で使用するレポート[!INCLUDE[ssCrescent](../includes/sscrescent-md.md)]チュートリアルについてに移動して[PowerPivot と Power View における HelloWorldPicnic サンプル モデル用のイメージ ファイル](http://www.microsoft.com/download/details.aspx?id=26719)です。  
  
    > [!NOTE]  
    >  [!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] 機能は、 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]用アドイン[!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[SPS2010](../includes/sps2010-md.md)] Enterprise Edition。  
  
-   ダウンロードする[!INCLUDE[ssSQL14](../includes/sssql14-md.md)]のバージョンの[!INCLUDE[ssSampleDBCoShort](../includes/sssampledbcoshort-md.md)]データベースに移動して[Adventure Works 2014 サンプル データベース](http://msftdbprodsamples.codeplex.com/releases/view/125550)CodePlex で公開します。  
  
-   ダウンロードする[!INCLUDE[ssSQL11](../includes/sssql11-md.md)]のバージョンの[!INCLUDE[ssSampleDBCoShort](../includes/sssampledbcoshort-md.md)]データベースに移動して[SQL Server 2012 用 Adventure Works](http://msftdbprodsamples.codeplex.com/releases/view/55330) CodePlex で公開します。  
  
-   一覧を表示する[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]チュートリアルについてに移動して[チュートリアル](http://msdn.microsoft.com/library/ms167593.aspx)MSDN ライブラリです。  
