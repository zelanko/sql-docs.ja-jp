...
4.  **URL**のボックス、 **Web 参照の追加** ダイアログ ボックスなど、レポート サーバー Web サービスのサービスの説明を取得する URL を入力http://localhost/reportserver/reportservice2010.asmxします。 をクリックし、**移動**Web サービスに関する情報を取得するボタンをクリックします。  
