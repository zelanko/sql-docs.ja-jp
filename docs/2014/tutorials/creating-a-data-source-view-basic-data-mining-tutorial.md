---
title: 作成、データ ソース ビュー (基本的なデータ マイニング チュートリアル) |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/06/2017
...
6.  既定では、Adventure Works DW 2012 という名前のデータ ソース ビューが **[ウィザードの完了]** ページに表示されます。 名前を変更`Targeted Mailing`、順にクリック**完了**です。  
