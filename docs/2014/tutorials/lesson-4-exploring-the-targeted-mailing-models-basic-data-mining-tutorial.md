---
title: 'レッスン 4: 絞り込みモデル (基本的なデータ マイニング チュートリアル) の検証 |Microsoft ドキュメント'
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="lesson-4-exploring-the-targeted-mailing-models-basic-data-mining-tutorial"></a>レッスン 4: 絞り込みメール配信モデルの検証 (基本的なデータ マイニング チュートリアル)
 ...
 使用すると[!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]で、モデルを調査して、作成した各モデルが表示されている、**マイニング モデル ビューアー**データ マイニング デザイナーのタブです。 各種のビューアーを使用して、モデルを参照できます。 これらのビューアーは、[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] でも使用できます。  
 ...
 詳細についてに取得する場合[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]もと呼ばれる、HTML ビューアーを提供、**汎用コンテンツ ツリー ビューアー**、モデル データおよび半表形式で、検出されたパターンに関する詳細情報を表示します。 詳細については、「 [Microsoft 汎用コンテンツ ツリー ビューアーを使用したモデルの参照](../../2014/analysis-services/data-mining/browse-a-model-using-the-microsoft-generic-content-tree-viewer.md)」をご覧ください。  
...
-   [Naive Bayes モデルの検証&#40;基本的なデータ マイニングのチュートリアル&#41;](../../2014/tutorials/exploring-the-naive-bayes-model-basic-data-mining-tutorial.md)  
 ...
 使用して 3 つすべてのモデルを表示することができます、**汎用コンテンツ ツリー ビューアー**数式やデータ値などを抽出します。  
