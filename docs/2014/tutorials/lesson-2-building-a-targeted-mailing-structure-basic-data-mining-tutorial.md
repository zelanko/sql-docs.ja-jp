---
title: 'レッスン 2: 絞り込みメール構造 (基本的なデータ マイニング チュートリアル) を作成する |Microsoft Docs'
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="see-also"></a>参照  
 ...
 [リレーショナル マイニング構造の作成](../../2014/analysis-services/data-mining/create-a-relational-mining-structure.md)  
