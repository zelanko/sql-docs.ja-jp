---
title: ファイルの要素 (DTA) |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
|特性|説明|  
|--------------------|-----------------|  
|**データ型と長さ**|`string` データ型を使用して、ワークロード ファイルのあるディレクトリへのパスを指定します。 以下に例を示します。<br /><br /> `<File>C:\Tuning\tun.sql</File>`<br /><br /> 長さの制限は、サーバーによって決まります。|  
|**既定値**|[なし] :|  
