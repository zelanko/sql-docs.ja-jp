...
> [!NOTE]  
>  としてネットワーク プロトコルを指定する、 **sqlcmd**パラメーターを参照してください"する方法: sqlcmd.exe を使用してデータベース エンジンに接続"で[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]オンライン ブックの「します。  
