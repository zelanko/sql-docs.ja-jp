...
###  <a name="bkmk_bi_Sharepoint2013_3tier"></a>PowerPivot for SharePoint 2013 と Reporting Services 3 台のサーバー配置  
 ...
 ![Ssas および Ssrs sharepoint モード3サーバー配置](../../../2014/sql-server/install/media/as-and-rs-3server-deployment.gif "Ssas と ssrs Sharepoint モード3サーバー配置")  
...
|**(7)**|SharePoint コンテンツ データベース、構成データベース、およびサービス アプリケーション データベース。|  
 ...
 Sharepoint の![設定](https://docs.microsoft.com/analysis-services/analysis-services/media/as-sharepoint2013-settings-gear.gif "sharepoint")の設定では、Microsoft SQL Server 接続 (https://connect.microsoft.com/SQLServer/Feedback) を[使用してフィードバックと連絡先情報を送信し](https://connect.microsoft.com/SQLServer/Feedback)ます。  
...
###  <a name="bkmk_powerpivot_sharepoint2013_1server"></a>PowerPivot for SharePoint 2013 のシングルサーバー配置  
 ...
 シングルサーバー配置(../../../2014/sql-server/install/media/as-powerpivot-mode-1server-deployment.gif "PowerPivot for SharePoint")単一サーバー展開の![PowerPivot for SharePoint]  
...
###  <a name="bkmk_powerpivot_sharepoint2013_3server"></a>PowerPivot for SharePoint 2013 3 サーバーの展開  
 ...
 Powerpivot(../../../2014/sql-server/install/media/as-powerpivot-mode-3server-deployment.gif "Mode3 サーバー配置")としての![Powerpivot Mode3 サーバー配置として]  
...
###  <a name="bkmk_powerpivot_ssrs_sharepoint2013_1server"></a>PowerPivot for SharePoint 2013 と Reporting Services 単一サーバー配置  
 ...
 ![Ssas および Ssrs sharepoint モード1サーバー配置](../../../2014/sql-server/install/media/as-and-rs-1server-deployment.gif "Ssas と ssrs Sharepoint モード1サーバー配置")  
...
###  <a name="bkmk_powerpivot_ssrs_sharepoint2013_2server"></a>PowerPivot for SharePoint 2013 と Reporting Services 2 台のサーバー配置  
 ...
 ![Ssas および Ssrs Sharepoint モード2サーバー配置](../../../2014/sql-server/install/media/as-and-rs-2server-deployment.gif "Ssas と ssrs Sharepoint モード2サーバー配置")  
...
##  <a name="bkmk_example_deployments_2010"></a>SharePoint 2010 配置トポロジの例  
 ...
 ![論理アーキテクチャダイアグラム]の(../../../2014/sql-server/install/media/sql11bisetup.gif "論理アーキテクチャの図")  
...
##  <a name="bkmk_sharepoint2010_1server"></a>単一サーバー配置  
 ...
 すべての機能を 1 台のサーバーにインストールするには、 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] と [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] を順番に同じ物理サーバーにインストールします。 スタンドアロンサーバー構成の手順については、「[Deployment のチェックリスト:Reporting Services、Power View、および PowerPivot for SharePoint @ no__t-0。  
