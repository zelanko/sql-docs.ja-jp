...
### <a name="description"></a>説明  
 ...
 の[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]他のエディションの CPU およびメモリの制限の詳細については、「 [SQL Server のエディション別の計算容量制限](../compute-capacity-limits-by-edition-of-sql-server.md)」および「 [SQL Server の各エディションがサポートするメモリ](https://go.microsoft.com/fwlink/?LinkId=212633)」を参照してください。  
