---
title: ライセンスのトポロジの例と SQL Server 2014 セルフ サービス ビジネス インテリジェンスのコスト |Microsoft ドキュメント
ms.custom: ''
ms.date: 05/24/2017
...
-   [SQL Server 2014 のライセンス概要](#bkmk_sql_server_license)  
  
-   [SharePoint 2013 のライセンス概要](#bkmk_sharepoint_license)  
  
-   [個別の PowerPivot サーバーと 3 層トポロジ](#bkmk_3tier_powerpivot)  
...
-   SharePoint モードの Reporting Services (データ警告を含む)。  
 ...
 詳細については、の機能の表を参照して[を SharePoint と SQL Server BI 機能をインストール&#40;PowerPivot と Reporting Services&#41;](../../../2014/sql-server/install/install-sql-server-bi-features-sharepoint-powerpivot-reporting-services.md)です。  
...
###  <a name="bkmk_sql_server_license"></a> SQL Server 2014 のライセンス概要  
...
-   [仮想環境のライセンス](http://www.microsoft.com/licensing/about-licensing/virtualization.aspx)(http://www.microsoft.com/licensing/about-licensing/virtualization.aspx)です。  
  
-   [SQL Server 2014 ライセンス データシート - Microsoft ホーム ページ](http://download.microsoft.com/download/6/6/F/66FF3259-1466-4BBA-A505-2E3DA5B2B1FA/SQL_Server_2014_Licensing_Datasheet.pdf)(http://download.microsoft.com/download/6/6/F/66FF3259-1466-4BBA-A505-2E3DA5B2B1FA/SQL_Server_2014_Licensing_Datasheet.pdf)です。  
...
###  <a name="bkmk_sharepoint_license"></a> SharePoint 2013 のライセンス概要  
...
-   [SharePoint ライセンスの完全な一覧](http://technet.microsoft.com/en-in/library/jj819267.aspx#bkmk_FeaturesOnPremise)(http://technet.microsoft.com/en-in/library/jj819267.aspx#bkmk_FeaturesOnPremise)です。  
  
-   [SharePoint の購入方法](http://sharepoint.microsoft.com/en-in/Pages/buy.aspx)(http://sharepoint.microsoft.com/en-in/Pages/buy.aspx)です。  
...
-   [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] for SharePoint は別のサーバー (3) で実行されます。 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] for SharePoint 2013、SharePoint ファームの外部で実行して、パフォーマンスを向上させる、SharePoint のインストールが含まれていないサーバーにインストールすることができます。  
...
-   Analysis Services の PowerPivot モードで、ファームの外部 (2) 実行されますが、PowerPivot が実行されている**同じ物理**他のアプリケーション ロール内のサーバー。  
  
-   データベース ロール (3) は、SQL Server Enterprise を使用できるように、[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]機能、AlwaysOn 可用性グループは、使用します。  
...
-   [Microsoft License Advisor](http://mla.microsoft.com/default.aspx) (http://mla.microsoft.com/default.aspx)です。  
  
-   [クライアント アクセス ライセンス (CAL) のデシジョン ツール](http://www.microsoft.com/licensing/CalTool/)(http://www.microsoft.com/licensing/CalTool/)です。  
  
-   [Microsoft Business Hub: 購入方法](http://www.microsoftbusinesshub.com/How_To_Buy#)(http://www.microsoftbusinesshub.com/How_To_Buy#)です。  
  
### <a name="microsoft-license-information"></a>Microsoft のライセンスに関する情報  
  
-   [ライセンス情報: クライアント アクセス ライセンスと管理ライセンス](http://www.microsoft.com/licensing/about-licensing/client-access-license.aspx)(http://www.microsoft.com/licensing/about-licensing/client-access-license.aspx)です。  
  
-   [ライセンス情報: 製品のライセンスの検索](http://www.microsoftvolumelicensing.com/default.aspx)(http://www.microsoftvolumelicensing.com/default.aspx)です。  
  
-   [ボリューム ライセンス: 価格と購入方法](http://www.microsoft.com/licensing/how-to-buy/how-to-buy.aspx)(http://www.microsoft.com/licensing/how-to-buy/how-to-buy.aspx)です。  
...
-   [SQL Server 2014 のライセンスに対する変更](http://www.brentozar.com/archive/2014/04/sql-server-2014-licensing-changes)(http://www.brentozar.com/archive/2014/04/sql-server-2014-licensing-changes)です。  
  
-   [SQL Server 2014 のライセンスに対する変更](https://www.directionsonmicrosoft.com/sites/default/files/PDFs/Licensing_Changes_for_SQL_Server_2014.pdf)(https://www.directionsonmicrosoft.com/sites/default/files/PDFs/Licensing_Changes_for_SQL_Server_2014.pdf)です。  
  
-   [SharePoint 2013 のライセンス コストの推定](http://www.degdigital.com/blog/sharepoint-2013-licensing-for-dummies/)(http://www.degdigital.com/blog/sharepoint-2013-licensing-for-dummies/)です。  
  
-   [Microsoft ボリューム ライセンス カスタマー コミュニティ](http://www.microsoft.com/licensing/existing-customers/community.aspx)(http://www.microsoft.com/licensing/existing-customers/community.aspx)です。  
