...
### <a name="install-and-deploy-the-farm-solution"></a>ファームソリューションのインストールと配置
...
6.  [サーバー名] に、 **\<サーバー名 >** を入力します。ここで **\<サーバー名 >** は、PowerPivot for SharePoint がインストールされているコンピューターの名前です。  
