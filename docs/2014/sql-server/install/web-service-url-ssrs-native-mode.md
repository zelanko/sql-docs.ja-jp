...
-   "*nnn.nnn.nnn.nnn* " は、コンピューターのネットワーク アダプター カードの IPv4 アドレスです。 ネットワークで IPv6 アドレス指定が使用されている場合、IP アドレスは、ヘッダー>:*nnnn: nnnn: nnnn:* nnnn の\<形式と同様の 8 4 バイトのフィールドの128ビット値になります。  
