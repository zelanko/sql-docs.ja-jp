...
-   SharePoint 開発者ツールのみ SharePoint スタンドアロン構成をサポートします。  詳細については、SharePoint のマニュアルを参照してください: [SharePoint ソリューションの開発要件](http://msdn.microsoft.com/library/ee231582.aspx)です。  
