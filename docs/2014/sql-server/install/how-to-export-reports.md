---
title: '方法: レポートのエクスポート |Microsoft Docs'
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "37181489"
---
# <a name="how-to-export-reports"></a>方法: レポートのエクスポート
...
1.  レポート ビューアーで、エクスポートするレポートを表示します。 手順については、次を参照してください。[方法: アップグレード アドバイザーのレポート表示](../../../2014/sql-server/install/how-to-view-an-upgrade-advisor-report.md)します。  
  
2.  レポートをフィルター処理するから値を選択、**でフィルター処理**ボックス。  
  
3.  クリックして**レポートをエクスポート**します。  
