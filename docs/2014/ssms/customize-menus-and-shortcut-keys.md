...
ms.locfileid: "36072463"
---
# <a name="customize-menus-and-shortcut-keys"></a>メニューとショートカット キーのカスタマイズ
  キーボード ショートカット キーでは、alt キーを押してメニュー コマンドやボタンを選択できます。*\<単一文字 >* です。 たとえば、 **[編集]** メニューを開くには、ALT + E キーを押します。 ツール バーのボタン、メニュー、メニュー コマンドの並べ替えや変更を行うには、 **[ユーザー設定]** ダイアログ ボックスを使用します。 マウスを使用して設定を変更する方法と、キーボードだけを使用して設定を変更する方法を以下に示します。  
