 ...
 **Objects that depend on**_\<選択したオブジェクトに依存するオブジェクト>_    
 このボタンをクリックすると、依存関係が監視され、選択されているオブジェクトに依存するオブジェクトの一覧が表示されます。  
  
 **Objects on which**_\<選択したオブジェクト>_ が**依存**するオブジェクト      
 このボタンをクリックすると、依存関係が監視され、選択されているオブジェクトが依存するオブジェクトの一覧が表示されます。  
  
 **依存関係**  
 _ \<選択したオブジェクト>_ **に依存するオブジェクト**がクリックされると、選択したオブジェクトに依存するオブジェクトの階層ビューが表示されます。 _ \<選択したオブジェクト>_ **依存****するオブジェクト**がクリックされると、選択したオブジェクトが依存するオブジェクトの階層ビューが表示されます。  
