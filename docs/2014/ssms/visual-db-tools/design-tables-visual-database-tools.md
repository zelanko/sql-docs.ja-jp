...
## <a name="in-this-section"></a>このセクションの内容  
 [Visual Database Tools &#40;テーブルデザイナーを開き&#41;](visual-database-tools.md)  
 新規または既存のデータベース テーブルを開きます。  
  
 [Visual Database Tools &#40;テーブルデザイナーで作業内容を保存&#41;](../../database-engine/save-your-work-in-table-designer-visual-database-tools.md)  
