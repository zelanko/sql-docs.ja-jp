...
ms.locfileid: "37194832"
---
# <a name="execute-statements-against-multiple-servers-simultaneously-sql-server-management-studio"></a>複数のサーバーに対するステートメントの同時実行 (SQL Server Management Studio)
