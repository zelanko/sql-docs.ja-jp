---
title: 複数のサーバーに対してステートメントを同時に実行 (SQL Server Management Studio) |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "36173387"
---
# <a name="execute-statements-against-multiple-servers-simultaneously-sql-server-management-studio"></a>複数のサーバーに対してステートメントを同時に実行 (SQL Server Management Studio)
