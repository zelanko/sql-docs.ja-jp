 ...
 **入力列**  
  ...
  **[使用できる入力列]** ボックスの一覧を使用して、マッピングを変更できます。 出力から列を除外するには、[ ** \<>を無視**] を選択します。  
...
## <a name="see-also"></a>参照  
 ...
 [[フラットファイル変換先エディター] &#40;[接続マネージャー] ページ&#41;](../../2014/integration-services/flat-file-destination-editor-connection-manager-page.md)  
