...
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client 11.0 OLEDB プロバイダーでは、マルチサブネット フェールオーバー クラスタリングの新しい接続文字列キーワード (MultiSubnetFailover=True) はサポートされません。 詳細については、次を参照してください。、 [SQL Server リリース ノート](http://go.microsoft.com/fwlink/?LinkId=247824)とブログの投稿、 [AlwaysOn マルチ サブネット フェールオーバーと SSIS](http://go.microsoft.com/fwlink/?LinkId=247825)、www.mattmasson.com にします。  
