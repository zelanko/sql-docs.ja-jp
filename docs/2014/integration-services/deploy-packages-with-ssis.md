...
ms.locfileid: "53368254"
---
# <a name="ssis-tutorial-deploying-packages"></a>SSIS チュートリアル:パッケージを展開します。
 ...
 **このチュートリアルを完了するまでに時間を推定するには。** 2 時間  
