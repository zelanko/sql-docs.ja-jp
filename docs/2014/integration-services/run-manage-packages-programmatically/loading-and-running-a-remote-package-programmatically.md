...
-   MSDN ライブラリのビデオ「[SQL Server エージェント (SQL Server ビデオ) を使用して SSIS パッケージの実行を自動化](https://technet.microsoft.com/sqlserver/ff686764.aspx)、technet.microsoft.com  
