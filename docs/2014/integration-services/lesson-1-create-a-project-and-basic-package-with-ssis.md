---
title: 'レッスン 1: プロジェクトと基本パッケージの作成 |Microsoft ドキュメント'
ms.custom: ''
ms.date: 06/13/2017
...
> [!IMPORTANT]  
>  このチュートリアルには、 **AdventureWorksDW2012** サンプル データベースが必要です。 **AdventureWorksDW2012** をインストールおよび展開する方法の詳細については、「[Reporting Services Product Samples on CodePlex (CodePlex の Reporting Services 製品サンプル)](http://go.microsoft.com/fwlink/p/?LinkID=52691)」を参照してください。  
