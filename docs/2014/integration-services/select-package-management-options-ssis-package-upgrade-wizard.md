...
-   [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Native Client  
  ...
  [!INCLUDE[ssIS](../includes/ssis-md.md)] パッケージ アップグレード ウィザードは、接続マネージャーに格納されている接続文字列だけを更新します。 
  [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] の式言語またはスクリプト タスクのコードによって動的に構築される接続文字列は更新しません。  
 ...
 **パッケージのアップグレードが失敗したときにアップグレードプロセスを続行する**  
