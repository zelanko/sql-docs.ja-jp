...
>   
>  コレクションに追加するファイルを式で指定するには、 **[コレクション]** ページの **[式]** を展開し、 **[FileSpec]** プロパティを選択して参照ボタン ([…]) をクリックし、プロパティ式を追加します。 指定ファイルの動的選択の詳細については、「 [SSIS– ファイル マスクの動的設定: FileSpec](http://go.microsoft.com/fwlink/?LinkId=238154)」を参照してください。  
...
-   beyondrelational.com のブログ「 [SSIS– ファイル マスクの動的設定: FileSpec](http://go.microsoft.com/fwlink/?LinkId=238154)」  
