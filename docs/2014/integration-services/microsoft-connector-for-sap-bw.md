...
# <a name="microsoft-connector-11-for-sap-bw"></a>Microsoft Connector 1.1 for SAP BW
  SAP BW [!INCLUDE[msCoName](../includes/msconame-md.md)]のコネクタ1.1 は、SAP Netweaver BW version 7 システムからデータを抽出したり、データをデータに読み込んだりするための3つのコンポーネントのセットで構成されています。  
...
## <a name="components"></a>Components  
 SAP BW [!INCLUDE[msCoName](../includes/msconame-md.md)]のコネクタ1.1 には、次のコンポーネントがあります。  
...
## <a name="documentation"></a>ドキュメント  
 SAP BW の[!INCLUDE[msCoName](../includes/msconame-md.md)]コネクタ1.1 のこのヘルプファイルには、次のトピックとセクションが含まれています。  
  
 [Microsoft Connector 1.1 for SAP BW のインストール](installing-the-microsoft-connector-for-sap-bw.md)  
 SAP BW の[!INCLUDE[msCoName](../includes/msconame-md.md)]コネクタ1.1 のインストール要件について説明します。  
  
 [Microsoft Connector 1.1 for SAP BW のコンポーネント](microsoft-connector-for-sap-bw-components.md)  
 SAP BW の[!INCLUDE[msCoName](../includes/msconame-md.md)]コネクタ1.1 の各コンポーネントについて説明します。  
  
 [Microsoft Connector 1.1 for SAP BW の F1 ヘルプ](microsoft-connector-for-sap-bw-f1-help.md)  
 SAP BW の[!INCLUDE[msCoName](../includes/msconame-md.md)]コネクタ1.1 の各コンポーネントのユーザーインターフェイスについて説明します。  
