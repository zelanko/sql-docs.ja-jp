 ...
 **RemoveFromMessageQueue**  
 メッセージが受信された後にキューからメッセージを削除するかどうかを示します。 既定では、この値はに`False`設定されています。  
...
|**文字列メッセージを変数に**|メッセージです。<br /><br /> この値を選択すると、動的オプションの **[StringMessage]** が表示されます。|  
 ...
 **変数**  
 変数名を入力するか、 \<[**新しい変数...**> をクリックし、新しい変数を構成します。  
...
|**成る**|メッセージに **[CompareString]** オプションで指定した文字列が含まれている必要があります。|  
 ...
 **変数**  
 受信したメッセージを保持する変数の名前を入力するか\<、[**新しい変数...**> をクリックして新しい変数を構成します。  
