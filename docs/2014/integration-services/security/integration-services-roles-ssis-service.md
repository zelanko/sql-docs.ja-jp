...
|----------|-----------------|------------------|  
|`db_ssisadmin`<br /><br /> or<br /><br /> `sysadmin`|独自のパッケージを列挙する。<br /><br /> すべてのパッケージを列挙する。<br /><br /> 独自のパッケージを表示する。<br /><br /> すべてのパッケージを表示する。<br /><br /> 独自のパッケージを実行する。<br /><br /> すべてのパッケージを実行する。<br /><br /> 独自のパッケージをエクスポートする。<br /><br /> すべてのパッケージをエクスポートする。<br /><br /> 
...
|**db_ssisoperator**|すべてのパッケージを列挙する。<br /><br /> すべてのパッケージを表示する。<br /><br /> すべてのパッケージを実行する。<br /><br /> すべてのパッケージをエクスポートする。<br /><br /> 
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] エージェント内のすべてのパッケージを実行する。|なし|  
...
## <a name="access-to-packages"></a>パッケージへのアクセス  
 ...
 ユーザー定義ロールを使用する場合は、パッケージに割り当てる前に、 `msdb`データベースに追加する必要があります。 
  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]では、新しいデータベース ロールを作成できます。  
...
-   **オブジェクトエクスプローラーを開き Integration Services に接続します**  
