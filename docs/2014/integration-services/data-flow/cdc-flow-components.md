...
|7-ERROR|CDC グループはエラー状態です。|  
 ...
 ![状態図](../media/statediagram.gif "状態図")  
...
-   mattmasson.com のブログ「 [SQL Server 2012 用の SSIS の CDC](http://go.microsoft.com/fwlink/?LinkId=242543)」  
