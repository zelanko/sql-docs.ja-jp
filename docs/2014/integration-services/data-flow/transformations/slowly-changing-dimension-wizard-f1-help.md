...
# <a name="slowly-changing-dimension-wizard-f1-help"></a>緩やかに変化するディメンション ウィザードの F1 ヘルプ
 ...
 [ディメンション テーブルおよびキーを選択して&#40;緩やかに変化するディメンション ウィザード&#41;](select-a-dimension-table-and-keys-slowly-changing-dimension-wizard.md)  
 緩やかに変化するディメンション テーブルを選択して、そのキー列を指定します。  
  
 [緩やかに変化するディメンション列&#40;緩やかに変化するディメンション ウィザード&#41;](slowly-changing-dimension-columns-slowly-changing-dimension-wizard.md)  
 選択された緩やかに変化するディメンションの列の変化の種類を選択します。  
  
 [固定属性と変化する属性オプション&#40;緩やかに変化するディメンション ウィザード](fixed-and-changing-attribute-options-slowly-changing-dimension-wizard.md)  
