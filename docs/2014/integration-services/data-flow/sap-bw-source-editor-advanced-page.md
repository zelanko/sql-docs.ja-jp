...
|オプション|説明|  
|------------|-----------------|  
|**自動文字列変換**|すべての文字列を変換`nvarchar`SAP Netweaver BW システムが Unicode システムの場合。 それ以外の場合にすべての文字列を変換`varchar`です。|  
...
> [!NOTE]  
>  このオプションは、エディターの **[接続マネージャー]** ページの **[実行モード]** の値として **[W - 通知を待機]** を選択した場合にのみ有効です。 詳細については、次を参照してください。 [SAP bw 変換元エディター&#40;接続マネージャー ページ&#41;](sap-bw-source-editor-connection-manager-page.md)です。  
