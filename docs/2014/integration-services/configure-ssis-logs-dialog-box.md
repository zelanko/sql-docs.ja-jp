 ...
 **Configuration**  
 ...
 関連項目 :[OLE DB 接続マネージャー](connection-manager/ole-db-connection-manager.md)マネージャー、[ファイル接続マネージャー](connection-manager/file-connection-manager.md)  
