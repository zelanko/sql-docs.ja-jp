---
title: 'レッスン 4: エラー フロー リダイレクトの追加 |Microsoft ドキュメント'
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="lesson-4-adding-error-flow-redirection"></a>レッスン 4 : エラー フロー リダイレクションの追加
 ...
 このレッスンで開発したパッケージのコピーを作成します[レッスン 3: 追加のログ記録](lesson-3-add-logging-with-ssis.md)です。 この新しいパッケージを使用し、壊れたサンプル データ ファイルを作成します。 この破損ファイルは、パッケージを実行するときに変換エラーを発生させます。  
...
> [!IMPORTANT]  
>  このチュートリアルには、 **AdventureWorksDW2012** サンプル データベースが必要です。 インストールおよび展開方法の詳細についての**AdventureWorksDW2012**を参照してください[Reporting Services 製品サンプル CodePlex でのプロジェクト](http://go.microsoft.com/fwlink/p/?LinkId=526910)です。  
