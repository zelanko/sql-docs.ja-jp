---
title: (SSIS パッケージ アップグレード ウィザード) パッケージのアップグレード |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
 ...
 **アップグレード済みの SQL Server データベースまたはパッケージ ストアに保存されたパッケージを表示するには**  
 ...
 **アップグレード済みの SQL Server Data Tools からアップグレードされたパッケージを表示するには**  
