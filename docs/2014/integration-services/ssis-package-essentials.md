---
title: SSIS パッケージ Essentials |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
1.  MSDN.Microsoft.com のビデオ「 [基本パッケージの作成 (SQL Server ビデオ)](http://go.microsoft.com/fwlink/?LinkId=131023)」  
