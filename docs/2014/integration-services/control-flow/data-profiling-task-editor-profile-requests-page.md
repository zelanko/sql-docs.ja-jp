...
-   表示を選択した場合**すべての要求**が 2 つの列の要求ペイン。**プロファイルの種類**と**要求 ID**します。  
  
-   5 つの列プロファイルのいずれかを表示することを選択した場合は、4 つの列が要求ペイン。**プロファイルの種類**、**テーブルまたはビュー**、**列**、および**要求 ID**します。  
  
-   候補キー プロファイルを表示することを選択した場合は、4 つの列が要求ペイン。**プロファイルの種類**、**テーブルまたはビュー**、 **KeyColumns**、および**要求 ID**します。  
  
-   機能依存プロファイルを表示することを選択した場合は、5 つの列が要求ペイン。**プロファイルの種類**、**テーブルまたはビュー**、**決定列**、**依存列**、および**要求 ID**します。  
  
-   値包含プロファイルを表示することを選択した場合は、6 つの列が要求ペイン。**プロファイルの種類**、**サブセット側のテーブルまたはビュー**、**スーパー セット側のテーブルまたはビュー**、**サブセット側の列**、 **スーパーセット側の列**、および**要求 ID**します。  
