...
4.  いることを確認の値、`AllowConfigurationChanges`属性は**true**と XML が含まれています、 `Package` 2 つのパッケージの各要素、 `MiscellaneousFile` 4 つのパッケージでないファイルの各要素と`ConfigurationFile`2 つの XML 構成ファイルの各要素です。  
