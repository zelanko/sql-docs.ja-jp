...
# <a name="planning"></a>計画
  [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]理解[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]を深めるには、次のトピックを参考にしてください。 ニーズに最も合った [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 環境をインストールおよび構成する方法について学習してください。  
  
 ![小さいファイルフォルダーアイコン](../../2014/integration-services/media/filefolder-small.gif "小さいファイル フォルダー アイコン")**全般 Reporting Services 機能の計画とアーキテクチャ**  
 ...
 ![小さいファイルフォルダーアイコン](../../2014/integration-services/media/filefolder-small.gif "小さいファイル フォルダー アイコン") **Reporting Services セットアップ**  
