---
title: 軸のプロパティ ダイアログ ボックス、軸のオプション (レポート ビルダーおよび SSRS) |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/08/2017
