...
# <a name="contents-page-report-manager"></a>[コンテンツ] ページ (レポート マネージャー)
 ...
 [コンテンツ] ページには、表示権限のあるアイテムが表示されます。 所持している権限によっては、アイテムを移動、削除、および追加することもできます。 
  **[削除]** ボタンおよび **[移動]** ボタンにアクセスするには、 **[詳細ビュー]** をクリックする必要があります。 アイテムがまったく表示されない場合は、レポート サーバー管理者に問い合わせてください。 レポート サーバーのコンテンツや操作にアクセスできるロールに割り当てられていない可能性があります。  
 ...
 **[詳細ビュー]**  
 アイテムに関する詳細な情報が含まれる一覧として [コンテンツ] ページを表示する場合にクリックします。 
  **[詳細ビュー]** では、 **[削除]** ボタンと **[移動]** ボタンを使用して、フォルダー内のアイテムを削除および再配置することができます。  
