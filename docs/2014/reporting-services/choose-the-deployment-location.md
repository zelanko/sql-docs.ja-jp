 ...
 **レポート サーバー**  
 たとえば、レポート サーバーの仮想ディレクトリの URL を入力http://localhost/reportserverします。 これは、レポート マネージャーではなく、レポート サーバーの仮想ディレクトリです。 既定では、レポート サーバーは、reportserver という名前の仮想ディレクトリにインストールされます。  
