...
##  <a name="CreateTable"></a>1. はじめにから新しいレポートを作成します  
...
##  <a name="DataConnection"></a>sr-1. テーブル ウィザードでデータ接続を指定する  
...
##  <a name="Query"></a>ドル. テーブル ウィザードでクエリを作成する  
...
##  <a name="Subtotals"></a>引か. テーブル ウィザードで小計行と合計行を追加する  
...
##  <a name="Style"></a>1e. テーブル ウィザードでスタイルを選択する  
...
##  <a name="FormatCurrency"></a>2. データを通貨として書式設定する  
...
##  <a name="FormatDate"></a>3. データを日付として書式設定する  
...
##  <a name="Title"></a>5. レポートタイトルを追加する  
