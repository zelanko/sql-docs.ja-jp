...
#### <a name="microsoft-word-and-microsoft-excel-1997-2003-rendering"></a>Microsoft Word および Microsoft Excel 1997-2003 表示拡張機能  
 BIFF8[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]の表示拡張[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]機能は、 [!INCLUDE[msCoName](../includes/msconame-md.md)] Word および[!INCLUDE[msCoName](../includes/msconame-md.md)] Excel 1997-2003 バイナリインターチェンジファイル形式を報告します。 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)][!INCLUDE[msCoName](../includes/msconame-md.md)] Office 2007-2010 Open XML 形式で表示される拡張機能が含まれています。  
...
#### <a name="sql-server-2005-and-earlier-custom-report-items"></a>SQL Server 2005 およびそれ以前のバージョンのカスタム レポート アイテム  
 2005以前のバージョンで[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]コンパイルされたカスタムレポートアイテム (CRI) は非推奨となりました。  
  
#### <a name="reporting-services-snapshots-2005-and-earlier"></a>Reporting Services Snapshots 2005 およびそれ以前のバージョン  
 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]2005以前で[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]レンダリングされたスナップショットは非推奨となりました。  
  
#### <a name="report-models"></a>レポート モデル  
 セマンティック モデリング言語 (SMDL) レポート モデルは非推奨とされます。 既存のレポートモデルをレポートの[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]データソースとして使用することもできますが、レポートモデルへの依存関係を削除するには、レポートの更新を検討する必要があります。  
