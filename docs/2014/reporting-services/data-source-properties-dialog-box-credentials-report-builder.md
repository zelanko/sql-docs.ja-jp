---
title: データ ソースのプロパティ ダイアログ ボックス、資格情報 (レポート ビルダー) |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
