...
# <a name="schedule-properties-reports-page"></a>[スケジュールのプロパティ] ([レポート] ページ)
 ...
 このページを開くを起動[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]、開いているレポート サーバーへの接続、**共有スケジュール**フォルダー、共有スケジュールを右クリックし、選択**プロパティ**、順にクリック**レポート**.  
