...
##  <a name="bkmk_ConfigurationandDeploymentProperties"></a>構成と展開のプロパティ  
...
-   TargetServerVersion は、TargetServerURL プロパティで指定された対象[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]レポートサーバーにインストールされているの想定されるバージョンを識別する配置プロパティです。  
...
##  <a name="bkmk_SupportedVersions"></a>サポートされるバージョン  
...
|レポート サーバー プロジェクト<br /><br /> or<br /><br /> レポート サーバー プロジェクト ウィザード|[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]|2005 RDL スキーマ|[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]また[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]はレポートサーバー||  
