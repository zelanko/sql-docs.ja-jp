---
title: Microsoft のさまざまな環境でビジネス インテリジェンス機能の比較 |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="compare-business-intelligence-capabilities-in-different-microsoft-environments"></a>さまざまな Microsoft 環境での Business Intelligence 機能の比較
  Microsoft [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Business Intelligence は、さまざまななど、さまざまな環境で展開できます[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]SharePoint Server、SharePoint Online、および Power BI for Office 365 を使用します。 このトピックでは、各環境でサポートされるコンポーネントと機能を比較します。  
 ...
 **<sup>1</sup>**[データ管理におけるデータ スチュワードの役割について](https://support.office.com/Article/Understanding-the-Role-of-Data-Stewards-in-Data-Management-ae3352f3-4389-45e8-a682-7fd6edb92524?ui=en-US&rs=en-US&ad=US)と[ビデオ: Power BI の情報管理とデータ スチュワードシップ](https://www.youtube.com/watch?v=8dHOj68ts7c)です。    
  
 **<sup>2</sup>**[power BI Q & a: Power BI ブックの最適化 (クラウドのモデリング)](https://support.office.com/article/Power-BI-Q-A-Optimize-a-Power-BI-workbook-cloud-modeling--96dc5941-d0f1-44e2-9d9d-c038a3a55849?ui=en-US&rs=en-US&ad=US)です。    
  
 **<sup>3</sup>**[Office 365 の Power View での機能の新しい予測概要](http://blogs.msdn.com/b/powerbi/archive/2014/05/08/introducing-new-forecasting-capabilities-in-power-view-for-office-365.aspx)です。    
...
|機能をさまざまなブラウザーやバージョンで使用するための機能|Power View の視覚化の はい、  **<sup>3</sup>**|[はい]、ブックのファイルのサイズが 10 MB より少ない **<sup>3</sup>**|[はい]  **<sup>3</sup>**|  
  
 **<sup>1</sup>**[Microsoft Power BI](http://apps.microsoft.com/windows/app/microsoft-power-bi/b7e7c94d-2ea3-4fa6-a277-9d19a1f697ba)です。    
 ...
 **<sup>3</sup>**[のビジネス インテリジェンス (BI) ツールでモバイル デバイスのサポート](http://msdn.microsoft.com/library/dn151146\(v=sql.110\).aspx)と[Planning for Reporting Services と Power View のブラウザー サポート (Reporting Services 2014)](http://msdn.microsoft.com/library/ms156511.aspx)です。    
...
-   [Microsoft の BI レポートおよび分析ツールの概要](http://go.microsoft.com/fwlink/p/?LinkId=617093)  
