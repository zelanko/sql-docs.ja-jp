...
## <a name="see-also"></a>参照
 [警告管理者がデータ警告を Reporting Services するためのデータ警告マネージャー](../../2014/reporting-services/data-alert-manager-for-alerting-administrators.md) [](../ssms/agent/alerts.md)
