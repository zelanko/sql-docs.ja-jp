...
##  <a name="folders"></a><a name="bkmk_Folders"></a>フォルダ
...
|公開|プロジェクト内にある、レポート、レポート パーツ、データ ソース、またはデータセット以外のすべてのファイルは、リソースとしてアップロードされます。 リソースをパブリッシュするには、既存のアイテムをレポート デザイナーのプロジェクトに追加した後で、そのプロジェクトをレポート サーバーにパブリッシュします。|
...
|& (アンパサンド)|[amp]|*username*@*company*company&*company.com*は*username*[at]*company*[amp]*company.com*になります。|
|$ (ドル記号)|[dollar]|*ユーザー*名は*user*[] [ドル]*名*になります*Name*  $|
