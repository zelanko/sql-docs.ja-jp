 ...
 **[使用できるフィールド]**  
 テーブル上部のページ、テーブルのグループ化、またはテーブルの詳細に表示されるフィールドを選択します。 
  **[使用できるフィールド]** 内のフィールドを **[ページ]**、 **[グループ]**、または **[詳細]** に移動するには、フィールドを選択してから **[ページ]**、 **[グループ]**、または **[詳細]** をクリックします。 または、適切なボックスにフィールドをドラッグします。  
