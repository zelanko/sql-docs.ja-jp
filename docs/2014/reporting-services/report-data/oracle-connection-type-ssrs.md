...
-   Msdn.microsoft.com で[の Oracle の .NET Framework Data Provider の使用](https://go.microsoft.com/fwlink/?LinkId=112314)  
  
-   [Reporting Services を使用して Oracle データソースの構成とアクセスを行う方法](https://support.microsoft.com/kb/834305)  
  
-   [NETWORK SERVICE セキュリティプリンシパルにアクセス許可を追加する方法](https://support.microsoft.com/kb/870668)  
