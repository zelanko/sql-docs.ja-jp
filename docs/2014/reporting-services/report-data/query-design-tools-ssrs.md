---
title: クエリ デザイン ツールでレポート デザイナーの SQL Server データ ツール (SSRS) |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
