...
-   [通貨の書式を設定する](#bkmk_format_currency)  
  
-   [テキストのスタイルと列の幅を変更する](#bkmk_change_textstyle)  
...
##  <a name="bkmk_format_currency"></a>通貨の書式を設定する  
 [LineTotal] フィールドには通常の数値が表示されます。 このフィールドを書式設定して、数値を通貨として表示します。  
  
#### <a name="to-format-a-currency-field"></a>通貨フィールドを書式設定するには  
  
1.  
  `[LineTotal]` フィールド式が入力されているセルを右クリックし、[ **テキスト ボックスのプロパティ**] をクリックします。  
  
2.  
  **[数値]** をクリックし、 **[Category]** フィールドで **[通貨]** を選択します。  
...
##  <a name="bkmk_change_textstyle"></a>テキストのスタイルと列の幅を変更する  
