---
title: マップの緯線のプロパティ ダイアログ ボックス、ラベル |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/07/2017
...
ms.locfileid: "36083362"
---
# <a name="map-parallel-properties-dialog-box-labels"></a>[ラベル] ([マップの緯線のプロパティ] ダイアログ ボックス)
  使用して、 **MapParallel プロパティ** ダイアログ ボックスで、マップ ビューポートの水平グリッドのラベル オプションを変更します。 緯線とは、ビューポートに指定された座標系に応じて、次の値を表します。  
