...
|[ListInstalledSharePointVersions メソッド &#40;WMI&#41;](configurationsetting-method-listinstalledsharepointversions.md)|レポートサーバーと同じコンピューターにインストールされている[!INCLUDE[winSPServ](../../includes/winspserv-md.md)] [!INCLUDE[offSPServ](../../includes/offspserv-md.md)]Microsoft [!INCLUDE[SPF2010](../../includes/spf2010-md.md)]、、 [!INCLUDE[SPS2010](../../includes/sps2010-md.md)]またはのバージョンを表すトークンのセットを返します。|  
