...
4.  [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] プログラム ファイルの新しいフォルダーが作成されます。 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]インストール用のプログラムフォルダーには、MSRS12 が含まれます。\<*インスタンス名*>。
