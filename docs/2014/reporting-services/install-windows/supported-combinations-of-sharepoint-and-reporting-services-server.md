...
||レポート サーバー|アドイン|SharePoint バージョン|サポートされている|  
|-|-------------------|-------------|------------------------|---------------|  
...
|4|[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] および [!INCLUDE[ssSQL11SP1](../../includes/sssql11sp1-md.md)]|[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]|SharePoint 2010|はい<br /><br /> Exception:Power view の統合がサポートされていません。|  
