...
## <a name="see-also"></a>参照  
 [追加の Web またはアプリケーション サーバーをファーム (SharePoint Server 2010)](http://technet.microsoft.com/library/bb218968.aspx?missingurl=%2fen-us%2flibrary%2fe1aeaddf-6ee4-43a9-82b7-db20b68c71db\(Office.14\))   
