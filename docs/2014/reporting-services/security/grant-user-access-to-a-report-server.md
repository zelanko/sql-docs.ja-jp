---
title: ユーザー アクセスの許可をレポート サーバー (レポート マネージャー) |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
5.  **グループまたはユーザー名**Windows ドメイン ユーザー名を入力、または、この形式でアカウントをグループ化:\<ドメイン >\\< アカウント\>です。 フォーム認証やカスタム セキュリティを使用している場合は、その環境に合った適切な形式でユーザー アカウントまたはグループ アカウントを指定します。  
...
## <a name="see-also"></a>参照  
 ...
 [新しいロールの割り当て: ロールの割り当て ページの編集&#40;レポート マネージャー&#41;](../new-role-assignment-edit-role-assignment-page-report-manager.md)   
