...
3.  ドロップダウン メニューで次のいずれかの操作を行います。  
    ...
    -   
  **[管理]** をクリックします。 この操作により、レポートの [全般] プロパティ ページが開きます。 次に、[**サブスクリプション**] タブを選択します。ツールバーの [**新しいサブスクリプション**] をクリックするか、既存のサブスクリプションを選択して [**編集**] をクリックします。  
