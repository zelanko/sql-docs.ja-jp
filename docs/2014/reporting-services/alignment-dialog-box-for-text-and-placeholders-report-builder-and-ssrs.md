...
-   **一般的な**によって計算されたテキストを表示[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]します。 標準のテキストの配置を計算する方法の詳細については、「[テキストとプレースホルダーの書式設定 (レポート ビルダーおよび SSRS)](report-design/formatting-text-and-placeholders-report-builder-and-ssrs.md)」を参照してください。  
...
## <a name="see-also"></a>参照  
 ...
 [テキスト ボックス内のテキストを書式設定&#40;レポート ビルダーおよび SSRS&#41;](report-design/format-text-in-a-text-box-report-builder-and-ssrs.md)  
