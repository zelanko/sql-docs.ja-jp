...
-   **全般**によっ[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]て計算されたテキストを表示します。 標準のテキストの配置を計算する方法の詳細については、「[テキストとプレースホルダーの書式設定 (レポート ビルダーおよび SSRS)](report-design/formatting-text-and-placeholders-report-builder-and-ssrs.md)」を参照してください。  
  
-   **左**左揃えでテキストを表示します。  
  
-   **中央**中央に配置されたテキストを表示します。  
