...
## <a name="remarks"></a>コメント  
 ...
 `First`関数は、現在の (既定) のスコープ以外にグループ化フィルター式では使用できません。  
  
 使用することも`First`から最初の値を返し、ページ ヘッダーで、`ReportItems`ページの最初と最後のエントリを表示する辞書形式のヘッダーを生成するためにページのコレクション。  
