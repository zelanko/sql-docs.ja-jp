...
##  <a name="DefiningMinMax"></a>スケールの最小値、最大値、および間隔の定義  
...
2.  Interval に値を指定しない場合、既定値は Auto です。これは、最初のステップで指定された最小値と最大値に基づいて、アプリケーションが等間隔の間隔を計算することを意味します。 間隔の値を指定した場合は、ゲージで最大値と最小値の差が計算され、その数が間隔のプロパティに指定された値で除算されます。  
...
##  <a name="ReducingCollisions"></a>乗数によるラベルの衝突の削減  
...
##  <a name="SpecifyingScaleBar"></a>放射状スケールのスケールバーの幅、半径、および角度の指定  
...
## <a name="see-also"></a>参照  
 [ゲージの範囲の書式設定 &#40;レポートビルダーと SSRS&#41;](formatting-ranges-on-a-gauge-report-builder-and-ssrs.md)   
