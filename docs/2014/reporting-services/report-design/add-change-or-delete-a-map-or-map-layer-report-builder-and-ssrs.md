...
2.  ツールバーの**レイヤーの追加**ボタンをクリックし、ドロップダウン リストから、追加するレイヤーの種類をクリックします。**ポイント**、**行**、または**多角形**します。  
...
2.  ![[トップに戻る] リンクで使用される矢印アイコン](../../2014-toc/media/uparrow16x16.gif "[トップに戻る] リンクで使用される矢印アイコン") [トップに戻る](#BackToTop)  
