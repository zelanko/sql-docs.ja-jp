...
# <a name="sparklines-and-data-bars-report-builder-and-ssrs"></a>スパークラインとデータ バー (レポート ビルダーおよび SSRS)
 ...
 スパーク ラインをすぐに開始するを参照してください。[チュートリアル。レポートへのスパーク ラインの追加&#40;レポート ビルダー&#41; ](../tutorial-add-a-sparkline-to-your-report-report-builder.md)ビデオ[方法。テーブルにスパーク ラインを作成](https://go.microsoft.com/fwlink/?LinkId=197092)と[スパーク ライン、横棒グラフ、およびレポート ビルダーでのインジケーター](https://technet.microsoft.com/bi/video/ff877165)します。  
...
-   [縦棒グラフ&#40;レポート ビルダーおよび SSRS&#41;](charts-report-builder-and-ssrs.md):基本的な積み上げ縦棒グラフ、および 100% の積み上げ縦棒グラフ。  
  
-   [折れ線グラフ&#40;レポート ビルダーおよび SSRS&#41;](line-charts-report-builder-and-ssrs.md):3 D 折れ線グラフを除くすべてのグラフ。  
  
-   [面グラフ&#40;レポート ビルダーおよび SSRS&#41;](area-charts-report-builder-and-ssrs.md):3 D 面グラフを除くすべて  
  
-   [円グラフ&#40;レポート ビルダーおよび SSRS&#41;](pie-charts-report-builder-and-ssrs.md):ドーナツ グラフ、フラットで、3 D の両方が他の図形じょうごグラフやピラミッド グラフなどありません。  
  
-   [範囲グラフ&#40;レポート ビルダーおよび SSRS&#41;](range-charts-report-builder-and-ssrs.md):株価、ローソク足、エラー バー、およびボックス プロット グラフ。  
...
-   [横棒グラフ&#40;レポート ビルダーおよび SSRS&#41;](bar-charts-report-builder-and-ssrs.md):基本的な積み上げ縦棒グラフ、および 100% は積み上げ横棒グラフです。  
  
-   [縦棒グラフ&#40;レポート ビルダーおよび SSRS&#41;](charts-report-builder-and-ssrs.md):基本的な積み上げ縦棒グラフ、および 100% は積み上げ縦棒グラフです。 縦棒グラフはスパークラインまたはデータ バーのどちらにも変換できます。  
...
## <a name="see-also"></a>参照  
 ...
 [操作方法：(ビデオ) テーブルにスパーク ラインを作成します。](https://go.microsoft.com/fwlink/?LinkId=197092)  
