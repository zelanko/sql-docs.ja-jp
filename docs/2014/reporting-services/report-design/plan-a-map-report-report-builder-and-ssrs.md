...
##  <a name="MapPurpose"></a>マップの目的を指定します  
...
-   **空間データ。** 空間データ フィールドには、ポイント、線、または多角形をそれぞれ定義する座標セットが格納されます。  
  
-   **一致フィールド。** 個々の空間データ フィールドを一意に識別する 1 つまたは複数のフィールドです。 たとえば、店舗所在地を表すポイントの場合は、その店舗の名前を使用します。 その空間データに重複する店舗名が存在する場合は、店舗名に市区町村の名前も含めるなどして対処します。  
...
##  <a name="Embedding"></a>レポート定義のサイズとレポート処理時間のバランスを取る  
...
## <a name="see-also"></a>参照  
 ...
 [チュートリアル: マップレポート &#40;レポートビルダー&#41;](../tutorial-map-report-report-builder.md)   
