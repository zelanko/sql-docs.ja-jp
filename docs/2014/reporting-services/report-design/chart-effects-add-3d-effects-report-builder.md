...
3.  (省略可) **[3D オプション]** では、3D の角度とシーンのオプションに関連するさまざまなプロパティを設定できます。 これらのプロパティの詳細については、次を参照してください。 [3 d、傾斜、およびその他の効果グラフ&#40;レポート ビルダーおよび SSRS&#41;](chart-effects-3d-bevel-and-other-report-builder.md)です。  
