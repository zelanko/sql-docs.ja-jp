...
##  <a name="ComponentWorkflow"></a>レポートパーツパブリッシュのライフサイクル  
...
1.  
  **[レポート パーツのパブリッシュ]** ダイアログ ボックスで、パブリッシュするレポート アイテムにフラグを設定します。  
...
##  <a name="SearchReuseComponents"></a>レポートパーツの再利用  
...
##  <a name="RepublishingComponents"></a>レポートパーツの再パブリッシュ  
