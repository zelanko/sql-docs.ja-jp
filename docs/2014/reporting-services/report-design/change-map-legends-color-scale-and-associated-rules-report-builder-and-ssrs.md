...
2.  データが をクリックしてレイヤーを右クリックして_\<要素の型をマップ\>_**色のルール**します。  
...
2.  をクリックし、データがレイヤーを右クリックして_\<要素の型をマップ\>_**色のルール**します。  
...
2.  をクリックし、データがレイヤーを右クリックして_\<要素の型をマップ\>_**ルール**します。  
