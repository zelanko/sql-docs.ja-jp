...
-   エンティティは、明示的階層およびコレクションに対して有効化されている必要があります。 詳細については、次を参照してください。[明示的階層およびコレクションに対してエンティティを有効にする&#40;Master Data Services&#41;](../../2014/master-data-services/enable-an-entity-for-explicit-hierarchies-and-collections-master-data-services.md)です。  
...
6.  **エンティティの編集** ページの 、**明示的階層** ウィンドウで、をクリックして**明示的階層を追加**です。  
  
7.  **明示的階層の追加**] ページの [、**明示的階層名**ボックスには、階層の名前を入力します。  
...
10. **エンティティの編集**] ページで [**エンティティの保存**です。  
