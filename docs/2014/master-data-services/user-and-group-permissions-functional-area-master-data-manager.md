...
# <a name="user-and-group-permissions-functional-area-master-data-manager"></a>[ユーザー/グループの権限] 機能領域 (マスター データ マネージャー)
 ...
 [ユーザーとグループ&#40;マスター データ サービス&#41;](../../2014/master-data-services/users-and-groups-master-data-services.md)  
 ...
 [メンバーの権限を直ちに適用する&#40;マスター データ サービス&#41;](../../2014/master-data-services/immediately-apply-member-permissions-master-data-services.md)  
