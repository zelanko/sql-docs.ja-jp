...
|**RelationshipType**<br /><br /> 必須|設定しているリレーションシップの種類。 設定可能な値は、次のとおりです。<br /><br /> **1**: 親<br /><br /> **2**: 兄弟 (同じレベル)|  
...
|**並べ替え順序**<br /><br /> Optional|親の下にある他のメンバーに対するメンバーの順序を示す整数。 各子メンバーは一意識別子を保持します。|  
