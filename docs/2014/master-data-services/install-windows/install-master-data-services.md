...
-   [事前インストール タスク](#preinstall):インストールする前に、システム要件を確認する[!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)]します。  
...
-   [インストール後のタスク](#postinstall):開いている[!INCLUDE[ssMDScfgmgr](../../includes/ssmdscfgmgr-md.md)]インストール後の操作を完了します。 [!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)] データベース、 [!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)] Web アプリケーション、および Web サービスの作成と構成を行い、サンプル モデルを配置します。  
