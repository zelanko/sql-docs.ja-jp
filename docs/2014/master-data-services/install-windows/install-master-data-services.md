...
|サンプル モデルを配置します。|サンプル モデル パッケージはマスター データ サービスと共にインストールされており、MDSModelDeploy.exe を使用して配置できます。|[SQL server 2012 の MDS サンプルのデプロイ](http://go.microsoft.com/fwlink/?LinkId=251486&clcid=0x409)|  
