...
-   **致命的な**:重大/予期しない結果を引き起こす可能性がある重大な実行時エラー。  
  
-   **エラー**:その他の実行時エラー。  
  
-   **警告**:エラーになる可能性があるイベントに関する警告。  
  
-   **情報**:エラーまたは警告以外の一般的なイベントに関する情報。 (DQS のプロセスが開始されたなど)。  
  
-   **デバッグ**:イベントに関する詳細 (verbose) 情報。  
...
3.  次に **ログの設定** タブをクリックします。次の DQS アクティビティには、重大度レベルを選択できますが一覧表示されます。**ドメイン管理**、**ナレッジ検出**、**クレンジング プロジェクト (例。RDS)**、**一致するポリシーと一致するプロジェクト**、および **RDS**) が表示されます。  
  
4.  DQS のアクティビティについて、ログに記録する重大度レベルを選択します。 次の中からいずれかを選択できます。**致命的な**、**エラー**、**警告**、**情報**、および**デバッグ**します。 たとえば、ナレッジ検出アクティビティに対する重大なメッセージだけを DQS ログ ファイルに書き込む場合は、 **[ナレッジ検出]** アクティビティのドロップダウン リストで **[Fatal]** を選択します。  
...
3.  次に、 **[重大度]** 列のドロップダウン リストからモジュールの重大度レベルを選択します。 次の中からいずれかを選択できます。**致命的な**、**エラー**、**警告**、**情報**、および**デバッグ**します。  
