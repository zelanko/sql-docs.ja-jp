...
|データ品質プロジェクトの管理方法 (開く、ロック解除、名前の変更、および削除) について説明します。|[管理&#40;を開く、ロック解除、名前変更、および削除&#41;データ品質プロジェクト](../../2014/data-quality-services/manage-open-unlock-rename-and-delete-a-data-quality-project.md)|  
