...
##  <a name="DataProfiling"></a>複合ドメインのデータプロファイル  
 ...
 クレンジング アクティビティの間のデータ プロファイリングについて詳しくは、「[DQS &#40;内部&#41; ナレッジを使用したデータのクレンジング](../../2014/data-quality-services/cleanse-data-using-dqs-internal-knowledge.md#Profiler)」の「[プロファイラーの統計情報](../../2014/data-quality-services/cleanse-data-using-dqs-internal-knowledge.md)」をご覧ください。  
