...
##  <a name="Activity"></a>アクティビティ別のプロファイルデータ  
...
-   [DQS &#40;内部&#41; ナレッジを使用してデータをクレンジングする](../../2014/data-quality-services/cleanse-data-using-dqs-internal-knowledge.md)  
...
##  <a name="Monitoring"></a>アクティビティ監視のプロファイルデータ  
