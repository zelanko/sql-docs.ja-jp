...
-   [一時停止と再開がログの切り捨てに与える影響](#EffectOnLogTrunc)  
  
-   [トランザクションログがいっぱいにならないようにする](#AvoidFullLog)  
  
-   [Related Tasks](#RelatedTasks)  
  
##  <a name="EffectOnLogTrunc"></a>一時停止と再開がログの切り捨てに与える影響  
...
##  <a name="AvoidFullLog"></a>トランザクションログがいっぱいにならないようにする  
...
## <a name="see-also"></a>参照  
 ...
 [データベースミラーリング &#40;SQL Server&#41;を削除しています](database-mirroring-sql-server.md)  
