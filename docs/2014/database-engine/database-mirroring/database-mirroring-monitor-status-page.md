 ...
 **状態**  
 プリンシパル/ミラー サーバー インスタンスごとに、最新の高度なミラーリング状態が反映されたグリッドが表示されます。 
  **[状態]** グリッドの行は、次の順序で表示されます。  
