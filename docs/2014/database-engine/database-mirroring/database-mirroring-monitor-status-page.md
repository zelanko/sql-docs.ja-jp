 ...
 **プリンシパルログ (** *\<time>* **)**  
 によって示される、サーバーインスタンスのローカル時刻の、プリンシパルサーバーインスタンスのログの状態 *\<time>* 。 以下のパラメーターが表示されます。  
 ...
 **ミラーログ (** *\<time>* **)**  
 サーバーインスタンスのローカル時刻 (によって示される) での、ミラーサーバーインスタンスのログの状態 *\<time>* 。 以下のパラメーターが表示されます。  
