---
title: データベース ミラーリング (TRANSACT-SQL) の Windows 認証を使用してセッションを確立 |Microsoft ドキュメント
ms.custom: ''
ms.date: 05/24/2017
