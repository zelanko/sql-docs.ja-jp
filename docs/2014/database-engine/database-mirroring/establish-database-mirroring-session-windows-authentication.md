---
title: データベース ミラーリング セッションの Windows 認証 (SQL Server Management Studio) を使用して確立 |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
