...
4.  **履歴レポート**ダイアログ ボックスで、適切なオプションを選択し、順にクリックします**OK**します。  
 ...
 ファイルの履歴を取得するときに指定することができます、オプションの詳細については、[ファイル履歴の表示](../../2014/database-engine/view-file-history.md)を参照してください。  
...
4.  **ファイル プロパティ レポート**ダイアログ ボックスで、適切なオプション をクリックし、順にクリックします**OK**します。  
 ...
 ファイルの状態を取得するときに指定することができます、オプションの詳細については、[ファイル状態の表示](../../2014/database-engine/view-file-status.md)を参照してください。  
