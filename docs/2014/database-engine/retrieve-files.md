---
title: ファイルの取得 |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/06/2017
...
-   **取得**コマンド  
     ...
     表示、**取得** ダイアログ ボックスは、選択したファイルの最新バージョンを取得するか、選択したソリューションまたはプロジェクト内のファイルのサブセットを取得するを使用することができます。  
...
2.  **ファイル** メニューのをポイント**ソース管理**、クリックして**最新バージョンの取得 (再帰)** です。  
...
2.  **ファイル** メニューのをポイント**ソース管理**をクリックし、**取得**です。  
  
3.  **取得**ダイアログ ボックスで、をクリックして**OK**です。 または、ソリューション エクスプローラーでソリューションまたはプロジェクトを選択した場合は、取得しない項目の横にあるチェック ボックスをオフにします。  
