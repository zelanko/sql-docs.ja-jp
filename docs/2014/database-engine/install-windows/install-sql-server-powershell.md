...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] PowerShell スナップイン。スナップインは、次の[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]2 種類の Windows PowerShell サポートを実装する dll ファイルです。  
