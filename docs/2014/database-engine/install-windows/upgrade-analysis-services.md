...
ms.locfileid: "36073069"
---
# <a name="upgrade-analysis-services"></a>Analysis Services のアップグレード
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] セットアップを使用して [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] をアップグレードします。 アップグレードの詳細については[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]SharePoint モードを参照してください。 [PowerPivot for SharePoint のアップグレード](upgrade-power-pivot-for-sharepoint.md)です。 既存の SQL Server のアップグレードの詳細については、インスタンスは、「[インストール ウィザードを SQL Server 2014 を使用するアップグレード&#40;セットアップ&#41;](upgrade-sql-server-using-the-installation-wizard-setup.md)です。  
...
-   これについては、[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]の特徴および機能が廃止、廃止、または変更を参照してください[Analysis Services の旧バージョンとの互換性](../../analysis-services/analysis-services-backward-compatibility.md)です。  
...
-   **インプレース アップグレード**、既存のプログラム ファイルが置き換えられます[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]プログラム ファイルです。 データベースは、同じ場所に残ります。 プログラム フォルダーは、新しい名前を反映して更新されます。  
  
-   A**サイド バイ サイド アップグレード**の新規インストールが[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]既存の Analysis Services インスタンスが同じコンピューターにします。 以前のバージョンを今後使用しない場合は、データベースを同じコンピューター上の新しいインスタンスへ移動し、以前のバージョンをアンインストールできます。  
