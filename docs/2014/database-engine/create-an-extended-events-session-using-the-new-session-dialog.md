---
title: '[新しいセッション] ダイアログを使用して拡張イベント セッションを作成 |Microsoft ドキュメント'
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>参照  
 ...
 [ウィザードを使用して拡張イベント セッションを作成する&#40;オブジェクト エクスプ ローラー&#41;](../ssms/object/object-explorer.md)   
