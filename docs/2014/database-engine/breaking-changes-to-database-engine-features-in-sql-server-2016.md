...
##  <a name="Yukon"></a> SQL Server 2005 における重大な変更  
 重大な変更で導入された一連の[!INCLUDE[ssVersion2005](../includes/ssversion2005-md.md)]を参照してください[SQL Server 2005 におけるデータベース エンジン機能の重大な変更](http://msdn.microsoft.com/library/ms143179\(SQL.90\).aspx)します。  
