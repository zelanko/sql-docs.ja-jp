...
-   **補足情報:** [セカンダリデータベースを構成する](#FollowUp)  
...
2.  
  **Join-SqlAvailabilityGroup** コマンドレットに可用性グループの名前を指定して実行し、セカンダリ レプリカを可用性グループに参加させます。  
...
##  <a name="FollowUp"></a>補足情報: セカンダリデータベースを構成する  
