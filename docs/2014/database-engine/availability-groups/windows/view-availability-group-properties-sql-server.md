...
## <a name="see-also"></a>参照  
 [AlwaysOn 可用性グループの概要&#40;SQL Server&#41; ](overview-of-always-on-availability-groups-sql-server.md) [可用性グループの監視&#40;TRANSACT-SQL&#41; ](monitor-availability-groups-transact-sql.md) [AlwaysOn との運用上の問題の AlwaysOn ポリシー可用性グループ&#40;SQL Server&#41;](always-on-policies-for-operational-issues-always-on-availability.md) 
