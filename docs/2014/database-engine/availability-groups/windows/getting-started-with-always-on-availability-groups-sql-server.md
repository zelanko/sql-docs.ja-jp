...
##  <a name="creating-and-configuring-a-new-availability-group"></a><a name="ConfigAG"></a>新しい可用性グループの作成と構成  
...
|データベースを追加または削除します。|[データベースを追加する](availability-group-add-a-database.md)<br /><br /> [セカンダリ データベースの削除](remove-a-secondary-database-from-an-availability-group-sql-server.md)<br /><br /> [プライマリ データベースの削除](remove-a-primary-database-from-an-availability-group-sql-server.md)|  
