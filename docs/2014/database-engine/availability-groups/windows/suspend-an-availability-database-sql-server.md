...
##  <a name="follow-up-avoiding-a-full-transaction-log"></a><a name="FollowUp"></a>補足情報: トランザクションログがいっぱいにならないようにする  
