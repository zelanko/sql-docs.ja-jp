...
4.  **[既存のセカンダリ レプリカへの接続]** ページで、可用性グループのすべてのセカンダリ レプリカに接続します。 詳細については、[既存のセカンダリ レプリカ ページへの接続&#40;のレプリカ追加ウィザードおよびデータベース追加ウィザード&#41;](connect-to-existing-secondary-replicas-page.md)を参照してください。  
