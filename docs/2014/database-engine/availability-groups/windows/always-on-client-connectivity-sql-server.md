...
|接続性に関する修正プログラムの ADO.NET with .NET Framework 4.0**<sup>*</sup>**|はい|はい|はい|はい|はい|  
|ADO.NET with .NET Framework 3.5 SP1 修正プログラムの接続と **<sup>**</sup>**|はい|はい|はい|はい|はい|  
|Microsoft JDBC Driver 4.0 for SQL Server|はい|はい|はい|はい|はい|  
  
 **<sup>*</sup>**  ADO .NET with .NET Framework 4.0 の接続性の修正プログラムをダウンロード: [ http://support.microsoft.com/kb/2600211](http://support.microsoft.com/kb/2600211)です。  
  
 **<sup>**</sup>* * ADO.NET with .NET Framework 3.5 SP1 の接続性の修正プログラムをダウンロードする: [ http://support.microsoft.com/kb/2654347](http://support.microsoft.com/kb/2654347)です。  
