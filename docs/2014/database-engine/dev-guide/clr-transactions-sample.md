---
title: CLR Transactions サンプル |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
7.  コピー、[!INCLUDE[tsql](../../includes/tsql-md.md)]ファイルにデータベース インストール コードとして保存して`installDB.sql`サンプル ディレクトリにします。  
