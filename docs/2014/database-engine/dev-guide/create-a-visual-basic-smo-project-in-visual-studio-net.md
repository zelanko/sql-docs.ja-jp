---
title: Visual Studio .NET で Visual Basic SMO プロジェクトを作成 |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
3.  **プロジェクトの種類**ダイアログ ボックスで、 **Visual Basic**、し、 **Windows**です。 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]インストールされたテンプレート ペインで、**コンソール アプリケーションです。**  
  
4.  (省略可能)**名前**フィールドに、新しいアプリケーションの名前を入力します。  
  
5.  をクリックして**OK**を読み込む、[!INCLUDE[vbprvb](../../includes/vbprvb-md.md)]コンソール アプリケーション テンプレート。  
  
6.  **[プロジェクト]** メニューの **[参照の追加]** を選択します。 **[参照の追加]** ダイアログ ボックスが表示されます。  
  
7.  をクリックして**参照**を C:\Program files \microsoft SQL server \120\sdk\assemblies フォルダー内で SMO アセンブリを検索してから、次のファイルを選択します。 これらは、SMO アプリケーションのビルドに最低限必要なファイルです。  
...
11. コードでは、すべての宣言の前に、次の入力**Imports** SMO 名前空間の型を修飾するステートメント。  
