---
title: Visual Basic .NET の概要 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="references-and-imports"></a>参照とインポート  
 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] プロジェクトを起動した後、[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 管理オブジェクト (SMO) アセンブリへの参照を追加する必要があります。 プログラムが SMO の型を認識できるようにし、必要な名前空間をインポートします。  
