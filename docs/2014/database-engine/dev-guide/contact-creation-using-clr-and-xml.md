---
title: 連絡先の CLR 型と XML を使用して作成 |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/13/2017
...
10. コピー[!INCLUDE[tsql](../../includes/tsql-md.md)]ファイルにコマンド スクリプトをテストし、として保存`test.sql`サンプル ディレクトリにします。  
