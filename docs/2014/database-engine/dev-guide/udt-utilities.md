...
-   Codeplex [Web サイト](https://go.microsoft.com/fwlink/?linkid=62796)で提供されている [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)] データベース  
