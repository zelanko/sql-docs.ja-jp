---
title: ストアド プロシージャの操作方法に関するトピック (ODBC) を実行している |。Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   [プロセスのリターン コードと出力パラメーター &#40;ODBC&#41;](../../relational-databases/native-client-odbc-how-to/running-stored-procedures-process-return-codes-and-output-parameters.md)  
