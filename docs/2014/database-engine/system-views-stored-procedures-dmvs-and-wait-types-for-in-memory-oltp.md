...
|[sys.tables &#40;Transact-SQL&#41;](/sql/relational-databases/system-catalog-views/sys-tables-transact-sql)|テーブルがメモリ最適化されているか確認し、さらにテーブルの持続性の設定を確認します。|**持続性**、 **durability_desc**、および**is_memory_optimized**列。|  
