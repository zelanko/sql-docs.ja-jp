...
## <a name="see-also"></a>参照  
 ...
 [実行中のトレース &#40;SQL Server プロファイラーからテンプレートを派生させ&#41;](../tools/sql-server-profiler/derive-a-template-from-a-running-trace-sql-server-profiler.md)   
 [トレースファイルまたはトレーステーブルからテンプレートを派生させる &#40;SQL Server プロファイラー&#41;](../tools/sql-server-profiler/derive-a-template-from-a-trace-file-or-trace-table-sql-server-profiler.md)   
