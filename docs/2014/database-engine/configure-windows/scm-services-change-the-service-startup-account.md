---
title: SQL Server (SQL Server 構成マネージャー) のサービス開始アカウントの変更 |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/07/2016
