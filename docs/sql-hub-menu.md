        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="products">
                         ...
                         <ul id="products-sql-server" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>スケーラブルなハイブリッド データベース プラットフォームを使って、インテリジェントでミッション クリティカルなアプリケーションを構築しましょう。 インメモリ パフォーマンスをはじめ、高度なセキュリティやデータベース内分析まで、すべてがこのプラットフォームに組み込まれています。</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SQL Server 2016 のインストール</h3>
                                                <p>インストール オプションと完了までの手順</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>SQL でリレーショナル データベースを操作するための機能とリファレンス</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>新しいサンプル</h3>
                                                <p>Wide World Importers のデータベース</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SQL Server Management Studio のチュートリアル</h3>
                                                <p>SQL Server Management Studio の使用方法を確認する</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Transact-SQL のチュートリアル</h3>
                                                <p>Transact-SQL ステートメントの作成方法を確認する</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="#products-sql-server-azure">Azure VM での SQL Server</a>
                        <ul id="products-sql-server-azure" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>Azure 仮想マシンで、SQL Server 2016 Enterprise Edition などの SQL Server をホストします。 ギャラリーのイメージを使用するか、ご自身のライセンスを取得してください。 オンプレミスのSQL Server ワークロードをクラウドに移行します。</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>について</h3>
                                                <p>Azure VM での SQL Server について</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>プロビジョニング</h3>
                                                <p>Azure Portal での SQL Server 仮想マシンのプロビジョニング</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>移行</h3>
                                                <p>SQL Server データベースを Azure 仮想マシン上の SQL Server に移行する</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>可用性と復旧</h3>
                                                <p>Azure 仮想マシンでの SQL Server の高可用性と障害復旧</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>VM での SQL Server のシナリオ</h3>
                                                <p>SQL Server 仮想マシンがさまざまなビジネス上の問題をどのように解決するか確認する</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>よく寄せられる質問</h3>
                                                <p>Azure VM 上の SQL Server に関してよく寄せられる質問に対する回答を確認する</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ドキュメント</h3>
                                                <p>Azure VM ドキュメントで SQL Server をダウンロードする</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="/en-us/sql/advanced-analytics/r-services/">SQL Server R サービス</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/en-us/sql/microsoft-sql-documentation-table-of-contents">SQL の目次</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="#sdkstools">SDK とツール</a>
                <ul id="sdkstools">
                    <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>T-SQL</h3>
                                                <p><a href="https://msdn.microsoft.com/library/bb510741.aspx">開始するには</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ADO.NET</h3>
                                                <p><a href="/sql/connect/ado-net/microsoft-ado-net-for-sql-server">開始するには</a></p>
                                                <p><a href="https://msdn.microsoft.com/library/system.data.sqlclient.aspx">API リファレンス</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ドライバー</h3>
                                                <p><a href="/sql/connect/sql-server-drivers">開始するには</a></p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SSMS</h3>
                                                <p><a href="/azure/sql-database/sql-database-connect-query-ssms">開始するには</a></p>
                                                <p><a href="/sql/ssms/download-sql-server-management-studio-ssms">SQL Server Management Studio のダウンロード</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SSDT</h3>
                                                <p><a href="https://msdn.microsoft.com/library/hh272686(v=vs.103).aspx">開始するには</a></p>
                                                <p><a href="/sql/ssdt/download-sql-server-data-tools-ssdt">SQL Server Data Tools のダウンロード</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>VS Code &amp; SQL 拡張機能</h3>
                                                <p><a href="https://code.visualstudio.com/docs">開始するには</a></p>
                                                <p><a href="https://code.visualstudio.com/">Visual Studio Code のダウンロード</a></p>
                                                <p><a href="https://marketplace.visualstudio.com/items?itemName=ms-mssql.mssql">SQL 拡張機能 (mssql)</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>PowerShell</h3>
                                                <p><a href="/azure/powershell-install-configure">開始するには</a></p>
                                                <p><a href="/powershell/resourcemanager/azurerm.sql/v2.3.0/azurerm.sql">Azure SQL Database コマンドレット</a></p>
                                                <p><a href="https://msdn.microsoft.com/library/mt740629.aspx">SQL Server コマンドレット</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI 2.0</h3>
                                                <p><a href="/cli/azure/get-started/">開始するには</a></p>
                                                <p><a href="https://github.com/Azure/azure-cli">Azure CLI 2.0 のダウンロード</a></p>
                                                <p><a href="/cli/azure/">リファレンス</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI</h3>
                                                <p><a href="/azure/xplat-cli-install?toc=/azure/virtual-machines/linux/toc.json">開始するには</a></p>
                                                <p><a href="http://aka.ms/linux-azure-cli">Linux 用 Azure CLI のダウンロード</a></p>
                                                <p><a href="http://aka.ms/mac-azure-cli">Mac 用 Azure CLI のダウンロード</a></p>
                                                <p><a href="http://aka.ms/webpi-azure-cli">Windows 用 Azure CLI のダウンロード</a></p>
                                                <p><a href="https://azure.microsoft.com/documentation/articles/azure-cli-arm-commands/">リファレンス</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <ul id="architecture">
                    <li>
                        ...
                        <ul id="architecture1" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>Azure SQL Database を開始するにあたっての SQL のアーキテクチャ推奨事項とパターン。</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>マルチテナント型の SaaS アプリケーション</h3>
                                                    <p>Azure SQL Database におけるマルチテナント型の SaaS アプリケーションのデザイン パターン</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>行レベルのセキュリティ</h3>
                                                    <p>Azure SQL Database のシャード データベースを使用した行レベルのセキュリティの実装</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>障害復旧のためのアプリケーション デザイン</h3>
                                                    <p>Azure SQL Database のアクティブ geo レプリケーションを使用したクラウド障害復旧用のアプリケーションの設計</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>エラスティック プールを使用した障害復旧戦略</h3>
                                                    <p>Azure SQL Database のエラスティック プールを使用したアプリケーション障害復旧戦略</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
