...
description: SQL Server での機械学習機能のインストールとアップグレードに関する一般的な質問に回答します。
ms.prod: sql
...
この記事では、SQL Server での機械学習機能のインストールに関する一般的な質問に回答します。 また、アップグレードに関してよく寄せられる質問についても説明します。
