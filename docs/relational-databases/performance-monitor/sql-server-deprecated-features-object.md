...
## <a name="see-also"></a>参照  
 ...
 [SQL Server 2016 で廃止されたデータベース エンジンの機能](../../database-engine/discontinued-database-engine-functionality-in-sql-server.md)   
 [SQL Server 2016 で廃止されたフルテキスト検索機能](../../database-engine/discontinued-database-engine-functionality-in-sql-server.md)   
