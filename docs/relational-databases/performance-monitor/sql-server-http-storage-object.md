...
|**Avg.  Bytes/Read**|読み取りごとに HTTP ストレージから転送された平均バイト数。|  
|**Avg.  Bytes/Read BASE**|内部使用のみです。|
|**Avg.  Bytes/Transfer**|読み取りまたは書き込み操作中に HTTP ストレージから転送された平均バイト数。|  
|**Avg.  Bytes/Transfer BASE**|内部使用のみです。|
|**Avg.  Bytes/Write**|書き込みごとに HTTP ストレージから転送された平均バイト数。|  
|**Avg.  Bytes/Write BASE**|内部使用のみです。|
