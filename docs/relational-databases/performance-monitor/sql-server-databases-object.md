...
|**Commit table entries**|データベースのコミット テーブルのインメモリ部分のサイズ。 詳細については、「[sys.dm_tran_commit_table &#40;Transact-SQL&#41;](../Topic/sys.dm_tran_commit_table%20\(Transact-SQL\).md)」を参照してください。|  
