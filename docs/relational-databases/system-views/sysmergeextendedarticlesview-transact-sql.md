...
|**型**|**tinyint**|アーティクルの種類。次のいずれかになります。<br /><br /> **10**テーブルを = です。<br /><br /> **32** Proc スキーマのみを = です。<br /><br /> **64** = ビュー スキーマのみ、またはインデックス付きビュー スキーマのみです。<br /><br /> **128** = 関数スキーマのみです。<br /><br /> **160** = シノニム スキーマのみです。|  
|**オブジェクト id**|**int**|パブリッシャー オブジェクトの識別子。|  
