...
|**schema_option**|**[バイナリ]**|新機能をスクリプト化することを示します。参照してください[sp_addarticle &#40;TRANSACT-SQL&#41; ](../../relational-databases/system-stored-procedures/sp-addarticle-transact-sql.md)サポートされるスキーマ オプションの一覧についてはします。|  
