...
f1_keywords: 
  - "Security [SQL Server]"
helpviewer_keywords: 
  - "データベース オブジェクト [SQL Server], セキュリティ"
  - "SQL Server、セキュリティ"
  - "オペレーティング システム [SQL Server], セキュリティ"
  - "セキュリティ [SQL Server], 計画"
  - "アプリケーション [SQL Server], セキュリティ"
...
|ファイアウォールの構成: [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|[SSIS サービスにアクセスするように Windows ファイアウォールを構成する](../../integration-services/service/configure-a-windows-firewall-for-access-to-the-ssis-service.md)|  
...
|詳細|参照先|  
|---------------------------|---------|  
|接続、構成、制御: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|[SQL Server Management Studio の使用 [SQL Server]](../../ssms/use-sql-server-management-studio.md)|  
