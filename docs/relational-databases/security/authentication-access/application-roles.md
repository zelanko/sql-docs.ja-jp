...
ms.topic: "article"
helpviewer_keywords: 
  - "アプリケーション ロール [SQL Server]、アプリケーション ロールについて"
  - "プリンシパル [SQL Server]、アプリケーション ロール"
  - "資格情報 [SQL Server]、ロール"
  - "アプリケーション ロール [SQL Server]"
  - "ロール [SQL Server]、アプリケーション"
  - "権限 [SQL Server]、ロール"
  - "ユーザー [SQL Server]、アプリケーション ロール"
  - "認証 [SQL Server]、ロール"
  - "グループ [SQL Server]、ロール"
...
# アプリケーション ロール
 ...
 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] では、アプリケーション ロールは、サーバー レベルのプリンシパルと関連付けられていないため、サーバー レベルのメタデータにはアクセスできません。 この制限を無効にして、アプリケーション ロールがサーバー レベルのメタデータにアクセスできるようにするには、グローバル フラグ 4616 を設定します。 詳細については、「[トレース フラグ &#40;Transact-SQL&#41;](../Topic/Trace%20Flags%20\(Transact-SQL\).md)」および「[DBCC TRACEON &#40;Transact-SQL&#41;](../../../t-sql/database-console-commands/dbcc-traceon-transact-sql.md)」を参照してください。  
