...
helpviewer_keywords: 
  - "認証 [SQL Server], ログイン"
  - "ログイン [SQL Server], 作成"
  - "Management Studio を使用したログインの作成"
  - "ログインの作成 [SQL Server]"
  - "SQL Server ログイン"
...
## SQL Server 認証と SSMS を使用してログインを作成する  
