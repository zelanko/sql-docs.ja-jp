...
ms.topic: "article"
helpviewer_keywords: 
  - "サブコンポーネントの表示 [SQL Server]"
  - "メタデータ [SQL Server], 表示"
  - "アクセス許可 [SQL Server]、メタデータ アクセス"
  - "メタデータの表示"
  - "オブジェクト [SQL Server], メタデータ"
  - "メタデータの確認"
  - "データベース メタデータ [SQL Server]"
  - "メタデータ [SQL Server], アクセス許可"
...
|||  
|-|-|  
|カタログ ビュー|[!INCLUDE[ssDE](../../includes/ssde-md.md)] の **sp_help** ストアド プロシージャ|  
...
-   [!INCLUDE[ssDE](../../includes/ssde-md.md)] の **sp_help** ストアド プロシージャを実行しても、行のサブセットまたは NULL 値しか返されないことがあります。  
...
> [!NOTE]  
>  次の例で使用するのは、[sys.sysobjects](../../relational-databases/system-compatibility-views/sys-sysobjects-transact-sql.md) 互換性ビューではなく [sys.objects](../../relational-databases/system-catalog-views/sys-objects-transact-sql.md) カタログ ビューです。  
...
## 参照  
 ...
 [互換性ビュー &#40;Transact-SQL&#41;](../Topic/Compatibility%20Views%20\(Transact-SQL\).md)  
