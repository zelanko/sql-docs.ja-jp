...
helpviewer_keywords: 
  - "アクセスを拒否するセキュリティ [SQL Server]"
  - "権限の階層 [SQL Server]"
  - "セキュリティ保護可能なリソース [SQL Server]"
  - "アクセス許可のセキュリティ [SQL Server]"
  - "階層の権限 [SQL Server]"
  - "セキュリティ [SQL Server]、アクセス権の付与"
...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
 ...
 ![データベース エンジンの権限階層](../../relational-databases/security/media/wj-security-layers.gif "データベース エンジンの権限階層")  
