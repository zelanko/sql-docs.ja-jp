...
# [リレーショナル データベースに関する記事を最近更新](relational-databases-new-updated-sql-docs-pr.md)
...
# [セキュリティ](../relational-databases/security/security-center-for-sql-server-database-engine-and-azure-sql-database.md)
