...
helpviewer_keywords: 
  - "コレクション セット [SQL Server], スケジュールの変更"
  - "スケジュール [SQL Server], コレクション セットの変更"
  - "コレクション セット [SQL Server], スケジュールの表示"
  - "スケジュール [SQL Server], コレクション セットの表示"
...
---
# コレクション セットのスケジュールの表示または変更 (SQL Server Management Studio)
...
### キャッシュ モードのコレクション セットのスケジュールを変更するには  
...
### 非キャッシュ モードのコレクション セットのスケジュールを変更するには  
