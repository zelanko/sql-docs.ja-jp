...
helpviewer_keywords: 
  - "データ ウェアハウス [SQL Server], 複数のインスタンス"
  - "データ ウェアハウス [SQL Server], 構成"
  - "管理データ ウェアハウス構成ウィザード"
  - "管理データ ウェアハウス, 構成"
...
###  の 1 つまたは複数のインスタンスの管理データ ウェアハウスの構成 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
 ...
 **データベース ロール メンバーシップ:** *\<data warehouse name>*  
