...
helpviewer_keywords: 
  ...
  - "ファセット [SQL Server の XML]"
  - "xml データ型 [SQL Server], 列"
  - "型指定されていない XML"
  - "xml データ型 [SQL Server], 型指定された xml"
  - "XML [SQL Server], 型指定された"
  - "変数 [SQL Server の XML], 作成"
  - "xml データ型 [SQL Server], 型指定されていない xml"
  - "列 [SQL Server の XML], 作成"
  - "型指定された XML"
  - "ドキュメント モード処理 [SQL Server]"
  - "XML [SQL Server], 型指定されていない"
  - "xml データ型 [SQL Server], パラメーター"
...
### 例 : xml 型のパラメーターのストアド プロシージャへの受け渡し  
...
### 例 : 型指定された xml 列を制約するためのファセットの指定  
