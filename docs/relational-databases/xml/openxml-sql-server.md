...
helpviewer_keywords: 
  ...
  - "XML の記述, OPENXML ステートメント"
  - "OPENXML ステートメント, クエリ XML"
  - "属性中心のマッピング"
  - "SELECT ステートメント [SQL Server], OPENXML キーワード"
  - "列パターン [SQL Server の XML]"
  - "行パターン [SQL Server の XML]"
  - "rowpattern [SQL Server の XML]"
  - "クエリ [SQL Server の XML], OPENXML ステートメント"
  - "XML [SQL Server], OPENXML ステートメント"
