---
title: XML データ (SQL Server)
description: XML データ (Transact-SQL)
ms.prod: sql
...
## <a name="in-this-section"></a>このセクションの内容  
 [XML データ型と列 &#40;SQL Server&#41;](../../relational-databases/xml/xml-data-type-and-columns-sql-server.md)  
