---
title: "SqlServiceType プロパティ (SqlServiceAdvancedProperty クラス) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]詳細プロパティに関連付けられている管理されたサービスの種類を取得します。  
