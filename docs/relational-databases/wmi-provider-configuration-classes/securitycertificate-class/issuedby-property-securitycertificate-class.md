---
title: "IssuedBy プロパティ (SecurityCertificate クラス) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/04/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]セキュリティ証明書を発行したオブジェクトを取得します。  
