---
title: "SystemStore プロパティ (SecurityCertificate クラス) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]セキュリティ証明書のシステム ストアを取得します。  
...
## <a name="property-valuereturn-value"></a>プロパティ値/戻り値  
 セキュリティ証明書に対応するシステム ストアを指定する文字列値。  
