...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]に関する情報を表示するためのプロパティを提供する[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]ログ ファイルです。  
