---
title: "ProtocolName プロパティ (ServerNetworkProtocolIPAddress クラス) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]IP アドレスを参照するネットワーク プロトコル、サーバーの名前を取得します。  
