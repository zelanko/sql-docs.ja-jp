---
title: "Size プロパティ (ClientNetLibInfo クラス) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]クライアントのサイズ (キロバイト単位) のネットワーク ライブラリを取得します。  
