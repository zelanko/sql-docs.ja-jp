---
title: "SetEnable メソッド (ClientNetworkProtocol クラス) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]指定されているクライアント ネットワーク プロトコルを有効、 [Configure Client Protocols](http://technet.microsoft.com/library/ms181035.aspx)です。  
