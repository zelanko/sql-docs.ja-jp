...
## <a name="returns"></a>戻り値  
 パラメーター値を指すポインターを返します。 
  *n* 番目のパラメーターが NULL である場合、*n* 番目のパラメーターがない場合、またはリモート ストアド プロシージャがない場合には、NULL を返します。 パラメーター値が文字列である場合、NULL 終端ではないこともあります。 文字列の長さを判断するには、**srv_paramlen** を使用します。  
...
|新しいデータ型|入力データ長|  
|--------------------|-----------------------|  
|BITN|**NULL:** VP、NULL<br /><br /> **0:** VP、NULL<br /><br /> **>= 255:** 該当なし<br /><br /> **<255:** 該当なし|  
|BIGVARCHAR|**NULL:** NULL、N/A<br /><br /> **0:** VP、NULL<br /><br /> **>= 255:** VP、255文字<br /><br /> **<255:** VP、実際のデータ|  
|BIGCHAR|**NULL:** NULL、N/A<br /><br /> **0:** VP、255のスペース<br /><br /> **>= 255:** VP、255文字<br /><br /> **<255:** VP、実際のデータ + パディング (最大 255)|  
|BIGBINARY|**NULL:** NULL、N/A<br /><br /> **0:** VP、255 0x00<br /><br /> **>= 255:** VP、255バイト<br /><br /> **<255:** VP、実際のデータ + パディング (最大 255)|  
|BIGVARBINARY|**NULL:** NULL、N/A<br /><br /> **0:** VP、0x00<br /><br /> **>= 255:** VP、255バイト<br /><br /> **<255:** VP、実際のデータ|  
|NCHAR|**NULL:** NULL、N/A<br /><br /> **0:** VP、255のスペース<br /><br /> **>= 255:** VP、255文字<br /><br /> **<255:** VP、実際のデータ + パディング (最大 255)|  
|NVARCHAR|**NULL:** NULL、N/A<br /><br /> **0:** VP、NULL<br /><br /> **>= 255:** VP、255文字<br /><br /> **<255:** VP、実際のデータ|  
|NTEXT|**NULL:** 該当なし<br /><br /> **0:** 該当なし<br /><br /> **>= 255:** 該当なし<br /><br /> ** \<255:** 該当なし|  
