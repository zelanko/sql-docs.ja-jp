...
## <a name="arguments"></a>引数  
 ...
 [ **@new_name=** ] **'***new_name***'**  
 ポリシーの新しい名前です。 *新しい名前*は**sysname**、必要があります。 NULL または空の文字列を指定することはできません。  
...
## <a name="remarks"></a>コメント  
 ...
 いずれかの値を指定する必要があります*名前*または*policy_id*します。 両方を NULL にすることはできません。 これらの値を取得するには、msdb.dbo.syspolicy_policies システム ビューに対してクエリを実行します。  
