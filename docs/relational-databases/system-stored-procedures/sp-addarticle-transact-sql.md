...
> [!NOTE]
>  パブリケーションでキュー更新が有効になっている場合、 *schema_option*値**0x80**が、テーブルに表示される既定値に追加されます。 以外の*schema_option*パブリケーションの既定の Schema_option [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] は**0x050d3**です。  
