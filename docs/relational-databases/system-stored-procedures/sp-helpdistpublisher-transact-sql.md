...
|**パスワード**|**nvarchar (524)**|単純な暗号化形式で返されるパスワードです。 パスワードは NULL ユーザー以外の**sysadmin**です。|  
|**アクティブ**|**bit**|リモート パブリッシャーがディストリビューターとしてローカル サーバーを使用しているかどうかを示します。<br /><br /> **0** = なし<br /><br /> **1** = [はい]|  
