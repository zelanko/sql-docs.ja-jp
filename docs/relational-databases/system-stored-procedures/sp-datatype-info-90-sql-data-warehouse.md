---
title: sp_datatype_info_90 (SQL データ ウェアハウス) |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/13/2017
ms.prod: ''
...
## <a name="see-also"></a>参照  
 [SQL データ ウェアハウスのストアド プロシージャ](../../relational-databases/system-stored-procedures/sql-data-warehouse-stored-procedures.md)   
