---
title: sp_validname (Transact SQL) |マイクロソフトのドキュメント
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="arguments"></a>引数  
 ...
 [  **@raise_error=** ] *raise_error*  
 エラーを生成するかどうかを指定します。 *raise_error* 、**ビット**、既定値は 1 です。 つまり、エラーが表示されます。 0 の場合、エラー メッセージは表示されません。  
