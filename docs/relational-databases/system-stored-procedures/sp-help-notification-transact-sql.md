...
|**use_email**|**int**|電子メールを使用して、オペレーターに通知します。<br /><br /> **1** = [はい]<br /><br /> **0** = なし|  
|**use_pager**|**int**|ポケットベルを使用して、オペレーターに通知します。<br /><br /> **1** = [はい]<br /><br /> **0** = なし|  
|**use_netsend**|**int**|オペレーターへの通知にネットワーク ポップアップを使用するかどうか。<br /><br /> **1** = [はい]<br /><br /> **0** = なし|  
...
|**has_email**|**int**|オペレーターが電子メール アドレスを持っているかどうか。<br /><br /> **1** = [はい]<br /><br /> **0** = なし|  
|**has_pager**|**int**|オペレーターがポケットベル アドレスを持っているかどうか。<br /><br /> **1** = [はい]<br /><br /> **0** = なし|  
|**has_netsend**|**int**|オペレーターに net send 通知が構成されているかどうか。<br /><br /> **1** = [はい]<br /><br /> **0** = なし|  
...
## <a name="see-also"></a>参照  
 ...
 [sp_delete_notification &#40;です。TRANSACT-SQL と #41 です。](../../relational-databases/system-stored-procedures/sp-delete-notification-transact-sql.md)   
