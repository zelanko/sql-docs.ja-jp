...
## <a name="see-also"></a>参照  
 ...
 [sys.sp_xtp_bind_db_resource_pool & #40 です。TRANSACT-SQL と #41 です。](../../relational-databases/system-stored-procedures/sys-sp-xtp-bind-db-resource-pool-transact-sql.md)  
