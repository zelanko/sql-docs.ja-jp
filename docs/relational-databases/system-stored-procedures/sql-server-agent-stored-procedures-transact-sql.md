---
title: "SQL Server エージェント ストアド プロシージャ (TRANSACT-SQL) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] では、次のシステム ストアド プロシージャによって使用されている[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]エージェント スケジュールされたスキャンとイベント ドリブン アクティビティを管理します。  
