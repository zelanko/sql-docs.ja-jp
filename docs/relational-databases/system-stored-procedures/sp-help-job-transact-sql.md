...
|**型**|**int**|ジョブの種類。<br /><br /> 1 = ローカル ジョブ<br /><br /> **2**マルチ サーバー ジョブを = です。<br /><br /> **0** = ジョブに対象サーバーがありません。|  
...
|**フラグ**|**nvarchar (4000)**|**ビットマスク**のステップの動作を制御する値。|  
...
|**有効になっています。**|**int**|スケジュールがアクティブかどうか (**1**) か (**0**)。|  
