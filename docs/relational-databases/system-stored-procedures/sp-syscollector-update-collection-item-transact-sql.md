...
## <a name="examples"></a>使用例  
 次の例で定義されている例で作成したコレクション項目に基づいています[sp_syscollector_create_collection_item &#40;TRANSACT-SQL&#41;](../../relational-databases/system-stored-procedures/sp-syscollector-create-collection-item-transact-sql.md)です。  
