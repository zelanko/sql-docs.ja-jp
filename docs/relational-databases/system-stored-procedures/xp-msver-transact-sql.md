...
|オプション/列名|説明|  
|-------------------------|-----------------|  
|**同様**|製品名;たとえば、 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]のようになります。|  
...
|**コメント**|に関する[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]その他の情報。|  
...
|**製品 ID**|プロダクト ID (PID) 番号。 これは、インストール時に指定します。 この番号は、元[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]の CD ケースのステッカーに記載されています。|  
