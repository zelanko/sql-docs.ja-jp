...
>  [!INCLUDE[ssNoteStrongPass](../../includes/ssnotestrongpass-md.md)]  
 ...
 [ @deflanguage=] '*言語*'  
 ログインの既定の言語を指定します。 *言語*は**sysname**、既定値は NULL です。 場合*言語*が指定されていない既定*言語*新しいログインのサーバーの現在の既定の言語に設定されています。  
