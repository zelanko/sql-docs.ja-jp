...
-   SET TRANSACTION ISOLATION LEVEL を使用してセッションのロック レベルを指定します。 構文と制限事項を参照してください。 [SET TRANSACTION ISOLATION LEVEL &#40;TRANSACT-SQL&#41;](../../t-sql/statements/set-transaction-isolation-level-transact-sql.md)です。  
