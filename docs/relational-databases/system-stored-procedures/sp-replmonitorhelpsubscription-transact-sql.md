...
|**番**|エラーが発生したか、しきい値メトリック警告が生成されたサブスクリプションのみを返します。|  
|**4**|上位25件の最も低いサブスクリプションを返します。|  
|**5/5**|最も低い50の実行中のサブスクリプションを返します。|  
...
|**distributionagentjobid**|**バイナリ (16)**|トランザクションパブリケーションに対するサブスクリプションのディストリビューションエージェントジョブの ID。|  
|**mergeagentjobid**|**バイナリ (16)**|マージパブリケーションに対するサブスクリプションのマージエージェントジョブの ID。|  
