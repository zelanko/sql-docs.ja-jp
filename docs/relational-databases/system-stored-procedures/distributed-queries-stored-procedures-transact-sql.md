---
title: 分散クエリ ストアド プロシージャ (TRANSACT-SQL) |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "47640440"
---
# <a name="distributed-queries-stored-procedures-transact-sql"></a>分散クエリのストアド プロシージャ (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 実装および分散クエリを管理するために使用する次のシステム ストアド プロシージャをサポートしています。  
