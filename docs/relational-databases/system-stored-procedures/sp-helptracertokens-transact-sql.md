 ...
 **sp_helptracertokens**を実行するとき、トレーサー トークン Id を取得するために使用[sp_helptracertokenhistory (& a) #40 です。TRANSACT-SQL と #41 です。](../../relational-databases/system-stored-procedures/sp-helptracertokenhistory-transact-sql.md).  
