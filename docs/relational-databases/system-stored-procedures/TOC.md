# [概要](system-stored-procedures-transact-sql.md)  
...
# テンポラル テーブル
## [テンポラル表の - sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
...
## [Filestream および FileTable - sp_filestream_force_garbage_collection](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
## [Filestream および FileTable - sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
# アクティブな地理的レプリケーション
...
## [sp_syscollector_delete_collection_item は](sp-syscollector-delete-collection-item-transact-sql.md)  
## [sp_syscollector_delete_collection_set は](sp-syscollector-delete-collection-set-transact-sql.md)  
...
## [sp_syscollector_update_collection_set は](sp-syscollector-update-collection-set-transact-sql.md)  
...
## [sp_execute_remote (Azure SQL データベース)](sp-execute-remote-azure-sql-database.md)  
...
## [sp_helpfile を実行](sp-helpfile-transact-sql.md)  
...
# [分散クエリ](distributed-queries-stored-procedures-transact-sql.md)  
...
# [ファイアウォール規則 (Azure SQL データベース)](firewall-rules-stored-procedures-azure-sql-database.md)  
## [sp_set_firewall_rule (Azure SQL データベース)](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule (Azure SQL データベース)](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule (Azure SQL データベース)](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule (Azure SQL データベース)](sp-delete-database-firewall-rule-azure-sql-database.md)  
# [フルテキスト検索およびセマンティック検索](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
## [照会します。](sp-help-fulltext-columns-transact-sql.md)  
...
## [core.sp_create_snapshot を呼び出します](core-sp-create-snapshot-transact-sql.md)  
## [core.sp_update_data_source を呼び出します](core-sp-update-data-source-transact-sql.md)  
...
## [sp_syspolicy_subscribe_to_policy_category は](sp-syspolicy-subscribe-to-policy-category-transact-sql.md)  
## [sp_syspolicy_unsubscribe_from_policy_category は](sp-syspolicy-unsubscribe-from-policy-category-transact-sql.md)  
...
## [sp_droprolemember の各](sp-droprolemember-transact-sql.md)  
...
## [ログイン](sp-helplinkedsrvlogin-transact-sql.md)  
...
# [SQL データ ウェアハウス](sql-data-warehouse-stored-procedures.md)  
...
# [Stretch Database の拡張](stretch-database-extended-stored-procedures-transact-sql.md)  
...
## [sp_db_selective_xml_index を使用](sp-db-selective-xml-index-transact-sql.md)  
