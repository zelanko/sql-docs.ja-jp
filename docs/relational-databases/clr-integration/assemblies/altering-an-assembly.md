...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]登録されているアセンブリ[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]ALTER ASSEMBLY ステートメントを使用して、新しいバージョンから更新できます。 アセンブリを更新するには、ALTER ASSEMBLY ステートメントを次の構文で使用します。  
