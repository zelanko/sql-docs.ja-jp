...
>  Clr ユーザー関数などの CLR 機能は、Azure SQL Database ではサポートされて*いません*。  
 ...
 [共通言語ランタイム&#40;CLR&#41;統合を使用したデータベースオブジェクトの構築](../../relational-databases/clr-integration/database-objects/building-database-objects-with-common-language-runtime-clr-integration.md)  
