...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]<xref:Microsoft.SqlServer.Management.Smo.Transfer>クラスは、オブジェクトやデータを転送するためのツールを提供するユーティリティ クラス。  
