---
title: SQL Server のインスタンスに接続する |Microsoft Docs
ms.custom: ''
ms.date: 08/06/2017
ms.prod: sql
...
この例では、Windows 認証を使用して SQL Server のローカル インスタンスに接続する Visual Basic .NET コードです。 
