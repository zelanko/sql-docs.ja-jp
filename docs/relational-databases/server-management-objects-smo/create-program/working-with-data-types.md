...
-   <xref:Microsoft.SqlServer.Management.Smo.DataType>クラスの静的メンバーの1つ ( **Int**など) を使用します。これにより、 <xref:Microsoft.SqlServer.Management.Smo.DataType>実際にはオブジェクトのインスタンスが返されます。  
