...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]管理オブジェクト (SMO) の表記規則に基づいてで使用される[!INCLUDE[msCoName](../../includes/msconame-md.md)]Visual Studio .NET のリファレンス資料。  
