...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  コンシューマ-つまり、ネイティブ クライアントの OLE [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] DB プロバイダーを使用するクライアント アプリケーションは、コマンド テキストが OLE DB プロバイダーに渡されている場合、各コマンド パラメーターの種類を検出できます。 テーブル値パラメーターの型がわかったら、コンシューマーはテーブル値パラメーターの個別の列ごとにメタデータ情報を検出できます。  
