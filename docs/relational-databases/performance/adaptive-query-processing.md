...
一般的なレベルでは、[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] はクエリを次のように実行します。
...
[ユーザー定義関数の作成 (データベース エンジン)](../../relational-databases/user-defined-functions/create-user-defined-functions-database-engine.md#TVF)  
