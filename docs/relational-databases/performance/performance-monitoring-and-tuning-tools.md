...
ms.topic: "article"
helpviewer_keywords: 
  - "ツール [SQL Server], パフォーマンスの監視"
  - "サーバー パフォーマンスの監視 [SQL Server], ツール"
  - "パフォーマンスの監視 [SQL Server], ツール"
  - "データベース パフォーマンス [SQL Server], ツール"
  - "データベースのチューニング [SQL Server], ツール"
  - "データベース監視 [SQL Server], ツール"
  - "パフォーマンス [SQL Server], 監視ツール"
  - "サーバー パフォーマンス [SQL Server], ツール"
