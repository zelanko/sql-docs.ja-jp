---
title: "Tutorial: Using the Microsoft Azure Blob storage service with SQL Server 2016 databases (チュートリアル: Microsoft Azure BLOB ストレージ サービスと SQL Server 2016 データベースの使用) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "01/07/2016"
...
---
# Tutorial: Using the Microsoft Azure Blob storage service with SQL Server 2016 databases (チュートリアル: Microsoft Azure BLOB ストレージ サービスと SQL Server 2016 データベースの使用)
