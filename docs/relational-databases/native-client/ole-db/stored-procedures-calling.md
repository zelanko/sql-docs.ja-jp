...
```  
 ...
 RPC エスケープシーケンスを示すサンプルアプリケーションについては、「 [Rpc 構文を使用したストアドプロシージャ &#40;の実行」&#41; および「リターンコードと出力パラメーターの処理」 &#40;OLE DB&#41;](../../../relational-databases/native-client-ole-db-how-to/results/execute-stored-procedure-with-rpc-and-process-output.md)を参照してください。  
