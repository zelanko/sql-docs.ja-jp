...
-   [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client ODBC ドライバー固有[SQLGetInfo](../../../relational-databases/native-client-odbc-api/sqlgetinfo.md)型。  
