...
[!INCLUDE[SNAC_Deprecated](../../../includes/snac-deprecated.md)]
 ...
 テーブル値パラメーターと ODBC については、[テーブル値パラメーター &#40;ODBC&#41;](../../../relational-databases/native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md)を参照してください。  
