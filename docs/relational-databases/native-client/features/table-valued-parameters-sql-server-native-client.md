...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 テーブル値パラメーターと ODBC の詳細については、「[テーブル値&#40;パラメーター&#41;の odbc](../../../relational-databases/native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md)」を参照してください。  
  
 テーブル値パラメーターと OLE DB の詳細については、「[テーブル値&#40;パラメーター&#41;OLE DB](../../../relational-databases/native-client-ole-db-table-valued-parameters/table-valued-parameters-ole-db.md)」を参照してください。  
