---
title: SQL Server ネイティブ クライアントの機能 |マイクロソフトドキュメント
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 ネイティブ[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]クライアントが、ミラー化されたデータベースの使用をサポートする[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]方法について説明します。  
 ...
 オブジェクトと[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]カスタム データ構造を[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]データベースに格納できるようにすることで SQL 型システムを拡張するユーザー定義型 (UDT) をネイティブ クライアントがサポートする方法について説明します。  
 ...
 テーブルまたは[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]ビューとの間で大量のデータを転送できる一括コピー操作を[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]ネイティブ クライアントでサポートする方法について説明します。  
 ...
 [SQL Server ネイティブ クライアント&#41;&#40;テーブル値パラメーター](../../../relational-databases/native-client/features/table-valued-parameters-sql-server-native-client.md)  
 ...
 拡張[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]された FILESTREAM 機能のネイティブ クライアント サポートについて説明します。  
 ...
 [日付と時刻の改善](../../../relational-databases/native-client/features/date-and-time-improvements.md)  
 ...
 [!INCLUDE[ssSQL11](../../../includes/sssql11-md.md)] で導入された動作の変更について説明します。 列の結果または出力パラメーターをバインドするときに固定長バッファーを指定し、終了文字の前にバッファーに書き込まれた**wchar**文字がサロゲート ペアの上位サロゲート コード ポイントである場合、次**の wchar**文字が[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]低サロゲート コード ポイントの場合、ネイティブ クライアントは、高サロゲート コード ポイントをバッファーに追加しません。  
...
## <a name="see-also"></a>参照  
 ...
 [OLE DB の使い方のトピック](../../../relational-databases/native-client-ole-db-how-to/ole-db-how-to-topics.md)   
