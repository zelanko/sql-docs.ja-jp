...
-   ICommandWithParameters:: GetParameterInfo (詳細については、 [ICommandWithParameters](../../../relational-databases/native-client-ole-db-interfaces/icommandwithparameters.md)を参照してください)  
