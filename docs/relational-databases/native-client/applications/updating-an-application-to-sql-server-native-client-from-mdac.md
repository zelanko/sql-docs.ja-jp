---
title: MDAC から更新する
description: Windows Data Access Components から SQL Server Native Client にアップグレードします。これにより、旧バージョンとの互換性を備えた SQL Server 2005 の新機能が公開されます。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
