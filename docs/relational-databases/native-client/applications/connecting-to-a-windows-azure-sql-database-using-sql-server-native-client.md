---
title: ネイティブ クライアント、Azure SQL DB に接続します。
ms.custom: ''
ms.date: 03/14/2017
ms.reviewer: ''
ms.prod: sql
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  ネイティブ クライアントを使用して[!INCLUDE[ssSDSfull](../../../includes/sssdsfull-md.md)][!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]接続する方法を示すサンプルについては、「[開発: ハウツー トピック (Azure SQL Database)」](https://msdn.microsoft.com/library/ee621787.aspx)を参照してください。  
