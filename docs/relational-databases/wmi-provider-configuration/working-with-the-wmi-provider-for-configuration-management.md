...
## <a name="permissions-and-server-authentication"></a>権限とサーバー認証  
 ...
 WMI Provider for Configuration Management では、セキュリティ証明書がサポートされています。 証明書の詳細については、[暗号化階層](../../relational-databases/security/encryption/encryption-hierarchy.md)を参照してください。  
