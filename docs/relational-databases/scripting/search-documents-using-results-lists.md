...
ms.topic: "article"
helpviewer_keywords: 
  - "検索 [SQL Server Management Studio], 結果一覧"
  - "結果一覧の検索 [SQL Server Management Studio]"
  - "検索 [SQL Server Management Studio], 複数のファイル"
  - "クエリ エディター [SQL Server Management Studio], 複数ファイルの検索"
