...
ms.topic: "article"
helpviewer_keywords: 
  - "Transact-SQL デバッガー, sysadmin 要件"
  - "Transact-SQL デバッガー、サポートされているバージョン"
  - "クエリ エディター [データベース エンジン], 右クリック メニュー"
  - "デバッグ [SQL Server], T-SQL デバッガー"
  - "Transact-SQL デバッガー, クエリ エディターのショートカット メニュー"
  - "Transact-SQL デバッガー, 停止"
  - "Transact-SQL デバッガー, [デバッグ] メニュー"
  - "デバッグ [SQL Server]"
  - "Transact-SQL デバッガー, [デバッグ] ツールバー"
  - "Transact-SQL デバッガー, キーボード ショートカット"
  - "Transact-SQL デバッガー, 開始"
...
-   **[クエリ]** ツール バーの **[クエリ実行のキャンセル]** ボタンをクリックする。  
 ...
 また、**[デバッグ]** メニューの **[すべてデタッチ]** をクリックすると、デバッグ モードを停止し、残りの [!INCLUDE[tsql](../../includes/tsql-md.md)] ステートメントを実行できます。  
...
|**[デバッグ開始]**|使用不可|**[デバッグ開始]**|Alt + F5|クエリ エディター ウィンドウをデバッグ モードにし、最初のブレークポイントまで実行します。 デバッグ モードのクエリ エディター ウィンドウにフォーカスを移した場合、**[デバッグ開始]** は **[続行]** に切り替わります。|  
...
|**[すべてデタッチ]**|使用不可|使用不可|使用不可|デバッグ モードを終了しますが、クエリ エディター ウィンドウ内の残りのステートメントを実行します。|  
