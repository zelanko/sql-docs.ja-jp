...
ms.topic: "article"
helpviewer_keywords: 
  - "利用できないオプション [IntelliSense]"
  - "IntelliSense [SQL Server], トラブルシューティング"
  - "IntelliSense [SQL Server], 利用できないオプション"
...
manager: "jhubbard"
---
# IntelliSense のトラブルシューティング (SQL Server Management Studio)
...
-   IntelliSense は、[!INCLUDE[ssDE](../../includes/ssde-md.md)]のクエリ エディターが [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 以降の[!INCLUDE[ssDE](../../includes/ssde-md.md)]のインスタンスに接続されている場合にのみ使用できます。 Intellisense は、クエリ エディターが以前のバージョンの[!INCLUDE[ssDE](../../includes/ssde-md.md)]のインスタンスに接続されているときは使用できません。  
