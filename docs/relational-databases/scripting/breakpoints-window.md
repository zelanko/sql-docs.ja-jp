 ...
 **言語**  
 [!INCLUDE[tsql](../../includes/tsql-md.md)] を表す **[Transact-SQL]** が表示されます。  
 ...
 **[処理]**  
 [!INCLUDE[ssDE](../../includes/ssde-md.md)] プロセスであることを示す **[SQL]** が表示されます。 この後に、コードが実行される[!INCLUDE[ssDE](../../includes/ssde-md.md)]のインスタンスの名前が表示されます。  
