...
ms.topic: "article"
helpviewer_keywords: 
  - "対話形式の検索 [SQL Server Management Studio]"
  - "検索 [SQL Server Management Studio]、対話形式"
  - "クエリ エディター [SQL Server Management Studio]、対話形式の検索"
