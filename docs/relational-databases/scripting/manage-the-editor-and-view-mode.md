...
ms.topic: "article"
helpviewer_keywords: 
  - "クエリ エディター [SQL Server Management Studio], ウィンドウの動作の管理"
  - "ワークベンチ ビュー モード [SQL Server Management Studio]"
  - "全画面モード [SQL Server Management Studio]"
  - "フォント [SQL Server Management Studio]"
  - "右端の折り返し [SQL Server Management Studio]"
  - "仮想空間モード [SQL Server Management Studio]"
  - "ドキュメント ビューの分割"
  - "行番号の表示"
  - "ビュー モード [SQL Server Management Studio]"
