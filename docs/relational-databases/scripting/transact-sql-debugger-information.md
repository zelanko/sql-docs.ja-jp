...
helpviewer_keywords: 
  ...
  - "Transact-SQL デバッガー, [ウォッチ] ウィンドウ"
  - "Transact-SQL デバッガー, [スレッド] ウィンドウ"
  - "Transact-SQL デバッガー, [呼び出し履歴] ウィンドウ"
  - "Transact-SQL デバッガー, クイック ウォッチ"
  - "Transact-SQL デバッガー, 情報の表示"
...
## 参照  
 ...
 [[ブレークポイント] ウィンドウ](../Topic/Breakpoints%20Window.md)   
 [[呼び出し履歴] ウィンドウ](../Topic/Call%20Stack%20Window.md)   
 [[スレッド] ウィンドウ](../Topic/Threads%20Window.md)   
 [[出力ウィンドウ]](../../relational-databases/scripting/output-window.md)   
