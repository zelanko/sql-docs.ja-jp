...
f1_keywords: 
  - "VS.TextEditor"
helpviewer_keywords: 
  - "クエリ エディター [SQL Server Management Studio]"
  - "コード エディター [SQL Server Management Studio], クエリ エディターについて"
  - "クエリ エディター [SQL Server Management Studio], 全画面モード"
  - "クエリ エディター [データベース エンジン], テンプレート"
  - "全画面モード [SQL Server Management Studio]"
  - "SQL Server Management Studio [SQL Server], テンプレート"
  - "スクリプトの記述"
  - "スクリプトの変更"
  - "SQL Server Management Studio [SQL Server], クエリ エディター"
  - "クエリ エディター [SQL Server Management Studio], クエリ エディターについて"
  - "クエリの記述"
  - "SQL Server Management Studio [SQL Server], エディター"
  - "スクリプト [SQL Server], SQL Server Management Studio"
  - "クエリ [SQL Server], SQL Server Management Studio"
 ...
 **SQLCMD モード**  
 sqlcmd ユーティリティによってサポートされる一連のコマンドを含んだ [!INCLUDE[tsql](../../includes/tsql-md.md)] スクリプトを実行します。 詳細については、「[sqlcmd 操作方法のトピック](../Topic/sqlcmd%20How-to%20Topics.md)」を参照してください。  
...
|MDX クエリ エディターの基本的な機能を表示し、使用する方法について説明します。|[MDX クエリ エディター &#40;Analysis Services - 多次元データ&#41;](../Topic/MDX%20Query%20Editor%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)|  
|DMX クエリ エディターの基本的な機能を表示し、使用する方法について説明します。|[DMX クエリ エディター &#40;Analysis Services - データ マイニング&#41;](../Topic/DMX%20Query%20Editor%20\(Analysis%20Services%20-%20Data%20Mining\).md)|  
