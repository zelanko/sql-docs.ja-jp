...
|**name**|**nvarchar(128)**|メディア セットの名前。 NULL を指定できます。<br /><br /> 詳細についてを参照してください MEDIANAME と MEDIADESCRIPTION[バックアップ &#40;です。TRANSACT-SQL と #41 です](../../t-sql/statements/backup-transact-sql.md)。|  
|**説明**|**nvarchar (255)**|メディア セットの説明。 NULL を指定できます。<br /><br /> 詳細についてを参照してください MEDIANAME と MEDIADESCRIPTION[バックアップ &#40;です。TRANSACT-SQL と #41 です](../../t-sql/statements/backup-transact-sql.md)。|  
...
|**is_encrypted**|**Bit**|バックアップが暗号化されているかどうか。<br /><br /> 0 = 暗号化されていません。<br /><br /> 1 = 暗号化|  
