...
|**有効になっています。**|**tinyint**|警告通知の状態 (ブール値)。 場合**1**警告が発生したときに、このオペレーターが通知を受信できます。|  
...
|**エージェント**|**int**|平日 (月曜から金曜まで)、オペレーターのポケットベルによる警告通知が受信不能になる時刻。|  
|**エージェント**|**int**|土曜日にオペレーターのポケットベルによる警告通知が受信可能になる時刻。|  
|**@saturday_pager_end_time**|**int**|土曜日にオペレーターのポケットベルによる警告通知が受信不能になる時刻。|  
|**エージェント**|**int**|日曜日にオペレーターのポケットベルによる警告通知が受信可能になる時刻。|  
|**エージェント**|**int**|日曜日にオペレーターのポケットベルによる警告通知が受信不能になる時刻。|  
