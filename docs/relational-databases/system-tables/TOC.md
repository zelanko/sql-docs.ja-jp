# [概要](system-tables-transact-sql.md)  
# [拡張イベント テーブル - trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [拡張イベント テーブル - trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [データ層アプリケーション テーブル - sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [データ層アプリケーション テーブル - sysdac_instances_internal に対応します。](data-tier-application-tables-sysdac-instances-internal.md)  
# [システム ビューへのシステム テーブルのマッピング](mapping-system-tables-to-system-views-transact-sql.md)  
# [システム ベース テーブル](system-base-tables.md)  
# [バックアップと復元テーブル](backup-and-restore-tables-transact-sql.md)  
...
# [変更データ キャプチャ テーブル](change-data-capture-tables-transact-sql.md)  
...
# [データベース メンテナンス プラン テーブル](database-maintenance-plan-tables-transact-sql.md)  
...
# [Integration Services のテーブル](integration-services-tables-transact-sql.md)  
...
# [ログ配布テーブル](log-shipping-tables-transact-sql.md)  
...
# [SQL Server エージェント テーブル](sql-server-agent-tables-transact-sql.md)  
...
## [では](dbo-sysjobschedules-transact-sql.md)  
...
# [レプリケーション テーブル](replication-tables-transact-sql.md)  
