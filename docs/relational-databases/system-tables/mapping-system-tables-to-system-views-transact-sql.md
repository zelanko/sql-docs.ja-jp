---
title: "システム ビュー (TRANSACT-SQL) へのシステム テーブルのマッピング |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/17/2017
