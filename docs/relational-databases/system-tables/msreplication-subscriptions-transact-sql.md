...
|**ごと**|**smalldatetime**|ディストリビューションエージェントによって最後に更新された時刻。|  
|**記述**|**nvarchar(255)**|サブスクリプションの説明。|  
|**transaction_timestamp**|**varbinary(16)**|内部使用のみ。|  
|**update_mode**|**tinyint**|更新の種類。|  
|**agent_id**|**バイナリ (16)**|エージェントの ID。|  
|**subscription_guid**|**バイナリ (16)**|パブリケーションにおけるサブスクリプションのバージョンを表すグローバル識別子。|  
|**subid**|**バイナリ (16)**|匿名サブスクリプションのグローバル識別子。|  
