---
title: "データベース メンテナンス プラン テーブル (TRANSACT-SQL) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="database-maintenance-plan-tables-transact-sql"></a>データベース メンテナンス プランのテーブル (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  ここでは、データベース メンテナンス プランで使用される情報を格納するシステム テーブルについて説明します。 これらのテーブルの情報を保持の以前のバージョンからアップグレードされたインスタンス[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]です。  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 アップグレードされたデータベース メンテナンス プランが関連付けられているデータベースごとに 1 行のデータを格納します。  
 ...
 アップグレードされたデータベース メンテナンス プランのジョブごとに 1 行のデータを格納します。  
  
 [sysdbmaintplans](../../relational-databases/system-tables/sysdbmaintplans-transact-sql.md)  
 アップグレードされたデータベース メンテナンス プランごとに 1 行のデータを格納します。  
