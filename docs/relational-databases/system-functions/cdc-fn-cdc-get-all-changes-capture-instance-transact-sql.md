...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 この列挙関数は、ソース テーブルに対して変更データ キャプチャを有効にした時点で作成されます。 関数の名前は派生し、形式を使用して **cdc.fn_cdc_get_all_changes_***capture_instance*場所*capture_instance*ソース テーブルが、キャプチャ インスタンスの指定された値は、変更データ キャプチャを有効にします。  
 ...
 *from_lsn*  
 結果セットに含める LSN 範囲の下端を表す LSN 値を指定します。 *from_lsn* is **binary(10)**.  
