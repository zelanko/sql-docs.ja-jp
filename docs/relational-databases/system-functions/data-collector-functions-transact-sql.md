---
title: "データ コレクター関数 (TRANSACT-SQL) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/03/2017
...
---
# <a name="data-collector-functions--transact-sql"></a>データ コレクター関数 (TRANSACT-SQL)
...
## <a name="see-also"></a>参照  
 ...
 [管理データ ウェアハウスのストアド プロシージャと #40 です。TRANSACT-SQL と #41 です。](../../relational-databases/system-stored-procedures/management-data-warehouse-stored-procedures-transact-sql.md)  
