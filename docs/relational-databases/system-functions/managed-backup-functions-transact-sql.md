...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [managed_backup.fn_backup_instance_config &#40;です。TRANSACT-SQL と #41 です。](../../relational-databases/system-functions/managed-backup-fn-backup-instance-config-transact-sql.md)  
