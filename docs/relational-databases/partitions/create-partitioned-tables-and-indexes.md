...
helpviewer_keywords: 
  - "作成するパーティション インデックス [SQL Server]"
  - "作成するパーティション構成 [SQL Server]"
  - "作成するパーティション関数 [SQL Server]"
  - "作成するパーティション テーブル [SQL Server]"
  - "パーティション関数 [SQL Server]"
  - "パーティション構成 [SQL Server]"
...
#### パーティション テーブルの新しいファイル グループを作成するには  
