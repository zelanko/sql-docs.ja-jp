...
helpviewer_keywords: 
  - "データベース メール [SQL Server], 構成オブジェクト"
  - "データベース メール [SQL Server], アカウント"
  - "構成オブジェクト [データベース メール]"
  - "データベース メール [SQL Server], プロファイル"
...
-   [データベース メール構成オブジェクトの関係](#VisualElement)  
  
-   [データベース メール アカウント](#DBAccount)  
  
-   [[データベース メール プロファイル]](#DBProfile)  
  
-   [データベース メール構成タスク](#RelatedTasks)  
  
-   [その他のデータベース メール構成タスク (システム ストアド プロシージャ)](#Add_Tasks)  
  
-   [その他のリファレンス](#RelatedContent)  
...
##  <a name="VisualElement"></a> データベース メール構成オブジェクトの関係  
 ...
 ![ユーザー、プロファイル、およびアカウントの関係](../../relational-databases/database-mail/media/databasemailprofileaccount.gif "ユーザー、プロファイル、およびアカウントの関係")  
