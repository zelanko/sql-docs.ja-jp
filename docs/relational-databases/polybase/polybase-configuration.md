...
PolyBase では、SQL Server 2016 SP1 CU7 および SQL Server 2017 以降の Hadoop 暗号化ゾーンがサポートされることに注意してださい。
