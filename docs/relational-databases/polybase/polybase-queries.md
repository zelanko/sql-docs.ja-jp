...
keywords: 
  - "PolyBase"
helpviewer_keywords: 
  - "PolyBase, インポートおよびエクスポート"
  - "Hadoop, PolyBase によるインポート"
  - "Hadoop, PolyBase によるエクスポート"
  - "Azure BLOB ストレージ, PolyBase によるインポート"
  - "Azure BLOB ストレージ, PolyBase によるエクスポート"
