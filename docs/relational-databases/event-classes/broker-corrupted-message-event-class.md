...
|**RoleName**|**nvarchar**|このメッセージを受信するエンドポイントのロール。 次の値のうちの 1 つです。<br /><br /> **initiator**: 受信エンドポイントはメッセージ交換の発信側です。<br /><br /> **target**:                受信エンドポイントはメッセージ交換の対象となる側です。|38|いいえ|  
