...
|IntegerData|**int**|ステートメントによって返された行数。|25|[ユーザー アカウント制御]|  
...
|NestLevel|**int**|ステートメントがストアド プロシージャ内で実行された場合のストアド プロシージャの入れ子レベル。|29|[ユーザー アカウント制御]|  
...
|Reads|**bigint**|SQL ステートメントによるページの読み取り回数。|16|[ユーザー アカウント制御]|  
...
|TextData|**ntext**|実行されたステートメントのテキスト。|1|[ユーザー アカウント制御]|  
|TransactionID|**bigint**|ステートメントがトランザクション内で実行された場合のトランザクションの ID。|4|[ユーザー アカウント制御]|  
|Writes|**bigint**|SQL ステートメントによるページの書き込み回数。|17|[ユーザー アカウント制御]|  
