...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] RPC Output Parameter イベント クラスは、リモート プロシージャ コール (RPC) を実行した後の出力パラメーター値をトレースします。  
