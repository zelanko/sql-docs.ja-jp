...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Server Object Take Ownership イベント クラス"
...
## Audit Server Object Take Ownership イベント クラスのデータ列  
...
|**ObjectType**|**int**|イベントに関係するオブジェクトの種類を表す値。 この列に返される値は、**sys.objects** カタログ ビューの **type** 列の対応する値と、[ObjectType トレース イベント列](../../relational-databases/event-classes/objecttype-trace-event-column.md)に示された値の組み合わせになります。|28|可|  
