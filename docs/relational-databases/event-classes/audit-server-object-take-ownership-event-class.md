...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Server Object Take Ownership** イベント クラスは、サーバー スコープ内でオブジェクトの所有者が変更されるときに発生します。  
