...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Object Derived Permission イベント クラス"
...
## Audit Object Derived Permission イベント クラスのデータ列  
...
|**ObjectName**|**nvarchar**|作成、変更、または削除されるオブジェクトの名前。|34|可|  
...
|**OwnerName**|**nvarchar**|作成、変更、または削除されるオブジェクトの所有者のデータベース ユーザー名。|37|可|  
