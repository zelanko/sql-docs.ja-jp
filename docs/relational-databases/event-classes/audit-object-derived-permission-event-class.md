...
|**DBUserName**|**nvarchar**|データベースに格納されている実行者のユーザー名。|40|[ユーザー アカウント制御]|  
|**EventClass**|**int**|イベントの種類 = 118。|27|いいえ|  
|**EventSequence**|**int**|要求内の特定のイベントのシーケンス。|51|いいえ|  
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 作成<br /><br /> 2 = 変更<br /><br /> 3 = 削除<br /><br /> 4 = ダンプ<br /><br /> 11 = 読み込み|21|[ユーザー アカウント制御]|  
...
|**ObjectName**|**nvarchar**|作成、変更、または削除されるオブジェクトの名前。|34|[ユーザー アカウント制御]|  
...
|**OwnerName**|**nvarchar**|作成、変更、または削除されるオブジェクトの所有者のデータベース ユーザー名。|37|[ユーザー アカウント制御]|  
