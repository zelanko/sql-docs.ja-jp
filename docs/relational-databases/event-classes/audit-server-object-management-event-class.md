...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Server Object Management** イベント クラスは、サーバー オブジェクトに対して CREATE、ALTER、または DROP が実行された場合に発生します。  
