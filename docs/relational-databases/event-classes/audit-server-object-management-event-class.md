...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Server Object Management イベント クラス"
...
## Audit Server Object Management イベント クラスのデータ列  
...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 作成<br /><br /> 2 = 変更<br /><br /> 3 = 削除<br /><br /> 4 = ダンプ<br /><br /> 7 = 資格情報をログインにマッピング<br /><br /> 9 = 資格情報のマッピングを破棄<br /><br /> 11 = 読み込み|21|可|  
