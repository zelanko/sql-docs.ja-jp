...
## Audit Add DB User イベント クラスのデータ列  
...
|**DatabaseName**|**nvarchar**|ユーザー名が追加または削除されたデータベースの名前。|35|可|  
|**DBUserName**|**nvarchar**|データベース内の発行者のユーザー名。|40|はい|  
|**EventClass**|**int**|イベントの種類 = 109。|27|いいえ|  
|**EventSequence**|**int**|要求内の特定のイベントのシーケンス。|51|不可|  
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 追加<br /><br /> 2 = 削除<br /><br /> 3 = データベース アクセスの許可<br /><br /> 4 = データベース アクセスの禁止|21|可|  
...
|**TargetLoginName**|**nvarchar**|データベースへのアクセス権が変更されたログイン名。|42|可|  
|**TargetLoginSid**|**image**|新しいログインの追加など、ログインを対象とする操作で、対象となるログインのセキュリティ識別番号 (SID)。|43|はい|  
|**TargetUserName**|**nvarchar**|ユーザーにより追加されたデータベース名。|39|可|  
