...
|**BinaryData**|**image**|ANSI NULL、ANSI PADDING、cursor close on commit、NULL 連続、引用符で囲まれた識別子などの、セッション レベルの設定。|2|[ユーザー アカウント制御]|  
...
|**IntegerData**|**int**|使用されているネットワーク パケット サイズ。|25|[ユーザー アカウント制御]|  
...
|**成功**|**int**|1 = 成功。 0 = 失敗。 このイベントでは、常に成功 (1) が表示されます。|23|[ユーザー アカウント制御]|  
|**TextData**|**ntext**|設定されるすべてのオプションをセミコロンで区切ったリスト。|1|[ユーザー アカウント制御]|  
