...
## Execution Warnings イベント クラスのデータ列  
...
|EventSequence|**int**|トレース内にある特定のイベントのシーケンス。|51|不可|  
|EventSubClass|**int**|イベント サブクラスの種類。<br /><br /> 1 = クエリ待機<br /><br /> 2 = クエリ タイムアウト|21|可|  
