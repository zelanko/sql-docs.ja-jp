...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = バックアップ<br /><br /> 2 = 復元<br /><br /> 3 = バックアップ ログ|21|[ユーザー アカウント制御]|  
...
|**TextData**|**ntext**|バックアップ ステートメントまたは復元ステートメントの SQL テキスト。|1|[ユーザー アカウント制御]|  
