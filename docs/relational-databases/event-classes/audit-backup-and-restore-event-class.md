...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] **Audit Backup/Restore** イベント クラスは、バックアップまたは復元コマンドが実行されたときに発生します。  
...
|**TextData**|**ntext**|バックアップ ステートメントまたは復元ステートメントの SQL テキスト。|@shouldalert|はい|  
