...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Add Member to DB Role イベント クラス"
...
## Audit Add Member to DB Role イベント クラスのデータ列  
...
|**DatabaseName**|**nvarchar**|ロールのメンバーシップが変更されたデータベースの名前。|35|可|  
|**DBUserName**|**nvarchar**|データベース内の発行者のユーザー名。|40|はい|  
|**EventClass**|**int**|イベントの種類 = 110。|27|いいえ|  
|**EventSequence**|**int**|要求内の特定のイベントのシーケンス。|51|不可|  
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 追加<br /><br /> 2 = 削除<br /><br /> 3 = グループの変更|21|可|  
...
|**TargetUserName**|**nvarchar**|ロールのメンバーシップが変更されたユーザーの名前。|39|可|  
