...
|ObjectID|**int**|非推奨の機能の ID 番号。|22|[ユーザー アカウント制御]|  
|ObjectName|**nvarchar**|非推奨の機能の名前。|34|[ユーザー アカウント制御]|  
...
|SqlHandle|**image**|SQL バッチまたはストアド プロシージャの識別に使用できるバイナリ ハンドル。|63|[ユーザー アカウント制御]|  
