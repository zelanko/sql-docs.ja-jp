...
|**CPU**|**int**|接続時にユーザーが使用した CPU 時間 (ミリ秒) です。|18|[ユーザー アカウント制御]|  
...
|**Duration**|**bigint**|ユーザーがログインしてからの時間 (概算) です。|13|[ユーザー アカウント制御]|  
|**EndTime**|**datetime**|ログアウトの終了時刻です。|15|[ユーザー アカウント制御]|  
...
|**Reads**|**bigint**|接続時にユーザーが実行した論理読み取り I/O の数です。|16|[ユーザー アカウント制御]|  
...
|**Writes**|**bigint**|接続時にユーザーが実行した論理書き込み I/O の数です。|17|[ユーザー アカウント制御]|  
