...
|**CPU**|**int**|接続時にユーザーが使用した CPU 時間 (ミリ秒) です。|18|可|  
...
|**EndTime**|**datetime**|ログアウトの終了時刻です。|15|可|  
|**EventClass**|**int**|イベントの種類 = 15。|27|いいえ|  
|**EventSequence**|**int**|要求内の特定のイベントのシーケンス。|51|不可|  
|**EventSubClass**|**int**|ログインに使用される接続の種類。 1 = プールされていない。2 = プールされた。|21|可|  
