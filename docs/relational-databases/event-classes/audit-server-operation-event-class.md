...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 一括操作の管理<br /><br /> 2 = 設定の変更<br /><br /> 3 = リソースの変更<br /><br /> 4 = 認証<br /><br /> 5 = 外部アクセス<br /><br /> 6=サーバー状態の変更<br /><br /> 7=安全でないアセンブリ<br /><br /> 8=	接続の変更<br /><br /> 9=リソース ガバナーの変更<br /><br /> 10=任意のワークロード グループの使用<br /><br /> 11=サーバー状態の表示|21|[ユーザー アカウント制御]|  
