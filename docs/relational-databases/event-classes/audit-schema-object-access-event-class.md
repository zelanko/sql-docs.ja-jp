...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Schema Object Access** イベント クラスは、オブジェクト権限 (SELECT など) が使用されたときに発生します。  
