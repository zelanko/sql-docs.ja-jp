...
|**ColumnPermissions**|**int**|列権限が設定されていたかどうかを示します。 ステートメント テキストを解析して、どの権限が適用されたかを調べます。 1 = 設定済み、0 = 設定なしです。|44|[ユーザー アカウント制御]|  
...
|**ObjectName**|**nvarchar**|権限がチェックされているオブジェクトの名前です。|34|[ユーザー アカウント制御]|  
...
|**OwnerName**|**nvarchar**|対象になっているオブジェクトの所有者のデータベース ユーザー名です。|37|[ユーザー アカウント制御]|  
|**ParentName**|**nvarchar**|オブジェクトを含むスキーマの名前です。|59|[ユーザー アカウント制御]|  
|**権限**|**bigint**|チェックする権限の種類を表す整数値。<br /><br /> 1 = SELECT ALL<br /><br /> 2 = UPDATE ALL<br /><br /> 4 = REFERENCES ALL<br /><br /> 8 = INSERT<br /><br /> 16 = DELETE<br /><br /> 32 = EXECUTE (プロシージャのみ)|19|[ユーザー アカウント制御]|  
...
|**TextData**|**ntext**|ステートメントの SQL テキスト。|1|[ユーザー アカウント制御]|  
