...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Server Principal Management イベント クラス"
...
## Audit Server Principal Management イベント クラスのデータ列  
...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 作成<br /><br /> 2 = 変更<br /><br /> 3 = 削除<br /><br /> 4 = ダンプ<br /><br /> 5 = 無効<br /><br /> 6 = 有効<br /><br /> 11 = 読み込み|21|可|  
