...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 書き込み開始<br /><br /> 2 = 書き込み終了|21|可|  
...
|**LoginSid**|**image**|ログイン ユーザーのセキュリティ ID 番号 (SID)。 この情報は、**master** データベースの **syslogins** テーブルにあります。 各 SID はサーバーのログインごとに一意です。|41|可|  
