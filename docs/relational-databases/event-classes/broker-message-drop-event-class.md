...
|**EventSubClass**|**nvarchar**|削除されたメッセージがシーケンス番号付きメッセージであるかどうかを示します。 次の 2 つの値のいずれかになります。<br /><br /> **Sequenced Message**。 削除されたメッセージはシーケンス番号付きメッセージです。<br /><br /> **Unsequenced Message**。 削除されたメッセージはシーケンス番号付きメッセージではありません。|21|可|  
