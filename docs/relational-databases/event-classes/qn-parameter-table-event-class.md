...
ms.topic: "article"
helpviewer_keywords: 
  - "イベント クラス [SQL Server], QN:Parameter Table"
...
## QN:Parameter table イベント クラスのデータ列  
...
|LoginName|**nvarchar**|ユーザーのログイン名 (*DOMAIN*\\*Username* の形式で表された [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] セキュリティ ログインまたは Windows ログイン資格情報)。|11|いいえ|  
