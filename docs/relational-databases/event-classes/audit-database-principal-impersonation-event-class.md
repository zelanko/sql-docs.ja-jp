...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Database Principal Impersonation** イベント クラスは、EXECUTE AS \<*user*> や SETUSER などのデータベース スコープ内で権限の借用が生じるときに発生します。  
