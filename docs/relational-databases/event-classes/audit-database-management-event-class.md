...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Database Management イベント クラス"
...
## Audit Database Management イベント クラスのデータ列  
...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 作成<br /><br /> 2 = 変更<br /><br /> 3 = 削除<br /><br /> 4 = ダンプ<br /><br /> 11 = 読み込み|21|可|  
...
|**ObjectType**|**int**|イベントに関係するオブジェクトの種類を表す値。 この値は、 **sysobjects** テーブルの type 列に相当します。 値については、「[ObjectType トレース イベント列](../../relational-databases/event-classes/objecttype-trace-event-column.md)」を参照してください。|28|可|  
