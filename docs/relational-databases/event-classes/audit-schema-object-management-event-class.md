...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Schema Object Management イベント クラス"
...
## Audit Schema Object Management イベント クラスのデータ列  
...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 作成<br /><br /> 2 = 変更<br /><br /> 3 = 削除<br /><br /> 4 = ダンプ<br /><br /> 8 = 転送<br /><br /> 11 = 読み込み|21|可|  
...
|**ParentName**|**nvarchar**|オブジェクトが存在するスキーマの名前。|59|可|  
