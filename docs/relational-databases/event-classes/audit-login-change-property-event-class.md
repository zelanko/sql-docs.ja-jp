...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 既定のデータベースの変更<br /><br /> 2 = 既定の言語の変更<br /><br /> 3 = 名前の変更<br /><br /> 4 = 資格情報の変更<br /><br /> 5 = ポリシーの変更<br /><br /> 6 = 有効期限の変更|21|[ユーザー アカウント制御]|  
