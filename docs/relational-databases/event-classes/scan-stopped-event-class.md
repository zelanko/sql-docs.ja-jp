...
|IndexID|**int**|スキャンされているインデックス。|24|[ユーザー アカウント制御]|  
...
|ObjectID|**int**|スキャンされているオブジェクトのシステム割り当て ID。|22|[ユーザー アカウント制御]|  
|Reads|**bigint**|(論理的に) 読み取られたページ数。|16|[ユーザー アカウント制御]|  
