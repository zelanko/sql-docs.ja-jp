...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] User Error Message イベント クラスでは、エラーや例外が発生した場合に、ユーザーに通知するエラー メッセージを表示します。 エラー メッセージのテキストは、TextData フィールドに表示されます。  
...
|Severity|**int**|エラーまたは例外の重大度レベル。|20|はい|  
