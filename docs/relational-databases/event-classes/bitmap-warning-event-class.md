...
|**EventSubClass**|**int**|イベント サブクラスの種類。 0 = ビットマップ フィルターは無効になっています。|21|[ユーザー アカウント制御]|  
...
|**Exchange Spill**|**int**|パーティション再分割に関係するハッシュ チームのルートのノード ID。 Showplan のノード ID と一致します。|22|[ユーザー アカウント制御]|  
