...
|**BinaryData**|**image**|結果のカーソルの種類です。 値は次のとおりです。<br /><br /> 1 = キー セット<br /><br /> 2 = 動的<br /><br /> 4 = 順方向専用<br /><br /> 8 = 静的<br /><br /> 16 = 高速順方向|2|[ユーザー アカウント制御]|  
...
|**Handle**|**int**|イベントで参照されているオブジェクトのハンドル。|33|[ユーザー アカウント制御]|  
...
|**RequestID**|**int**|暗黙的な変換の要求識別子です。|49|[ユーザー アカウント制御]|  
