...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Server Principal Impersonation** イベント クラスは、サーバー スコープ内に EXECUTE \<*AS login*> などの権限の借用がある場合に発生します。  
