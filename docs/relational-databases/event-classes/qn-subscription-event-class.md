...
ms.topic: "article"
helpviewer_keywords: 
  - "イベント クラス [SQL Server], QN:Subscription"
...
---
# QN:Subscription イベント クラス
  QN:Subscription イベントでは、通知サブスクリプションに関する情報が報告されます。  
  
## QN:Subscription イベント クラスのデータ列  
