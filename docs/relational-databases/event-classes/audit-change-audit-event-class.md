...
## Audit Change Audit イベント クラスのデータ列  
...
|**ColumnPermissions**|**int**|列権限が設定されているかどうかのインジケーター。 ステートメントのテキストを解析して、どの権限がどの列に適用されていたかを判断します。|44|可|  
...
|**EventSubClass**|**int**|イベント サブクラスの種類。<br /><br /> 1 = 監査の開始<br /><br /> 2 = 監査の停止<br /><br /> 3 = C2 モード オン<br /><br /> 4 = C2 モード オフ|21|可|  
