...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Server Object GDR** イベント クラスは、Microsoft SQL Server のユーザーが、サーバー オブジェクトの権限に対して GRANT、REVOKE、または DENY を実行するたびに発生します。  
