...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] SQLTransaction イベント クラスは、特にアプリケーション、トリガー、またはストアド プロシージャをテストするとき、トランザクションがいつ開始され、いつ完了したかを監視する場合に使用します。  
