...
|EventSubClass|**int**|イベント サブクラスの種類。<br /><br /> 0 = 開始<br /><br /> 1 = コミット<br /><br /> 2 = ロールバック<br /><br /> 3 = セーブポイント|21|[ユーザー アカウント制御]|  
...
|IntegerData|**int**|0 = システム トランザクション。<br /><br /> 1 = ユーザー トランザクション|25|[ユーザー アカウント制御]|  
