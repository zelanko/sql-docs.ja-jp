...
|**TargetLoginName**|**nvarchar**|ログインを対象とする操作で、対象となるログインの名前。|42|[ユーザー アカウント制御]|  
|**TargetLoginSid**|**image**|ログインを対象とする操作で、対象となるログインのセキュリティ識別番号 (SID)。|43|[ユーザー アカウント制御]|  
