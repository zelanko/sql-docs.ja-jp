...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit App Role Change Password** イベント クラスは、アプリケーション ロールのパスワードが変更された場合に発生します。  
