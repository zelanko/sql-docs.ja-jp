...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] ユーザーなどのプリンシパルがデータベースで作成、変更、または削除されると、**Audit Database Principal Management** イベント クラスが発生します。  
