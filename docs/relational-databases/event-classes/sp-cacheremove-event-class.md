...
|EventSubClass|**int**|イベント サブクラスの種類。<br /><br /> 1 = コンパイル済みプランの削除: コンパイル済みのクエリ プランがキャッシュから削除されています。<br /><br /> 2 = プロシージャ キャッシュのフラッシュ: プロシージャ キャッシュからすべてのエントリが削除されています。|21|[ユーザー アカウント制御]|  
...
|TextData|**ntext**|キャッシュから削除する SQL のテキスト。|1|[ユーザー アカウント制御]|  
