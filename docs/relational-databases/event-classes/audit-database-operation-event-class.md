...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Database Operation** イベント クラスは、チェックポイント処理、クエリ通知のサブスクライブなど、データベースで操作が行われるときに発生します。  
