...
|**Duration**|**bigint**|ファイルの拡張に必要な時間 (ミリ秒単位)。|13|[ユーザー アカウント制御]|  
|**EndTime**|**datetime**|データ ファイルの自動拡張が終了した時刻。|18|[ユーザー アカウント制御]|  
|**EventClass**|**int**|イベントの種類 = 92。|27|いいえ|  
|**EventSequence**|**int**|バッチ内の **CursorClose** イベント クラスのシーケンス。|51|いいえ|  
|**Filename**|**nvarchar**|拡張されているファイルの論理名。|36|[ユーザー アカウント制御]|  
...
|**IntegerData**|**int**|ファイルの拡張単位を表す 8 KB ページの数。|25|[ユーザー アカウント制御]|  
...
|**NTDomainName**|**nvarchar**|[!INCLUDE[msCoName](../../includes/msconame-md.md)] ユーザーが所属する Windows ドメイン。|7|[ユーザー アカウント制御]|  
