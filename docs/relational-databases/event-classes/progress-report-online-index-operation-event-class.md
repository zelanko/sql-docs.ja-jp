...
|BigintData1|**bigint**|挿入された行数。|52|[ユーザー アカウント制御]|  
|BigintData2|**bigint**|0 は直列実行プランです。それ以外の場合は、並列実行時のスレッド ID です。|53|[ユーザー アカウント制御]|  
...
|IndexID|**int**|イベントの影響を受けるオブジェクトに付けられたインデックス用の ID。|24|[ユーザー アカウント制御]|  
...
|PartitionId|**bigint**|作成されているパーティションの ID。|65|[ユーザー アカウント制御]|  
|PartitionNumber|**int**|作成されているパーティションの序数。|25|[ユーザー アカウント制御]|  
...
|StartTime|**datetime**|イベントの開始時刻。|14|[ユーザー アカウント制御]|  
