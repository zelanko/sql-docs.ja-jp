...
|-----------------|----------|-----------------|-------------------|----------------|  
|**ApplicationName**|**nvarchar**|このイベント クラスでは使用しません。|10|[ユーザー アカウント制御]|  
|**ClientProcessID**|**int**|このイベント クラスでは使用しません。|9|[ユーザー アカウント制御]|  
|**DatabaseID**|**int**|[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] では、 **ServerName** データ列がトレースにキャプチャされ、そのサーバーが利用可能な場合、データベースの名前が表示されます。 データベースに対応する値は、DB_ID 関数を使用して特定します。|3|[ユーザー アカウント制御]|  
|**EventClass**|**int**|キャプチャされたイベント クラスの種類。 **Audit Broker Login** の場合は、常に **159**。|27|いいえ|  
|**EventSequence**|**int**|このイベントのシーケンス番号。|51|いいえ|  
|**EventSubClass**|**int**|イベント サブクラスの種類です。各イベント クラスについての詳細な情報を提供します。 次の表に、このイベントのイベント サブクラス値を示します。|21|[ユーザー アカウント制御]|  
...
|**HostName**|**nvarchar**|このイベント クラスでは使用しません。|8|[ユーザー アカウント制御]|  
...
|**SPID**|**int**|クライアントに関連付けられているプロセスに SQL Server によって割り当てられているサーバー プロセス ID。|12|[ユーザー アカウント制御]|  
