...
## ユーティリティ エクスプローラーからの SQL Server インスタンスまたはデータ層アプリケーションの登録  
...
### SQL Server ユーティリティのナビゲーション ウィンドウ  
