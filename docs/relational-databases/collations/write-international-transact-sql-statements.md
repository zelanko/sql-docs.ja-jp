...
helpviewer_keywords: 
  - "国際化に対応したステートメントの記述"
  - "Transact-SQL の国際化に関する注意点"
  - "国際化に関する注意点 [SQL Server], Transact-SQL"
  - "データベース エンジンの国際化に関する注意点 [SQL Server], Transact-SQL"
  - "ステートメント [SQL Server], 国際化"
  - "データベースの国際化に関する注意点 [SQL Server], Transact-SQL"
  - "データ [SQL Server], 国際化に関する注意点"
