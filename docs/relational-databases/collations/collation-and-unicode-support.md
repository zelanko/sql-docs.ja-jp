...
helpviewer_keywords: 
  - "バイナリ照合順序 [SQL Server]"
  - "式レベルの照合順序 [SQL Server]"
  - "Windows 照合順序 [SQL Server]"
  - "グローバリゼーション [SQL Server], グローバリゼーションの概要"
  - "補助文字のサポート"
  - "コード ページ [SQL Server], コード ページの概要"
  - "照合順序 [SQL Server], 照合順序の概要"
  - "Unicode [SQL Server], 照合順序"
  - "データベースレベルの照合順序 [SQL Server]"
  - "読み取り順"
  - "列レベルの照合順序"
  - "ロケール [SQL Server], ロケールの概要"
  - "ロケール [SQL Server]"
  - "コード ページ [SQL Server]"
  - "SQL Server 照合順序"
  - "サーバーレベルの照合順序 [SQL Server]"
...
##  <a name="a-nametermsa-collation-terms"></a><a name="Terms"></a> 照合順序の用語    
...
###  <a name="a-namecollationdefna-collation"></a><a name="Collation_Defn"></a> 照合順序    
...
|アクセントを区別する (_AS)|アクセントのある文字とアクセントのない文字を区別します。 たとえば、"a" と "&#xE1;" は等しくありません。 このオプションを選択しないと、照合順序でアクセントが区別されなくなります。 つまり、アクセントのある文字とアクセントのない文字は、並べ替えを行う際に同じものと見なされます。 アクセントを区別しないことを明示的に選択するには、_AI と指定します。|    
...
###  <a name="a-namelocaledefna-locale"></a><a name="Locale_Defn"></a> ロケール    
...
###  <a name="a-namecodepagedefna-code-page"></a><a name="Code_Page_Defn"></a> コード ページ    
...
###  <a name="a-namesortorderdefna-sort-order"></a><a name="Sort_Order_Defn"></a> 並べ替え順序    
 並べ替え順序は、データ値の並べ替え方法を指定します。 これは、データ比較の結果に影響を及ぼします。 データは、照合順序を使用して並べ替えられ、インデックスを使用して最適化することができます。    
    
##  <a name="a-nameunicodedefna-unicode-support"></a><a name="Unicode_Defn"></a> Unicode のサポート    
...
##  <a name="a-namesupplementarycharactersa-supplementary-characters"></a><a name="Supplementary_Characters"></a> 補助文字    
...
##  <a name="a-namegb18030a-gb18030-support"></a><a name="GB18030"></a> GB18030 のサポート    
...
##  <a name="a-namecomplexscripta-complex-script-support"></a><a name="Complex_script"></a> 複雑な文字表記のサポート    
...
##  <a name="a-namejapanesecollationsa-japanese-collations-added-in--includesssqlv14mdtokensqlv14sssqlv14mdmd"></a><a name="Japanese_Collations"></a> [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] に追加された日本語照合順序
...
##  <a name="a-namerelatedtasksa-related-tasks"></a><a name="Related_Tasks"></a> 関連タスク    
...
##  <a name="a-namerelatedcontenta-related-content"></a><a name="Related_Content"></a> 関連コンテンツ    
