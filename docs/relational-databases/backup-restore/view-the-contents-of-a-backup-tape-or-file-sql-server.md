...
###  <a name="Security"></a> セキュリティ  
 セキュリティについては、「[RESTORE HEADERONLY &#40;Transact-SQL&#41;](../Topic/RESTORE%20HEADERONLY%20\(Transact-SQL\).md)」を参照してください。  
...
3.  [RESTORE HEADERONLY](../Topic/RESTORE%20HEADERONLY%20\(Transact-SQL\).md) ステートメントを使用します。 この例は、`AdventureWorks2012-FullBackup.bak` というファイルに関する情報を返します。  
