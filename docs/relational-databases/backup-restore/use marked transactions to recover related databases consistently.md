---
title: "マークされたトランザクションを使用して関連するデータベースを一貫した状態に復元する方法 (完全復旧モデル) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "トランザクション マーク [SQL Server]"
  - "マーク付きトランザクション [SQL Server]"
  - "データベースの復元 [SQL Server], トランザクション マークの挿入"
  - "復旧 [SQL Server], 関連するデータベース"
  - "データベースの復元 [SQL Server], 関連するデータベースの復旧"
  - "データベースの復元 [SQL Server], 関連するデータベース"
  - "マークされたトランザクション [SQL Server], 作成"
  - "BEGIN TRAN...WITH MARK ステートメント"
