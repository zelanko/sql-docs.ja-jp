...
description: この記事では、Transact-SQL を使用して、データベース レベルとインスタンス レベルの両方で Microsoft Azure への SQL Server マネージド バックアップを無効にする方法または一時停止する方法について説明します。
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
...
#### <a name="to-disable-ss_smartbackup-for-all-the-databases"></a>すべてのデータベースについて [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] を無効にするには:  
