...
# [一部のファイル グループのみを復元する段階的な部分復元 (単純復旧モデル) の例](example-piecemeal-restore-of-only-some-filegroups-simple-recovery-model.md)
...
# [一部のファイル グループのみを復元する段階的な部分復元 (完全復旧モデル) の例](example-piecemeal-restore-of-only-some-filegroups-full-recovery-model.md)
...
# [データベースの段階的な部分復元 (単純復旧モデル) の例](example-piecemeal-restore-of-database-simple-recovery-model.md)
...
# [読み取り専用ファイルのオンライン復元の例 (完全復旧モデル)](example-online-restore-of-a-read-only-file-full-recovery-model.md)
# [データを復元しないデータベースの復旧 (Transact-SQL)](recover-a-database-without-restoring-data-transact-sql.md)
# [プライマリ ファイル グループと他のファイル グループを 1 つオフラインで復元する例 (完全復旧モデル)](example-offline-restore-of-primary-and-one-other-filegroup-full-recovery-model.md)
...
# [ファイルとファイル グループを既存のファイルに復元する](restore-files-and-filegroups-over-existing-files-sql-server.md)
...
# [SSMS を使用したデータベース バックアップの復元](restore-a-database-backup-using-ssms.md)
...
# [バックアップ概要](backup-overview-sql-server.md)
# [ページ復元](restore-pages-sql-server.md)
