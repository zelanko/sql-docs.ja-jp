...
description: データベースのバックアップに関係なく、SQL Server のトランザクション ログを頻繁にバックアップすることができます。 トランザクション ログ バックアップのシーケンスは、ログ チェーンです。
ms.custom: ''
ms.date: 01/05/2018
ms.prod: sql
...
##  <a name="how-a-sequence-of-log-backups-works"></a><a name="LogBackupSequence"></a> 一連のログ バックアップの動作  
