...
helpviewer_keywords: 
  ...
  - "バックアップ [SQL Server]. 損傷したデータベース"
  - "トランザクション ログ バックアップ [SQL Server], 損傷したデータベース"
...
## 参照  
 ...
 [[データベースのバックアップ] &#40;[バックアップ オプション] ページ&#41;](../Topic/Back%20Up%20Database%20\(Backup%20Options%20Page\).md)   
 [[データベースのバックアップ] &#40;[全般] ページ&#41;](../Topic/Back%20Up%20Database%20\(General%20Page\).md)   
