...
> [!NOTE]  
>  ODBC **Sqlbulkoperations**関数には、@no__t 1 つの一括コピー関数とのリレーションシップはありません。 アプリケーションでは、[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 固有の一括コピー関数を使用して、一括コピー操作を実行する必要があります。  
