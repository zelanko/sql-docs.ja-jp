...
ms.topic: "article"
helpviewer_keywords: 
  - "変更データ キャプチャ [SQL Server], 変更の追跡との比較"
  - "変更データ キャプチャと変更の追跡"
  - "変更データ キャプチャ [SQL Server], データ型の動作"
  - "Sync Services for ADO.NET"
  - "変更の追跡 [SQL Server], Sync Services for ADO.NET"
  - "変更の追跡 [SQL Server]"
  - "変更データ キャプチャ [SQL Server], セキュリティ"
...
## 参照  
 ...
 [変更データ キャプチャに関連した動的管理ビュー &#40;Transact-SQL&#41;](../Topic/Change%20Data%20Capture%20Related%20Dynamic%20Management%20Views%20\(Transact-SQL\).md)  
