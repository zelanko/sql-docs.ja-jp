...
### 一方向の同期アプリケーション  
 ...
 ![一方向の同期アプリケーション](../../relational-databases/track-changes/media/one-waysync.gif "一方向の同期アプリケーション")  
...
### 双方向の同期アプリケーション  
 ...
 ![二方向の同期アプリケーション](../../relational-databases/track-changes/media/two-waysync.gif "二方向の同期アプリケーション")  
