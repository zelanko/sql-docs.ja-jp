...
# [ネイティブ プロシージャの ATOMIC ブロック](ネイティブ-プロシージャの-atomic-ブロック.md)
...
# [クイック スタート 1: Transact-SQL のパフォーマンスを向上させるインメモリ OLTP テクノロジ](quick-start-1-in-memory-oltp-technologies-for-faster-transact-sql-performance.md)
