...
helpviewer_keywords: 
  - "ストップリスト [フルテキスト検索]"
  - "ストップ リストのフルテキスト検索 [SQL Server]"
  - "フルテキスト検索 [SQL Server], ノイズ ワード"
  - "ノイズ ワード [フルテキスト検索]"
...
7.  次に示すストップリスト作成オプションのいずれかを選択します。  
    ...
    -   **[既存のフルテキスト ストップリストから作成する]**  
     ...
     詳細については、「[新しいフルテキスト ストップリスト &#40;[全般] ページ&#41;](../Topic/New%20Full-Text%20Stoplist%20\(General%20Page\).md)」を参照してください。  
...
##  <a name="queries"></a> フルテキスト クエリでのストップリストの使用  
...
##  <a name="viewing"></a> ストップリストとストップリスト メタデータの表示  
...
##  <a name="change"></a> ストップリストのストップワードの変更  
...
5.  [[フルテキスト ストップリストのプロパティ]](../Topic/Full-Text%20Stoplist%20Properties.md) ダイアログ ボックスで:  
...
##  <a name="upgrade"></a> SQL Server 2005 のノイズ ワードからのアップグレード  
