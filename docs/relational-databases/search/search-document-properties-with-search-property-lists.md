...
7.  以下のオプションの 1 つを選択します。  
    ...
    -   **[既存の検索プロパティ リストから作成する]**  
     ...
     詳細については、「 [New Search Property List](../../t-sql/statements/create-search-property-list-transact-sql.md)」を参照してください。  
