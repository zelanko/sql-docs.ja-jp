---
title: "LocalDBShareInstance 関数 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]指定された共有名を使用して、コンピューターの他のユーザーと指定した SQL Server Express LocalDB インスタンスを共有します。  
