...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]存在するかどうかを使用する LocalDB バージョンが実行されているかどうかなど、指定した SQL Server Express LocalDB インスタンスの情報を返します。  
