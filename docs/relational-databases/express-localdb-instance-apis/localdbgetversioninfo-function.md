...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]存在するかどうか、LocalDB 完全バージョン番号 (リリース番号およびビルドを含む) など、指定された SQL Server Express LocalDB バージョンの情報を返します。  
