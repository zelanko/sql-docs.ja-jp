...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]現在の Windows ユーザーが所有するすべての SQL Server Express LocalDB インスタンス API のトレースを有効を呼び出します。  
