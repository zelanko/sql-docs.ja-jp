---
title: 常に可用性グループの動的管理ビューの 次のように機能します |。Microsoft ドキュメント
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
---
# <a name="always-on-availability-groups-dynamic-management-views---functions"></a>常に可用性グループの動的管理ビューの 次のように機能します。
...
|[および「](../../relational-databases/system-dynamic-management-views/sys-dm-hadr-availability-replica-cluster-nodes-transact-sql.md)|[sys.dm_hadr_database_replica_states](../../relational-databases/system-dynamic-management-views/sys-dm-hadr-database-replica-states-transact-sql.md)|  
