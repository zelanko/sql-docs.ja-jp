...
## <a name="see-also"></a>参照  
 ...
 [sys.dm_hadr_database_replica_states & #40 です。TRANSACT-SQL と #41 です。](../../relational-databases/system-dynamic-management-views/sys-dm-hadr-database-replica-states-transact-sql.md)  
