...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  Always On 可用性グループごとに Windows Server フェールオーバー クラスタ リング (WSFC) クラスターでの Always On 可用性グループ内の可用性データベースの正常性を把握するための情報を含む行を返します。 クエリ**sys.dm_hadr_database_replica_states**次の質問に回答します。  
