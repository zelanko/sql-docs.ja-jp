...
| `ForcingFailed` | クエリで推奨されるプランを強制することはできません。 `last_force_failure_reason` [Query_store_plan](../../relational-databases/system-catalog-views/sys-query-store-plan-transact-sql.md)ビューでを見つけて、エラーの原因を見つけます。 |
...
推奨事項ビューの値のクエリに使用できる JSON 関数の詳細については、「」の「 [Json サポート](../../relational-databases/json/index.md)」を参照してください [!INCLUDE[ssde_md](../../includes/ssde_md.md)] 。
