...
ms.locfileid: "47782490"
---
# <a name="database-related-dynamic-management-views-transact-sql"></a>データベース関連の動的管理ビュー (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  このセクションでは、次の動的管理オブジェクトを説明します[!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)]と SQL データベースの場合もあります。  
...
DMV は、SQL Database または SQL Data Warehouse に固有の。   
| | | 
|-|-|  
