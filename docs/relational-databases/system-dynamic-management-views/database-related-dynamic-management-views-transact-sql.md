---
title: "データベース関連の動的管理ビュー (TRANSACT-SQL) |Microsoft ドキュメント"
ms.custom: 
ms.date: 05/18/2017
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  このセクションでは、次の動的管理オブジェクトをについて説明[!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)]と SQL データベースの場合もあります。  
...
DMV の SQL データベースまたは SQL Data Warehouse に固有です。   
| | | 
|-|-|  
|[sys.dm_db_wait_stats &#40;です。Azure SQL データベース &#41;](../../relational-databases/system-dynamic-management-views/sys-dm-db-wait-stats-azure-sql-database.md)|[sys.dm_database_copies &#40;です。Azure SQL データベース &#41;](../../relational-databases/system-dynamic-management-views/sys-dm-database-copies-azure-sql-database.md)|  
|[sys.dm_db_resource_stats &#40;です。Azure SQL データベース &#41;](../../relational-databases/system-dynamic-management-views/sys-dm-db-resource-stats-azure-sql-database.md)|[sys.dm_db_objects_impacted_on_version_change &#40;です。Azure SQL データベース &#41;](../../relational-databases/system-dynamic-management-views/sys-dm-db-objects-impacted-on-version-change-azure-sql-database.md)|  
