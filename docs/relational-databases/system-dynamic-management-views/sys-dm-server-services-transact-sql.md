...
|startup_type|**int**|サービスの開始モードを示します。 使用可能な値とその対応する説明を次に示します。<br /><br /> 0:Other<br />1:Other<br />2:Automatic<br />3:手動<br />4:Disabled<br /><br /> NULL 値が許可されます。|  
