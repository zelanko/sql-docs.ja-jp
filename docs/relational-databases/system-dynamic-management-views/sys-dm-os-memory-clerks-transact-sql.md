...
[!INCLUDE[tsql-appliesto-ss2008-all-md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  の[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]インスタンスで現在アクティブなすべてのメモリクラークのセットを返します。  
