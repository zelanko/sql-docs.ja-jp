...
|distribution_id|**通り**|ワーカーが実行されているディストリビューション (存在する場合)。|『 [Transact-sql&#41;&#40;pdw_distributions](../../relational-databases/system-catalog-views/sys-pdw-distributions-transact-sql.md)の distribution_id を参照してください。|  
