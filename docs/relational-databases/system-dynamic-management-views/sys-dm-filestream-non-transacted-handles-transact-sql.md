...
|handle_id|int|一意のハンドル コンテキスト ID。 によって使用される、 [sp_kill_filestream_non_transacted_handles &#40;です。TRANSACT-SQL と #41 です。](../../relational-databases/system-stored-procedures/filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)ストアド プロシージャを特定のハンドルを強制終了します。|  
