---
title: sys.dm_os_virtual_address_dump (TRANSACT-SQL) |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
> [!NOTE]  
>  この情報がによって返されるも、 **VirtualQuery** Windows API。  
  
> [!NOTE]  
>  これから[!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)]または[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]、名前を使用して**sys.dm_pdw_nodes_os_virtual_address_dump**です。  
