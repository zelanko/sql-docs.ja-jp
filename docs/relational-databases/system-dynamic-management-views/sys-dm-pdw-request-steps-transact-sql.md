...
[!INCLUDE[tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md](../../includes/tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md.md)]
  ...
  特定の要求を作成またはでクエリを実行するすべてのステップに関する情報を保持 [!INCLUDE[ssSDW](../../includes/sssdw-md.md)]です。 これには、クエリのステップごとに 1 行が一覧表示します。  
...
|start_time|**datetime**|ステップの実行開始時刻。|小さいまたは現在の時刻と等しい、大きいか等しい end_compile_time が、この手順が属している、クエリのです。 クエリの詳細については、[sys.dm_pdw_exec_requests &#40;TRANSACT-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-pdw-exec-requests-transact-sql.md)を参照してください。|  
