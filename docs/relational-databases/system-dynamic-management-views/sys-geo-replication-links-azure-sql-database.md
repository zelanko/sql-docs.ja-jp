...
|modify_date|**datetimeoffset**|SQL データベースにデータ センター データベースの地理的レプリケーションが完了したときに地域別に UTC 時刻。 新しいデータベースは、この時点で、プライマリ データベースと同期されます。 」をご覧ください。|  
...
## <a name="see-also"></a>参照  
 ...
 [sys.dm_geo_replication_link_status &#40;Azure SQL データベース&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-geo-replication-link-status-azure-sql-database.md)   
