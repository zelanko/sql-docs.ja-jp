# [概要](system-dynamic-management-views.md)  
...
## [sys.dm_db_objects_impacted_on_version_change (Azure SQL データベース)](sys-dm-db-objects-impacted-on-version-change-azure-sql-database.md)  
...
## [sys.dm_db_wait_stats (Azure SQL データベース)](sys-dm-db-wait-stats-azure-sql-database.md)  
## [sys.dm_operation_status (Azure SQL データベース)](sys-dm-operation-status-azure-sql-database.md)  
## [sys.dm_database_copies (Azure SQL データベース)](sys-dm-database-copies-azure-sql-database.md)  
## [sys.dm_db_resource_stats (Azure SQL データベース)](sys-dm-db-resource-stats-azure-sql-database.md)  
...
## [sys.dm_xe_database_sessions (Azure SQL データベース)](sys-dm-xe-database-sessions-azure-sql-database.md)  
## [sys.dm_xe_database_session_targets (Azure SQL データベース)](sys-dm-xe-database-session-targets-azure-sql-database.md)  
## [sys.dm_xe_database_session_object_columns (Azure SQL データベース)](sys-dm-xe-database-session-object-columns-azure-sql-database.md)  
## [sys.dm_xe_database_session_events (Azure SQL データベース)](sys-dm-xe-database-session-events-azure-sql-database.md)  
## [sys.dm_xe_database_session_event_actions (Azure SQL データベース)](sys-dm-xe-database-session-event-actions-azure-sql-database.md)  
...
# [フルテキスト検索およびセマンティック検索](full-text-and-semantic-search-dynamic-management-views-functions.md)  
...
# [Geo レプリケーション (Azure SQL データベース)](geo-replication-dynamic-management-views-and-functions-azure-sql-database.md)  
## [sys.geo_replication_links (Azure SQL データベース)](sys-geo-replication-links-azure-sql-database.md)  
## [sys.dm_geo_replication_link_status (Azure SQL データベース)](sys-dm-geo-replication-link-status-azure-sql-database.md)  
## [sys.dm_continuous_copy_status (Azure SQL データベース)](sys-dm-continuous-copy-status-azure-sql-database.md)  
...
# [セキュリティに関連します。](security-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [サーバーに関連します。](server-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [SQL Data Warehouse と並列データ ウェアハウス](sql-and-parallel-data-warehouse-dynamic-management-views.md)  
...
# [SQL Server オペレーティング システム](sql-server-operating-system-related-dynamic-management-views-transact-sql.md)  
...
## [sys.dm_os_tasks と組み合わせます](sys-dm-os-tasks-transact-sql.md)  
