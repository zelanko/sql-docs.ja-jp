...
|**state**|**smallint**|接続の現在の状態。 NULL 値を許容します。 有効値は次のとおりです。<br /><br /> 1 = NEW<br /><br /> 2 = 接続<br /><br /> 3 = CONNECTED<br /><br /> 4 = LOGGED_IN<br /><br /> 5 = 終了|  
|**state_desc**|**nvarchar(60)**|接続の現在の状態。 NULL 値を許容します。 有効値は次のとおりです。<br /><br /> NEW<br /><br /> CONNECTING<br /><br /> CONNECTED<br /><br /> LOGGED_IN<br /><br /> CLOSED|  
