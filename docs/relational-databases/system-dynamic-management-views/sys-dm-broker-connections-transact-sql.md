...
|**state_desc**|**nvarchar(60)**|接続の現在の状態。 NULL 値を許容します。 設定可能な値:<br /><br /> 新機能<br /><br /> CONNECTING<br /><br /> CONNECTED<br /><br /> LOGGED_IN<br /><br /> CLOSED|  
