...
|**sqlserver_start_time_ms_ticks**|**bigint**|最後に**ms_tick**開始され[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]たときの ms_tick 番号を表します。 現在の ms_ticks 列と比較します。 Null 値は許容されません。|  
