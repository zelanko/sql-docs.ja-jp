...
> [!NOTE]  
>  このビューに置き換わります[sys.dm_io_cluster_shared_drives &#40;です。TRANSACT-SQL と #41 です。](../../relational-databases/system-dynamic-management-views/sys-dm-io-cluster-shared-drives-transact-sql.md)将来のリリースでします。  
