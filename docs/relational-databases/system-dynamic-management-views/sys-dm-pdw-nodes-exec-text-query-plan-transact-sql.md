---
title: sys _pdw_nodes_exec_text_query_plan (Transact-sql) |Microsoft Docs
...
---
# <a name="sysdm_pdw_nodes_exec_text_query_plan--transact-sql"></a>sys _pdw_nodes_exec_text_query_plan (Transact-sql)
...
## <a name="remarks"></a>備考  
[_Exec_text_query_plan](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-exec-text-query-plan-transact-sql?view=sql-server-ver15)でも同じ解説が適用されます。  
