---
title: sys.dm_xe_session_events (TRANSACT-SQL) |Microsoft ドキュメント
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
|sys.dm_xe_session_events.event_package_guid、sys.dm_xe_session_events.event_name|sys.dm_xe_objects.name、sys.dm_xe_objects.package_guid|多対一|  
