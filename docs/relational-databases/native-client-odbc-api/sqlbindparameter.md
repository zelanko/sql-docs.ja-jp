 ...
 **場合は、SQLBindParameter**大きい CLR ユーザー定義型 (Udt) がサポートされています。 詳細については、[Large CLR User-Defined 型&#40;ODBC&#41;](../../relational-databases/native-client/odbc/large-clr-user-defined-types-odbc.md)を参照してください。  
