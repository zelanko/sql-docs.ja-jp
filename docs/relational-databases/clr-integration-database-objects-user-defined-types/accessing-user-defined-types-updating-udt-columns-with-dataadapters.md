...
-   **UserInsertCommand Dedcommands**。 **Points**テーブル ( **timestamp**列を含まない) の**Point** UDT を更新するために、 ****、 **UpdateCommand**、および**DeleteCommand**オブジェクトを指定する方法を示しています。  
