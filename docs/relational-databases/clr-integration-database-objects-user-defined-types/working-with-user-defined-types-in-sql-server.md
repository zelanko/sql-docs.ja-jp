---
title: SQL Server のユーザー定義型の使用 |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [UDT データを操作します。](../../relational-databases/clr-integration-database-objects-user-defined-types/working-with-user-defined-types-manipulating-udt-data.md)  
