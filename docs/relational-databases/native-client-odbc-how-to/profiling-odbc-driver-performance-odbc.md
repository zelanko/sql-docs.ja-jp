---
title: ODBC ドライバー パフォーマンスに関するトピック (ODBC) をプロファイリング |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "37426071"
---
# <a name="profiling-odbc-driver-performance-odbc"></a>ODBC ドライバー (ODBC) のパフォーマンスのプロファイリング
