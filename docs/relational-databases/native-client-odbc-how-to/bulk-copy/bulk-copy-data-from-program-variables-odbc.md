---
title: データを一括コピー プログラム変数 (ODBC) から |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "35696403"
---
# <a name="bulk-copy-data-from-program-variables-odbc"></a>プログラム変数からのデータの一括コピー (ODBC)
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
[!INCLUDE[SNAC_Deprecated](../../../includes/snac-deprecated.md)]

  このサンプルは、データを一括コピー プログラム変数から SQL Server を使用する一括コピー関数を使用する方法を示しています。 **bcp_bind**と**bcp_sendrow**です。 (この例では、簡略化のためエラーチェック コードが削除されています)。  
  
 このサンプルは、ODBC 3.0 以降のバージョン用に開発されました。  
  
 **セキュリティに関する注意**可能であれば、Windows 認証を使用します。 Windows 認証が使用できない場合は、実行時に資格情報を入力するようユーザーに求めます。 資格情報をファイルに保存するのは避けてください。 資格情報を保持する必要がある場合、それらを暗号化する必要があります[Win32 cryptoAPI](http://go.microsoft.com/fwlink/?LinkId=9504)です。  
...
5.  呼び出す[bcp_bind](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-bind.md)それぞれの列に一括コピーする列をプログラム変数にバインドします。  
  
6.  データ、および呼び出しを使用してプログラム変数を設定[bcp_sendrow](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-sendrow.md)データの行を送信します。  
  
7.  いくつかの行の送信後に、呼び出す[bcp_batch](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-batch.md)を送信済みの行のチェックポイントにします。 呼び出すことをお勧め[bcp_batch](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-batch.md) 1000 行ごとに 1 回以上です。  
  
8.  すべての行の送信後に、呼び出す[bcp_done](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-done.md)操作を完了します。  
  
 変更できますプログラム変数の長さと場所のバルク コピー操作中に呼び出すことによって[bcp_colptr](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-colptr.md)と[bcp_collen](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-collen.md)です。 使用して[bcp_control](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-control.md)各種の一括コピー オプションを設定します。 使用して[bcp_moretext](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-moretext.md)を送信する**テキスト**、 **ntext**、および**イメージ**サーバーへのセグメント内のデータ。  
...
## <a name="example"></a>例  
 ...
 最初の実行 ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) コード リストのサンプルを使用するテーブルを作成します。  
 ...
 3 番目の実行 ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) コード リストをサンプルで使用されるテーブルを削除します。  
