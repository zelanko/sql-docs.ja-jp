...
## <a name="example"></a>例  
 ...
 2 つ目の実行 ( [!INCLUDE[tsql](../../includes/tsql-md.md)]) コード リストを master データベースにアセンブリを追加します。  
 ...
 4 つ目の実行 ( [!INCLUDE[tsql](../../includes/tsql-md.md)]) コード リストを master データベースにアセンブリを削除します。  
