---
description: SQL Server Native Client ユーザー定義関数の実行とリターンコードの処理 (OLE DB)
...
ms.locfileid: "88475734"
---
# <a name="execute-a-sql-server-native-client-user-defined-function-and-process-return-code-ole-db"></a>SQL Server Native Client ユーザー定義関数の実行とリターンコードの処理 (OLE DB)
