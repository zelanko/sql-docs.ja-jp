...
-   SQLNCLI11 エラーのエラー処理を表示します。  
 ...
 テーブル値パラメーターの詳細については、「 [SQL Server ネイティブ クライアント&#41;&#40;テーブル値パラメーター ](../../relational-databases/native-client/features/table-valued-parameters-sql-server-native-client.md)」を参照してください。  
