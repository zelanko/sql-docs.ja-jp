...
ms.topic: "article"
helpviewer_keywords: 
  - "データベース [SQL Server]、ファイル"
  - "ファイル グループ [SQL Server]"
  - "トランザクション ログ [SQL Server]、説明"
  - "トランザクション ログ [SQL Server]、ファイル"
  - ".mdf ファイル"
  - "データ ファイル [SQL Server]"
  - "既定のファイル グループ"
  - "ファイル [SQL Server]、ファイルとファイル グループについて"
  - "セカンダリ ファイル [SQL Server]"
  - "ログ ファイル [SQL Server]"
  - ".ndf ファイル"
  - "ファイル [SQL Server]"
  - ".ldf ファイル"
  - "データベース ファイル [SQL Server]"
  - "データベース [SQL Server]、ファイル グループ"
  - "ファイル グループ [SQL Server]、タイプ"
  - "プライマリ ファイル グループ [SQL Server]"
  - "ユーザー定義ファイル グループ [SQL Server]"
  - "ファイル グループ [SQL Server]、ファイル グループについて"
  - "プライマリ ファイル [SQL Server]"
  - "ファイルの種類 [SQL Server]"
