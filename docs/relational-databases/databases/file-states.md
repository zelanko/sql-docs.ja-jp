...
ms.topic: "article"
helpviewer_keywords: 
  - "復元のファイル状態 [SQL Server]"
  - "ファイルの状態の確認"
  - "現在のファイルの状態"
  - "ファイル グループの状態の確認"
  - "ファイルの状態 [SQL Server]"
  - "オンラインのファイル状態"
  - "オフラインのファイル状態 [SQL Server]"
  - "ファイル グループの状態の参照"
  - "ファイルの状態の参照"
  - "問題があると考えられるファイル状態"
  - "復旧のファイル状態 [SQL Server]"
  - "現在のファイル グループの状態"
  - "復旧保留のファイル状態 [SQL Server]"
  - "ファイルの状態の表示"
  - "状態 [SQL Server], ファイル"
  - "ファイル グループの状態の表示"
  - "機能していないファイル状態"
