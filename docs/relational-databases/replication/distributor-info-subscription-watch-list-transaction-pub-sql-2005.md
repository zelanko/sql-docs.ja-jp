---
title: "ディストリビューター情報、サブスクリプション ウォッチ リスト (トランザクション パブリケーション、SQL 2005 以降) | Microsoft Docs"
ms.custom: 
ms.date: 03/20/2017
