...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] ここでは、[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] レプリケーションのテクニカル リファレンス ドキュメントへのリンクを示します。  
