...
-   [エージェントのセキュリティと #40 です。パブリケーションの新規作成ウィザードと #41 です。](../../relational-databases/replication/agent-security-new-publication-wizard.md)  
...
-   [スナップショット エージェントと #40 です。パブリケーションの新規作成ウィザードと #41 です。](../../relational-databases/replication/snapshot-agent-new-publication-wizard.md)  
