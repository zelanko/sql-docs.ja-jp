...
6.  (省略可) プロパティを変更するには、設定可能な <xref:Microsoft.SqlServer.Replication.TransArticle> プロパティのいずれかに新しい値を設定します。  
...
6.  (省略可) プロパティを変更するには、設定可能な <xref:Microsoft.SqlServer.Replication.MergeArticle> プロパティのいずれかに新しい値を設定します。  
