...
ms.topic: "article"
helpviewer_keywords: 
  - "レプリケーション [SQL Server], パブリッシング モデル"
  - "サブスクリプション [SQL Server レプリケーション], サブスクリプションについて"
  - "アーティクル [SQL Server レプリケーション]"
  - "パブリケーション [SQL Server レプリケーション]"
  - "パブリッシャー [SQL Server レプリケーション], パブリッシャーについて"
  - "サブスクライバー [SQL Server レプリケーション]"
  - "ディストリビューター [SQL Server レプリケーション], ディストリビューターについて"
  - "サブスクライバー [SQL Server レプリケーション], サブスクライバーについて"
  - "アーティクル [SQL Server レプリケーション], アーティクルについて"
  - "パブリケーション [SQL Server レプリケーション], パブリケーションについて"
  - "ディストリビューター [SQL Server レプリケーション]"
