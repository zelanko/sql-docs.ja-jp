...
# キュー リーダー エージェント (Queue Reader Agent)
   **キュー リーダー エージェント** ] ダイアログ ボックスでは、状態、履歴、情報メッセージ、エラー メッセージなど、キュー リーダー エージェントの詳細な情報が表示されます。  
  
## オプション  
 表示するキュー リーダー エージェント セッションを選択、 **ビュー** ] メニューの [しというラベルのグリッドで特定のセッションを選択して **キュー リーダー エージェントのセッション**します。 このセッションの詳細情報は、 **[選択されたセッションのアクション]**というラベルのグリッドに表示されます。 選択したセッションがエラーで終了した場合は、 **[選択されたセッションのエラーの詳細またはメッセージ]** というラベルのテキスト領域も表示されます。  
 ...
 **[動作時間]**  
 アクションがで説明する時間、 **アクション メッセージ** 列が実行されます。  
