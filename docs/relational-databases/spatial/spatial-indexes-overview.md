...
>  空間インデックスのための空間の分解は、アプリケーション データが使用する測定単位に依存しません。  
 ...
 ![4 × 4 のレベル 1 グリッド上の多角形と線](../../relational-databases/spatial/media/spndx-level-1-objects.png "4 × 4 のレベル 1 グリッド上の多角形と線")  
...
3.  平面化された四角錐を結合して、非ユークリッド平面を形成します。  
 ...
 ![楕円体の平面への投影](../../relational-databases/spatial/media/spndx-geodetic-projection.png "楕円体の平面への投影")  
