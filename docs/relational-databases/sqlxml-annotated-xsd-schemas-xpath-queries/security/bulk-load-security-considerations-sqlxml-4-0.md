---
title: "一括読み込みのセキュリティに関する注意点 (SQLXML 4.0) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]XML 一括読み込みを使用するためのセキュリティ ガイドラインを次に示します。  
  
-   操作がトランザクションとして実行するには、一括読み込みを使用することを指定すると、 **TempFilePath**を一時ファイルを作成するフォルダーを指定するプロパティです。  
