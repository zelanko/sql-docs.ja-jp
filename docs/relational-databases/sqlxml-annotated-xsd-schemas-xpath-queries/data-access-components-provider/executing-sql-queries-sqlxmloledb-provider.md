---
title: "SQL クエリ (SQLXMLOLEDB プロバイダー) の実行 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]この例では、次の SQLXMLOLEDB プロバイダー固有のプロパティの使用を示します。  
...
-   xml root  
 ...
 Xml のルートのプロパティは、生成される XML ドキュメントの 1 つの最上位ルート要素を提供します。  
