...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]このセクションのトピックでは、XML 一括読み込みで XSD スキーマで注釈を解釈する方法について説明します。 ここで説明する動作は、XDR スキーマの注釈にも当てはまります。  
