...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]DiffGram の書式がで導入された、**データセット**コンポーネント、 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] .NET フレームワークです。 .NET Framework では、DiffGram を作成して、Microsoft [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] データベースのテーブルのデータを変更するときに使用できます。  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [ADO &#40; を使用して、DiffGram の実行SQLXML 4.0 &#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/diffgram/executing-a-diffgram-by-using-ado-sqlxml-4-0.md)  
