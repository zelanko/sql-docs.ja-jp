...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]ノード テストでは、ロケーション ステップで選択したノードの種類を指定します。 すべての軸 (**子**、**親**、**属性**、または**self**) 主ノード型を持ちます。 **属性**軸、主ノード型は**\<属性 >**です。 **親**、**子**、および**self**軸の場合、主ノード型は**\<要素 >**です。  
