...
以下のガイドを参照できます。 全般的な概念について説明し、それ以外の場合、それぞれのガイドに記載しない限り、SQL Server のすべてのバージョンに適用します。 

[Always On 可用性グループのトラブルシューティングおよび監視ガイド](http://msdn.microsoft.com/library/dn135328)  
[インデックス デザイン ガイド](../relational-databases/sql-server-index-design-guide.md)  
...
[移行後の検証および最適化ガイド](post-migration-validation-and-optimization-guide.md)  
