...
### <a name="parameter-sniffing"></a>パラメーター スニッフィング
...
MAXDOP 構成のベスト プラクティスについては、[この Microsoft サポート記事](https://support.microsoft.com/en-us/help/2806535/recommendations-and-guidelines-for-the-max-degree-of-parallelism-configuration-option-in-sql-server)を参照してください。
