...
# [Azure SQL データベース](azure-sql-database-catalog-views.md)  
...
# [データ コレクター](data-collector-views-transact-sql.md)  
...
# [データ領域](data-spaces-transact-sql.md)  
...
# [データベース メール ビュー](database-mail-views-transact-sql.md)  
...
# [エンドポイント](endpoints-catalog-views-transact-sql.md)  
...
# [外部の操作](external-operations-catalog-views-transact-sql.md)  
...
# [Filestream と FileTable](filestream-and-filetable-catalog-views-transact-sql.md)  
...
# [リンク サーバー](linked-servers-catalog-views-transact-sql.md)  
...
# [オブジェクト](object-catalog-views-transact-sql.md)  
...
# [パーティション関数](partition-function-catalog-views-transact-sql.md)  
...
# [ポリシー ベースの管理ビュー](policy-based-management-views-transact-sql.md)  
...
# [リソース ガバナー](resource-governor-catalog-views-transact-sql.md)  
...
# [クエリ ストア](query-store-catalog-views-transact-sql.md)  
...
# [スカラー型](scalar-types-catalog-views-transact-sql.md)  
...
# [サーバー全体の構成](server-wide-configuration-catalog-views-transact-sql.md)  
...
# [空間データ](spatial-data-catalog-views.md)  
...
# [XML スキーマ (XML 型システム)](xml-schemas-xml-type-system-catalog-views-transact-sql.md)  
