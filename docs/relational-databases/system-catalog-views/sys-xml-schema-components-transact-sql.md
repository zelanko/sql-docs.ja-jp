...
|**種類**|**char (1)**|XML スキーマ コンポーネントの種類。<br /><br /> N = 任意の型 (特殊な固有コンポーネント)<br /><br /> Z = 任意の単純型 (特殊な固有コンポーネント)<br /><br /> P = プリミティブ型 (固有の型)<br /><br /> S = 単純型<br /><br /> L = リスト型<br /><br /> U = union 型<br /><br /> C = 複合単純型 (単純型から派生)<br /><br /> K = 複合型<br /><br /> E = 要素<br /><br /> M = モデル - グループ<br /><br /> W = 要素 - ワイルドカード<br /><br /> A = 属性<br /><br /> G = 属性 - グループ<br /><br /> V = 属性 - ワイルドカード|  
