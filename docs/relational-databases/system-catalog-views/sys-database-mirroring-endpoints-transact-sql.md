...
|列名|データ型|Description|  
|-----------------|---------------|-----------------|  
|**\<継承された列 >**|—|列を継承**sys.endpoints** (詳細については、次を参照してください。 [sys.endpoints &#40;です。TRANSACT-SQL と #41 です。](../../relational-databases/system-catalog-views/sys-endpoints-transact-sql.md)).|  
|**ロール**|**tinyint**|ミラーリング ロール。次のいずれかになります。<br /><br /> **0** = なし<br /><br /> **1**パートナーを =<br /><br /> **2** = ミラーリング監視サーバー<br /><br /> **3** = all<br /><br /> 注: この値はデータベース ミラーリングのみ関連します。|  
...
## <a name="see-also"></a>参照  
 [追加または可用性レプリカ &#40; を変更する場合は、エンドポイント URL を指定します。SQL Server &#41;](../../database-engine/availability-groups/windows/specify-endpoint-url-adding-or-modifying-availability-replica.md)   
