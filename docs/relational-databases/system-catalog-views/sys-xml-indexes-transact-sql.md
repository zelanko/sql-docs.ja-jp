...
|**secondary_type_desc**|**nvarchar(60)**|セカンダリ インデックスの説明を入力します。<br /><br /> PATH = PATH セカンダリ XML インデックス<br /><br /> VALUE = VALUE セカンダリ XML インデックス<br /><br /> PROPERTY = PROPERTY secondary xml indexes.<br /><br /> NULL = プライマリ XML インデックス|  
