---
title: sys.crypt_properties (TRANSACT-SQL) |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
|列名|データ型|Description|  
|-----------------|---------------|-----------------|  
|**class**|**tinyint**|プロパティが存在するリソースのクラスの識別子。<br /><br /> 1 = オブジェクトまたは列|  
|**class_desc**|**nvarchar(60)**|プロパティが存在するリソースのクラスの説明。<br /><br /> OBJECT_OR_COLUMN|  
