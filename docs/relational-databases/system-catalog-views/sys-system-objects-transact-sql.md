...
[!INCLUDE[tsql-appliesto-ss2008-all-md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  に[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]含まれているすべてのスキーマスコープシステムオブジェクトに対して1行のレコードを格納します。 すべてのシステム オブジェクトは、sys または INFORMATION_SCHEMA という名前のスキーマに含まれています。  
...
|schema_id|**int**|オブジェクトが含まれているスキーマの ID。<br /><br /> 
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] に含まれているすべてのスキーマ スコープ システム オブジェクトに対して、この値は常に (schema_id('sys'), schema_id('INFORMATION_SCHEMA')) の形式で示されます。|  
