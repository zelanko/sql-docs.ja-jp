...
|**幅**|**int**|ファイルの現在のサイズ (8 KB ページ単位)。<br /><br /> 0 = 適用なし<br /><br /> データベース スナップショットの場合、size は、スナップショットがファイルに対して使用する中で最大の領域を表します。<br /><br /> FILESTREAM ファイルグループコンテナーの場合、サイズはコンテナーの現在使用されているサイズを反映します。|  
...
|**drop_lsn**|**数値 (25, 0)**|ファイルが削除された LSN。<br /><br /> 0 = ファイル名は再利用できません。|  
