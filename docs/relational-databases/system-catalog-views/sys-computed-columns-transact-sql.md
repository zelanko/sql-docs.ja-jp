---
title: sys.computed_columns (Transact SQL) |マイクロソフトのドキュメント
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
|列名|データ型|説明|  
|-----------------|---------------|-----------------|  
|**\<列を継承 >**||**Sys.computed_columns**ビュー内のすべての列を取得する、 **sys.columns**ビューです。 また、次に示す追加の列も返します。 列の説明についてを**sys.computed_columns**のビューを継承**sys.columns**を参照してください[sys.columns &#40;Transact SQL&#41;](../../relational-databases/system-catalog-views/sys-columns-transact-sql.md)。 値、 **is_computed**列は常に設定を 1 に、 **sys.computed_columns**ビューです。|  
