---
title: "空間データのカタログ ビュー |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  ここでは、空間データに関する情報を提供するカタログ ビューについて説明します。  
 ...
 [sys.spatial_reference_systems &#40;です。TRANSACT-SQL と #41 です。](../../relational-databases/system-catalog-views/sys-spatial-reference-systems-transact-sql.md)  
 サポートされている空間参照系 (SRID) の一覧を表示します。  
