...
|**stdev_query_max_used_memory です。**|**FLOAT**|メモリ許可の集計間隔内でクエリ プランの標準偏差 (8 KB ページの数として報告されます)。 常にネイティブを使用してクエリの場合は 0 では、メモリ最適化の手順がコンパイルされます。<br/>**注:** Azure SQL Data Warehouse は、ゼロ (0) を常に返します。|
