...
|event_retention_mode|**nchar(1)**|イベントの損失を処理する方法を決定します。 既定値は S です。NULL 値は許可されません。 次のいずれかを指定します。<br /><br /> S. Event_retention_mode_desc = ALLOW_SINGLE_EVENT_LOSS にマップします。<br /><br /> M. Event_retention_mode_desc = ALLOW_MULTIPLE_EVENT_LOSS にマップします。<br /><br /> N. Event_retention_mode_desc = NO_EVENT_LOSS にマップします。|  
