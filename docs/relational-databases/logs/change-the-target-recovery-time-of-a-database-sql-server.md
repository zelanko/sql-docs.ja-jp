...
-   **ターゲットの復旧時間の変更に使用するもの:** [SQL Server Management Studio](#SSMSProcedure) または [Transact-SQL](#TsqlProcedure)  
...
2.  次の [ALTER DATABASE](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md)ステートメントを、次のように使用します。  
