---
title: "列ストア インデックスの最適化 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "01/27/2017"
...
## ALTER INDEX REORGANIZE を使用して、列ストア インデックスをオンラインで最適化する  
...
## 参照  
 ...
 [列ストア インデックスのメンテナンス タスク](../../relational-databases/indexes/columnstore-indexes-defragmentation.md)  
