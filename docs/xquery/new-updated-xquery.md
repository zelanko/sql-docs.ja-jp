---
title: 更新済み - SQL Server ドキュメント用の XQuery |Microsoft ドキュメント
description: 最近変更したドキュメントについては、Microsoft SQL Server の XQuery の更新されたコンテンツのスニペットを表示します。
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
---
# <a name="new-and-recently-updated-xquery-for-sql-server"></a>新規または最近更新された: SQL Server 用の XQuery
...
- *サブジェクト領域:* &nbsp; **for SQL Server XQuery**です。
