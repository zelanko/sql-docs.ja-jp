...
テーブル名を指定する必要があります、 [FROM](../../t-sql/queries/from-transact-sql.md)結果を返すには、この関数の句。 クエリの結果セットの各行の結果の行が返されます使用して[TOP (TRANSACT-SQL)](../../t-sql/queries/top-transact-sql.md)返された行の数を制限します。  
