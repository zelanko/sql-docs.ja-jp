...
### <a name="c-using-nchar-and-unicode"></a>C. NCHAR と UNICODE を使用する  
 次の例では、`UNICODE` 関数と `NCHAR` 関数を使用して、`UNICODE` という文字列の 2 番目の文字の `NCHAR` 値と `København` (Unicode 文字) を出力することによって、`ø` という実際の 2 番目の文字を出力します。  
...
### <a name="d-using-substring-unicode-convert-and-nchar"></a>D. SUBSTRING、UNICODE、CONVERT、および NCHAR を使用する  
 次の例では、 `SUBSTRING`、 `UNICODE`、 `CONVERT`、および`NCHAR`関数は文字番号、Unicode 文字、および文字列内の各文字の UNICODE 値を印刷する`København`です。  
...
## <a name="see-also"></a>参照  
 ...
 [UNICODE & #40 です。TRANSACT-SQL と #41 です。](../../t-sql/functions/unicode-transact-sql.md)  
