...
### <a name="d-eomonth-with-explicit-datetime-type"></a>D. 明示的な datetime 型を使用する EOMONTH  
...
### <a name="e-eomonth-with-string-parameter-and-implicit-conversion"></a>E. 文字列パラメーターと暗黙的な変換を使用する EOMONTH  
...
### <a name="f-eomonth-with-and-without-the-monthtoadd-parameter"></a>F. month_to_add パラメーターを使用する EOMONTH と使用しない EOMONTH  
