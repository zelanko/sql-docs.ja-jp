 ...
 *expression* 文字列、または文字列に変換できる[式](../../t-sql/language-elements/expressions-transact-sql.md)です。 式は 4,000 文字未満にする必要があります。 datetime および smalldatetime を除く日付および時刻データ型は、ISDATE の引数として使用できません。
