---
title: "STPointFromText (geometry データ型) |Microsoft ドキュメント"
ms.custom: 
ms.date: 08/03/2017
 ...
 *point_tagged_text*  
 WKT 表現です、 **geometryPoint**インスタンスを取得します。 *point_tagged_text*は、 **nvarchar (max)**式。  
...
## <a name="examples"></a>使用例  
 次の例で`STPointFromText()`を作成する、`geometry`インスタンス。  
