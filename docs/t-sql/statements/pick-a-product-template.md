...
> |||||
> |---|---|---|---|
> |**_\* SQL Server \*_** &nbsp;|[SQL Database<br />単一データベース/エラスティック プール](pick-a-product-template.md?view=azuresqldb-current)|[SQL Database<br />マネージド インスタンス](pick-a-product-template.md?view=azuresqldb-mi-current)|[Azure Synapse<br />Analytics](pick-a-product-template.md?view=azure-sqldw-latest)|||
