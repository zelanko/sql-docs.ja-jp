 ...
 *IF EXISTS*    
 条件付きでは既に存在する場合にのみ、関数を削除します。 [!INCLUDE[ssnoversion_md](../../includes/ssnoversion_md.md)] 2016 以降および [!INCLUDE[sssds_md](../../includes/sssds_md.md)] で使用できます。
