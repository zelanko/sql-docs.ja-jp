...
-   プライマリ レプリカがアクティブになっている必要があります。 非アクティブなプライマリ レプリカのトラブルシューティング方法の詳細については、「[AlwaysOn 可用性グループの構成のトラブルシューティング (SQL Server)](http://go.microsoft.com/fwlink/?LinkId=225834)」を参照してください。  
