...
## [REMOTE TABLE AS SELECT (並列データ ウェアハウス)](create-remote-table-as-select-parallel-data-warehouse.md)  
...
## [TABLE (SQL グラフ)](create-table-sql-graph.md)  
## [TABLE AS SELECT (Azure SQL Data Warehouse)](create-table-as-select-azure-sql-data-warehouse.md)
## [TABLE IDENTITY (プロパティ)](create-table-transact-sql-identity-property.md) 
...
## [DENY (サーバー アクセス許可の拒否)](deny-server-permissions-transact-sql.md)  
...
## [GRANT (検索プロパティ リスト アクセス許可の許可)](grant-search-property-list-permissions-transact-sql.md)  
...
## [REVOKE (フルテキストのアクセス許可の取り消し)](revoke-full-text-permissions-transact-sql.md)  
...
# SET 
## [概要](set-statements-transact-sql.md)
