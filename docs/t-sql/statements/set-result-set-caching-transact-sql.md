...
ms.locfileid: "66826867"
---
# <a name="set-result-set-caching-transact-sql-applies-to-azure-sql-data-warehouse-gen2-only-preview"></a>SET RESULT SET CACHING (Transact-SQL) Azure SQL Data Warehouse Gen2 のみに適用 (プレビュー)
