...
---
# <a name="--subtract-equals-transact-sql"></a>-= (減算代入) (Transact-SQL)
...
## <a name="remarks"></a>解説  
 詳細については、次を参照してください。 [-& #40 です。減算 (& a) #41;& #40 です。TRANSACT-SQL と #41 です。](../../t-sql/language-elements/subtract-transact-sql.md).  
