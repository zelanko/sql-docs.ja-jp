...
description: 異常な `sparkhead` ポッドにより、Active Directory ドメインの SQL Server ビッグ データ クラスターの展開がハングすることに対するトラブルシューティング。
author: macarv-ms
ms.author: macarv
ms.reviewer: mikeray
ms.date: 08/20/2020
...
## <a name="check-the-hdfs-and-sparkservices"></a>HDFS および Spark のサービスを確認する 
...
:::image type="content" source="media/troubleshoot-ad-hung-deployment-unhealthy-sparkhead-pods/missing_reverse_lookup_zone_entry_for_domain_controller_add.png" alt-text="ドメイン コントローラーの逆引き参照ゾーン エントリが見つからない":::
