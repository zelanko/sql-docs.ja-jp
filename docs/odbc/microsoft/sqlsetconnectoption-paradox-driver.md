---
title: SQLSetConnectOption (Paradox ドライバー) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|SQL_AUTOCOMMIT|Paradox ドライバーでは、トランザクションをサポートしていないために (既定の状態) に設定されている SQL_AUTOCOMMIT のみサポートされます。|  
