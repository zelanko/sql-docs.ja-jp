---
description: ドライバーのベース アドレス
title: ドライバーのベースアドレス |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88500375"
---
# <a name="base-address-of-drivers"></a>ドライバーのベース アドレス
各 ODBC Desktop データベースドライバは、0x04c0000 のベースアドレスにリンクされています。
