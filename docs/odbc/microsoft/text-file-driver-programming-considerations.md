---
title: "テキスト ファイル ドライバーのプログラミングに関する考慮事項 |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
-   [プログラムによってテキスト ファイルのドライバーのオプションの設定](../../odbc/microsoft/setting-options-programmatically-for-the-text-file-driver.md)  
  
-   [テキスト ファイルのデータ型](../../odbc/microsoft/text-file-data-types.md)  
  
-   [SQLGetInfo は、テキスト ファイルの値が返されます](../../odbc/microsoft/sqlgetinfo-returned-values-for-text-files.md)  
