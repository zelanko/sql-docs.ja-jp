---
title: "その他の Paradox ドライバー プログラミングの詳細 |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="other-paradox-driver-programming-details"></a>その他の Paradox ドライバー プログラミングの詳細
> [!NOTE]  
>  このセクションでは、ODBC 関数およびその他のプログラミングの詳細について Paradox ドライバー固有の情報を提供します。 関数に関する概要については、下の該当するトピックを参照してください。 [ODBC API リファレンス](../../odbc/reference/syntax/odbc-api-reference.md)です。  
...
-   [Paradox のインデックスを作成します。](../../odbc/microsoft/create-index-for-paradox.md)  
