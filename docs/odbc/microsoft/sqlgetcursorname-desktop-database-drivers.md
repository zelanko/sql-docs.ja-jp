---
title: SQLGetCursorName (デスクトップ データベース ドライバー) |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "68003442"
---
# <a name="sqlgetcursorname-desktop-database-drivers"></a>SQLGetCursorName (デスクトップ データベース ドライバー)
**SQLGetCursorName**はサポートされてができる場合にのみ使用、カーソル ライブラリを使用すると、ドライバーでは、位置指定操作はサポートされていないためです。
