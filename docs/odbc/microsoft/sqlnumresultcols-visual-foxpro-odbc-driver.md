---
title: SQLNum 結果のコルス (ビジュアル フォックスプロ ODBC ドライバー) |マイクロソフトドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
>  このトピックには、ビジュアル フォックス プロ ODBC ドライバー固有の情報が含まれています。 この関数の一般的な情報については[、ODBC API リファレンス](../../odbc/reference/syntax/odbc-api-reference.md)の該当するトピックを参照してください。  
 ...
 詳細については *、ODBC プログラマ リファレンス*[の「SQLNumResultCols」](../../odbc/reference/syntax/sqlnumresultcols-function.md)を参照してください。
