---
description: 翻訳の Dll およびデスクトップ データベース ドライバー
title: 変換 Dll およびデスクトップデータベースドライバー |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88471446"
---
# <a name="translation-dlls-and-desktop-database-drivers"></a>翻訳の Dll およびデスクトップ データベース ドライバー
サポートされていません。
