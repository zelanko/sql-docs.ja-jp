---
title: API への準拠レベル (ODBC Driver for Oracle) |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "47654900"
---
# <a name="api-conformance-level-odbc-driver-for-oracle"></a>API への準拠レベル (ODBC Driver for Oracle)
> [!IMPORTANT]  
>  この機能は、Windows の将来のバージョンで削除されます。 新規の開発作業ではこの機能を使用しないようにし、現在この機能を使用しているアプリケーションは修正することを検討してください。 代わりに、Oracle によって提供される ODBC ドライバーを使用します。  
  
 ODBC Driver for Oracle は、[コア レベル API 関数](../../odbc/microsoft/core-level-api-functions-odbc-driver-for-oracle.md)と[レベル 1 API 関数](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)します。 ドライバーは、次もサポートしています[レベル 2 API 関数](../../odbc/microsoft/level-2-api-functions-odbc-driver-for-oracle.md):。  
