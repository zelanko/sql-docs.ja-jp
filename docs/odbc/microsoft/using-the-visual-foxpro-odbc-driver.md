---
title: Visual FoxPro ODBC ドライバーの使用 |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
-   [接続文字列の使用](../../odbc/microsoft/using-connection-strings.md)  
  
-   [Visual Basic アプリケーションで、Visual FoxPro ODBC ドライバーの使用](../../odbc/microsoft/using-the-vfp-foxpro-odbc-driver-with-your-visual-basic-application.md)  
  
-   [Visual FoxPro ODBC ドライバーを使用して、C または C++ アプリケーション](../../odbc/microsoft/using-the-visual-foxpro-odbc-driver-with-your-c-or-visual-c-application.md)  
