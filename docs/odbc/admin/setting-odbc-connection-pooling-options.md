...
|1 秒あたりの ODBC 接続の論理的なカウンター|1 秒あたりのプールでなければ接続の数、つまりからの接続プールがユーザーに渡さします。 このカウンターは、プールが動作しているかどうかを示します。 サーバーで、負荷に応じて 1 秒あたり 40 ~ 60 の論理的な接続を表示することも珍しくはされません。|  
