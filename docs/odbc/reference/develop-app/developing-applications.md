---
title: "アプリケーションの開発 |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
-   [結果 (基本) を取得します。](../../../odbc/reference/develop-app/retrieving-results-basic.md)  
  
-   [(詳細) 結果を取得します。](../../../odbc/reference/develop-app/retrieving-results-advanced.md)  
  
-   [データの更新の概要](../../../odbc/reference/develop-app/updating-data-overview.md)  
...
-   [プログラミングに関する考慮事項](../../../odbc/reference/develop-app/programming-considerations.md)  
