...
-   [ステートメント ハンドルの割り当てください。](../../../odbc/reference/develop-app/allocating-a-statement-handle-odbc.md)  
  
-   [ステートメント属性](../../../odbc/reference/develop-app/statement-attributes.md)  
  
-   [ステートメントを実行します。](../../../odbc/reference/develop-app/executing-a-statement.md)  
