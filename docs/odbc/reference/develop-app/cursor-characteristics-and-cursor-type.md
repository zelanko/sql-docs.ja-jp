...
|SQL_ATTR_CURSOR_SCROLLABLE が SQL_NONSCROLLABLE に|SQL_ATTR_CURSOR_TYPE to SQL_CURSOR_FORWARD_ONLY|  
...
|SQL_ATTR_CURSOR_TYPE to SQL_CURSOR_FORWARD_ONLY|SQL_ATTR_CURSOR_SCROLLABLE を SQL_NONSCROLLABLE します。|  
