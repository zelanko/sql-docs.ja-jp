---
title: SQLAllocEnv 関数 |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **概要**  
 ODBC 3 です。*x*、ODBC 2 *。x*関数**SQLAllocEnv**代わりました**SQLAllocHandle**です。 詳細については、次を参照してください。 [SQLAllocHandle 関数](../../../odbc/reference/syntax/sqlallochandle-function.md)です。  
