 ...
 **まとめ**  
 ODBC 3。*x*、ODBC 2 *。x*関数**SQLAllocEnv**置き換わりました**SQLAllocHandle**します。 詳細については、次を参照してください。 [SQLAllocHandle 関数](../../../odbc/reference/syntax/sqlallochandle-function.md)します。  
