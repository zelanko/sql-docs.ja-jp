---
title: "ODBC リファレンス |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
次のトピックには、構文とセマンティクスについてすべての ODBC 関数が含まれます。  
...
-   [インストーラー DLL の API リファレンス](../../../odbc/reference/syntax/installer-dll-api-reference-function.md)  
  
-   [翻訳 DLL 関数のリファレンス](../../../odbc/reference/syntax/translation-dll-api-reference.md)  
