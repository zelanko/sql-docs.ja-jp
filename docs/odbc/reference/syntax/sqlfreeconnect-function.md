---
title: SQLFreeConnect 関数 |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **概要**  
 ODBC 3 *.x*、ODBC 2.0 関数**SQLFreeConnect**代わりました**SQLFreeHandle**です。 詳細については、次を参照してください。 [SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md)です。  
