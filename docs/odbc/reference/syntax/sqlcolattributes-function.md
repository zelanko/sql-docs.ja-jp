---
title: SQLColAttributes 関数 |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
 ...
 **概要**  
 ODBC 3 です。*x*、ODBC 2.0 関数**SQLColAttributes**代わりました**SQLColAttribute**です。 詳細については、次を参照してください。 [SQLColAttribute 関数](../../../odbc/reference/syntax/sqlcolattribute-function.md)です。  
