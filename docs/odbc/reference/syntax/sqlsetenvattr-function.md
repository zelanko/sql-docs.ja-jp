...
## <a name="comments"></a>コメント  
 アプリケーションが呼び出すことができます**SQLSetEnvAttr**環境に接続ハンドルが割り当てられていない場合にのみです。 正常に環境のアプリケーションによって設定されたすべての環境属性がされるまで保持**SQLFreeHandle**が環境内で呼び出されます。 ODBC 3 では、複数の環境ハンドルを同時に割り当てることが *.x*します。  
