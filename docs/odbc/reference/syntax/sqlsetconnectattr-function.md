...
|SQL_ATTR_CONNECTION_DEAD|これらの手順の完了後、|  
|SQL_ATTR_CONNECTION_TIMEOUT|接続前/接続後|  
|SQL_ATTR_CURRENT_CATALOG|いずれか [1]|  
|SQL_ATTR_DBC_INFO_TOKEN|これらの手順の完了後、|  
|SQL_ATTR_ENLIST_IN_DTC|これらの手順の完了後、|  
...
|SQL_ATTR_TRANSLATE_LIB|これらの手順の完了後、|  
|SQL_ATTR_TRANSLATE_OPTION|これらの手順の完了後、|  
