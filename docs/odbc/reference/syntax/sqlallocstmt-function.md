 ...
 **概要**  
 ODBC 3。*x*、ODBC 2 *。x*関数**SQLAllocStmt**置き換わりました**SQLAllocHandle**します。 詳細については、[SQLAllocHandle 関数](../../../odbc/reference/syntax/sqlallochandle-function.md)を参照してください。  
