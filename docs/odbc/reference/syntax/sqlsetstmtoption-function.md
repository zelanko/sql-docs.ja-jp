---
title: "SQLSetStmtOption 関数 |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
 ...
 **概要**  
 ODBC 3*.x*、ODBC 2.0 関数**SQLSetStmtOption**代わりました**SQLSetStmtAttr**です。 詳細については、次を参照してください。 [SQLSetStmtAttr](../../../odbc/reference/syntax/sqlsetstmtattr-function.md)です。  
