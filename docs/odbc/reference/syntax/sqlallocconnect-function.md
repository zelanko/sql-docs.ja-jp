 ...
 **まとめ**  
 ODBC 3 の場合。*x*、ODBC 2。*x*関数**sqlallocconnect**は**SQLAllocHandle**に置き換えられました。 詳細については、「 [SQLAllocHandle 関数](../../../odbc/reference/syntax/sqlallochandle-function.md)」を参照してください。  
