---
title: 'C から SQL へ: 数値 |Microsoft Docs'
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
数値の ODBC C データ型の識別子は次のとおりです。  
 ...
 次の表は、ODBC SQL データ型が数値の C データを変換する可能性がありますを示します。 列とテーブルの用語の詳細については、[C から SQL データ型への変換データ](../../../odbc/reference/appendixes/converting-data-from-c-to-sql-data-types.md)を参照してください。  
