...
GUID の ODBC SQL データ型の識別子です。  
 ...
 次の表は、ODBC C データ型の GUID の SQL データを変換する可能性がありますを示します。 列とテーブルの用語の詳細については、[SQL から C データ型への変換データ](../../../odbc/reference/appendixes/converting-data-from-sql-to-c-data-types.md)を参照してください。  
