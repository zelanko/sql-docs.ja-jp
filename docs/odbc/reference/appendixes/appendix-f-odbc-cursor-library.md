...
-   [ODBC カーソル ライブラリを使用します。](../../../odbc/reference/appendixes/using-the-odbc-cursor-library.md)  
  
-   [位置指定更新ステートメントと Delete ステートメントを実行します。](../../../odbc/reference/appendixes/executing-positioned-update-and-delete-statements.md)  
