...
|SQL_ODBC_API_CONFORMANCE (ODBC 1.0)|ODBC 準拠のレベルを示す SQLSMALLINT 値。<br /><br /> SQL_OAC_NONE = None<br /><br /> SQL_OAC_LEVEL1 = レベル 1 のサポート<br /><br /> SQL_OAC_LEVEL2 = レベル 2 のサポート|  
