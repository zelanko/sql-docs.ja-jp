...
|SQL_C_TYPE_TIMESTAMP|データの値が有効な*タイムスタンプ値または有効な時刻値*; 小数秒の部分を切り捨てることができません [a]<br /><br /> データの値が有効な*タイムスタンプ値または有効な時刻値*; 小数秒の部分を切り捨てる [a]<br /><br /> データの値が有効な*日付値*[a]<br /><br /> データの値が有効な*時刻値*[a]<br /><br /> データの値が有効な*日付値*、*時刻値*、または*タイムスタンプ値*[a]|データ<br /><br /> 切り捨てられたデータ<br /><br /> Data[f]<br /><br /> データ [g]<br /><br /> 未定義。|16 [b]<br /><br /> 16 [b]<br /><br /> 16 [b]<br /><br /> 16 [b]<br /><br /> 未定義。|n/a<br /><br /> 01S07<br /><br /> n/a<br /><br /> n/a<br /><br /> 22018|  
