---
title: "Analysis Services の MDX クエリ デザイナーでのパラメーターの定義 (レポート ビルダーおよび SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "パラメーター [Reporting Services]、MDX"
  - "多次元式 [Reporting Services]"
  - "データ マイニング予測 [Reporting Services]"
  - "MDX [Reporting Services]、パラメーターの定義"
...
manager: "erikre"
---
# Analysis Services の MDX クエリ デザイナーでのパラメーターの定義 (レポート ビルダーおよび SSRS)
...
3.  MDX クエリ デザイナーのツール バーで、**[クエリ パラメーター]** をクリックします (\(![[クエリ パラメーター] ダイアログ ボックスのアイコン](../../reporting-services/report-data/media/iconqueryparameter.png "[クエリ パラメーター] ダイアログ ボックスのアイコン"))。 [クエリ パラメーター] ダイアログ ボックスが表示されます。  
