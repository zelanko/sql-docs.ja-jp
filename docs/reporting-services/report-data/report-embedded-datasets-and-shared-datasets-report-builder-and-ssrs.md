---
title: レポート埋め込みデータセットと共有データセット (レポート ビルダー) | Microsoft Docs
description: レポート埋め込みデータセットと共有データセットについて説明します。これにより、レポートの実行時に実際のデータに評価される式を作成できます。
ms.date: 03/14/2017
