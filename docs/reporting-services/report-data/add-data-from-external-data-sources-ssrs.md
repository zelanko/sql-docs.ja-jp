---
title: "外部データ ソース (SSRS) からデータを追加 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/17/2017
...
|[レポート ビルダーでのデータ接続、データ ソース、および接続文字列](http://msdn.microsoft.com/library/7e103637-4371-43d7-821c-d269c2cc1b34)|データ接続とデータ ソースについて説明します。|  
