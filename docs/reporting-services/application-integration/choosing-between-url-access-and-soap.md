...
description: Reporting Services をカスタム アプリケーションに統合するには、2 つの方法があります。URL アクセスと Reporting Services SOAP API です。 どちらの方法を使用するかは、いくつかの要因によって異なります。
ms.date: 10/19/2017
