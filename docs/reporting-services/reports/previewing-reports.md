...
ms.topic: "article"
helpviewer_keywords: 
  - "レポート デザイナー [Reporting Services], レポートのプレビュー"
  - "レポートのプレビュー [Reporting Services]"
  - "印刷プレビュー"
  - "テスト サーバー [Reporting Services]"
...
-   [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] の標準ツール バー ![ssrs_ssdt_startdebug](../../reporting-services/reports/media/ssrs-ssdt-startdebug.png "ssrs_ssdt_startdebug") で **[開始]** をクリックする。  
...
## 参照  
 ...
 [レポートのパブリッシュ](../Topic/Publish%20Reports.md)   
