---
title: "EditionName プロパティ (WMI MSReportServer_Instance) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---editionname"></a>MSReportServer_Instance プロパティ - EditionName
...
## <a name="property-value"></a>プロパティ値  
 人間が判読できる、レポート サーバーのエディション名を表す **文字列** 。  
