---
title: "Version プロパティ (WMI MSReportServer_Instance) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---version"></a>MSReportServer_Instance プロパティ - バージョン
