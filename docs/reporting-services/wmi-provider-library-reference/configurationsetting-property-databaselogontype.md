---
title: "DatabaseLogonType プロパティ (WMI MSReportServer_ConfigurationSetting) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="configurationsetting-property---databaselogontype"></a>DatabaseLogonType ConfigurationSetting プロパティ
