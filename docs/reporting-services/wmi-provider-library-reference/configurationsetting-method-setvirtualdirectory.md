---
title: "SetVirtualDirectory メソッド (WMI MSReportServer_ConfigurationSetting) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-method---setvirtualdirectory"></a>SetVirtualDirectory ConfigurationSetting メソッド
