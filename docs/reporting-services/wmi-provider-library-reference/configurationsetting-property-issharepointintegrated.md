---
title: "IsSharePointIntegrated プロパティ (WMI) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-property---issharepointintegrated"></a>IsSharePointIntegrated ConfigurationSetting プロパティ
