---
title: "SetDatabaseConnection メソッド (WMI MSReportServer_ConfigurationSetting) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="configurationsetting-method---setdatabaseconnection"></a>SetDatabaseConnection ConfigurationSetting メソッド
