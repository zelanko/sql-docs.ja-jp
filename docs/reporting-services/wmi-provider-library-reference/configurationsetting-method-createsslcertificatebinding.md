---
title: "CreateSSLCertificateBinding メソッド (WMI MSReportServer_ConfigurationSetting) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-method---createsslcertificatebinding"></a>CreateSSLCertificateBinding ConfigurationSetting メソッド
  SSL 証明書のバインドを作成します。  
