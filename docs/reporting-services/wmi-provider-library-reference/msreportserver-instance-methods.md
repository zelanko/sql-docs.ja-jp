...
|||  
|-|-|  
|[GetReportServerUrls メソッド &#40;WMI MSReportServer_Instance&#41;](../../reporting-services/wmi-provider-library-reference/getreportserverurls-method-wmi-msreportserver-instance.md)|ユーザーがレポート サーバーおよび [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)]へのアクセスに使用できる URL の一覧を示します。|  
