...
ms.topic: "article"
helpviewer_keywords: 
  - "GetDatabaseVersionDisplayName メソッド"
...
manager: "erikre"
---
# GetDatabaseVersionDisplayName メソッド (WMI)
...
|修正プログラム||最も近い適用可能なバージョン|  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 2000 より前の *Version* では、HRESULT として ACT_E_BAD_VERSION が返されます。  
