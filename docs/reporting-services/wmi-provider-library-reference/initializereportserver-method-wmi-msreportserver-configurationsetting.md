...
## 解説  
 ...
 レポート サーバーの [IsInitialized](../../reporting-services/wmi-provider-library-reference/isinitialized-property-wmi-msreportserver-configurationsetting.md) プロパティが **true** に設定されている場合に InitializeReportServer メソッドを呼び出すと、メソッドは暗号化キーの暗号化を試みないで成功を返します。  
