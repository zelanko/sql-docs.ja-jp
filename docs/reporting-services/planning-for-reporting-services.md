...
# <a name="planning-for-reporting-services"></a>Reporting Services の計画
 ...
 ![小さいファイル フォルダー アイコン](../analysis-services/media/filefolder-small.png "Small File Folder Icon")**全般的な Reporting Services の機能の計画とアーキテクチャ**  
 ...
 ![小さいファイル フォルダー アイコン](../analysis-services/media/filefolder-small.png "Small File Folder Icon") **Reporting Services セットアップ**  
 [Reporting Services Report Server](../reporting-services/report-server-sharepoint/reporting-services-report-server.md)  
  
 [配置のチェック リスト: 既存の SharePoint ファームへの Reporting Services のインストール](http://msdn.microsoft.com/library/436b4c3d-3f2f-464a-be7e-5c051d9ffb8f)  
  
 [SharePoint の SQL Server BI 機能の配置トポロジ](http://msdn.microsoft.com/library/39f76bc7-94e6-4dbc-bfa5-d56f4430bb26)  
