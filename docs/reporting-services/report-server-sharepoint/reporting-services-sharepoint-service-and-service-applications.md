...
description: SQL Server Reporting Services SharePoint モードでサービス アプリケーションを作成すると、そのサービスが利用可能になり、サービス アプリケーション データーベースが生成されます。
ms.date: 09/25/2017
