...
description: コンテンツの種類として、[レポート ビルダー レポート]、[レポート モデル]、および [レポート データ ソース] をライブラリに追加すると、[新規作成] コマンドが有効になり、その種類のドキュメントを新規作成できるようになります。
ms.date: 09/25/2017
...
2.  **[サイトの設定]** に移動します。  
    ...
    -   SharePoint 2013 の場合、 **[設定]** アイコンをクリックします。 ![SharePoint の設定](/analysis-services/analysis-services/media/as-sharepoint2013-settings-gear.gif "SharePoint の設定")  
