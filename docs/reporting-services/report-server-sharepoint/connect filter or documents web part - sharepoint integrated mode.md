---
title: "フィルター Web パーツまたはドキュメント Web パーツの接続 (Reporting Services の SharePoint 統合モード) | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "フィルター Web パーツ [Reporting Services]"
  - "SharePoint 統合 [Reporting Services], Web パーツ"
  - "レポート ビューアー Web パーツ [Reporting Services]"
  - "ドキュメント Web パーツ [Reporting Services]"
...
manager: "erikre"
---
# フィルター Web パーツまたはドキュメント Web パーツの接続 (Reporting Services の SharePoint 統合モード)
...
8.  **[すべての Web パーツ]** の **[その他]** カテゴリで、**[SQL Server Reporting Services レポート ビューアー]** をクリックします。  
