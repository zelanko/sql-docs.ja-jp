---
title: "SharePoint CA にレポート サーバー ファイル同期機能をアクティブ化 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="activate-the-report-server-file-sync-feature-in-sharepoint-ca"></a>SharePoint CA にレポート サーバー ファイル同期機能をアクティブ化します。
