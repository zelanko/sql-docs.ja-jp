...
ms.topic: "article"
helpviewer_keywords: 
  - "サブスクリプション [Reporting Services]、非アクティブ"
  - "サブスクリプション [Reporting Services]、ステータス"
  - "監視 [Reporting Services]、サブスクリプション"
  - "状態情報 [Reporting Services]"
  - "非アクティブなサブスクリプション [Reporting Services]"
