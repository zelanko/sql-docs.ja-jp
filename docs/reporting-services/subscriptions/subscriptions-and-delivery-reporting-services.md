...
description: この記事では、特定の時刻に、またはイベントへの応答としてレポートを配信する、Reporting Services サブスクリプションについて説明します。
ms.date: 03/14/2017
...
##  <a name="subscription-and-delivery-scenarios"></a><a name="bkmk_subscription_scenarios"></a> サブスクリプションおよび配信のシナリオ  
...
##  <a name="standard-and-data-driven-subscriptions"></a><a name="bkmk_standard_and_datadriven"></a> 標準のサブスクリプションとデータ ドリブン サブスクリプション  
...
##  <a name="parts-of-a-subscription"></a><a name="bkmk_parts_of_subscription"></a> サブスクリプションの要素  
...
##  <a name="programmatic-control-of-subscriptions"></a><a name="bkmk_code"></a> サブスクリプションのプログラムによる制御  
