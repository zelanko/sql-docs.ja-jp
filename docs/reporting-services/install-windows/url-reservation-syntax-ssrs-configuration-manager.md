---
description: URL 予約の構文 (レポート サーバー構成マネージャー)
title: URL 予約の構文 (構成マネージャー) | Microsoft Docs
ms.date: 05/18/2016
...
ms.locfileid: "91934132"
---
# <a name="url-reservation-syntax--report-server-configuration-manager"></a>URL 予約の構文 (レポート サーバー構成マネージャー)
...
|プロパティ|有効な値|説明|  
|--------------|------------------|-----------------|  
|Scheme|http または https|非 TLS 接続と TLS 接続に対するプレフィックス。|  
