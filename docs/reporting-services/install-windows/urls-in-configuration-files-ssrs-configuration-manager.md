---
title: "構成ファイル内の URL (SSRS 構成マネージャー) | Microsoft Docs"
ms.custom: ""
ms.date: "05/18/2016"
...
#### [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)] および Web パーツをレポート サーバー Web サービスに接続するための URL  
