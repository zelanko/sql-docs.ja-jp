---
title: "スケールアウト配置に関する暗号化キーの追加と削除 (SSRS 構成マネージャー) | Microsoft Docs"
ms.custom: ""
ms.date: "05/31/2016"
...
## Reporting Services 構成ツールを使用したスケールアウト配置の構成  
...
### レポート サーバーをスケールアウト配置に結合する方法 (rskeymgmt)  
...
### レポート サーバーをスケールアウト配置から削除する方法 (rskeymgmt)  
