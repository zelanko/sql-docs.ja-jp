...
## Web ポータルまたは SharePoint ライブラリから [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] をインストールする 
...
### 統合された SharePoint サイト:  [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]
...
## System Center Configuration Manager を使用する [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] のインストール 
...
## 共有から [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] をインストールするには  
...
## コマンド ラインから [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] をインストールするには 
...
## [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 既定値を設定する  
