...
helpviewer_keywords: 
  ...
  - "接続 [Reporting Services]"
  - "レポート サーバー [Reporting Services], 接続"
  - "レポート サーバー データベース"
  - "データベース [Reporting Services], 接続"
  - "セキュリティ [Reporting Services], データベース接続"
...
-   レポート サーバー データベースの名前。 接続を初めて作成する場合、新しいレポート サーバー データベースを作成することも、既存のデータベースを選択することもできます。 詳細については、「[レポート サーバー データベースの作成 &#40;SSRS 構成マネージャー&#41;](../../reporting-services/install-windows/create-a-report-server-database-ssrs-configuration-manager.md)」を参照してください。  
