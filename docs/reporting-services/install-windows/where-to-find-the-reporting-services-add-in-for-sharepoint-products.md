---
title: "SharePoint 製品用 Reporting Services アドインの検索場所 |Microsoft ドキュメント"
ms.custom:
- SQL2016_New_Updated
ms.date: 05/30/2016
...
##  <a name="bkmk_sql16"></a> [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SharePoint 製品用 Reporting Services アドイン  
...
SQL Server 2016 のリリースでアドインをインストールできます機能の選択 ページで、SQL Server インストール ウィザードの一部として。 アドインを別途ダウンロードしてインストールする場合、このファイルの最新バージョンは、 [!INCLUDE[msCoName](../../includes/msconame-md.md)] ダウンロード センターの「 [Microsoft® SharePoint® テクノロジ 2010 用 Microsoft® SQL Server® 2012 Reporting Services アドイン](http://go.microsoft.com/fwlink/?LinkID=207242) 」ページからオンラインで入手できます。
...
[Reporting Services アドインをアンインストールした後に既定以外のゾーンでの SharePoint ページを参照できません。](http://support.microsoft.com/kb/2009212)  
