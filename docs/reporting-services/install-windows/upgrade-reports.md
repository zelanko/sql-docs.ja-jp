...
ms.topic: "article"
helpviewer_keywords: 
  - "レポート [Reporting Services], アップグレード"
  - "パブリッシュされたレポート [Reporting Services], アップグレード"
  - "カスタム レポート アイテム, アップグレード"
  - "Reporting Services, アップグレード"
  - "Reporting Services のアップグレード"
  - "スナップショット [Reporting Services], アップグレード"
  - "レポート定義ファイル [Reporting Services]"
  - ".rdl ファイル"
...
-   既にインストールされている [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] を [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] にアップグレードすると、レポート サーバーにパブリッシュされている既存のレポートとスナップショットは、最初に処理されるときにコンパイルされ、新しいスキーマへと自動的にアップグレードされます。 レポートを自動的にアップグレードできない場合、レポートは下位互換性モードを使用して処理されます。 レポート定義は元のスキーマのまま残ります。  
 ...
 [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] の新機能については、「[Reporting Services &#40;SSRS&#41; の新機能](../Topic/What's%20New%20in%20Reporting%20Services%20\(SSRS\).md)」を参照してください。  
...
## 参照  
 ...
 [SQL Server 2016 における SQL Server Reporting Services の重大な変更](../../reporting-services/breaking-changes-in-sql-server-reporting-services-in-sql-server-2016.md)   
 ...
 [SQL Server 2016 で廃止された SQL Server Reporting Services の機能](../Topic/Discontinued%20Functionality%20to%20SQL%20Server%20Reporting%20Services%20in%20SQL%20Server%202016.md)   
