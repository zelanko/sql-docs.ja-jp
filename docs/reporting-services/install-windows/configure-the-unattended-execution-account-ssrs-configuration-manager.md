...
2.  コマンド プロンプトを開きます。 **[スタート]** ボタンをクリックし、 **[ファイル名を指定して実行]** をクリックして「**cmd**」と入力し、 **[OK]** をクリックします。  
