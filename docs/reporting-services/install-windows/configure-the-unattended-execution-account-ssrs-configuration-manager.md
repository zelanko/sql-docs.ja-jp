...
helpviewer_keywords: 
  ...
  - "セキュリティ [Reporting Services], 自動レポート処理"
  - "自動レポート処理 [Reporting Services]"
  - "資格情報 [Reporting Services]"
  - "外部データ ソース [Reporting Services]"
  - "アカウント [Reporting Services]"
  - "レポート [Reporting Services], 処理"
...
## 参照  
 [Reporting Services 構成マネージャー (SSRS ネイティブ モード)](http://msdn.microsoft.com/ja-jp/379eab68-7f13-4997-8d64-38810240756e)  
