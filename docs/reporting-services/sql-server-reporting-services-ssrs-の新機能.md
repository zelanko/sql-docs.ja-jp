...
helpviewer_keywords: 
  ...
  - "Reporting Services, 新機能"
  - "SQL Server Reporting Services, 新機能"
  - "SSRS, 新機能"
...
SQL Server [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] の新機能について説明します。 ここでは、主な機能領域を扱います。新しいアイテムがリリースされた場合は更新します。
  ...
  SQL Server の他の領域の新機能については、「[SQL Server vNext の新機能](../sql-server/what-s-new-in-sql-server-vnext.md)」、または「[SQL Server 2016 の新機能](../sql-server/what-s-new-in-sql-server-2016.md)」を参照してください。
...
-   Azure アカウントをすでにお持ちですか?  すでにお持ちの場合は、 **[こちら](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016sp1enterprisewindowsserver2016/)** にアクセスして、 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] がインストール済みの仮想マシンをすぐにご利用いただけます。  
  
 ![メモ](../analysis-services/instances/install-windows/media/ssrs-fyi-note.png "メモ") 最新のリリース ノートについては、「[SSRS での Power BI レポートの技術プレビュー - リリース ノート](../reporting-services/reporting-services-のリリース-ノート.md)」、および「[SQL Server 2016 リリース ノート](../sql-server/sql-server-2016-release-notes.md)」を参照してください。  

## <a name="whats-new-in-the-january-2017-technical-preview-of-power-bi-reports-in-sql-server-reporting-services"></a>SQL Server Reporting Services での Power BI レポートの技術プレビュー (2017 年 1 月) の新機能

### <a name="reporting-services-has-a-new-setup-experience"></a>Reporting Services の新しいセットアップ エクスペリエンス

Reporting Services は SQL Server セットアップの外でもインストールできるようになりました。 手順が少なくなり、より簡易なセットアップ エクスペリエンスになりました。 セットアップ中に Reporting Services ファイルがインストールされます。 その後、レポート サーバーのデータベースを構成できます。 これには、環境内の SQL Server Database Engine サーバーへのアクセス権が必要です。

![ssrs-standalone-setup1](../reporting-services/media/ssrs-standalone-setup1.png)

詳細については、[SQL Server Reporting Services での Power BI レポートの技術プレビュー (2017 年 1 月) のインストール](Install%20the%20January%202017%20Technical%20Preview%20of%20Power%20BI%20reports%20in%20SQL%20Server%20Reporting%20Services.md)に関する記事を参照してください。

### <a name="host-power-bi-reports-within-the-web-portal"></a>Web ポータル内で Power BI レポートをホストする

Power BI Desktop ファイルを Reporting Services にアップロードして、レポートを Web ポータルで直接表示できるようになりました。

![ssrs-powerbi-report-config-render](../reporting-services/media/ssrs-powerbi-report-config-render.png)

Power BI Desktop リリース (SQL Server Reporting Services) をダウンロードする必要があります。 プレビューでは現在、このバージョンの Power BI Desktop で作成されたレポートのみがサポートされています。 Power BI Desktop (SQL Server Reporting Services) は Power BI サービスの Power BI Desktop とサイド バイ サイドで共存できます。 Power BI Desktop (SQL Server Reporting Services) をダウンロードするには、Microsoft ダウンロード センターにアクセスします。 

現在、Power BI レポートの作成は Analysis Services (テーブルまたは多次元) へのライブ接続に制限されています。 今後のプレビューでは、他のデータ ソースのサポートの追加と、Power Query 機能の使用を予定しています。

詳細については、「[Power BI reports in Reporting Services (Reporting Services での Power BI レポート](../reporting-services/power-bi-reports-in-reporting-services.md)」に関するページを参照してください。
...
### <a name="reporting-services-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>Reporting Services [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)]  
 ...
 #### <a name="custom-branding-for-the-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>[!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] のカスタム ブランド化 
  ブランド化パックを使用して、組織のロゴや色で [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)]をカスタマイズできます。  
  
  カスタムブランド化の詳細については、「[Web ポータルのブランド化](http://msdn.microsoft.com/ja-jp/6dac97f7-02a6-4711-81a3-e850a6b40bf1)」を参照してください。
 
 #### <a name="key-performance-indicators-kpi-in-the-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>[!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] での主要業績評価指標 (KPI) 
...
使用しているフォルダーのコンテキストに適合する KPI を [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] で直接作成できます。 KPI を作成するときは、データセットを選択し、それらの値を集約できます。 詳細をドリル スルーするための関連コンテンツを選択することもできます。
 ...
 詳細については、「[Reporting Services で KPI を使用する](http://msdn.microsoft.com/ja-jp/a28cf500-6d47-4268-a248-04837e7a09eb)」を参照してください。
...
**レポートアイテムの Power BI ダッシュボードへのピン留め:** [!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)]でレポートを表示しているときに、レポート アイテムを選択し、[!INCLUDE[sspowerbi](../includes/sspowerbi-md.md)] ダッシュボードにピン留めできます。   ピン留めできるアイテムは、グラフ、ゲージ パネル、マップ、イメージです。 **(1)** ピン留めするダッシュボードを含むグループを選択し、**(2)** アイテムをピン留するダッシュボードも選択して、**(3)** ダッシュボードでのタイルの更新頻度を選択できます。   ![メモ](../analysis-services/instances/install-windows/media/ssrs-fyi-note.png "メモ") 更新は [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] サブスクリプションによって管理されます。アイテムをピン留めした後に、サブスクリプションを編集し、別の更新スケジュールを構成できます。  
...
**High DPI のサポート:** [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 用の[!INCLUDE[ssRBnoversion](../includes/ssrbnoversion-md.md)]では、高 DPI (インチあたりのドット数) スケーリングと高 DPI デバイスをサポートします。  高 DPI の詳細については、次の記事をご覧ください。  
...
## <a name="see-also"></a>参照  
 [Analysis Services の新機能](http://msdn.microsoft.com/ja-jp/aa69c299-b8f4-4969-86d8-b3292fe13f08)  
 [SSRS での Power BI レポートの技術プレビュー - リリース ノート](../reporting-services/reporting-services-のリリース-ノート.md)  
 [SQL Server 2016 リリース ノート](../sql-server/sql-server-2016-release-notes.md)   
 [旧バージョンとの互換性](http://msdn.microsoft.com/ja-jp/675b0e0e-cfee-4790-9675-80fc3ea6d30f)   
 [SQL Server 2016 の各エディションがサポートする Reporting Services の機能](http://msdn.microsoft.com/ja-jp/39f03d2d-6e48-4b34-a9d3-07f86313b937)   
