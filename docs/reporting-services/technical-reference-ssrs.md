...
# <a name="technical-reference-ssrs"></a>テクニカル リファレンス (SSRS)
 ...
 ![小さいファイル フォルダー アイコン](../analysis-services/media/filefolder-small.png "Small File Folder Icon")**レポート サーバーのコマンド プロンプト ユーティリティ**  
 ...
 ![小さいファイル フォルダー アイコン](../analysis-services/media/filefolder-small.png "Small File Folder Icon") **Reporting Services WMI プロバイダー クラス ライブラリ**  
