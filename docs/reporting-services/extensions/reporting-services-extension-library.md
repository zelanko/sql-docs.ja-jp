---
title: "Reporting Services 拡張機能ライブラリ |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
# <a name="reporting-services-extension-library"></a>Reporting Services 拡張機能ライブラリ
  Reporting Services 拡張機能ライブラリは、[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] に含まれているクラス、インターフェイス、および値の型のセットです。 このライブラリがシステムの機能へのアクセスを提供し、基盤に設計されています[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)]アプリケーションは、拡張を使用することができます[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]コンポーネントです。  
