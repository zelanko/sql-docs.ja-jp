...
##  <a name="bkmk_trace_configuration_settings"></a> トレースの構成設定  
 ...
 `\Program Files\Microsoft SQL Server\MSRS13.<instance name>\Reporting Services\ReportServer\bin`」を参照してください。  
