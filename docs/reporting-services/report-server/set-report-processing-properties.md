...
helpviewer_keywords: 
  - "要求時レポート"
  - "レポート処理 [Reporting Services], 実行プロパティ"
  - "スナップショット [Reporting Services], レポートの実行"
  - "キャッシュされたレポート [Reporting Services]"
  - "レポート スナップショット [Reporting Services], レポートの実行"
  - "レポート実行スナップショット [Reporting Services]"
...
# レポート処理プロパティの設定
 ...
 レポート実行プロパティを設定するには、レポート マネージャーでレポートを開き、[実行] プロパティ ページに移動します。 詳細については、「[[処理オプション] プロパティ ページ &#40;レポート マネージャー&#41;](../Topic/Processing%20Options%20Properties%20Page%20\(Report%20Manager\).md)」を参照してください。 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] を使用してプロパティを設定することもできます。「[[処理オプション] プロパティ ページ &#40;レポート マネージャー&#41;](../Topic/Processing%20Options%20Properties%20Page%20\(Report%20Manager\).md)」を参照してください。  
