---
title: "作成、削除、または変更 Folder (web ポータル) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
1.  開始、[レポート マネージャー &#40;です。SSRS ネイティブ モード &#41;](http://msdn.microsoft.com/library/80949f9d-58f5-48e3-9342-9e9bf4e57896).  
