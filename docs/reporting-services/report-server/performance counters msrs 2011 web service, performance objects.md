---
title: "MSRS 2011 Web Service と MSRS 2011 Windows Service パフォーマンス オブジェクトのパフォーマンス カウンター (ネイティブ モード) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "レポート サーバー Web サービス, パフォーマンス カウンター"
  - "Reporting Services パフォーマンス オブジェクト"
  - "RS Web Service パフォーマンス オブジェクト"
