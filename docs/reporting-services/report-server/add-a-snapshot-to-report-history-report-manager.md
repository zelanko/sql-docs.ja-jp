...
ms.topic: "article"
helpviewer_keywords: 
  - "レポート履歴 [Reporting Services], スナップショットの追加"
  - "履歴データ [Reporting Services]"
  - "スナップショット [Reporting Services], レポート スナップショットの追加"
  - "レポート履歴へのスナップショットの追加"
  - "レポート スナップショット [Reporting Services], 追加"
...
3.  **[新しいスナップショット]** をクリックします。 **[実行時]** 列に新しいスナップショットが作成されます。  
    ...
    > [!NOTE]  
    >  レポート履歴にスナップショットを追加するには、管理者がレポート履歴の構成で **[履歴の手動作成を許可する]** に設定しておく必要があります。 詳細については、[「Limit Report History (Report Manager)」](../../reporting-services/reports/limit-report-history-report-manager.md) (レポート履歴を制限する (レポート マネージャー)) を参照してください。  
