---
title: "MSRS 2011 Web Service SharePoint Mode と MSRS 2011 Windows Service SharePoint Mode パフォーマンス オブジェクトのパフォーマンス カウンター (SharePoint モード) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "レポート サーバー Windows サービス, パフォーマンス カウンター"
  - "RS Windows サービス パフォーマンス オブジェクト"
  - "スケジュールおよび配信のプロセッサのパフォーマンス オブジェクト [Reporting Services]"
...
manager: "erikre"
---
# MSRS 2011 Web Service SharePoint Mode と MSRS 2011 Windows Service SharePoint Mode パフォーマンス オブジェクトのパフォーマンス カウンター (SharePoint モード)
  このトピックでは、[!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] SharePoint モード配置の一部である **MSRS 2011 Web Service SharePoint Mode** と **MSRS 2011 Windows Service SharePoint Mode** パフォーマンス オブジェクトのパフォーマンス カウンターについて説明します。  
...
##  <a name="bkmk_powershell"></a> PowerShell コマンドレットを使用して一覧を取得する  
 ![PowerShell 関連コンテンツ](../../analysis-services/instances/install-windows/media/rs-powershellicon.png "PowerShell 関連コンテンツ")次の Windows PowerShell スクリプトは、CounterSetName が "msr" で始まる一連のカウンターを返します。  
