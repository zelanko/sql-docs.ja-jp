---
title: "複数のレポートのキャッシュ (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "レポート処理 [Reporting Services], キャッシュ"
  - "キャッシュされたインスタンス [Reporting Services]"
  - "キャッシュを更新する"
  - "キャッシュされたレポート [Reporting Services]"
  - "キャッシュの事前読み込み"
  - "無効なキャッシュされたレポート [Reporting Services]"
  - "パフォーマンス [Reporting Services]"
  - "有効期限 [Reporting Services]"
  - "スナップショット [Reporting Services], キャッシュ"
...
## 参照  
 ...
 [キャッシュ更新オプション (レポート マネージャー)](../Topic/Cache%20Refresh%20Options%20\(Report%20Manager\).md)  
