...
- [共有データセットを作成する](#create)  
  
- [既存の共有データセットを管理する](#manage)  
...
> [!NOTE] フォルダーに共有データセットが表示されない場合は、データセットを表示していることを確認します。 Web ポータルの右上にあるメニュー バーで **[表示]** を選択します。 **[データセット]** がオンになっていることを確認します。  
...
> [!NOTE] 有効期限を設定しても、キャッシュは更新されません。 キャッシュ更新計画がない場合、データはデータセットの次の実行時に更新されます。  
