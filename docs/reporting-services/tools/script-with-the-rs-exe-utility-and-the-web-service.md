...
ms.topic: "article"
helpviewer_keywords: 
  - "Web サービス [Reporting Services], スクリプト"
  - "rs ユーティリティ (rs utility)"
  - "XML Web サービス [Reporting Services], スクリプト"
  - "レポート サーバー Web サービス, スクリプト"
  - "スクリプト [Reporting Services], Web サービス"
...
# rs.exe ユーティリティと Web サービスを使用したスクリプト
 ...
 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]  スクリプトを使用すると、レポート サーバー Web サービスのあらゆる操作を実行できます。 スクリプトを使用すれば、サーバー上の複数のレポートにセキュリティをコピーしたり、アイテムを追加または削除したり、サーバー間でレポート サーバー アイテムをコピーすることができます。 スクリプト環境の詳細については、「[Reporting Services スクリプト ファイルを実行する](../../reporting-services/tools/run-a-reporting-services-script-file.md)」を参照してください。 スクリプト ファイルは特定の書式を使用しており、[!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .NET で記述されます。 詳細については、「[Reporting Services スクリプト ファイルを書式設定する](../../reporting-services/tools/format-a-reporting-services-script-file.md)」を参照してください。  
