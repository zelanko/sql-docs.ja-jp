...
helpviewer_keywords: 
  ...
  - "Reporting Services、スクリプトの作成"
  - "スクリプトの作成 [Reporting Services]"
...
-   [PowerShell を使用して SSRS を管理する方法](http://curah.microsoft.com/13107/how-to-administer-ssrs-using-powershell)。  
