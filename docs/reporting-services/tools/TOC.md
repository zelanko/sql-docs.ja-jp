...
# [レポート デザイナーを使用してレポートをデザインする](design-reports-with-report-designer-ssrs.md)
# [SQL Server データ ツールの配置およびバージョン サポート](deployment-and-version-support-in-sql-server-data-tools-ssrs.md)
