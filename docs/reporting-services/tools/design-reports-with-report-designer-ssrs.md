...
ms.topic: "article"
helpviewer_keywords: 
  - "レポート デザイナー [Reporting Services]、レポートの作成"
...
##  <a name="a-namebkmkshareddatasourcesa-shared-data-sources"></a><a name="bkmk_SharedDataSources"></a> 共有データ ソース  
...
##  <a name="a-namebkmkshareddatasetsa-shared-datasets"></a><a name="bkmk_SharedDatasets"></a> 共有データセット  
...
##  <a name="a-namebkmkreportsa-paginated-reports"></a><a name="bkmk_Reports"></a> ページネーションのあるレポート  
...
##  <a name="a-namebkmkreportpartsa-report-parts"></a><a name="bkmk_ReportParts"></a> レポート パーツ  
...
##  <a name="a-namebkmkresourcesa-resources"></a><a name="bkmk_Resources"></a> リソース  
...
##  <a name="a-namebkmkreportlayouta-paginated-report-layout"></a><a name="bkmk_ReportLayout"></a> ページ分割されたレポートのレイアウト  
...
##  <a name="a-namebkmkpreviewa-preview-a-paginated-report"></a><a name="bkmk_Preview"></a> ページ分割されたレポートのプレビュー  
...
##  <a name="a-namebkmksaveanddeploya-save-and-deploy-paginated-reports"></a><a name="bkmk_SaveandDeploy"></a> ページ分割レポートの保存および配置  
...
##  <a name="a-namebkmkreportvalidationanderrorlevelsa-report-validation-and-error-levels"></a><a name="bkmk_ReportValidationandErrorLevels"></a> レポートの検証とエラー レベル  
...
*  [SQL Server Data Tools のダウンロード](http://go.microsoft.com/fwlink/?LinkID=616714)  [SQL Server データ ツールの Reporting Services &#40;SSDT&#41;](../../reporting-services/tools/reporting-services-in-sql-server-data-tools-ssdt.md)   
