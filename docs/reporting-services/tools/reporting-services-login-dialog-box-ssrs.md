...
## <a name="options"></a>[変数]  
 **Server**  
 レポート サーバーの名前を表示します。 たとえば、 `https://localhost/reportserver`のようにします。 既定のポート 80 と異なるポートを使用するレポート サーバーの場合は、ポート番号を含めます。 たとえば、`https://localhost:81/reportserver` のようにします。  
