---
title: "日付の Analysis Services のモバイル レポートの書式設定を保持 |Reporting Services |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/07/2017
...
-  [Reporting Services モバイル レポート用のデータ](../../reporting-services/mobile-reports/data-for-reporting-services-mobile-reports.md)
