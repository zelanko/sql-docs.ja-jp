...
ms.topic: "article"
helpviewer_keywords: 
  - "個人用レポート フォルダーへのアクセスの拒否"
  - "プライベート フォルダー [Reporting Services]"
  - "ユーザー作業領域 [Reporting Services]"
  - "セキュリティ [Reporting Services], 個人用レポート フォルダー"
  - "個人用レポート フォルダー [Reporting Services]"
