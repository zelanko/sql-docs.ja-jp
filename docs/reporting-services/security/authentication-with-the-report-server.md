...
helpviewer_keywords: 
  ...
  - "接続 [Reporting Services], アカウント"
  - "Windows 認証 [Reporting Services]"
...
|[!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)]がカスタム認証のシナリオを処理できるようにします。|[カスタム認証クッキーを送信するように Web ポータルを構成する](http://msdn.microsoft.com/ja-jp/91aeb053-149e-4562-ae4c-a688d0e1b2ba)|  
