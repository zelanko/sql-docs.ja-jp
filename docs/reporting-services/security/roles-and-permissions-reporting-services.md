---
title: "ロールと権限 (Reporting Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "アクセス制御 [Reporting Services]"
  - "権限 [Reporting Services], 権限の概要"
  - "セキュリティ [Reporting Services], ID およびアクセス制御"
  - "認証 [Reporting Services]"
  - "権限 [Reporting Services]"
  - "セキュリティ [Reporting Services], ロールベース"
