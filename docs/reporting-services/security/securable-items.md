...
ms.topic: "article"
helpviewer_keywords: 
  - "セキュリティ保護可能なアイテム [Reporting Services]"
  - "ロール [Reporting Services], セキュリティ保護可能なアイテム"
  - "セキュリティ [Reporting Services], セキュリティ保護可能なアイテム"
  - "ロールベースのセキュリティ [Reporting Services], セキュリティ保護可能なアイテム"
