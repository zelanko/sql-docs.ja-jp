...
description: この記事では、レポート リソースの追加、選択、整理や、レポート アイテムのプロパティの変更に使用する、[レポート ビルダー] ウィンドウのコントロールについて明します。
ms.date: 03/01/2017
...
##  <a name="parameters-pane"></a><a name="Ribbon"></a> パラメーター ペイン  
...
##  <a name="the-report-part-gallery"></a><a name="ReptPartGallery"></a> レポート パーツ ギャラリー  
