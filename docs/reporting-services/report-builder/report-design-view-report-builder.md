...
##  <a name="Ribbon"></a> パラメーター ペイン  
 ...
 「レポート パラメーター (レポート ビルダーおよびレポート デザイナー)」の詳細は[ここ](../../reporting-services/report-design/report-parameters-report-builder-and-report-designer.md)にあります。  
...
##  <a name="ReptDataPane"></a> レポート データ ペイン  
