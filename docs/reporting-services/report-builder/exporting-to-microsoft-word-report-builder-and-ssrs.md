---
title: "Microsoft Word (レポート ビルダーおよび SSRS) へのエクスポート |Microsoft ドキュメント"
ms.custom: 
ms.date: 05/30/2017
