...
![レポート ビルダーの縦棒グラフを示すスクリーンショット。](../reporting-services/media/report-builder-column-chart-tutorial.png)    
> [!NOTE]  
...
6.  **[完了]** をクリックします。  
    ...
    ![デザイン ビューでのレポート ビルダーの縦棒グラフのスクリーンショット。](../reporting-services/media/report-builder-column-chart-1-design-view.png)
  
7.  グラフをクリックして、グラフのハンドルを表示します。 グラフの右下隅をドラッグして、グラフのサイズを大きくします。 レポート デザイン画面も、グラフ サイズに合わせて大きくなります。  
  
8.  **[実行]** をクリックして、レポートをプレビューします。  

    ![レポート ビルダーの縦棒グラフのプレビューを示すスクリーンショット。](../reporting-services/media/report-builder-column-chart-1-preview.png)
...
![その日付書式で表示されているレポート ビルダーの縦棒グラフのスクリーンショット。](../reporting-services/media/report-builder-column-chart-2-preview.png)
...
8.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
    ...
    ![レポート ビルダーの縦棒グラフのスクリーンショット。デザイン ビューで X 軸のテキストが回転しています。](../reporting-services/media/report-builder-column-chart-rotate-x-axis.png)
  
9. **[実行]** をクリックして、レポートをプレビューします。  
  
グラフでラベルが回転します。  

![レポート ビルダーの縦棒グラフのプレビューを示すスクリーンショット。X 軸のテキストが回転しています。](../reporting-services/media/report-builder-column-chart-rotate-x-axis-preview.png)
...
12. **[実行]** をクリックして、レポートをプレビューします。  
    ...
    ![レポート ビルダーの縦棒グラフの書式のプレビューを示すスクリーンショット。Y 軸のラベルが正しく付けられています。](../reporting-services/media/report-builder-column-chart-format-y-axis.png)
...
3. プロパティ ペインで、LabelInterval を 1 に設定します。
    ...
    ![レポート ビルダーの縦棒グラフでラベルの間隔を設定する方法を示すスクリーンショット。](../reporting-services/media/report-builder-column-chart-set-label-interval.png)

    グラフはデザイン ビューで同じに見えます。 
    
5.  **[実行]** をクリックして、レポートをプレビューします。

    ![レポート ビルダーの縦棒グラフのプレビューを示すスクリーンショット。ラベルの間隔が 1 に設定されています。](../reporting-services/media/report-builder-column-chart-label-interval-one-preview.png)
...
3.  **[値]** 領域の **[Sum(Sales)]** フィールドを右クリックし、 **[計算系列の追加]** をクリックします。  
     ...
     ![レポート ビルダーの縦棒グラフに計算系列を追加する方法を示すスクリーンショット。](../reporting-services/media/report-builder-column-chart-add-calculated-series.png)
...
![移動平均を示しているレポート ビルダーの縦棒グラフのスクリーンショット。](../reporting-services/media/report-builder-column-chart-moving-average.png)
