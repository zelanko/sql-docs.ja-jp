---
title: 詳細レポート (レポート ビルダー) | Microsoft Docs
description: レポート ビルダーで、元の概要レポートに含まれるアイテムに関する詳細を取得するためにレポート内のリンクを選択したときに開くドリルスルー レポートについて説明します。
ms.date: 03/07/2017
