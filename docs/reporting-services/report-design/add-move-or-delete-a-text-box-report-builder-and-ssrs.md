---
title: テキスト ボックスの追加、移動、または削除 (レポート ビルダー) | Microsoft Docs
description: レポート ビルダーで、テキスト ボックスをレポート本文に追加し、タイトル、パラメーターの選択肢、組み込みフィールド、日付などの情報を表示します。
ms.date: 03/01/2017
