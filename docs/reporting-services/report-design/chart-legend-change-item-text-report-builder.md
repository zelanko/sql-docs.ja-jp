---
title: 凡例アイテムのテキストの変更 (レポート ビルダー) | Microsoft Docs
description: レポート ビルダーで、凡例アイテムのテキストを変更して個々のデータ ポイントの詳細を表示する方法について説明します。
ms.date: 03/01/2017
