---
title: レポート デザインに関するヒント (レポート ビルダー) | Microsoft Docs
description: レポート ビルダーで視覚的にデザインし、データの表示を改善する方法について説明します。 自分のレポートを、グラフ、データ バー、インジケーター、スパークライン、テーブル、マップを使用してカスタマイズできます。
ms.date: 03/01/2017
