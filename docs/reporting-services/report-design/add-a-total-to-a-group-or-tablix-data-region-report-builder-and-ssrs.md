---
title: グループまたは Tablix に合計を追加する (レポート ビルダーおよび SSRS) | Microsoft Docs
description: SQL Server Reporting Services のページ分割されたレポートでは、グループまたはデータ領域全体の Tablix データ領域に合計を追加できます。
ms.date: 12/16/2019
