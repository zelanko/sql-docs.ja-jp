---
title: "軸の間隔 (レポート ビルダーおよび SSRS) を指定 |Microsoft ドキュメント"
ms.custom: 
ms.date: 09/02/2016
...
サンプル データでの軸の間隔を設定するのには、次を参照してください。[チュートリアル: レポート (レポート ビルダー) に縦棒グラフを追加](Tutorial:%20Add%20a%20Column%20Chart%20to%20Your%20Report%20\(Report%20Builder\).md)です。
