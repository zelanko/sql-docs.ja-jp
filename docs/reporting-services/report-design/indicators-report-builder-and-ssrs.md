...
|-------------------|--------------------|  
|![Rs_DirectionalIcons](../../reporting-services/report-design/media/rs-directionalicons.png "Rs_DirectionalIcons")|方向: 上向き、下向き、平坦 (変化なし)、上昇、または下降の矢印を使用して傾向を示します。|  
|![Rs_SymbolIcons](../../reporting-services/report-design/media/rs-symbolicons.png "Rs_SymbolIcons")|記号: チェックマークや感嘆符などの一般的な記号を使用して状態を示します。|  
|![Rs_ShapeIcons](../../reporting-services/report-design/media/rs-shapeicons.png "Rs_ShapeIcons")|図形: 交通標識や菱形などの一般的な図形を使用して条件を示します。|  
|![rs_RatingIcons](../../reporting-services/report-design/media/rs-ratingicons.png "rs_RatingIcons")|評価: 正方形の四分区間数など、連続する値を表示する一般的な図形および記号を使用して評価を示します。|  
