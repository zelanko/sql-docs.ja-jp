...
##  <a name="AddingList"></a> レポートへの一覧の追加  
 ...
 ![デザイン画面上の [新しい一覧] レポート アイテム](../../reporting-services/report-design/media/rs-listtemplatenew.png "デザイン画面上の [新しい一覧] レポート アイテム")  
...
##  <a name="DisplayingGrouping"></a> 単一グループ化レベルでのデータの表示  
 ...
 ![2 つのテーブルのある一���、一方はグラフ��入れ子](../../reporting-services/report-design/media/rs-basiclistgroupdesign.gif "2 つのテーブルのある一���、一方はグラフ��入れ子")  
 ...
 ![プレビュー、2 つのテーブル、一方はグラフが入れ子](../../reporting-services/report-design/media/rs-basiclistgrouppreview.gif "プレビュー、2 つのテーブル、一方はグラフが入れ子")  
