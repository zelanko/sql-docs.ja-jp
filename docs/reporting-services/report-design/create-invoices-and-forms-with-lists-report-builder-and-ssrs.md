...
##  <a name="adding-a-list-to-your-report"></a><a name="AddingList"></a> レポートへの一覧の追加  
...
##  <a name="displaying-data-with-one-level-of-grouping"></a><a name="DisplayingGrouping"></a> 単一グループ化レベルでのデータの表示  
 ...
 ![2 つのテーブルが含まれるリスト、一方はグラフが入れ子](../../reporting-services/report-design/media/rs-basiclistgroupdesign.gif "2 つのテーブルが含まれるリスト、一方はグラフが入れ子")  
