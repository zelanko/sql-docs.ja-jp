...
description: レポート ビルダーでユーザーが、レポートに含まれるテーブルまたはマトリックスのグループに関連付けられているアイテム、行、列を展開したり、折りたたんだりできるようにします。
ms.date: 12/19/2019
...
1.  レポート デザイン ビューで、レポート アイテムを右クリックして表示または非表示にし、 *[\<report item>* **のプロパティ]** をクリックします。 レポート アイテムの *[\<report item>* **のプロパティ]** ダイアログ ボックスが表示されます。  
