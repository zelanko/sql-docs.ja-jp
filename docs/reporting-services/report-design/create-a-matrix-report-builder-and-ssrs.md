---
title: "マトリックス (レポート ビルダーおよび SSRS) を作成 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/07/2017
...
>  このウィザードは、 [!INCLUDE[ssRBDenali](../../includes/ssrbdenali-md.md)]でのみ使用できます。  
 ...
 ![1 つの行と 1 つの列グループのマトリックスの空白](../../reporting-services/report-design/media/rs-matrixtemplatenew.gif "1 行と 1 つの列グループを含む空のマトリックス")  
...
-   新しい列に、レポート データセットからの既定のデータ行を示す行グループ セルが 1 つ表示されます。 この行の Tablix 本体に含まれているセルは、この行グループのメンバーになります。 列グループが定義されている場合、列に含まれているセルは、それらの列グループのメンバーになります。 各セルのグループ メンバーシップは、グループ インジケーターによって視覚的に判断できます。  
 ...
 ![マトリックス、入れ子になった行および列グループと合計](../../reporting-services/report-design/media/rs-basicmatrixnestedgroupstotalsdesign.gif "行と列グループと合計がマトリックスに入れ子になった")  
  
 プレビュー モードでは、レポートが次の図のように表示されます。  
  
 ![プレビュー内のグループを入れ子になった](../../reporting-services/report-design/media/rs-basicmatrixnestedgroupstotalspreview.gif "プレビュー内のグループを入れ子になった")  
...
## <a name="see-also"></a>参照  
 [集計関数リファレンス &#40;です。レポート ビルダーおよび SSRS &#41;](../../reporting-services/report-design/report-builder-functions-aggregate-functions-reference.md)   
