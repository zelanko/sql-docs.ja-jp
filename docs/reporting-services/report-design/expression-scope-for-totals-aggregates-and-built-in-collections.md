---
title: "式の合計、集計、および組み込みコレクションのスコープ |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/07/2017
