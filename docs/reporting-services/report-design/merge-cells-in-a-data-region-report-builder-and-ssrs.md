---
title: データ領域内のセルの結合 (レポート ビルダー) | Microsoft Docs
description: レポート ビルダーで、データ領域内のセルを結合することで、セルを組み合わせたり、データ領域の外観を改善したり、複数の列グループおよび行グループにまたがるラベルを指定したりする方法について説明します。
ms.date: 03/01/2017
