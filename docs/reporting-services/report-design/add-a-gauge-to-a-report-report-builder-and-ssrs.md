---
title: レポートへのゲージの追加 (レポート ビルダー) | Microsoft Docs
description: レポート ビルダーで、ゲージ データ領域を作成し、そのゲージのウィンドウにレポート データセット フィールドをドラッグして、ビジュアル形式でデータを集計する方法について説明します。
ms.date: 03/01/2017
