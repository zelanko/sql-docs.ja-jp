---
title: ゲージへの最小値または最大値の設定 (レポート ビルダー) | Microsoft Docs
description: ページ分割されたレポートでゲージとグラフがどのように違うかについて説明します。 レポート ビルダーでは、スケールの最小値と最大値を定義します。
ms.date: 03/01/2017
