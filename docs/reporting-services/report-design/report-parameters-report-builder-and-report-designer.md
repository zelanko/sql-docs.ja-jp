...
## <a name="viewing-a-report-with-parameters"></a><a name="UserInterface"></a> パラメーターを持つレポートの表示
...
**パラメーターを持つデータセット クエリまたはストアド プロシージャ**
 ...
 ![レポート ビルダー パラメーターのデータセットのプロパティ](../../reporting-services/report-design/media/ssrb-paramdatasetprops.png "レポート ビルダー パラメーターのデータセットのプロパティ")  
...
## <a name="report-parameter-properties"></a><a name="bkmk_Report_Parameters"></a> レポート パラメーター プロパティ
...
##  <a name="related-sections"></a><a name="bkmk_Related_Topics"></a> 関連項目  
