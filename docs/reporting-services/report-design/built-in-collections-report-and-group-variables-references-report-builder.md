---
title: "レポート ファイルとグループ変数コレクションの参照 (レポート ビルダーおよび SSRS) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="built-in-collections---report-and-group-variables-references-report-builder"></a>組み込みコレクションのレポートとグループ変数参照 (レポート ビルダー)
