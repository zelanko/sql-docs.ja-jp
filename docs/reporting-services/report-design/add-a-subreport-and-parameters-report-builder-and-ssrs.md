---
title: サブレポートおよびパラメーターの追加 (レポート ビルダー) | Microsoft Docs
description: サブレポートを追加する方法について説明します。 レポート ビルダーで、複数の関連レポートのコンテナーとしてメイン レポートを作成するとき、サブレポートを使用します。
ms.date: 03/01/2017
