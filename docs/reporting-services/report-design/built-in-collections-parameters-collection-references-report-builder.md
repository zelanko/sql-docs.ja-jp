...
description: 式でパラメーターを使用し、レポート ビルダーのユーザー選択に基づき、レポート データや外観をカスタマイズする方法について説明します。
ms.date: 03/07/2017
