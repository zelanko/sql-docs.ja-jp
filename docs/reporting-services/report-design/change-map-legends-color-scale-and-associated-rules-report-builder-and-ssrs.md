---
title: "マップの凡例、カラー スケールに関連付けられているルール SSRS でレポート ビルダーでの変更 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/07/2017
...
1.  デザイン ビューで凡例を右クリックし、開く、 *\<レポート アイテム >***プロパティ**ページ。  
  
2.  **[位置]**で、ビューポートを基準とする凡例の相対的な表示位置をクリックします。  
  
3.  ビューポートの外に凡例を表示する選択**表示\<レポート アイテム > ビューポートの外側**です。  
...
2.  をクリックしたデータを含むレイヤーを右クリックして*\<要素の型をマップ >***色ルール**です。  
...
2.  をクリックするデータを含むレイヤーを右クリックして*\<要素の型をマップ >***色ルール**です。  
...
3.  選択、**を使用してデータを視覚化**\<規則の種類 > オプション。 分布オプションを使用するには、レイヤーに関連付けられている分析データに基づき、 **[分布]** ページで範囲を作成する必要があります。  
...
2.  をクリックするデータを含むレイヤーを右クリックして*\<要素の型をマップ >***ルール**です。  
  
3.  いることを確認**を使用してデータを視覚化** \<*規則の種類*> を選択します。  
...
3.  使用する色ルールを選択します。 項目を表示するマップの凡例またはカラー スケールのいずれかを選択する必要があります、**を使用してデータを視覚化**\<規則の種類 > オプション。  
