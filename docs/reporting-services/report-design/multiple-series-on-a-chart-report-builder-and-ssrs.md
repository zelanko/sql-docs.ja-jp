---
title: グラフ上の複数の系列 (レポート ビルダー) | Microsoft Docs
description: 価格と売買高または収入と税金など、関連する 2 つのデータ系列をレポート ビルダーで表示する場合、複数の系列を 1 つのグラフで使用する方法について説明します。
ms.date: 03/07/2017
