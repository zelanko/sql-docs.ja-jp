...
これで、レポートのデータを取得するクエリを指定できました。 次に、レポートのレイアウトを作成します。 参照してください[レッスン 4: レポート &#40; をテーブルの追加Reporting Services &#41;](../reporting-services/lesson-4-adding-a-table-to-the-report-reporting-services.md).  
