---
title: "表示拡張機能 (Reporting Services) のデバイス情報設定 |Microsoft ドキュメント"
ms.custom:
- SQL2016_New_Updated
ms.date: 09/15/2015
...
|[PDF デバイス情報設定](../reporting-services/pdf-device-information-settings.md)|PDF 表示出力に関連するデバイス情報設定について説明します。|  
