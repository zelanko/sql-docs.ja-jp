...
|インターネット インフォメーション サービス (IIS)|[レコードとストリーム](../../ado/guide/data/records-and-streams.md)<br /><br /> [ストリームと永続性](../../ado/guide/data/streams-and-persistence.md)<br /><br /> [コマンド ストリーム](../../ado/guide/data/command-streams.md)<br /><br /> [インターネットへの発行に ADO を使用する](../../ado/guide/data/using-ado-for-internet-publishing.md)<br /><br /> [リモート データ アクセスのソリューション](../../ado/guide/remote-data-service/solutions-for-remote-data-access.md)<br /><br /> [RDS のシナリオ](../../ado/guide/remote-data-service/rds-scenario.md)<br /><br /> [IIS での仮想サーバーの構成](../../ado/guide/remote-data-service/configuring-virtual-servers-on-iis.md)<br /><br /> [RDS アプリケーションの保護](../../ado/guide/remote-data-service/securing-rds-applications.md)<br /><br /> ["インターネットサーバーエラー: アクセスが拒否されました"](../../ado/guide/remote-data-service/internet-server-error-access-denied.md)<br /><br /> [Microsoft OLE DB Provider for Internet Publishing](../../ado/guide/appendixes/microsoft-ole-db-provider-for-internet-publishing.md)<br /><br /> [インターネット インフォメーション サービスのエラー コード](../../ado/guide/appendixes/internet-information-services-error-codes.md)|
|JScript|[他の言語でのエラーの処理](../../ado/guide/data/handling-errors-in-other-languages.md)<br /><br /> [JScript での ADO プログラミング](../../ado/guide/appendixes/jscript-ado-programming.md)<br /><br /> [Microsoft JScript での ADO のコード例](../../ado/reference/ado-api/ado-code-examples-in-microsoft-jscript.md)|
