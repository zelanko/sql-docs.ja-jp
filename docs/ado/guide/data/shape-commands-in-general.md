...
-   [集計関数、CALC 関数と NEW キーワード](../../../ado/guide/data/aggregate-functions-the-calc-function-and-the-new-keyword.md)  
  
-   [基になるデータ プロバイダーにコマンドを発行します。](../../../ado/guide/data/issuing-commands-to-the-underlying-data-provider.md)
