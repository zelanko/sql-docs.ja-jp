...
-   [接続オブジェクトを使用します。](../../../ado/guide/data/using-a-connection-object.md)  
  
-   [レコード セット オブジェクトの使用](../../../ado/guide/data/using-a-recordset-object.md)  
  
-   [接続文字列の作成](../../../ado/guide/data/creating-a-connection-string.md)  
  
-   [接続のプロパティを指定します。](../../../ado/guide/data/specifying-connection-properties.md)  
