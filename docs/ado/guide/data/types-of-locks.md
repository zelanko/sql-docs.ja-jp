...
## <a name="adlockoptimistic"></a>adLockOptimistic  
 プロバイダーがオプティミスティック ロックを使用することを示します: レコードのロックを呼び出すときにのみ、 **Update**メソッド。 レコードとを呼び出したときに編集する別のユーザーが、時間の間でデータを変更することがあります可能性があることを意味**Update**、これにより、競合が発生します。 競合が発生する可能性が不足している状況でこの種類のロックを使用して、または競合がすぐに解決できます。  
