...
-   [ハンドラー プロパティの使用例](../../../ado/reference/rds-api/handler-property-example-vb.md)  
  
-   [InternetTimeout プロパティの使用例](../../../ado/reference/rds-api/internettimeout-property-example-vb.md)
