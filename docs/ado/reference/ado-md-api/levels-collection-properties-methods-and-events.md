---
title: コレクションのプロパティ、メソッド、およびイベントのレベル |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "35284002"
---
# <a name="levels-collection-properties-methods-and-events"></a>レベルのコレクションのプロパティ、メソッド、およびイベント
