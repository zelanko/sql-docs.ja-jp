---
title: 軸の例 (VBScript) |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "35283401"
---
# <a name="axis-example-vbscript"></a>軸の例 (VBScript)
このアクティブ サーバー ページでは、MDX クエリ文字列の OLAP データを表示し、結果のセル セットを HTML テーブル構造に書き込みます。  
