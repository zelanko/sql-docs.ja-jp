---
title: オブジェクトのプロパティ、メソッド、およびイベントの位置 |Microsoft ドキュメント
ms.prod: sql
...
---
# <a name="position-object-properties-methods-and-events"></a>オブジェクトのプロパティ、メソッド、およびイベントを位置します。
## <a name="propertiescollections"></a>プロパティ/コレクション  
 [メンバーのコレクション](../../../ado/reference/ado-md-api/members-collection-ado-md.md)  
  
 [序数に基づくプロパティ (位置)](../../../ado/reference/ado-md-api/ordinal-property-ado-md-position.md)  
