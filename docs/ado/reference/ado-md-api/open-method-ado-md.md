 ...
 *Source*  
 任意。 A**バリアント**多次元式 (MDX) クエリなどの有効な多次元クエリを評価します。 *ソース*引数に対応、[ソース](../../../ado/reference/ado-md-api/source-property-ado-md.md)プロパティ。 MDX の詳細については、次を参照してください。、 [OLE DB のオンライン分析処理 (OLAP)](http://msdn.microsoft.com/8a7673c6-3ca1-4411-9f1e-adf1e47df4f3) Microsoft Data Access Components SDK のドキュメント。  
