---
title: "コレクションのプロパティ、メソッド、およびイベントをディメンション |Microsoft ドキュメント"
...
---
# <a name="dimensions-collection-properties-methods-and-events"></a>ディメンションのコレクションのプロパティ、メソッド、およびイベント
