---
title: 階層オブジェクトのプロパティ、メソッド、およびイベント |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "35283921"
---
# <a name="hierarchy-object-properties-methods-and-events"></a>階層オブジェクトのプロパティ、メソッド、およびイベント
