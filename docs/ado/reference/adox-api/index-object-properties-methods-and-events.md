---
title: オブジェクトのプロパティ、メソッド、およびイベントのインデックスを作成 |Microsoft ドキュメント
ms.prod: sql
...
---
# <a name="index-object-properties-methods-and-events"></a>インデックス オブジェクトのプロパティ、メソッド、およびイベント
## <a name="propertiescollections"></a>プロパティ/コレクション  
 ...
 [一意のプロパティ](../../../ado/reference/adox-api/unique-property-adox.md)  
