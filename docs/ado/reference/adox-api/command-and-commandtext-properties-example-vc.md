---
title: コマンドと CommandText プロパティの例 (vc++) |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "35285397"
---
# <a name="command-and-commandtext-properties-example-vc"></a>コマンドと CommandText プロパティの例 (vc++)
