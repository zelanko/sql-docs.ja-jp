---
title: メソッドを追加、プロパティの例 (vc++) という名前の列とテーブル |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "35285311"
---
# <a name="columns-and-tables-append-methods-name-property-example-vc"></a>列とテーブルの追加メソッド、プロパティの使用例の名前 (vc++)
