---
title: エラー オブジェクトのプロパティ、メソッド、およびイベント |Microsoft ドキュメント
ms.prod: sql
...
---
# <a name="error-object-properties-methods-and-events"></a>エラー オブジェクトのプロパティ、メソッド、およびイベント
## <a name="properties"></a>プロパティ  
 ...
 [以下のプロパティ](../../../ado/reference/ado-api/nativeerror-property-ado.md)  
