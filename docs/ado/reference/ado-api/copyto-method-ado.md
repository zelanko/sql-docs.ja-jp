 ...
 *NumChars*  
 任意。 **整数**バイトまたはソース内の現在位置からコピーする文字の数を指定する値**Stream**先に**Stream**します。 既定値は – 1 は、すべての文字またはバイト数を現在の位置からコピーされるように指定[EOS](../../../ado/reference/ado-api/eos-property.md)します。  
  
## <a name="remarks"></a>コメント  
 このメソッドは文字またはバイト単位で指定された現在の位置からの指定した数をコピー、[位置](../../../ado/reference/ado-api/position-property-ado.md)プロパティ。 指定した数が利用できるまでのバイト数よりも多い場合**EOS**、し、文字またはバイトのみに現在位置から**EOS**コピーされます。 場合の値*NumChars* -1、または省略すると、すべての文字または現在位置から始まるバイトをコピーします。  
