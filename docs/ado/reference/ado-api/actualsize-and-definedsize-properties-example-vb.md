---
title: "ActualSize と DefinedSize プロパティの例 (VB) |Microsoft ドキュメント"
...
---
# <a name="actualsize-and-definedsize-properties-example-vb"></a>ActualSize と DefinedSize プロパティの例 (VB)
