...
## <a name="settings-and-return-values"></a>設定と戻り値  
 設定または取得を[格納](../../../ado/reference/ado-api/datatypeenum.md)値。  
  
## <a name="remarks"></a>コメント  
 **パラメーター** 、オブジェクト、**型**読み取り/書き込みプロパティです。 新しい**フィールド**に追加されたオブジェクト、[フィールド](../../../ado/reference/ado-api/fields-collection-ado.md)のコレクションを[レコード](../../../ado/reference/ado-api/record-object-ado.md)、**型**後にのみ読み取り/書き込みは、[値](../../../ado/reference/ado-api/value-property-ado.md)プロパティを**フィールド**が指定されているデータ プロバイダーからその新しいが正常に追加し、**フィールド**呼び出すことによって、[更新](../../../ado/reference/ado-api/update-method.md)のメソッド、**フィールド**コレクション。  
