---
title: 'レコード (Visual C++ 構文のインデックス #import) |Microsoft ドキュメント'
ms.prod: sql
...
ms.locfileid: "35280841"
---
# <a name="record-visual-c-syntax-index-with-import"></a>レコード (Visual C++ 構文のインデックス #import)
