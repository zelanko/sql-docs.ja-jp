---
title: NumericScale と有効桁数のプロパティの例 (vc++) |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "35279901"
---
# <a name="numericscale-and-precision-properties-example-vc"></a>NumericScale と (vc++) の有効桁数のプロパティの例
