---
title: "準備ができているプロパティの例 (vc++) |Microsoft ドキュメント"
...
---
# <a name="prepared-property-example-vc"></a>準備済みのプロパティの例 (vc++)
...
## <a name="see-also"></a>参照  
 ...
 [準備済みのプロパティ (ADO)](../../../ado/reference/ado-api/prepared-property-ado.md)
