---
title: 'RecordsetEvents (Visual C++ 構文のインデックス #import) |Microsoft ドキュメント'
ms.prod: sql
...
ms.locfileid: "35281281"
---
# <a name="recordsetevents-visual-c-syntax-index-with-import"></a>RecordsetEvents (Visual C++ 構文のインデックス #import)
