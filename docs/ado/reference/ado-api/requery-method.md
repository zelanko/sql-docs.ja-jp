 ...
 *オプション*  
 省略可能。 この操作に影響を与える[Executeoptionenum](../../../ado/reference/ado-api/executeoptionenum.md)値および[commandtypeenum](../../../ado/reference/ado-api/commandtypeenum.md)値を含むビットマスク。  
