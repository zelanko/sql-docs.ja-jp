---
title: UpdateBatch と CancelBatch メソッドの例 (vc++) |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "35282861"
---
# <a name="updatebatch-and-cancelbatch-methods-example-vc"></a>UpdateBatch と CancelBatch メソッドの例 (vc++)
