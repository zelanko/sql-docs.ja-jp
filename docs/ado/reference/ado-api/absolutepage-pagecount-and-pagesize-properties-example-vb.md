---
title: AbsolutePage、PageCount、および PageSize のプロパティの例 (VB) |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "35274921"
---
# <a name="absolutepage-pagecount-and-pagesize-properties-example-vb"></a>AbsolutePage、PageCount、および PageSize のプロパティの例 (VB)
```  
'BeginAbsolutePageVB  
