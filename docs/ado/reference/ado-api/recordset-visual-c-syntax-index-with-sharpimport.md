---
title: 'レコード セット (Visual C++ 構文のインデックス #import) |Microsoft ドキュメント'
ms.prod: sql
...
ms.locfileid: "35281201"
---
# <a name="recordset-visual-c-syntax-index-with-import"></a>レコード セット (Visual C++ 構文のインデックス #import)
