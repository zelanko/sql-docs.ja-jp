---
title: 追加する方法の例を CreateParameter (vc++) |Microsoft ドキュメント
ms.prod: sql
...
ms.locfileid: "35275771"
---
# <a name="append-and-createparameter-methods-example-vc"></a>追加する方法の例を CreateParameter (vc++)
