...
## <a name="propertiescollections"></a>プロパティ/コレクション  
 ...
 [プロバイダーのプロパティ](../../../ado/reference/ado-api/provider-property-ado.md)  
  
 [State プロパティ](../../../ado/reference/ado-api/state-property-ado.md)  
  
 [Version プロパティ](../../../ado/reference/ado-api/version-property-ado.md)  
  
## <a name="methods"></a>メソッド  
 [BeginTrans、CommitTrans、および RollbackTrans メソッド](../../../ado/reference/ado-api/begintrans-committrans-and-rollbacktrans-methods-ado.md)  
