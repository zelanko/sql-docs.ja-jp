...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Azure VM と SQL Server の取得</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Microsoft SQL ドキュメント</h1>
        <ul class="pivots">
            <li>
                                  ...
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              ...
                                              <ul class="noBullet">
                                              <li><a class="barLink" href="/sql/sql-server/sql-server-technical-documentation?toc=../toc/toc.json"><strong>オンプレミス</strong></a></li>
                                              ...
                                              <li><a class="barLink" href="/sql/sql-server/what-s-new-in-sql-server-ver15/"><strong>新機能</strong></a></li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>
                                      ...
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              ...
                                              <ul class="noBullet">
                                                  ...
                                                  <li><a class="barLink" href="https://azure.microsoft.com/updates/?status=all&product=sql-database"><strong>新機能</strong></a></li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/sql/linux/sql-server-linux-whats-new/"><strong>新機能</strong></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>インストールまたはアップグレード</h3>
                                                          <p>まず、SQL Server とそれに関連付けられているサービスのインストールとアップグレードの方法を詳しく説明するドキュメントを参照します。</p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>ビジネス継続性</h3>
                                                          <p><b>高可用性、ディザスター リカバリー、Always On 可用性グループ、Always On フェールオーバー クラスター インスタンス、データベース ミラーリング、バックアップと復元</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Security</h3>
                                                          <p><b>アクセス許可、アクセス管理、Always Encrypted、TDE、SSL</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>管理、監視、チューニング</h3>
                                                          <p><b>メンテナンス プラン、SQL Profiler、自動チューニング、インメモリ OLTP、パーティション、統計、インデックス、カーディナリティ推定 </b>  </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>データの移行、読み込み、移動</h3>
                                                          <p><b>Migration Assistant、Integration Services (SSIS)、インポートおよびエクスポート ウィザード、レプリケーション </b> </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>SQL Server について</h3>
                                                          <p>一連のガイドとチュートリアルを使用して、SQL Server の内部アーキテクチャについて学習します。 </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                  <div class="cardText">
                                                        <h3>デザイン</h3>
                                                        <ul class="noBullet">
                                                          <li><a class="barLink" href="/sql/relational-databases/database-features/">リレーショナル データベースの概念</a></li>
                                                            <li><a class="barLink" href="/sql/connect/homepage-sql-connection-programming/">オンプレミスのクライアント アプリケーションとの接続</a></li>
                                                            <li><a class="barLink" href="/azure/sql-database/sql-database-libraries">Azure SQL DB 接続ライブラリ</a></li>
                                                            <li><a class="barLink" href="https://docs.microsoft.com/azure/sql-database/sql-database-develop-overview">Azure SQL DB アプリケーション</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li><a class="barLink" href="/sql/tools/overview-sql-tools">その他の SQL ツール</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cardSize">
                                            <div class="cardPadding">
                                                ...
                                                <ul class="noBullet">
                                                     ...
                                                     <li><a class="barLink" href="/sql/samples/sql-samples-where-are/">データベースのサンプル</a></li>
                                                     <li><a class="barLink" href="/previous-versions/sql/">アーカイブ コンテンツ (SQL 2005 から 2012)</a></li>
                                                </ul></td></tr></table>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                  <div class="cardText">
                                                        <h3>レポーティング</h3>
                                                        <ul class="noBullet">
                                                             <li><a class="barLink" href="/sql/reporting-services/create-deploy-and-manage-mobile-and-paginated-reports/">SQL Server Reporting Services (SQL Server Reporting Services)</a></li>
                                                            <li><a class="barLink" href="/power-bi/service-get-started/">Power BI サービス</a></li>
                                                            <li><a class="barLink" href="/power-bi/report-server/get-started/">Power BI レポート サーバー</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <li><a class="barLink" href="/sql/analytics-platform-system/">Microsoft Analytics Platform System</a></li>
                                                            ...
                                                            <li><a class="barLink" href="/sql/relational-databases/polybase/polybase-guide/">PolyBase</a></li>                                                            <li><a class="barLink" href="/sql/big-data-cluster/big-data-cluster-overview/">SQL Server 2019 のビッグ データ クラスター</a></li>
                                                       </ul>
                                                    </div>
                                                </div>
                                            </div>
