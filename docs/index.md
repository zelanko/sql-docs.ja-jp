                             ...
                             <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3 class="bgdAccent1" style="padding:20px;">データベース</h3>
                                                <h4>SQL</h4>
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="https://docs.microsoft.com/en-us/previous-versions/sql/">以前の SQL Server バージョン (2005 - 2012)</a></li>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3 class="bgdAccent1" style="padding:20px;">開発</h3>
                                                <h4>デザイン</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/sql/connect/homepage-sql-connection-programming">クライアント アプリケーションとの接続</a></li>
                                                    <li><a class="barLink" href="/sql/relational-databases/database-features">リレーショナル データベースの概念</a></li>
                                                    <li><a class="barLink" href="/sql/relational-databases/security">SQL セキュリティ</a></li>
                                                </ul>
                                                <h4>ツール</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/sql/sql-operations-studio/download">SQL Operations Studio <sup>プレビュー</sup></a></li>   <li><a class="barLink" href="/sql/ssms/download-sql-server-management-studio-ssms">SQL Server Management Studio (SSMS)</a></li>
                                                    <li><a class="barLink" href="/sql/ssdt/download-sql-server-data-tools-ssdt">SQL Server Data Tools (SSDT)</a></li>
                                                    <li><a class="barLink" href="/sql/tools/overview-sql-tools">すべての SQL ツールを参照</a></li>
                                                </ul>
                                                <h4>リファレンス</h4>
                                                <ul class="noBullet">
                                                ...
                                                <h4>サンプル</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="https://github.com/Microsoft/sql-server-samples/tree/master/samples">GitHub のコード サンプル</a></li>
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="https://powerbi.microsoft.com/en-us/documentation/powerbi-service-get-started/">Power BI サービス</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
