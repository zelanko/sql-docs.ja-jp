                                  ...
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              ...
                                              <ul class="noBullet">
                                              <li><a class="barLink" href="/sql/sql-server/sql-server-technical-documentation/"><strong>オンプレミス</strong></a></li>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>管理、監視、チューニング</h3>
                                                          <p><b>メンテナンス プラン、SQL Profiler、自動調整、インメモリ OLTP で、パーティション、統計、インデックス、カーディナリティ推定 </b>  </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
