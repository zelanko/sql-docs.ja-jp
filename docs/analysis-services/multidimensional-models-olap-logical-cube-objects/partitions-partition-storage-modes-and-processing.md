...
ms.locfileid: "62640462"
---
# <a name="partitions---partition-storage-modes-and-processing"></a>パーティション - パーティションのストレージ モードおよび処理
...
-   パーティションが使用するメジャーを含めることはできません、 **Min**または**最大**集計関数。  
