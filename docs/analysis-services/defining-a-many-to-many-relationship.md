...
10. **[テーブル]** ペインで **[InternetSalesReason (dbo.FactInternetSalesReason)]** を右クリックし、**[データの探索]** をクリックします。  
    ...
    ![商品の購入動機を識別するためのキー値](../analysis-services/media/l5-many-to-many-1.png "商品の購入動機を識別するためのキー値")  
...
12. **Sales Reason** ディメンションのディメンション デザイナーの **[属性]** ペインで **[Sales Reason Key]** をクリックします。次に、[プロパティ] ウィンドウで、**Name** プロパティを **Sales Reason** に変更します。  
...
4.  **[中間メジャー グループ]** ボックスの一覧で **[Internet Sales Reason]** を選択します。  
    ...
    ![[リレーションシップの定義] ダイアログ ボックス](../analysis-services/media/l5-many-to-many-3.gif "[リレーションシップの定義] ダイアログ ボックス")  
...
2.  配置が正常に完了したら、[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial キューブのキューブ デザイナーで **[ブラウザー]** タブに切り替え、**[再接続]** をクリックします。  
...
6.  **Sales Reason Type** レベルの各メンバーを展開し、クイーンズランドの顧客がインターネット経由で [!INCLUDE[ssSampleDBCoShort](../includes/sssampledbcoshort-md.md)] 製品を購入した理由と、その売上金額を確認します。  
    ...
    ![キューブ デザイナーの [フィルター] ペインと [データ] ペイン](../analysis-services/media/l5-many-to-many-5.gif "キューブ デザイナーの [フィルター] ペインと [データ] ペイン")  
  
## このレッスンの次の作業  
[メジャー グループでのディメンション粒度の定義](../analysis-services/defining-dimension-granularity-within-a-measure-group.md)  
...
[多対多リレーションシップと多対多リレーションシップのプロパティの定義](../analysis-services/multidimensional-models/define-a-many-to-many-relationship-and-many-to-many-relationship-properties.md)  
