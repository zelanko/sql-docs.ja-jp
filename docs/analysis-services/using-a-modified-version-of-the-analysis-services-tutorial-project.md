---
title: "Analysis Services チュートリアル プロジェクトの修正バージョンの使用 | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
## このレッスンの次の作業  
[親子階層の親属性プロパティの定義](../analysis-services/defining-parent-attribute-properties-in-a-parent-child-hierarchy.md)  
