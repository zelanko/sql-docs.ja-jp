...
6.  **[Components]** を展開します。**Model Name** レベルのメンバーのうち、ラベルが付いていないメンバーを展開します。  
    ...
    ![他の部品を組み立てるのに使用するアセンブリ部品](../analysis-services/media/l4-productdimensionerrorconfig-2.gif "他の部品を組み立てるのに使用するアセンブリ部品")  
  
## スノーフレーク テーブルおよび Product Category ユーザー定義階層の属性の定義  
  
1.  [!INCLUDE[ssSampleDBCoShort](../includes/sssampledbcoshort-md.md)] DW データ ソース ビューのデータ ソース ビュー デザイナーを開き、**[ダイアグラム オーガナイザー]** ペインで **[Reseller Sales]** を選択します。次に、[!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] の **[データ ソース ビュー]** メニューの **[オブジェクトの追加と削除]** をクリックします。  
...
5.  [!INCLUDE[ssBIDevStudio](../includes/ssbidevstudio-md.md)] の **[書式]** メニューで **[自動レイアウト]** をポイントし、**[ダイアグラム]** をクリックします。  
...
4.  SELECT DISTINCT クエリをクリックし、**[詳細表示]** をクリックします。  
    ...
    ![SELECT DISTINCT 句に含まれた WHERE 句](../analysis-services/media/l4-productnametraceline-1.gif "SELECT DISTINCT 句に含まれた WHERE 句")  
