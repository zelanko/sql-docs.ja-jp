---
title: "ブックが保存されている信頼できる場所で、外部データ接続が許可されていません。 以下の接続を更新できませんでした: Power Pivot データ | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
manager: "erikre"
---
# ブックが保存されている信頼できる場所で、外部データ接続が許可されていません。 以下の接続を更新できませんでした: Power Pivot データ
