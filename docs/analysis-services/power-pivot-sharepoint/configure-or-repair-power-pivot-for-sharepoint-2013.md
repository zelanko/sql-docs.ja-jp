---
title: "PowerPivot for SharePoint 2013 の構成または修復 (Power Pivot 構成ツール) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|**[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] サービス アプリケーションの作成**|サービス アプリケーション名|既定値|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] サービス アプリケーション名。既定の名前は "**既定の [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] サービス アプリケーション**" です。 ツールで別の値に置き換えることができます。|  
...
1.  SharePoint 2013 サイトで、設定アイコン ![SharePoint の設定](../../analysis-services/media/as-sharepoint2013-settings-gear.png "SharePoint の設定")、**[サイトの設定]** の順にクリックします。  
...
-   [Power Pivot in Excel 2013 の新機能](http://office.microsoft.com/excel-help/whats-new-in-powerpivot-in-excel-2013-HA102893837.aspx?CTT=1) (http://office.microsoft.com/excel-help/whats-new-in-powerpivot-in-excel-2013-HA102893837.aspx?CTT=1)  
...
### SharePoint モードの Analysis Services サーバーの追加  
