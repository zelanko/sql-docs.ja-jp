---
title: "ブックのデータ接続パスがローカル ドライブ上のファイルを指しているか、無効な URI です。 以下の接続を更新できませんでした: Power Pivot データ | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
manager: "erikre"
---
# ブックのデータ接続パスがローカル ドライブ上のファイルを指しているか、無効な URI です。 以下の接続を更新できませんでした: Power Pivot データ
