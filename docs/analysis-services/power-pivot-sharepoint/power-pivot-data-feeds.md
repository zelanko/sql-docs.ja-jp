...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]データ フィードは、クライアント アプリケーションに、オンライン データ ソースからの要求時にデータのストリームを提供します。 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]では、データ フィードを使用して、Atom 対応の Web サービスまたはアプリケーションから Excel ブックの [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] データ ソースにデータを追加できます。  
