---
title: "ドリルスルー アクションの定義と使用 | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
2.  **[アクション]** タブのツール バーで **[新しいドリルスルー アクション]** ボタンをクリックします。  
    ...
    ![表示ペインの空白のアクション テンプレート](../analysis-services/media/l8-action2.gif "表示ペインの空白のアクション テンプレート")  
...
7.  売上高を右クリックし、**[追加アクション]** をポイントして、**[Drillthrough to Order Details]** をクリックします。  
    ...
    ![Adam Powell 氏に出荷された注文](../analysis-services/media/l8-action6.gif "Adam Powell 氏に出荷された注文")  
...
9. [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial キューブのキューブ デザイナーを開き、**[アクション]** タブに切り替えます。  
...
2.  配置が正常に完了したら、[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial キューブのキューブ デザイナーで **[ブラウザー]** タブに切り替え、**[再接続]** ボタンをクリックします。  
...
5.  **Internet Sales-Sales Amount** データ セルをクリックし、**[追加アクション]** をポイントして、**[Drillthrough to Order Details]** をクリックします。  
    ...
    ![Adam Powell 氏に出荷された注文](../analysis-services/media/l8-action8.gif "Adam Powell 氏に出荷された注文")  
...
[ファクト リレーションシップの定義](../analysis-services/defining-a-fact-relationship.md)  
