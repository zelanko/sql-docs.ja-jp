---
title: "ディメンションに対する権限の付与 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  - "ディメンション [Analysis Services], セキュリティ"
  - "読み取り/書き込み権限"
  - "ユーザー アクセス権 [Analysis Services], ディメンション"
  - "権限 [Analysis Services], ディメンション"
...
2.  **[ディメンション]** ペインで、ディメンション セットを \<cube-name> **[キューブ ディメンション]** に変更します。  
