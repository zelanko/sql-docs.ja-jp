---
title: "多次元モデルの Power View について | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
 ...
 **多次元モデルの Power View のアーキテクチャ**  
 ...
 ![多次元モデル アーキテクチャの Power View](../../analysis-services/multidimensional-models/media/daxmd-architecture.gif "多次元モデル アーキテクチャの Power View")  
 ...
 **Power View のフィールド リスト内のメジャー グループ**  
 ...
 ![Power View のフィールド リスト](../../analysis-services/multidimensional-models/media/daxmd-powerviewfieldlist.gif "Power View のフィールド リスト")  
 ...
 **メジャー グループ内のメジャーと KPI**  
 ...
 ![Power View のフィールド リストでのメジャー グループ](../../analysis-services/multidimensional-models/media/daxmd-fieldlist-group.gif "Power View のフィールド リストでのメジャー グループ")  
 ...
 **SSDT と Power View のフィールド リストにおけるディメンション属性の geography 型**  
 ...
 ![ディメンションの属性の geography 型](../../analysis-services/multidimensional-models/media/daxmd-ssdt-attribute-geog-types.gif "ディメンションの属性の geography 型")  
 ...
 **計算されるメンバーを含む Power View レポート**  
 ...
 ![Power View での計算されるメンバー](../../analysis-services/multidimensional-models/media/daxmd-calcmembersinpowerview.gif "Power View での計算されるメンバー")  
 ...
 **固定フィルター**  
 ...
 ![固定フィルター](../../analysis-services/multidimensional-models/media/daxmd-pinnedfilterinpowerview.gif "固定フィルター")  
