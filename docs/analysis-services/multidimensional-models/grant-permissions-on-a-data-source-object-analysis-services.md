---
title: "データ ソース オブジェクトに対する権限の付与 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  - "読み取り/書き込み権限"
  - "ユーザー アクセス権 [Analysis Services], データ ソース"
  - "security [Analysis Services], data sources"
  - "接続文字列 [Analysis Services]"
  - "データ ソース [Analysis Services], セキュリティ"
