...
## データ メンバーの使用  
 ...
 ![3 つのレベルから成る総売上高ディメンション](../../analysis-services/multidimensional-models/media/agdatamember1.gif "3 つのレベルから成る総売上高ディメンション")  
