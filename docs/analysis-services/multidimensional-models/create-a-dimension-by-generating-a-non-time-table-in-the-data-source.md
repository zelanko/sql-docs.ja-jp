---
title: "データ ソースに時間テーブル以外のテーブルを生成することによるディメンションの作成 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "データ ソース [Analysis Services], データ ソースを持たないディメンション"
  - "ディメンション [Analysis Services], 標準"
  - "ディメンション [Analysis Services], データ ソースなしで作成"
...
---
# データ ソースに時間テーブル以外のテーブルを生成することによるディメンションの作成
