...
ms.topic: "article"
helpviewer_keywords: 
  - "権限 [Analysis Services], アセンブリ"
  - "ユーザー定義関数の呼び出し"
  - "ユーザーの権限借用 [Analysis Services]"
  - "権限借用 [Analysis Services]"
  - "データ マイニング拡張機能 [Analysis Services], アセンブリ"
  - "MDX [Analysis Services], アセンブリ"
  - "ユーザー定義関数 [Analysis Services]"
  - "Analysis Services オブジェクト, アセンブリ"
  - "アセンブリ [Analysis Services]"
  - "アプリケーション ドメイン [Analysis Services]"
