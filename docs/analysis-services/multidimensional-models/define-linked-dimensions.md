...
ms.topic: "article"
helpviewer_keywords: 
  - "ディメンション [Analysis Services]、リンク"
  - "リンク ディメンション [Analysis Services]"
...
1.  ウィザードを開始します。 [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] で、[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] データベースまたはプロジェクトの **[ディメンション]** フォルダーを右クリックし、**[新しいリンク ディメンション]** をクリックします。  
