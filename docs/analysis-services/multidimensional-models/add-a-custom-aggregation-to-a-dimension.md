...
helpviewer_keywords: 
  ...
  - "ビジネス インテリジェンス拡張機能 [Analysis Services], カスタム集計"
  - "集計 [Analysis Services], カスタム"
  - "単項演算子"
  - "カスタム集計 [Analysis Services]"
...
> [!NOTE]  
>  ビジネス インテリジェンス ウィザードを実行してカスタム集計を追加する前に、拡張するディメンションに親子属性階層が含まれていることを確認してください。 詳細については、[「親子ディメンション」](../../analysis-services/multidimensional-models/parent-child-dimensions.md) を参照してください。  
