---
title: "Analysis Services プロジェクトのビルド (SSDT) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  ...
  - "Business Intelligence Development Studio, プロジェクトの作成 [Analysis Services]"
...
|\< 構成名>\LastBuilt.xml|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] プロジェクトの最終作成時刻を表すタイム スタンプおよびハッシュ コードが含まれています。|  
 ...
 この XML ファイルには、\<Create> および \<Alter> タグは含まれていません。これらは配置時に作成されます。  
