---
title: "ディメンションへのディメンション インテリジェンスの追加 | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "ビジネス インテリジェンス拡張機能 [Analysis Services], ディメンション インテリジェンス"
  - "ディメンション [Analysis Services], ビジネス インテリジェンス拡張機能"
  - "ディメンション インテリジェンス [Analysis Services]"
  - "Type プロパティ"
...
> [!NOTE]  
>  ディメンションに **[勘定科目]** を選択した場合は、ディメンションに勘定科目インテリジェンスを指定します。 詳細については、「[ディメンションへの勘定科目インテリジェンスの追加](../../analysis-services/multidimensional-models/add-account-intelligence-to-a-dimension.md)」を参照してください。  
