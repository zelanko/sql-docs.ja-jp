---
title: "Analysis Services の配置に関する要件と注意点 | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
helpviewer_keywords: 
  ...
  - "スケーラビリティ [Analysis Services]"
  - "領域 [Analysis Services]"
  - "Analysis Services の配置, 要件"
  - "配置 [Analysis Services], 要件"
  - "ディスク領域 [Analysis Services]"
  - "要件 [Analysis Services]"
  - "プロセッサ [Analysis Services]"
  - "システム要件 [Analysis Services]"
...
### 構造的変更の処理時における可用性の提供  
 ...
 ソース データの増分更新を簡単に処理するには、プロアクティブ キャッシュを有効にします。 プロアクティブ キャッシュでは、新しいソース データを使用してキューブが更新されます。手動での処理は必要なく、キューブの可用性に影響を与えることもありません。 詳細については、「[プロアクティブ キャッシュ (パーティション)](../Topic/Proactive%20Caching%20\(Partitions\).md)」をご覧ください。  
