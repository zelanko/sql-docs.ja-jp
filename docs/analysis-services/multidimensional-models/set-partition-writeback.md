...
ms.topic: "article"
helpviewer_keywords: 
  - "書き込み許可パーティション [Analysis Services]"
  - "パーティション [Analysis Services], 書き戻し"
  - "パーティション [Analysis Services], 書き込み許可"
  - "書き戻し [Analysis Services], パーティション"
...
## 参照  
 [書き込み許可パーティション](../Topic/Write-Enabled%20Partitions.md)   
