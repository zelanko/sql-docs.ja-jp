...
ms.topic: "article"
helpviewer_keywords: 
  - "データ ソース ビュー [Analysis Services], バインド"
  - "DSO, バインド"
  - "Analysis Services スクリプト言語, データ ソース"
  - "キューブ [Analysis Services], バインド"
  - "OLAP マイニング モデル [Analysis Services スクリプト言語]"
  - "バインド [Analysis Services スクリプト言語]"
  - "再バインド [Analysis Services スクリプト言語]"
  - "ASSL, バインド"
  - "リレーショナル マイニング モデル [ASSL]"
  - "データ ソース [Analysis Services スクリプト言語]"
  - "ASSL, データ ソース"
  - "ディメンション [Analysis Services], バインド"
  - "メジャー [Analysis Services], バインド"
  - "リレーショナル データ ソース [Analysis Services スクリプト言語]"
  - "Analysis Services スクリプト言語, バインド"
  - "チャプター行セット"
  - "粒度 (granularity)"
  - "マイニング モデル [Analysis Services], データ ソース"
  - "インライン バインド [ASSL]"
  - "不一致バインド"
  - "メジャー グループ [Analysis Services], バインド"
  - "パーティション [Analysis Services], バインド"
...
### 不一致バインド型の定義  
 ASSL では、不一致 **Bindings** コレクション内で、複数のオブジェクトのバインドのコレクションである、各 **Binding**を使用できます。 各 **Binding** には拡張オブジェクト参照があります。これはオブジェクト参照に似ていますが、マイナー オブジェクト (たとえばディメンション属性やメジャー グループ属性) の参照も可能です。 このオブジェクトは、**Process** コマンドの **Object** 要素に特有のフラット形式ですが、\<*Object*>\<*/Object*> タグはありません。  
