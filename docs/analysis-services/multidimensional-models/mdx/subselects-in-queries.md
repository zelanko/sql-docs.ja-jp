...
||||||||  
|-|-|-|-|-|-|-|  
||All Sales Territories|Australia|カナダ|Central|Northwest|Southwest|  
...
-   NON EMPTY 句は軸句では使用できません。代わりに [NonEmpty &#40;MDX&#41;](../../../mdx/nonempty-mdx.md) 関数式を使用します。  
