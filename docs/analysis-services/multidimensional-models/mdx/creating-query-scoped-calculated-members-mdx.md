---
title: "クエリ スコープの計算されるメンバーの作成 (MDX) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
> [!NOTE]  
>  計算されるメンバーの詳細については、「[MDX での計算されるメンバーの作成 &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/building-calculated-members-in-mdx-mdx.md)」を参照してください。  
...
## 参照  
 ...
 [セッション スコープの計算されるメンバーの作成 &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/creating-session-scoped-calculated-members-mdx.md)  
