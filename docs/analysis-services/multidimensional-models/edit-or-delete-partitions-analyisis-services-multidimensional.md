...
---
# パーティションの編集または削除 (Analysis Services - 多次元)
...
## パーティション ソース  
 ...
 ![[パーティション] ペイン内の基になる列](../../analysis-services/multidimensional-models/media/ssas-partitionsource.png "[パーティション] ペイン内の基になる列")  
