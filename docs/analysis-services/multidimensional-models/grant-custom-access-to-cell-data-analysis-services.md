---
title: "セル データへのカスタム アクセス権の付与 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
helpviewer_keywords: 
  - "ユーザー アクセス権 [Analysis Services], セル データ"
  - "アクセス許可 [Analysis Services], セル"
  - "Read-Contingent 権限"
  - "読み取り権限"
  - "セル [Analysis Services]"
  - "セル データへのカスタム アクセス権 [Analysis Services]"
...
# セル データへのカスタム アクセス権の付与 (Analysis Services)
 ...
 ![許可されているセルと拒否されているセルが示されているピボットテーブル](../../analysis-services/multidimensional-models/media/ssas-permscellsallowed.png "許可されているセルと拒否されているセルが示されているピボットテーブル")  
...
```  
 ...
 ![セルが使用不可として示されている Excel の列](../../analysis-services/multidimensional-models/media/ssas-permscellshidemeasure.png "セルが使用不可として示されている Excel の列")  
...
```  
 ...
 ![使用可能なセルと使用不可能なセルを含む Excel テーブル](../../analysis-services/multidimensional-models/media/ssas-permscalculatedcells.png "使用可能なセルと使用不可能なセルを含む Excel テーブル")  
...
## 参照  
 [MDX ビルダー (Analysis Services - 多次元データ)](../Topic/MDX%20Builder%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)   
