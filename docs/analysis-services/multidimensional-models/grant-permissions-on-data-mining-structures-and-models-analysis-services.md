---
title: "データ マイニング構造およびデータ マイニング モデルに対する権限の付与 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  - "データ マイニング [Analysis Services], セキュリティ"
  - "権限 [Analysis Services], マイニング モデル"
  - "マイニング モデル [Analysis Services], セキュリティ"
  - "マイニング構造 [Analysis Services], セキュリティ"
  - "権限 [Analysis Services], マイニング構造"
  - "ユーザー アクセス権 [Analysis Services], マイニング構造"
  - "ユーザー アクセス権 [Analysis Services], マイニング モデル"
