---
title: "多次元モデルの処理 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "オンライン モード [Analysis Services]"
  - "オブジェクトの処理 [Analysis Services]"
  - "パーティション [Analysis Services], 処理"
  - "ジョブ [Analysis Services]"
  - "オブジェクト [Analysis Services], 処理"
  - "オブジェクトの再処理"
  - "影響の分析 [Analysis Services]"
  - "ディメンション [Analysis Services], 処理"
  - "プロジェクト モード [Analysis Services]"
  - "キューブ [Analysis Services], 処理"
