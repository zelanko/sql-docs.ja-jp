---
title: "データ ソース ビュー デザイナーでのダイアグラムの操作 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "データ ソース ビュー [Analysis Services], ダイアグラム"
  - "ダイアグラム [Analysis Services]"
...
##  <a name="bkmk_add"></a> ダイアグラムの追加  
 ...
 Analysis Services プロジェクトでデータ ソース ビュー (DSV) を初めて定義すると、データ ソース ビューに追加されているすべてのテーブルとビューが \<すべてのテーブル> ダイアグラムに追加されます。 このダイアグラムはデータ ソース ビュー デザイナーの [ダイアグラム オーガナイザー] ペインに表示され、このダイアグラム内のテーブルおよびその列とリレーションシップが [テーブル] ペインに一覧表示され、さらにスキーマ ペインにグラフィック表示されます。 ただし、テーブル、ビュー、および名前付きクエリを \<すべてのテーブル> ダイアグラムに追加していくと、このダイアグラム内のオブジェクト数が非常に多いため、リレーションシップのグラフィック表示が煩雑になります。特に、複数のファクト テーブルをダイアグラムに追加する場合、ディメンション テーブルが複数のファクト テーブルに関連していると、表示が難しくなります。  
 ...
 関連するテーブルや名前付きクエリを業務上の目的に合わせて別々のダイアグラムにグループ化すると、多数のテーブル、ビュー、および名前付きクエリが含まれているデータ ソース ビューが理解しやすくなります。 同じテーブルまたは名前付きクエリを、\<すべてのテーブル> ダイアグラムを除く複数のダイアグラムに含めることができます。 \<すべてのテーブル> ダイアグラムでは、データ ソース ビューに含まれているすべてのオブジェクトが 1 回だけ表示されます。  
...
## 参照  
 ...
 [データ ソース ビュー デザイナー (Analysis Services - 多次元データ)](../Topic/Data%20Source%20View%20Designer%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)  
