---
title: "スキーマ生成ウィザードの使用 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "スキーマ生成ウィザード、手順"
  - "リレーショナル スキーマ [Analysis Services], スキーマ生成ウィザード"
...
---
# スキーマ生成ウィザードの使用 (Analysis Services)
...
## 手順 3: サブジェクト領域データベースのスキーマ オプションの指定  
...
## 手順 4: 名前付け規則の指定  
 スキーマ生成ウィザードの **[名前付け規則の指定]** ページで、サブジェクト領域データベースに特定のオブジェクトを生成するときにウィザードが使用する名前付け規則を定義できます。 **[名前付け規則の指定]** ページで使用できるオプションの詳細については、「[[名前付け規則の指定] &#40;スキーマ生成ウィザード&#41; &#40;Analysis Services - 多次元データ&#41;](../Topic/Specify%20Naming%20Conventions%20\(Schema%20Generation%20Wizard\)%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)」を参照してください。  
