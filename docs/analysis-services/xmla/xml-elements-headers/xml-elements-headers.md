...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]XML for Analysis (XMLA) プロトコルでは、SOAP ヘッダー内の XML 要素を使用して、セッションのサポートとサポートされる機能のネゴシエーションなど、プロトコル レベルの機能を管理します。  
