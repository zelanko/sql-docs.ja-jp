 ...
 **RelationshipEndVisualizationProperties** 、要素、 **IsDefaultMeasure**要素は、のもう一方の端に移動して、このエンティティの既定のメジャーを取得することであることを示しますこのリレーションシップです。 既定値**false**を取得する既定のメジャーがないことを示します。  
