 ...
 **コマンド**要素を使用して、 **Execute**データ ソースにコマンドをリレー メソッドです。 XML をのみ Analysis (XMLA) 1.1 仕様をサポートしているときに、**ステートメント**コマンドを Analysis Services は、多くの新しい XMLA コマンドをサポートしています。 サポートされる XMLA コマンドの詳細については[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]を参照してください[コマンド&#40;XMLA&#41;](../../../analysis-services/xmla/xml-elements-commands/xml-elements-commands.md)です。  
