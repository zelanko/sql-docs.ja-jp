...
ms.locfileid: "38036510"
---
# <a name="skippedlevels-element-xmla"></a>SkippedLevels 要素 (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  親によって表される属性メンバーがスキップするレベルの数を含む[属性](../../../analysis-services/xmla/xml-elements-properties/attribute-element-xmla.md)要素。  
 ...
 **SkippedLevels**要素の親によって定義された属性メンバーがスキップするレベルの数を決定する**属性**要素。  
