 ...
 **RelationshipEndVisualizationProperties** 、要素、 **DefaultDetailsPosition**要素には、既定の detail 要素の詳細のコレクション内の位置が含まれています。 既定値**false**使用する既定の詳細がないことを示します。  
