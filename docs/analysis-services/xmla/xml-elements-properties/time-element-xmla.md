---
title: "時刻の要素 (XMLA) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/06/2017
...
---
# <a name="time-element-xmla"></a>Time 要素 (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]によって使用される制限時間を指定します、 [DesignAggregations](../../../analysis-services/xmla/xml-elements-commands/designaggregations-element-xmla.md)集計をデザインするコマンド。  
