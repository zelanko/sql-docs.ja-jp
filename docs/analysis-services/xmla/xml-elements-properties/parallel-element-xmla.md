...
ms.locfileid: "38050411"
---
# <a name="parallel-element-xmla"></a>Parallel Element (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  親を使用して並列で実行できる処理ジョブの数を指定[バッチ](../../../analysis-services/xmla/xml-elements-commands/batch-element-xmla.md)コマンド。  
...
|属性|説明|  
|---------------|-----------------|  
|maxParallel|省略可能で、 **Integer** 型の属性。 コマンドを並列に実行するスレッドの最大数を示します。 かどうかを指定または Analysis Services のインスタンス 0 に設定するコンピューターで使用可能なプロセッサの数に基づいてスレッドの最適な数を決定します。|  
