...
## <a name="remarks"></a>解説  
 **バインド**要素のデータ ソースおよびデータ ソース ビュー、以外の行外のバインディングを定義する[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]によって処理されるオブジェクト、**バッチ**または**プロセス**コマンド。 オブジェクトの処理の詳細については、次を参照してください。[オブジェクトの処理 & #40 です。XMLA &#41;](../../../analysis-services/multidimensional-models-scripting-language-assl-xmla/processing-objects-xmla.md).  
