 ...
 **DisplayInfo**要素には、クライアント アプリケーションが、親の表示に役立つ情報のさまざまな項目が含まれています。 **HierarchyInfo**または**メンバー**要素。 値は、OLE DB for OLAP 仕様で軸行セットに関して定義される DISPLAY_INFO プロパティと同等です。  
