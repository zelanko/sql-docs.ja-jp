...
ms.locfileid: "34575244"
---
# <a name="lock-element-xmla"></a>Lock 要素 (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  Analysis Services インスタンス上には、指定したオブジェクトをロックします。  
...
## <a name="see-also"></a>参照
 [要素のロック解除&#40;XMLA&#41;](../../../analysis-services/xmla/xml-elements-commands/unlock-element-xmla.md)   
