---
title: "配置したキューブの表示 | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
1.  [!INCLUDE[ssBIDevStudio](../includes/ssbidevstudio-md.md)] のキューブ デザイナーに切り替えるには、ソリューション エクスプローラーの **[キューブ]** フォルダーで **[[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial]** キューブをダブルクリックします。  
