...
ms.topic: "reference"
helpviewer_keywords: 
  - "SQMSupportEnabled プロパティ"
  - "ComUdfEnabled プロパティ"
  - "LinkToOtherInstanceEnabled プロパティ"
  - "ManagedCodeEnabled プロパティ"
  - "ConnStringEncryptionEnabled プロパティ"
  - "LinkFromOtherInstanceEnabled プロパティ"
  - "LinkInsideInstanceEnabled プロパティ"
  - "UseCachedPageAllocators プロパティ"
