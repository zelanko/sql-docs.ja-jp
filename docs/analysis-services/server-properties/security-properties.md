...
ms.topic: "reference"
helpviewer_keywords: 
  - "セキュリティ [Analysis Services], プロパティ"
  - "SecurityPackageList プロパティ"
  - "BuiltinAdminsAreServerAdmins プロパティ"
  - "DisableClientImpersonation プロパティ"
  - "ErrorMessageMode プロパティ"
  - "RequiredProtectionLevel プロパティ"
  - "ServiceAccountIsServerAdmin プロパティ"
  - "RequireClientAuthentication プロパティ"
