...
### キューブ デザイナーでキューブとディメンションのプロパティを確認するには  
...
## このレッスンの次の作業  
[Analysis Services プロジェクトの配置](../analysis-services/deploying-an-analysis-services-project.md)  
  
## 参照  
[ディメンション デザイナーでのディメンション データの参照](../analysis-services/multidimensional-models/browse-dimension-data-in-dimension-designer.md)  
