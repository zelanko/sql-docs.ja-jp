...
1. [データ ソースが SQL Server Analysis Services で 1400 の表形式モデルをサポート](tabular-models/data-sources-supported-ssas-tabular-1400.md)
2. [表形式のモデリング (1400 互換性レベル)](tutorial-tabular-1400/as-adventure-works-tutorial.md)
3. [パーティションを作成します。](tutorial-tabular-1400/as-lesson-10-create-partitions.md)
4. [ロールを作成します。](tutorial-tabular-1400/as-lesson-11-create-roles.md)
5. [Excel で分析します。](tutorial-tabular-1400/as-lesson-12-analyze-in-excel.md)
6. [配置](tutorial-tabular-1400/as-lesson-13-deploy.md)
7. [表形式モデル プロジェクトを作成します。](tutorial-tabular-1400/as-lesson-1-create-a-new-tabular-model-project.md)
8. [データを取得します。](tutorial-tabular-1400/as-lesson-2-Get-data.md)
9. [日付テーブルとしてマークします。](tutorial-tabular-1400/as-lesson-3-mark-as-date-table.md)
10. [リレーションシップを作成します。](tutorial-tabular-1400/as-lesson-4-create-relationships.md)
11. [計算列を作成します。](tutorial-tabular-1400/as-lesson-5-create-calculated-columns.md)
12. [メジャーを作成します。](tutorial-tabular-1400/as-lesson-6-create-measures.md)
13. [主要業績評価指標を作成します。](tutorial-tabular-1400/as-lesson-7-create-key-performance-indicators.md)
14. [パースペクティブを作成します。](tutorial-tabular-1400/as-lesson-8-create-perspectives.md)
15. [階層を作成します。](tutorial-tabular-1400/as-lesson-9-create-hierarchies.md)
16. [補足のレッスン: 詳細行](tutorial-tabular-1400/as-supplemental-lesson-detail-rows.md)
17. [補足のレッスン: 動的なセキュリティ](tutorial-tabular-1400/as-supplemental-lesson-dynamic-security.md)
18. [補足のレッスン: 不規則階層](tutorial-tabular-1400/as-supplemental-lesson-ragged-hierarchies.md)
