...
1. [Analysis Services の旧バージョンとの互換性 (SQL 2017)](analysis-services-backward-compatibility-sql2017.md)
2. [オブジェクト レベルのセキュリティ](tabular-models/object-level-security.md)
