---
title: "テーブル モデル データ アクセス | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
### DAX  
 ...
 テーブル モデルに対して DAX を使用してクエリを実行する例については、「[DAX クエリ構文のリファレンス](http://msdn.microsoft.com/ja-jp/4dd0cf0e-191d-411d-987c-f606813fc39e)」を参照してください。  
...
### CSDL  
 ...
 テーブル モデルで CSDL を使用する方法については、「[ビジネス インテリジェンス向けの CSDL 注釈 (CSDLBI)](../../analysis-services/tabular-model-programming-compatibility-levels-1050-1103/csdl-annotations-for-business-intelligence-csdlbi.md)」を参照してください。  
...
-   AdventureWorks サンプル (CodePlex)  
  
 PowerShell を使用して、Analysis Services のインスタンスを管理、監視できるほか、テーブル モデル アクセスに必要なセキュリティを形成、監視することができます。 詳細については、「[Analysis Services での PowerShell スクリプティング](../../analysis-services/instances/powershell-scripting-in-analysis-services.md)」を参照してください。  
...
-   [DISCOVER_XEVENT_TRACE_DEFINITION 行セット](../Topic/DISCOVER_XEVENT_TRACE_DEFINITION%20Rowset.md)  
