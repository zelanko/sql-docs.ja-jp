---
title: "SQL Server 2016 Analysis Services における表形式モデルの双方向のクロス フィルター | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2017"
...
---
# SQL Server 2016 Analysis Services における表形式モデルの双方向のクロス フィルター
 ...
 SSDT では、クロス フィルターを設定するしくみは、テーブル リレーションシップ ダイアログ ボックスの [フィルターの方向] オプションによって提供されます。 この機能は、[SQL Server Data Tools for Visual Studio 2015 (SSDT)](http://go.microsoft.com/fwlink/p/?LinkID=627574) で互換性レベル 1200 で作成された表形式モデルでのみ使用できます。  
...
4.  モデルの互換性レベルが **SQL Server 2016 RTM (1200)** に設定されていることを確認します。  
...
## 参照  
 ...
 [A Practical Example of How to Handle Simple Many-to-Many Relationships in Power Pivot and SSAS Tabular Models (Power Pivot と SSAS の表形式モデルで簡単な多対多リレーションシップを処理する方法の実用的な例)](http://social.technet.microsoft.com/wiki/contents/articles/22202.a-practical-example-of-how-to-handle-simple-many-to-many-relationships-in-power-pivotssas-tabular-models.aspx)   
