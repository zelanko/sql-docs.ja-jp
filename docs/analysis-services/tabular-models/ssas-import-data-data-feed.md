...
---
# <a name="import-data---data-feed"></a>データのデータ フィードをインポートします。
...
> [!NOTE]  
>  これは、SharePoint 2010 および SharePoint 2013 にのみ適用されます。  
...
## <a name="see-also"></a>参照  
 ...
 [サポートされるデータ型 & #40 です。SSAS テーブル &#41;](../../analysis-services/tabular-models/data-types-supported-ssas-tabular.md)   
