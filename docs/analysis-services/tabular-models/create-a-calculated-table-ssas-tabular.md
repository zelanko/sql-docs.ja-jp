---
title: "計算テーブルを作成する (SSAS 表形式) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
1.  最初に、表形式モデルの互換性レベルが 1200 であることを確認します。 SSDT のモデルで **[互換性レベル]** プロパティを確認できます。  
...
### 集計されたデータセットまたはフィルター選択されたデータセット  
...
## 参照  
 ...
 [Analysis Services の Data Analysis Expressions (DAX)](../Topic/Data%20Analysis%20Expressions%20\(DAX\)%20in%20Analysis%20Services.md)   
