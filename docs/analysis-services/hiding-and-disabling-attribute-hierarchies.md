---
title: "属性階層の非表示化と無効化 | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
4.  [プロパティ] ウィンドウで、選択した属性の **AttributeHierarchyEnabled** プロパティの値を **False** に設定します。  
    ...
    **[属性]** ペインを見ると、各属性のアイコンが変わり、無効になっていることがわかります。  
    ...
    ![False に設定された AttributeHierarchyEnabled プロパティ](../analysis-services/media/l4-hierarchyenabled-1.gif "False に設定された AttributeHierarchyEnabled プロパティ")  
...
4.  [プロパティ] ウィンドウで、選択した属性の **AttributeHierarchyVisible** プロパティの値を **False** に設定します。  
    ...
    ![False に設定された AttributeHierarchyVisible プロパティ](../analysis-services/media/l4-hierarchyvisible-1.gif "False に設定された AttributeHierarchyVisible プロパティ")  
...
## このレッスンの次の作業  
[2 次属性に基づく属性メンバーの並べ替え](../analysis-services/sorting-attribute-members-based-on-a-secondary-attribute.md)  
