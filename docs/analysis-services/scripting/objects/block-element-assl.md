...
---
# <a name="block-element-assl"></a>Block 要素 (ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]またはのバイナリ コンテンツの一部が含まれています、 [ClrAssemblyFile](../../../analysis-services/scripting/data-type/clrassemblyfile-data-type-assl.md)要素。  
...
|リレーションシップ|要素|  
|------------------|-------------|  
|親要素|[ブロック](../../../analysis-services/scripting/collections/blocks-element-assl.md)|  
|子要素|なし|  
