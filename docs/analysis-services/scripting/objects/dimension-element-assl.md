...
|先祖または親|データ型|  
|------------------------|---------------|  
|[データベース](../../../analysis-services/scripting/objects/database-element-assl.md)|[ディメンション](../../../analysis-services/scripting/data-type/dimension-data-type-assl.md)|  
...
|リレーションシップ|要素|  
|------------------|-------------|  
|親要素|[ディメンション](../../../analysis-services/scripting/collections/dimensions-element-assl.md)|  
|子要素|なし|  
