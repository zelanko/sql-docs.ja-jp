...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]特定に属しているアクセス許可を定義[ロール](../../../analysis-services/scripting/objects/role-element-assl.md)特定のデータベース ディメンションまたはキューブ ディメンションの要素。  
...
|リレーションシップ|要素|  
|------------------|-------------|  
|親要素|[DimensionPermissions](../../../analysis-services/scripting/collections/dimensionpermissions-element-assl.md)|  
