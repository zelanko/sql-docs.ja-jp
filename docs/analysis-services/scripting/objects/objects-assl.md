...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]このリファレンス セクションには、Analysis Services スクリプト言語 (ASSL) スキーマでオブジェクトとして機能する各要素の構文と使用状況の情報が含まれています。  
