...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]親のローカライズされた翻訳を提供、[翻訳](../../../analysis-services/scripting/collections/translations-element-assl.md)コレクション。  
