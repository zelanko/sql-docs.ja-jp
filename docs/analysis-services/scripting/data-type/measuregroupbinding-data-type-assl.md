...
## <a name="remarks"></a>解説  
 詳細については、**バインド**型、バインディングの種類の Analysis Services スクリプト言語 (ASSL) オブジェクトとの継承階層のテーブルを含む**バインド**型を参照してください[バインディング データ型 & #40 です。ASSL &#41;](../../../analysis-services/scripting/data-type/binding-data-type-assl.md).  
