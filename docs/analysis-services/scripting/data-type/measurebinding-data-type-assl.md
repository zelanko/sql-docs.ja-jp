---
title: MeasureBinding データ型 (ASSL) |Microsoft ドキュメント
ms.custom: ''
ms.date: 03/06/2017
...
---
# <a name="measurebinding-data-type-assl"></a>MeasureBinding データ型 (ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]親要素に、メジャーのバインドを表す派生データ型を定義します。  
...
|------------------|-------------|  
|親要素|なし|  
|子要素|[MeasureID](../../../analysis-services/scripting/properties/measureid-element-assl.md)|  
...
## <a name="remarks"></a>解説  
 ...
 分析管理オブジェクト (AMO) オブジェクト モデルで対応する要素は<xref:Microsoft.AnalysisServices.MeasureBinding>します。  
