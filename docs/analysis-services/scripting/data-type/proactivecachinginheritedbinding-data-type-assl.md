...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]情報を表す派生データ型を定義、 [ProactiveCaching](../../../analysis-services/scripting/objects/proactivecaching-element-assl.md)テーブルおよびビューをキャッシュの再構築を必要とする既存のデータ バインドを介して識別されるデータ ソース変更に関して要素。  
