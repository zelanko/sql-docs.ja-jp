...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]内のテーブルの行へのバインディングを表す派生データ型を定義、 [DataSourceView](../../../analysis-services/scripting/objects/datasourceview-element-assl.md)要素。  
...
|------------------|-------------|  
|親要素|なし|  
|子要素|[TableID](../../../analysis-services/scripting/properties/tableid-element-assl.md)|  
