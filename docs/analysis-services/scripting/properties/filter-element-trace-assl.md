...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]記述する XML ドキュメント フラグメントが含まれています、[トレース](../../../analysis-services/scripting/objects/trace-element-assl.md)フィルター。  
