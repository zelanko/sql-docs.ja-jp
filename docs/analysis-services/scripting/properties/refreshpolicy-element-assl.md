...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]どのくらいの頻度を決定ディメンションまたはメジャー グループの動的部分 (で指定されたとおり、[永続化](../../../analysis-services/scripting/properties/persistence-element-assl.md)要素) の変更がチェックされます。  
...
## <a name="see-also"></a>参照  
 [Persistence 要素 &#40;です。ASSL &#41;](../../../analysis-services/scripting/properties/persistence-element-assl.md)   
