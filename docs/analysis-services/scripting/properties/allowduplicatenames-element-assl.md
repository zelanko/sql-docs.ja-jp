...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]重複する名前が使用できるかどうかを決定する[階層](../../../analysis-services/scripting/objects/hierarchy-element-assl.md)要素。  
