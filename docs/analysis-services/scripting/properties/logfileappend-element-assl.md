...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]指定するかどうか、[トレース](../../../analysis-services/scripting/objects/trace-element-assl.md)要素を既存のログ ファイルにログ出力を追加するか上書きします。  
