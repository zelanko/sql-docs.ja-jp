...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]どのようにスカラー値を表すプロバイダー固有の値を含むの列内で分散、 [MiningStructure](../../../analysis-services/scripting/objects/miningstructure-element-assl.md)要素。  
