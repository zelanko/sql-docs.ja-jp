...
ms.locfileid: "34040496"
---
# <a name="namingtemplate-element-assl"></a>NamingTemplate 要素 (ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  構築された親子階層におけるレベルの名前付け方法を定義、 [DimensionAttribute](../../../analysis-services/scripting/data-type/dimensionattribute-data-type-assl.md)親要素です。  
...
## <a name="see-also"></a>参照  
 [NamingTemplateTranslations 要素&#40;ASSL&#41;](../../../analysis-services/scripting/collections/namingtemplatetranslations-element-assl.md)   
