...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]基になる属性の識別子 (ID) を含む、[レベル](../../../analysis-services/scripting/objects/level-element-assl.md)要素に基づいています。  
