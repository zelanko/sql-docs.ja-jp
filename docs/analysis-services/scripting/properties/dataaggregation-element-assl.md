...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]インスタンスが永続化されたデータまたはのキャッシュされたデータを集計できるかどうかを判断、 [MeasureGroup](../../../analysis-services/scripting/objects/measuregroup-element-assl.md)です。  
