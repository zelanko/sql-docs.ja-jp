...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]データ ソースに接続するときに、権限借用の動作を決定するための情報が含まれています、[データベース](../../../analysis-services/scripting/objects/database-element-assl.md)要素。  
