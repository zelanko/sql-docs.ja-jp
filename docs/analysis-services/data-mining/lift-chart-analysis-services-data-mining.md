...
### 対象の値を持つリフト チャート  
 次に示すチャートは、「[基本的なデータ マイニング チュートリアル](../Topic/Basic%20Data%20Mining%20Tutorial.md)」で作成する **Targeted Mailing** モデルのリフト チャートです。 このチャートの対象の属性は [Bike Buyer] で、対象の値は 1 です。これは、自転車を購入したか、購入する可能性がある顧客を意味します。 したがって、このリフト チャートは、このモデルによって潜在顧客をより効率的に識別できることを示します。  
 ...
 ![2 つのモデルを示すリフト チャート](../../analysis-services/data-mining/media/newliftchart-tm30-30.gif "2 つのモデルを示すリフト チャート")  
...
### 対象の値を持たないモデルのリフト チャート  
 ...
 ![適正な予測を示すリフト チャート](../../analysis-services/data-mining/media/lift1.gif "適正な予測を示すリフト チャート")  
