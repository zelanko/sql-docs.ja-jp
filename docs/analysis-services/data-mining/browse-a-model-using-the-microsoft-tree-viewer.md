---
title: "Microsoft ツリー ビューアーを使用したモデルの参照 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "ツリー ビューアー [Analysis Services]"
  - "予測 [Analysis Services], 不連続属性"
  - "マイニング モデル コンテンツ、表示"
  - "予測 [Analysis Services], 連続属性"
  - "マイニング凡例 [Analysis Services]"
  - "不連続属性 [Analysis Services]"
  - "Microsoft ディシジョン ツリー アルゴリズム [Analysis Services]"
...
## 参照  
 ...
 [マイニング モデル ビューアー (データ マイニング モデル デザイナー)](../Topic/Mining%20Model%20Viewers%20\(Data%20Mining%20Model%20Designer\).md)   
