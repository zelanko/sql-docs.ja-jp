---
title: "モデルのテスト データの選択およびマップ | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "列 [データ マイニング]、マイニング精度チャート"
  - "マイニング精度チャート [Analysis Services]、列マッピング"
  - "入力列マッピング [Analysis Services]"
  - "入力列のマッピング [Analysis Services]"
