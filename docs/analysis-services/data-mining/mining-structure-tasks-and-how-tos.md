...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]**マイニング構造**でデータ マイニング デザイナーのタブ[!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]が作成、編集、およびマイニング構造の処理に使用できるツールが含まれています。  
...
## <a name="see-also"></a>参照  
 [設計と実装の方法に関するトピック (Analysis Services - データ マイニング)](https://msdn.microsoft.com/library/bb522452.aspx)  
