...
ms.topic: "article"
helpviewer_keywords: 
  - "予測 [Analysis Services], 不連続属性"
  - "予測 [Analysis Services], 連続属性"
  - "アルゴリズム [データ マイニング]"
  - "不連続属性 [Analysis Services]"
  - "分類アルゴリズム [Analysis Services]"
  - "不連続列 [Analysis Services]"
...
### 不連続列の予測  
 ...
 ![デシジョン ツリー ノード](../../analysis-services/data-mining/media/dt-tree.gif "デシジョン ツリー ノード")  
...
### 連続列の予測  
 ...
 ![非線形性を表す複数の回帰線](../../analysis-services/data-mining/media/regression-tree1.png "非線形性を表す複数の回帰線")  
 ...
 ![非線形性のポイントを表す式](../../analysis-services/data-mining/media/regression-tree2.gif "非線形性のポイントを表す式")  
