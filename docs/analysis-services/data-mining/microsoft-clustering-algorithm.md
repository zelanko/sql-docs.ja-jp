---
title: "Microsoft クラスタリング アルゴリズム | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "分割アルゴリズム [Analysis Services]"
  - "近傍 [データ マイニング]"
  - "クラスター [データ マイニング]"
  - "クラスター [Analysis Services]"
  - "リレーションシップ [Analysis Services], クラスター"
  - "アルゴリズム [データ マイニング]"
  - "分類アルゴリズム [Analysis Services]"
  - "データセット [Analysis Services]"
...
## アルゴリズムの動作  
 ...
 ![データセットの各ケースを示す散布図](../../analysis-services/data-mining/media/clustering-plot.png "データセットの各ケースを示す散布図")  
