...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)][!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] Office 用データ マイニング アドインでは、軽量な一連の予測分析できるように Excel のデータを使用して、予測、推奨設定、または検索の分析モデルを構築するためのツールです。  
