...
helpviewer_keywords: 
  ...
  - "データ型 [データ マイニング]"
  - "REGRESSOR フラグ"
  - "MODEL_EXISTENCE_ONLY フラグ"
  - "REGRESSOR 列"
  - "列 [data mining], モデリング フラグ"
  - "NOT NULL モデリング フラグ"
  - "モデリング フラグ [データ マイニング]"
  - "NULL 値 [Analysis Services]"
...
> [!NOTE]  
>  Missing はアルゴリズムによって使用される特殊な状態であり、列のテキスト値の "Missing" とは異なります。 詳細については、「[Missing 値 &#40;Analysis Services - データ マイニング&#41;](../../analysis-services/data-mining/missing-values-analysis-services-data-mining.md)」を参照してください。  
