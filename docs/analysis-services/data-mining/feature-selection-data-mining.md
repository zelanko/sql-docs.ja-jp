...
ms.topic: "article"
helpviewer_keywords: 
  - "マイニング モデル [Analysis Services], 機能選択"
  - "属性 [データ マイニング]"
  - "機能選択アルゴリズム [Analysis Services]"
  - "データ マイニング [Analysis Services], 機能選択"
  - "ニューラル ネットワーク アルゴリズム [Analysis Services]"
  - "Naive Bayes アルゴリズム [Analysis Services]"
  - "デシジョン ツリー アルゴリズム [Analysis Services]"
...
## SQL Server データ マイニングでの機能の選択のしくみ  
