...
ms.topic: "article"
helpviewer_keywords: 
  - "マイニング構造 [Analysis Services], OLAP"
  - "マイニング構造 [Analysis Services], 作成"
  - "OLAP [Analysis Services], マイニング モデル"
...
1.  [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] のソリューション エクスプローラーで、[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] プロジェクトの **[マイニング構造]** フォルダーを右クリックし、**[新しいマイニング構造]** をクリックして、データ マイニング ウィザードを開きます。  
