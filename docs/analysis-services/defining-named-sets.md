...
1.  [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial キューブのキューブ デザイナーを開いて、**[計算]** タブに切り替えます。次に、ツール バーの **[フォーム ビュー]** をクリックします。  
...
9. プロパティ ウィンドウで、**DiscretizationMethod** プロパティを **Automatic** に変更して、**DiscretizationBucketCount** プロパティを「**5**」に変更します。 詳細については、[「属性メンバーのグループ化 (分離)](../analysis-services/multidimensional-models/group-attribute-members-discretization.md)」を参照してください。  
...
6.  **[メタデータ]** ペインの **Product** ディメンションで、**Core Products** をフィルター領域にドラッグします。  
    ...
    ![Core Product 名前付きセットのメンバー](../analysis-services/media/l6-named-set-04.gif "Core Product 名前付きセットのメンバー")  
...
7.  **[メタデータ]** ペインで **Reseller** を展開し、フィルター領域に **Large Resellers** を追加します。  
    ...
    ![2 つの名前付きセットを含む [フィルター] ペイン](../analysis-services/media/l6-named-set-05.gif "2 つの名前付きセットを含む [フィルター] ペイン")  
