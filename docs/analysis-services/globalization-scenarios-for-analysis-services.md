...
ms.topic: "article"
helpviewer_keywords: 
  - "複数言語のサポート [Analysis Services]"
  - "言語 [Analysis Services]"
  - "SSAS、国際化に関する注意点"
  - "国際化に関する注意点 [Analysis Services]"
  - "グローバルな視点からの注意点 [Analysis Services]"
  - "SQL Server Analysis Services、国際化に関する注意点"
  - "Analysis Services、国際化に関する注意点"
