...
## <a name="see-also"></a>参照  
 [イベントのイベント カテゴリを検出します。](../../analysis-services/trace-events/discover-events-event-category.md)  
