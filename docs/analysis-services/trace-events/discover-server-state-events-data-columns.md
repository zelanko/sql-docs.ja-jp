...
## <a name="see-also"></a>参照  
 [Server State イベント カテゴリを検出します。](../../analysis-services/trace-events/discover-server-state-event-category.md)  
