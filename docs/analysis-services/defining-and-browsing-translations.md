...
1.  [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial キューブのキューブ デザイナーを開いて、**[翻訳]** タブに切り替えます。  
    ...
    ![[翻訳] タブの既定の言語](../analysis-services/media/l9-translations-5.gif "[翻訳] タブの既定の言語")  
...
3.  **データ** ペインからすべての階層とメジャーを削除して、**[パースペクティブ]** ボックスの一覧で [[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial] をクリックします。  
...
5.  ツール バーの **[言語]** ボックスの一覧で **[スペイン語 (スペイン)]** をクリックします。  
    ...
    ![値が再設定さ���たメタデータ ペイン](../analysis-services/media/l9-translations-6.png "値が再設定さ���たメタデータ ペイン")  
...
9. メタデータ ペインで **[Mes del Ano]** を右クリックし、**[クエリに追加]** をクリックします。  
    ...
    ![データ ペインに表示されたスペイン語での月の名前](../analysis-services/media/l9-translations-7.gif "データ ペインに表示されたスペイン語での月の名前")  
