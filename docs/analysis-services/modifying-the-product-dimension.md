...
2.  **[属性]** ペインの **[Model Name]** 属性を、**[階層]** ペインの **<new level>** セル (**[Product Line]** レベルの下) にドラッグします。  
  
3.  **[属性]** ペインの **[Product Name]** 属性を、**[階層]** ペインの **<new level>** セル (**[Model Name]** レベルの下) にドラッグします。 (前のセクションで、Product Key を Product Name に名前変更しました)。  
...
## このレッスンの次の作業  
[Date ディメンションの変更](../analysis-services/modifying-the-date-dimension.md)  
...
[属性階層の &#40;All&#41; レベルの構成](../analysis-services/multidimensional-models/configure-the-all-level-for-attribute-hierarchies.md)  
