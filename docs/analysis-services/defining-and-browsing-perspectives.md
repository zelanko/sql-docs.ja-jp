---
title: "パースペクティブの定義と表示 | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
2.  **[パースペクティブ]** タブのツール バーの **[新しいパースペクティブ]** ボタンをクリックします。  
    ...
    ![[パースペクティブ名] 列の新しいパースペクティブ](../analysis-services/media/l9-perspectives-2.gif "[パースペクティブ名] 列の新しいパースペクティブ")  
...
5.  または、Windows の [スタート] メニューから Excel を起動して、次の図のように、データ接続ウィザードで localhost 上の Analysis Services Tutorial データベースへの接続を定義し、パースペクティブを選択することもできます。  
    ...
    ![Excel でのデータ接続ウィザード](../analysis-services/media/l9-perspectives-3b.gif "Excel でのデータ接続ウィザード")  
...
## このレッスンの次の作業  
[翻訳の定義と表示](../analysis-services/defining-and-browsing-translations.md)  
