---
title: "Analysis Services インスタンス管理 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
|[Analysis Services の管理タスクのスクリプト作成](../../analysis-services/instances/script-administrative-tasks-in-analysis-services.md)|処理などの多くの管理タスクを自動化する方法について説明します。|  
