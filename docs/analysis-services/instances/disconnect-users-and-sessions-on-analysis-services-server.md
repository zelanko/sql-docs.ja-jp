---
title: "Analysis Services サーバー上のユーザーとセッションの切断 | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "ユーザー操作の終了 [Analysis Services]"
  - "接続 [Analysis Services]"
  - "セッション [Analysis Services]"
...
2.  F5 キーを押してキャンセル コマンドを実行します。  
 ...
 このトピックで参照された XMLA の詳細については、[「Execute メソッド (XMLA)」](../Topic/Execute%20Method%20\(XMLA\).md) および [「Cancel 要素 (XMLA)」](../../analysis-services/xmla/xml-elements-commands/cancel-element-xmla.md) を参照してください。  
