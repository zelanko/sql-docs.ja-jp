---
title: "Kerberos の制約付き委任のための Analysis Services の構成 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
-   Analysis Services に対して登録されている SPN が有効であることを確認します。 手順については、「 [SPN registration for an Analysis Services instance](../../analysis-services/instances/spn-registration-for-an-analysis-services-instance.md)」をご覧ください。  
