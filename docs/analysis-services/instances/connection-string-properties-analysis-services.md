...
##  <a name="a-namebkmkcommona-connection-parameters-in-common-use"></a><a name="bkmk_common"></a> よく使用される接続パラメーター  
...
##  <a name="a-namebkmkautha-authentication-and-security"></a><a name="bkmk_auth"></a> 認証およびセキュリティ  
...
##  <a name="a-namebkmkspeciala-special-purpose-parameters"></a><a name="bkmk_special"></a> 特別な用途のパラメーター  
...
|**CommitTimeout**|XMLA プロパティ。 現在実行中のコマンドのコミット フェーズがロールバックするまでに待機する時間をミリ秒数で指定します。 0 より大きいとき、サーバー構成の該当する CommitTimeout プロパティの値を上書きします。 |   
...
##  <a name="a-namebkmkreserveda-reserved-for-future-use"></a><a name="bkmk_reserved"></a> 予約済み  
