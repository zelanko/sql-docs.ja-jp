...
1.  [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Tutorial キューブのキューブ デザイナーを開いて、 **[パースペクティブ]** タブをクリックします。  
    ...
    ![キューブ デザイナーの [パースペクティブ] ペイン](../media/l9-perspectives-1.gif "キューブ デザイナーの [パースペクティブ] ペイン")  
...
2.  **[パースペクティブ]** タブのツール バーの **[新しいパースペクティブ]** ボタンをクリックします。  
    ...
    ![パースペクティブ名 列に新しいパースペクティブ](../media/l9-perspectives-2.gif "パースペクティブ名 列に新しいパースペクティブ")  
...
4.  次の図のように、Excel の分析機能では、Excel でモデルを参照するときに使用するパースペクティブを選択することができます。  
    ...
    ![Internet Sales パースペクティブのオブジェクト](../media/l9-perspectives-3.gif "Internet Sales パースペクティブのオブジェクト")  
...
5.  または、Windows の [スタート] メニューから Excel を起動して、次の図のように、データ接続ウィザードで localhost 上の Analysis Services Tutorial データベースへの接続を定義し、パースペクティブを選択することもできます。  
    ...
    ![Excel でデータ接続ウィザード](../media/l9-perspectives-3b.gif "Excel でデータ接続ウィザード")  
...
8.  モデルで再度 Excel を選択します。 **[Sales Summary]** を選択します。  
    ...
    ![Internet Sales および Reseller Sales メジャー](../media/l9-perspectives-4.gif "Internet Sales および Reseller Sales メジャー")  
