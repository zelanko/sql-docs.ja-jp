---
title: 可用性グループのフェールオーバー - SQL Server on Linux の管理します。
description: ''
author: MikeRayMSFT
ms.author: mikeray
ms.reviewer: vanto
...
- [Pacemaker - 手動でのリソースの移動](https://clusterlabs.org/pacemaker/doc/en-US/Pacemaker/1.1/html/Clusters_from_Scratch/_manually_moving_resources_around_the_cluster.html)
