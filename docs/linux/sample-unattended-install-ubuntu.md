---
title: Ubuntu 上の SQL Server の無人インストール |Microsoft Docs
...
ms.locfileid: "37409661"
---
# <a name="sample-unattended-sql-server-installation-script-for-ubuntu"></a>Ubuntu のサンプル: SQL Server の無人インストール スクリプト
