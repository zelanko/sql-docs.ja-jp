...
Linux 上の SQL Server 2017 RC2 は、SSDT 17.0 RC またはそれ以降のバージョンでサポートされています。

1. [ダウンロードしてインストール SSDT 17.0 RC2]です。
...
[ダウンロードしてインストール SSDT 17.0 RC2]:https://aka.ms/ssdt-download
