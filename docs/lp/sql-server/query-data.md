                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>結合</h3>
                                                    <p>結合を使用する際に SQL Server によって実行される、さまざまな並べ替え、積集合、和集合の操作を調査します。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>スクリプトの作成</h3>
                                                    <p>SQL Server でサポートされているさまざまなスクリプト言語 (Powershell、xQuery など) について調査します。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>サブクエリ</h3>
                                                    <p> サブクエリとは、SELECT、INSERT、UPDATE、または DELETE の各ステートメントの内部、または別のサブクエリの内部で入れ子になっているクエリです。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>シノニム</h3>
                                                    <p>ベース オブジェクトの名前や場所の変更からクライアント アプリケーションを保護するための抽象層を提供する、データベース オブジェクトです。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ユーザー定義関数</h3> 
                                                    <p>パラメーターの受け取り、アクションの実行、そのアクションの結果を値として返す操作などをルーチン化します。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
