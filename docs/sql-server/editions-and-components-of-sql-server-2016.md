...
---
# <a name="editions-and-components-of-sql-server-2016"></a>SQL Server 2016 のエディションとコンポーネント
> SQL Server 2016 の各エディションでサポートされる機能の詳細については、「 [SQL Server 2016 のエディションとサポートされている機能](../sql-server/editions-and-supported-features-for-sql-server-2016.md)」を参照してください。
...
## <a name="includesscurrentincludessscurrent-mdmd-editions"></a>[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] のエディション  
