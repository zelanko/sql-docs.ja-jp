...
|データベース スナップショット|[ユーザー アカウント制御]|可 <sup>3</sup>|可 <sup>3</sup>|可 <sup>3</sup>|可 <sup>3</sup>|
|Always On フェールオーバー クラスター インスタンス|[ユーザー アカウント制御]<br /><br /> ノードの数はオペレーティング システムの最大容量|[ユーザー アカウント制御]<br /><br /> 2 つのノードのサポート|いいえ|いいえ|いいえ|  
|Always On 可用性グループ|[ユーザー アカウント制御]<br /><br /> 2 個の同期セカンダリ レプリカを含む最大 8 個のセカンダリ レプリカ|いいえ|いいえ|いいえ|いいえ|
|基本的な可用性グループ <sup>2</sup>|いいえ|[ユーザー アカウント制御]<br /><br /> 2 つのノードのサポート|いいえ|いいえ|いいえ|
...
|機能|Enterprise|Standard|Web|Express with Advanced Services|Express|  
|-------------|----------------|--------------|---------|------------------------------------|------------------------| 
|列ストア <sup>1</sup>|[ユーザー アカウント制御]|可 <sup>2</sup>|可 <sup>2</sup>|可<sup>2</sup>|可<sup>2</sup>|  
|インメモリ OLTP <sup>1</sup>|[ユーザー アカウント制御]|可 <sup>2</sup>|可 <sup>2</sup>|可 <sup>2</sup>、 <sup>3</sup>|可 <sup>2</sup>|
...
|テーブルとインデックスのパーティション分割|[ユーザー アカウント制御]|可 <sup>2</sup>|可 <sup>2</sup>|可 <sup>2</sup>|可 <sup>2</sup>|  
|データ圧縮|[ユーザー アカウント制御]|可 <sup>2</sup>|可 <sup>2</sup>|可 <sup>2</sup>|可 <sup>2</sup>|
|[リソース ガバナー]|[ユーザー アカウント制御]|いいえ|いいえ|いいえ|いいえ|  
|パーティション テーブルの並列処理|[ユーザー アカウント制御]|いいえ|いいえ|いいえ|いいえ|
|複数の Filestream コンテナー|[ユーザー アカウント制御]|可 <sup>2</sup>|可 <sup>2</sup>|可 <sup>2</sup>|可 <sup>2</sup>|
...
|-------------|----------------|--------------|---------|-------------|------------------------------------| 
|行レベルのセキュリティ|[ユーザー アカウント制御]|[ユーザー アカウント制御]|可 <sup>1</sup>|可 <sup>1</sup>|可 <sup>1</sup>|  
|Always Encrypted|[ユーザー アカウント制御]|可 <sup>1</sup>|可 <sup>1</sup>|可 <sup>1</sup>|可 <sup>1</sup>| 
|動的なデータ マスキング|[ユーザー アカウント制御]|[ユーザー アカウント制御]|可 <sup>1</sup>|可 <sup>1</sup>|可 <sup>1</sup>|   
|基本的な監査|[ユーザー アカウント制御]|はい|はい|はい|[ユーザー アカウント制御]| 
|詳細な監査|[ユーザー アカウント制御]|可 <sup>1</sup>|可 <sup>1</sup>|可 <sup>1</sup>|可 <sup>1</sup>| 
...
|PowerShell スクリプティングのサポート|[ユーザー アカウント制御]|はい|はい|はい|[ユーザー アカウント制御]| 
...
|R Server (スタンドアロン)|[ユーザー アカウント制御]|いいえ|いいえ|いいえ|いいえ|   
|Polybase コンピューティング ノード|[ユーザー アカウント制御]|可 <sup>1</sup>|可 <sup>1</sup>、 <sup>2</sup>|可 <sup>1</sup>、 <sup>2</sup>|可 <sup>1</sup>、 <sup>2</sup>| 
...
|変更データ キャプチャ|[ユーザー アカウント制御]|可 <sup>1</sup>|いいえ|いいえ|いいえ| 
