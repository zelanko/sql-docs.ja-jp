...
ms.topic: "article"
helpviewer_keywords: 
  - "Stretch Database, データベースの特定"
  - "Stretch Database, テーブルの特定"
  - "データベースの特定、Stretch Database"
  - "テーブルの特定、Stretch Database"
...
## アップグレード アドバイザーのダウンロードおよびインストール  
 アップグレード アドバイザーを [ここ](http://go.microsoft.com/fwlink/?LinkID=613421)からダウンロードし、インストールします。 このツールは、 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] インストール メディアには含まれていません。  
