...
---
# Stretch Database と互換性のある SQL Server 機能を構成する
...
## Stretch Database で Always On を構成する
...
## Stretch Database で Always Encrypted を構成する
...
## Stretch Database で透過的なデータ暗号化 (TDE) を構成する
...
## Stretch Database でテンポラル テーブルを構成する
