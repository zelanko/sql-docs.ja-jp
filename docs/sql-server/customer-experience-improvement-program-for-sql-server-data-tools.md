...
---
# SQL Server Data Tools のカスタマー エクスペリエンス向上プログラム
...
## SQL Server Data Tools の CEIP を有効または無効にする  
...
### Visual Studio 2015 の CEIP と SQL Server Data Tools の選択および制御  
...
### CEIP および SQL Server Data Tools - BI (SSDT BI) の選択および制御  
