...
|[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|\<Install Directory>\130\DTS\|構成可能*|  
|クライアント コンポーネント (bcp.exe および sqlcmd.exe を除く)|\<Install Directory>\130\Tools\|構成可能*|  
