...
ms.topic: "article"
helpviewer_keywords: 
  - "ファイアウォール システム [SQL Server]"
  - "サーバー メッセージ ブロック [SQL Server]"
  - "プロトコルの無効化"
  - "セキュリティ [SQL Server], インストール"
  - "プロトコル [SQL Server], 無効化"
  - "NetBIOS [SQL Server]"
  - "サービス [SQL Server], セキュリティ"
  - "SMB [SQL Server]"
  - "サービスの分離 [SQL Server]"
  - "セットアップ [SQL Server], セキュリティ"
  - "低い SQL Server インストール権限"
  - "NTFS [SQL Server]"
  - "物理的なセキュリティ [SQL Server]"
  - "ファイル システムのセキュリティ [SQL Server]"
  - "SQL Server のインストール, セキュリティ"
...
## をインストールする前に [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
###  <a name="physical_security"></a> 物理的なセキュリティの強化  
...
###  <a name="firewalls"></a> ファイアウォールの使用  
...
###  <a name="isolated_services"></a> サービスの分離  
...
###  <a name="sa_with_least_privileges"></a> 安全なファイル システムの構成  
...
###  <a name="disabled_protocols"></a> NetBIOS とサーバー メッセージ ブロックの無効化  
...
## のインストール中またはインストール後 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
