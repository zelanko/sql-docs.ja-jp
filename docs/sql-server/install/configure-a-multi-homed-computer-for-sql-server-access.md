...
ms.topic: "article"
helpviewer_keywords: 
  - "ポート [SQL Server], マルチホーム コンピューター"
  - "マルチホーム コンピューター [SQL Server] ポートの構成"
  - "ファイアウォール システム、[データベース エンジン], マルチホーム コンピューター"
...
#### 使用される IP アドレスおよびポートを特定するには [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
