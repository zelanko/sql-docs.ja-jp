...
DB2 オブジェクトへの変換を分析する[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]オブジェクトを実行できます[データ移行レポート (SSMA 一般的)](http://msdn.microsoft.com/bbfb9d88-5a98-4980-8d19-c5d78bd0d241)します。  
