...
5.  **Connect to Oracle**ダイアログ ボックスで、接続の資格情報を入力し、をクリックして**接続**です。 Oracle への接続の詳細については、次を参照してください[Oracle に接続 (&) #40";"OracleToSQL"&"#41;。](../../ssma/oracle/connect-to-oracle-oracletosql.md)  
