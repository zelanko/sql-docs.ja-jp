---
title: メニュー コマンドやその他のショートカット キー (MySQLToSQL) |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|接続が表示されますか、ダイアログ ボックスで MySQL に再接続します。|ALT + F + T|  
...
|これを行う|キーを押します|  
|--------------|---------|  
|ダイアログ ボックスで MySQL の SSMA について表示します。|ALT + H + A|  
