...
|[SQL Server (MySQL to SQL) での SSMA コンポーネントのインストール](http://msdn.microsoft.com/6772d0c5-258f-4d7b-afb0-b5f810e71af1)|インスタンスに拡張機能パックをインストールするための情報と手順を提供します。[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]します。|  
