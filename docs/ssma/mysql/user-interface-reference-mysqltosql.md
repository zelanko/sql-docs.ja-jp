...
|[SQL Server に接続します。](http://msdn.microsoft.com/d73abd3a-80df-4293-b973-1723069db049)|使用して、 **SQL サーバーへの接続**移行する SQL Server のインスタンスに接続する ダイアログ ボックス。|  
...
|[グローバル設定 (ログ)](http://msdn.microsoft.com/0d033492-5ec3-473a-8de1-821894ec9518)|ログ記録 ページを使用して、**グローバル設定**ダイアログ ボックスをログ記録を構成します。|  
