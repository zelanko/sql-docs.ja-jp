...
|接続を表示または Sybase ダイアログ ボックスに再接続します。|ALT + F + T|  
...
|これを行う|キーを押します|  
|--------------|---------|  
|SSMA に関する for Sybase ダイアログ ボックスを表示します。|ALT + H + A|  
...
[ショートカット キー&#40;Sybase To SQL&#41;](../../ssma/sybase/shortcut-keys-sybase-to-sql.md)  
