---
title: メニュー コマンドやその他のショートカット キー (AccessToSQL) |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|移行ウィザードのダイアログ ボックスを表示します。|ALT + F + W|  
...
|表示変換、読み込みおよび移行ウィザード ダイアログ ボックス。|ALT + T + V|  
|リンク テーブルまたはテーブルをリンクします。|ALT + T、L|  
...
|これを行う|キーを押します|  
|--------------|---------|  
|SSMA についてのアクセス ダイアログ ボックスを表示します。|ALT + H + A|  
