...
1. [クライアントの Microsoft SQL Server へのプログラミングのホームページ](homepage-sql-connection-programming.md)
2. [Azure Active Directory 認証を使用して接続します。](php/azure-active-directory.md)
3. [アイドル接続の回復](php/connection-resiliency.md)
4. [PHP の Linux および Mac のドライバーのインストールのチュートリアル](php/installation-tutorial-linux-mac.md)
5. [Microsoft SQL データベースを接続するモジュール](sql-connection-libraries.md)
