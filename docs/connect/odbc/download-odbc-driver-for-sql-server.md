...
- [Ubuntu 19.04 .deb パッケージ](https://packages.microsoft.com/ubuntu/19.04/prod/pool/main/m/msodbcsql17/)
- [Ubuntu 18.10 .deb パッケージ](https://packages.microsoft.com/ubuntu/18.10/prod/pool/main/m/msodbcsql17/)
...
[ドライバーのインストール](linux-mac/installing-the-microsoft-odbc-driver-for-sql-server.md)に関する記事も参照してください。
...
#### <a name="macos"></a>macOS
- [OS X 10.11 および macOS 10.12、10.13 Homebrew formulae](https://github.com/Microsoft/homebrew-mssql-release)
