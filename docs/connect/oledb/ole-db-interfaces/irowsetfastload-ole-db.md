...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  **IRowsetFastLoad** インターフェイスでは、[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] のメモリベースの一括コピー操作のサポートが公開されます。 SQL Server コンシューマー用の OLE DB ドライバーは、インターフェイスを使用して、既存[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]のテーブルにデータを迅速に追加します。  
