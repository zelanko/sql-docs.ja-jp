...
JDBC ドライバーは、次のコードで POM.xml ファイル内の依存関係として追加することによって Maven プロジェクトに追加できます。
...
## <a name="download-previous-versions-of-jdbc-drivers-for-sql-server"></a>SQL Server の以前のバージョンの JDBC ドライバーをダウンロードします。  
