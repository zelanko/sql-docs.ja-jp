---
title: supportsOrderByUnrelated メソッド (SQLServerDatabaseMetaData) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>解説  
 この supportsOrderByUnrelated メソッドは、java.sql.DatabaseMetaData インターフェイスの supportsOrderByUnrelated メソッドによって指定されます。  
