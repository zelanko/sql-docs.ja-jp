---
title: supportsSchemasInDataManipulation メソッド |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>解説  
 この supportsSchemasInDataManipulation メソッドは、java.sql.DatabaseMetaData インターフェイスの supportsSchemasInDataManipulation メソッドによって指定されます。  
