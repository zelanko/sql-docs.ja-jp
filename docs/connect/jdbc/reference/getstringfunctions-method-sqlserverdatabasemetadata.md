---
title: getStringFunctions メソッド (SQLServerDatabaseMetaData) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  コンマ区切りの一覧を取得**文字列**データベースで使用される関数。  
...
## <a name="remarks"></a>解説  
 この getStringFunctions メソッドは、java.sql.DatabaseMetaData インターフェイスの getStringFunctions メソッドによって指定されます。  
