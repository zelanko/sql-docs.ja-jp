---
title: "updateRef (int, java.sql.Ref) メソッド |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
## <a name="see-also"></a>参照  
 [updateRef メソッド &#40;です。SQLServerResultSet &#41;](../../../connect/jdbc/reference/updateref-method-sqlserverresultset.md)   
