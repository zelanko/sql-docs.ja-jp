...
ms.locfileid: "32845187"
---
# <a name="sqlserverconnectionpooldatasource-constructor-"></a>SQLServerConnectionPoolDataSource () コンストラクター
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  新しいインスタンスを初期化、 [SQLServerConnectionPoolDataSource](../../../connect/jdbc/reference/sqlserverconnectionpooldatasource-class.md)クラスです。  
...
## <a name="see-also"></a>参照  
 [SQLServerConnectionPoolDataSource のコンス トラクター](../../../connect/jdbc/reference/sqlserverconnectionpooldatasource-constructors.md)   
