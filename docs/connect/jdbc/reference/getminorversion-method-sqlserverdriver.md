---
title: getMinorVersion メソッド (SQLServerDriver) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **Int** JDBC ドライバーのマイナー バージョン番号を格納しています。  
  
## <a name="remarks"></a>解説  
 この getMinorVersion メソッドは、java.sql.Driver インターフェイスの getMinorVersion メソッドによって指定されます。  
