---
title: Supportsopenカーソル Sacrossrollback メソッド |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 この Supportsopenカーソル Sacrossrollback メソッドは、java メタデータインターフェイスの Supportsopenカーソル Sacrossrollback メソッドによって指定されます。  
