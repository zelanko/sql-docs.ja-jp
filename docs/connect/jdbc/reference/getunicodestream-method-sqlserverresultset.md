...
|名前|Description|  
|----------|-----------------|  
|[getUnicodeStream メソッド &#40;int 型&#41;](../../../connect/jdbc/reference/getunicodestream-method-int.md)|この現在の行に指定された列インデックスの値を取得[SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) Unicode 文字のストリームとしてオブジェクト。|  
