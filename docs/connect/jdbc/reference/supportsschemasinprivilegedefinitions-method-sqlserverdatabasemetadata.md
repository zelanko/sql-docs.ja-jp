...
## <a name="remarks"></a>Remarks  
 この supportsSchemasInPrivilegeDefinitions メソッドは、java.sql.DatabaseMetaData インターフェイスで supportsSchemasInPrivilegeDefinitions メソッドによって指定されます。  
