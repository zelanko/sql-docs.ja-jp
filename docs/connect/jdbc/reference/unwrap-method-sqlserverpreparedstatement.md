...
## <a name="remarks"></a>解説  
 ...
 このメソッドが呼び出されると、オブジェクトは次のクラスにラップ解除されます。[SQLServerStatement](../../../connect/jdbc/reference/sqlserverstatement-class.md) および [SQLServerPreparedStatement](../../../connect/jdbc/reference/sqlserverpreparedstatement-class.md)。  
