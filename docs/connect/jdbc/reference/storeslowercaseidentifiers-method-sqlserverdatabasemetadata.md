---
title: storesLowerCaseIdentifiers メソッド (SQLServerDatabaseMetaData) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>解説  
 この storesLowerCaseIdentifiers メソッドは、java.sql.DatabaseMetaData インターフェイスの storesLowerCaseIdentifiers メソッドによって指定されます。  
