...
ms.locfileid: "47762268"
---
# <a name="getasciistream-method-sqlservercallablestatement"></a>getAsciiStream メソッド (SQLServerCallableStatement)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  指定されたパラメーターの値を  文字のストリームとして取得します。  
  
## <a name="overload-list"></a>オーバーロードの一覧  
  
|[オブジェクト名]|[説明]|  
|----------|-----------------|  
|[getAsciiStream](../../../connect/jdbc/reference/getasciistream-int.md)|パラメーターに渡されたインデックスを使用して、指定されたパラメーターの値を  文字のストリームとして取得します。|  
|[getAsciiStream &#40;java.lang.String&#41;](../../../connect/jdbc/reference/getasciistream-java-lang-string.md)|パラメーターに渡された名前を使用して、指定されたパラメーターの値を  文字のストリームとして取得します。|  
