---
title: getMaxTableNameLength メソッド (SQLServerDatabaseMetaData) |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 この getMaxTableNameLength メソッドは、java.sql.DatabaseMetaData インターフェイスで getMaxTableNameLength メソッドによって指定されます。  
