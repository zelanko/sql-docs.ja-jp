---
title: "getAsciiStream (int) |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  指定されたパラメーターの値のストリームとして取得**ASCII**パラメーター インデックスを指定した文字。  
...
## <a name="see-also"></a>参照  
 [getAsciiStream メソッド & #40 です。SQLServerCallableStatement &#41;](../../../connect/jdbc/reference/getasciistream-method-sqlservercallablestatement.md)   
