...
## <a name="remarks"></a>Remarks  
 ...
 このメソッドは置換の必要性[SQLServerBlob コンス トラクター &#40;SQLServerConnection、バイト&#41;](../../../connect/jdbc/reference/sqlserverblob-constructor-sqlserverconnection-byte.md)します。  
