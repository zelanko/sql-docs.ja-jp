---
title: "updateInt (int, int) メソッド |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
## <a name="see-also"></a>参照  
 [updateInt メソッド & #40 です。SQLServerResultSet &#41;](../../../connect/jdbc/reference/updateint-method-sqlserverresultset.md)   
