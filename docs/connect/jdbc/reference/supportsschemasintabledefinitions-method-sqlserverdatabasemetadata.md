---
title: "supportsSchemasInTableDefinitions メソッド |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
## <a name="remarks"></a>解説  
 この supportsSchemasInTableDefinitions メソッドは、java.sql.DatabaseMetaData インターフェイスの supportsSchemasInTableDefinitions メソッドによって指定されます。  
