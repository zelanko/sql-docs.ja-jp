---
title: getTime メソッド (SQLServerCallableStatement) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|[getTime (int, java.util.Calendar)](../../../connect/jdbc/reference/gettime-method-int-java-util-calendar.md)|指定されたパラメーターの値を渡された Calendar オブジェクトを使用して Java プログラミング言語パラメーター インデックスの java.sql.Time オブジェクトとして取得します。|  
...
|[getTime (java.lang.String, java.util.Calendar)](../../../connect/jdbc/reference/gettime-method-java-lang-string-java-util-calendar.md)|指定されたパラメーターの値を渡された Calendar オブジェクトを使用して Java プログラミング言語、パラメーター名の java.sql.Time オブジェクトとして取得します。|  
