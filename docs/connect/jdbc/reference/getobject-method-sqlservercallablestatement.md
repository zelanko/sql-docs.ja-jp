---
title: getObject メソッド (SQLServerCallableStatement) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|[getObject (int, java.util.Map)](../../../connect/jdbc/reference/getobject-method-int-java-util-map.md)|特定のマップ オブジェクトを使用して Java プログラミング言語パラメーター インデックス内のオブジェクトとして指定されたパラメーターの値を取得します。|  
...
|[getObject (java.lang.String, java.util.Map)](../../../connect/jdbc/reference/getobject-method-java-lang-string-java-util-map.md)|特定のマップ オブジェクトを使用して Java プログラミング言語のパラメーター名を指定のオブジェクトとして指定されたパラメーターの値を取得します。|  
