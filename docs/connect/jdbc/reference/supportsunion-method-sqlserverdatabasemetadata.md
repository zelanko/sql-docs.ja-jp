---
title: supportsUnion メソッド (SQLServerDatabaseMetaData) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>解説  
 この supportsUnion メソッドは、java.sql.DatabaseMetaData インターフェイスの supportsUnion メソッドによって指定されます。  
