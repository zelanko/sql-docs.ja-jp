---
title: getMajorVersion メソッド (SQLServerDriver) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **Int** JDBC ドライバーのメジャー バージョン番号を格納しています。  
