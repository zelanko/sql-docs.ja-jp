---
title: SQLServerDataSourceObjectFactory のコンス トラクター () |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32845617"
---
# <a name="sqlserverdatasourceobjectfactory-constructor-"></a>SQLServerDataSourceObjectFactory () コンストラクター
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  新しいインスタンスを初期化、 [SQLServerDataSourceObjectFactory](../../../connect/jdbc/reference/sqlserverdatasourceobjectfactory-class.md)クラスです。  
...
## <a name="see-also"></a>参照  
 [SQLServerDataSourceObjectFactory のコンス トラクター](../../../connect/jdbc/reference/sqlserverdatasourceobjectfactory-constructors.md)   
