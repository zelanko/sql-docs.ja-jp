---
title: "getInt (java.lang.String) メソッド |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  として指定されたパラメーターの値を取得、 **int** java プログラミング言語のパラメーター名を指定します。  
...
## <a name="see-also"></a>参照  
 [getInt メソッド & #40 です。SQLServerCallableStatement &#41;](../../../connect/jdbc/reference/getint-method-sqlservercallablestatement.md)   
