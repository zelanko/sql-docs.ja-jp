...
|[setNClob メソッド &#40;java.lang.String、java.io.Reader、時間の長い &#41;](../../../connect/jdbc/reference/setnclob-method-java-lang-string-java-io-reader-long.md)|指定された文字数は、指定したリーダー オブジェクトを指定されたパラメーターを設定します。|  
