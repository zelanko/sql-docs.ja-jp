...
## <a name="remarks"></a>Remarks  
 この supportsOpenStatementsAcrossCommit メソッドは、java.sql.DatabaseMetaData インターフェイスで supportsOpenStatementsAcrossCommit メソッドによって指定されます。  
