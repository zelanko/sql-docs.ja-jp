---
title: setTime (int, java.sql.Time, java.util.Calendar) メソッド
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="see-also"></a>参照  
 [execute メソッド &#40;SQLServerPreparedStatement&#41;](../../../connect/jdbc/reference/settime-method-sqlserverpreparedstatement.md)   
