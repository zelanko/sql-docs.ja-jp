---
title: "supportsSubqueriesInQuantifieds メソッド (SQLServerDatabaseMetaData) |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
...
## <a name="remarks"></a>解説  
 この supportsSubqueriesInQuantifieds メソッドは、java.sql.DatabaseMetaData インターフェイスの supportsSubqueriesInQuantifieds メソッドによって指定されます。  
