---
title: supportsGetGeneratedKeys メソッド (SQLServerDatabaseMetaData) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>解説  
 この supportsGetGeneratedKeys メソッドは、java.sql.DatabaseMetaData インターフェイスの supportsGetGeneratedKeys メソッドによって指定されます。  
