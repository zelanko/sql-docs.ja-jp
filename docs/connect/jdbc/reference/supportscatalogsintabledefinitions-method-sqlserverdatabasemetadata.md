...
## <a name="remarks"></a>Remarks  
 この supportsCatalogsInTableDefinitions メソッドは、java.sql.DatabaseMetaData インターフェイスで supportsCatalogsInTableDefinitions メソッドによって指定されます。  
