---
title: setFloat メソッド (SQLServerPreparedStatement) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>解説  
 この setFloat メソッドは、java.sql.PreparedStatement インターフェイスの setFloat メソッドによって指定されます。  
