...
|結果セット<br /><br /> (カーソル) の種類|SQL Server のカーソルの種類|特性|select<br /><br /> Method|応答<br /><br /> Buffering|説明|  
|------------------------------------|----------------------------|---------------------|-----------------------|----------------------------|-----------------|  
