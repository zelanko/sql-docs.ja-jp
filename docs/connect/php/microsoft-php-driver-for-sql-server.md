...
* [手順 2: PHP 開発用データベースを作成します。](step-2-create-a-sql-database-for-php-development.md)  
...
* [Red Hat Enterprise Linux (RHEL) での PHP の使用を開始します。](https://www.microsoft.com/sql-server/developer-get-started/php/rhel/)
* [SUSE Linux Enterprise Server (SLES) での PHP の使用を開始します。](https://www.microsoft.com/sql-server/developer-get-started/php/sles/)
