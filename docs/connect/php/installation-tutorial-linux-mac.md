...
> PHP 7.1 をインストールするには、下のリポジトリの URL に次の URL を置き換えます。 `https://download.opensuse.org/repositories/devel:/languages:/php:/php71/SLE_12/devel:languages:php:php71.repo`
