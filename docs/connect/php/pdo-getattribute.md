...
|PDO::ATTR_DRIVER_VERSION|[!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]|String|示します、[!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]バージョン (*MajorVer*.*MinorVer*.*BuildNumber*.*リビジョン*)|  
...
|PDO::ATTR_SERVER_VERSION|[!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]|String|SQL Server のバージョンを示します (*メジャー*.*マイナー*.*BuildNumber*)|  
