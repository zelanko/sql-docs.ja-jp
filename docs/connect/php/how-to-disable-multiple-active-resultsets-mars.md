---
title: '方法: 複数のアクティブな結果セット (MARS) を無効にする |Microsoft ドキュメント'
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="example"></a>例  
次の例の PDO_SQLSRV ドライバーを使用して、MARS サポートを無効にする方法を示しています、[!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]です。  
