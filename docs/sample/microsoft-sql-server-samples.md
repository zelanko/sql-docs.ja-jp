---
title: "Microsoft SQL Server のサンプル |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/19/2017
ms.reviewer: 
ms.suite: sql
...
Wide World importers 社 (第一次世界大戦)、showcase データベース デザインの最新機能と、ツール、および設計手法を使用するように開発と呼ばれる新しいサンプル データベースの機能に満足しています。 OLTP と OLAP データベースの SQL Server 2016 以降を実行するが作成されるサンプルが含まれます。 

## <a name="documentation"></a>ドキュメント
[第一次世界大戦ドキュメント](./world-wide-importers/wide-world-importers-documentation.md)が Microsoft のドキュメントにします。   
  

## <a name="sql-server-samples-repository"></a>SQL Server のサンプル リポジトリ
