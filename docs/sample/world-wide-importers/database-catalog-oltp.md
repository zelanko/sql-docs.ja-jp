---
title: "WideWorldImporters データベース カタログ |Microsoft ドキュメント"
...
このスキーマ内のストアド プロシージャは、ETL プロセスによって使用されます。 必要な時間帯でさまざまなテーブルから必要なデータを取得する、 [ETL パッケージ](etl-workflow.md)です。
