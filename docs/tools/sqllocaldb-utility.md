...
ms.topic: "article"
helpviewer_keywords: 
  - "SqlLocalDB ユーティリティ [SQL Server]"
  - "Local Database Runtime ユーティリティ"
  - "LocalDB、SqlLocalDB ユーティリティ"
...
[コマンド ライン管理ツール: SqlLocalDB.exe](Command-Line%20Management%20Tool:%20SqlLocalDB.exe.md)  
