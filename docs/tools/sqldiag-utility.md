...
ms.topic: "article"
helpviewer_keywords: 
  - "コマンド プロンプト ユーティリティ [SQL Server], SQLdiag"
  - "診断収集の停止"
  - "診断情報の格納"
  - "パフォーマンス [SQL Server], 診断収集"
  - "診断レコード [SQL Server]"
  - "スクリプト [SQL Server], 診断収集"
  - "ログ [SQL Server], 診断収集"
  - "診断収集の開始"
  - "SQL Server のクラスター化されたインスタンス"
  - "パフォーマンスの監視 [SQL Server], 診断収集"
  - "セキュリティ [SQL Server], 診断収集"
  - "SQLDIAG サービス"
  - "領域 [SQL Server], 診断収集"
  - "SQLdiag ユーティリティ"
  - "ディスク領域 [SQL Server], 診断収集"
  - "構成ファイル [SQL Server]"
  - "自動診断収集"
  - "クラスター [SQL Server], 診断収集"
 ...
 **/G** が指定されていない場合、**SQLdiag** は、ユーザーが Windows の **Administrators** グループのメンバーかどうかを判断するためのチェックを行い、ユーザーが **Administrators** グループのメンバーではない場合は [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] の診断情報を収集しません。  
...
## クラスター化された SQL Server インスタンスからの診断データの収集  
