---
title: "SQLdiag ユーティリティ |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
-   [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]ブロッキング情報  
 ...
 **/M** *machine1* [ *machine2**machineN*] | *@machinelistfile*  
 ...
 使用して *@machinelistfile* 構成ファイルに保存するコンピューター一覧のファイル名を指定します。  
