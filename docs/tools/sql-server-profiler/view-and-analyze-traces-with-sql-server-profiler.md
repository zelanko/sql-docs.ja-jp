...
ms.topic: "article"
helpviewer_keywords: 
  - "プロファイラー [SQL Server プロファイラー], トレースの表示"
  - "SQL Server プロファイラー, トレースの表示"
  - "トレース [SQL Server], 表示"
  - "SQL Server プロファイラー, トラブルシューティング"
  - "トラブルシューティング [SQL Server], トレース"
  - "イベント [SQL Server], トレース内の検索"
  - "プロファイラー [SQL Server プロファイラー], トラブルシューティング"
...
2.  対象のイベントを検索します。  
    ...
    -   トレース ファイルまたはテーブルを開き、必要なイベント クラスのノード、たとえば **Deadlock Chain**を展開します。 詳細については、「[トレース ファイルを開く &#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/open-a-trace-file-sql-server-profiler.md)」または「[トレース テーブルを開く &#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/open-a-trace-table-sql-server-profiler.md)」を参照してください。  
  
    -   目的のイベントが見つかるまで、トレース データ全体を検索します。[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] の **[編集]** メニューの **[検索]** を使用すると、トレース内の値を検索するときに便利です。 トレースするイベントの **ClientProcessID** データ列に加えて **Start Time** データ列の値を書き留めておきます。  
