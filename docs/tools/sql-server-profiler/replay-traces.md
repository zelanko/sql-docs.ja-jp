...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server プロファイラー、トレースの再生"
  - "[カーソルまで実行] オプション"
  - "[ブレークポイントの設定/解除] オプション"
  - "トレース [SQL Server]、再生"
  - "トレースの再生"
  - "再生エンジン [SQL Server Profiler]"
  - "イベント [SQL Server]、トレースの再生"
  - "プロファイラー [SQL Server]、トレースの再生"
...
|[再生オプション &#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/replay-options-sql-server-profiler.md)|[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] の **[構成の再生]** ダイアログ ボックスで設定できるオプションについて説明します。|  
