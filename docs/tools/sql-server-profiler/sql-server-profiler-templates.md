---
title: "SQL Server Profiler のテンプレート | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
 ...
 **[トレース テンプレートのプロパティ]** ダイアログ ボックスに移動するには、[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] で、**[ファイル]** メニューの **[テンプレート]** をクリックして、**[新しいテンプレート]** または **[テンプレートの編集]** をクリックします。  
