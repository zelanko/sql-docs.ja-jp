...
ms.topic: "article"
helpviewer_keywords: 
  - "テンプレート [SQL Server], SQL Server Profiler"
  - "Profiler [SQL Server Profiler], テンプレート"
  - "トレース テンプレート [SQL Server]"
  - "トレース テンプレートの変更"
  - "SQL Server Profiler, テンプレート"
 ...
 **トレース テンプレートを変更するには**  
 ...
 [SQL Server Profiler の使用](../../tools/sql-server-profiler/modify-a-trace-template-sql-server-profiler.md)  
 ...
 **トレース テンプレートまたはトレース ファイルからイベントを追加または削除するには**  
 ...
 [SQL Server Profiler の使用](../../tools/sql-server-profiler/specify-events-and-data-columns-for-a-trace-file-sql-server-profiler.md)  
  
 [Transact-SQL の使用](../../relational-databases/system-stored-procedures/sp-trace-setevent-transact-sql.md)  
