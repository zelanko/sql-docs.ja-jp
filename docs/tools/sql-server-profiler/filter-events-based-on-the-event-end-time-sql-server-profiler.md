...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]トレース イベントがイベントを使用して、終了時刻に基づいてフィルター選択をする方法を説明[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]です。  
