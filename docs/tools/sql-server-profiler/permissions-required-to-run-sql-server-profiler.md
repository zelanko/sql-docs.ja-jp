---
title: "SQL Server Profiler の実行に必要な権限 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "プロファイラー [SQL Server Profiler], 権限"
  - "トレース [SQL Server], 再生"
  - "トレースの再生"
  - "SQL Server Profiler, 権限"
  - "セキュリティ [SQL Server], SQL Server Profiler"
...
6.  対象のデータベースに Guest ユーザーが存在するかどうかがチェックされます。チェックの結果に応じて、次のいずれかが行われます。  
 ...
 ![SQL Server プロファイラーのトレース再生の権限](../../tools/sql-server-profiler/media/replaytracedecisiontree.gif "SQL Server プロファイラーのトレース再生の権限")  
