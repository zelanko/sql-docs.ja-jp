...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]**Dta**コマンド プロンプト ユーティリティは、それに加えて、データベース エンジン チューニング アドバイザーによって提供される機能を提供します。  
