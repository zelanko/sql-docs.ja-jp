...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]データベース エンジン チューニング アドバイザーの分析時に使用するか物理デザイン構造 (インデックスまたはインデックス付きビュー) が含まれています。  
