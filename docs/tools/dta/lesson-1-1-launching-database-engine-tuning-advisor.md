---
title: "起動するデータベース エンジン チューニング アドバイザー |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
> [!NOTE]  
> データベース エンジン チューニング アドバイザーが XML ファイルを取得する場合、[!INCLUDE[tsql](../../includes/tsql-md.md)]からスクリプトをインポート[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]クエリ エディター。 詳細については、「 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] データベース エンジン チューニング アドバイザーからの出力の表示および操作 [」の](../../relational-databases/performance/start-and-use-the-database-engine-tuning-advisor.md)クエリ エディターからデータベース エンジン チューニング アドバイザーを起動する方法に関するセクションを参照してください。  
  
## <a name="next-task-in-lesson"></a>このレッスンの次の作業  
[ツール オプションの設定とレイアウト](../../tools/dta/lesson-1-2-setting-tool-options-and-layout.md)  
