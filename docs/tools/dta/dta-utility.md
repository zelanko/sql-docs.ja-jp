...
helpviewer_keywords: 
  - "物理デザイン構造 [SQL Server]"
  - "コマンド プロンプト ユーティリティ [SQL Server]、dta"
  - "dta ユーティリティ"
  - "データベースのチューニング[SQL Server]、データベース エンジン チューニング アドバイザー"
  - "ワークロード [SQL Server]、分析"
  - "dta ユーティリティ、dta ユーティリティについて"
  - "パフォーマンス [SQL Server]、データベース エンジン チューニング アドバイザー"
  - "データベース エンジン チューニング アドバイザー [SQL Server]、コマンド プロンプト"
  - "データベースの最適化 [SQL Server]"
