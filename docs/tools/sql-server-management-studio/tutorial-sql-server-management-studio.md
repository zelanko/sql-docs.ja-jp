...
helpviewer_keywords: 
  - "プロジェクト [SQL Server Management Studio], チュートリアル"
  - "テンプレート [SQL Server], SQL Server Management Studio"
  - "ソース管理 [SQL Server Management Studio], チュートリアル"
  - "ヘルプ [SQL Server], SQL Server Management Studio"
  - "チュートリアル [SQL Server Management Studio]"
  - "Transact-SQL のチュートリアル"
  - "ソリューション [SQL Server Management Studio], チュートリアル"
  - "SQL Server Management Studio [SQL Server], チュートリアル"
