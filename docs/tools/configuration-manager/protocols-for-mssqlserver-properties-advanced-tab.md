 ...
 **拡張保護**は、[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] 以降の [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client によって完全にサポートされています。 その他の [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] クライアント プロバイダーでは、**拡張保護**は現時点ではサポートされていません。  
