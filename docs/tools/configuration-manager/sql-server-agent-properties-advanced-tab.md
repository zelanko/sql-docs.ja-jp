---
title: "SQL Server エージェントのプロパティ ([詳細] タブ) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]5 つのプロパティに表示される、 **[詳細設定]**既定のタブです。 カスタム プロパティが定義されていれば、そのプロパティと値もこのタブに表示されます。  
