...
> [!NOTE]  
>  この形式の**生成**関数場合に利用でき、計算のデバッグように、セット内のすべてのメンバーの名前を表示する文字列を返すことができます。 一連の厳密な MDX 表記よりも読みやすくする可能性がある、 [SetToStr (& a) #40 です。MDX と #41 です。](../mdx/settostr-mdx.md)関数が返される。  
