...
## <a name="see-also"></a>参照  
 ...
 [分析データ ソースからデータを取得します。](https://docs.microsoft.com/bi-reference/adomd/multidimensional-models-adomd-net-client/retrieving-data-from-an-analytical-data-source)   
