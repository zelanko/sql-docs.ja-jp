...
同時に発生するすべての負荷の合計サイズは、データベースの LOG_SIZE よりも小さくする必要があります。同時読み込みの合計サイズは、LOG_SIZE の50% 未満にすることをお勧めします。 このサイズ制限を実現するために、大きな負荷を複数のバッチに分割できます。 LOG_SIZE の詳細については、「 [CREATE DATABASE](../t-sql/statements/create-database-transact-sql.md?view=aps-pdw-2016) 」を参照してください。  
...
|付い|はい|はい|いいえ|Minimal|  
|付い|はい|いいえ|はい|[完全]|  
|付い|いいえ|はい|いいえ|Minimal|  
|付い|いいえ|いいえ|はい|[完全]|  
