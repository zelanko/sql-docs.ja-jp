---
title: Dwloader のデータ型変換規則 - Parallel Data Warehouse |Microsoft ドキュメント
description: このトピックの内容について説明します、入力データの形式と暗黙的なデータ型変換その dwloader のコマンド ライン ローダーは、並列データ ウェアハウス (PDW) にデータの読み込み時にサポートしています。"
author: mzaman1
manager: craigg
ms.prod: sql
