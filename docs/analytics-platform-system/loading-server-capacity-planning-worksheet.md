...
## <a name="clipboard-capacity-planning-worksheet"></a>![クリップボード](media/clipboard-icon.png "クリップボード")容量計画ワークシート
...
[読み込みサーバー](acquire-and-configure-loading-server.md)
の[dwloader コマンドラインローダー](dwloader.md)の取得と構成
