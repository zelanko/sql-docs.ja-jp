...
SQL Server PDW の Hadoop を使用して、前に SQL Server PDW に Java ランタイム環境をインストールする、アプライアンス管理者に問い合わせてください。 手順については、次を参照してください[外部データ &#40; への PolyBase 接続を構成する。Analytics Platform System &#41;](configure-polybase-connectivity-to-external-data.md)アプライアンス オペレーション ガイドです。  
