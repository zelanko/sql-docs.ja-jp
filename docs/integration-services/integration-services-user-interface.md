...
|ダイアログ ボックス|用途|アクセス|  
|----------------|-------------|------------|  
|**作業の開始**|サンプル、チュートリアル、およびビデオにアクセスします。|**[制御フロー]** タブまたは **[データ フロー]** タブのデザイン画面で右クリックし、**[作業の開始]** をクリックします。<br /><br /> 新しい [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] プロジェクトを作成するときに **[作業の開始]** ウィンドウが自動的に表示されるようにするには、ウィンドウの下部にある **[新しいプロジェクトで常に表示する]** を選択します。|  
