...
# <a name="sql-server-integration-services"></a>SQL Server Integration Services
 ...
 > 以前のバージョンの SQL Server に関連するコンテンツについては、「[SQL Server Integration Services](https://msdn.microsoft.com/en-US/library/ms141026(SQL.120).aspx)」をご覧ください。
...
- [SSIS の MSDN フォーラム - 質問する](https://social.msdn.microsoft.com/Forums/en-us/home?forum=sqlintegrationservices)
- [SSDT および SSMS の MSDN フォーラム - 質問する](https://social.msdn.microsoft.com/Forums/en-US/home?forum=sqltool)
