...
ms.topic: "article"
helpviewer_keywords: 
  - "Integration Services, インストール"
  - "SSIS, インストール"
  - "Integration Services のインストール, Integration Services のインストールについて"
  - "SQL Server Integration Services, インストール"
  - "セットアップ [Integration Services], Integration Services のインストールについて"
  - "Integration Services のインストール"
  - "セットアップ [Integration Services]"
...
> [!NOTE]    
>  以前のバージョンの [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]では、 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] をインストールすると、既定で Users グループの全ユーザーが [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] サービスにアクセスできました。 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]をインストールした場合、ユーザーは [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] サービスにアクセスできません。 このサービスは既定で保護されます。 特定のユーザーに対して **SQL Server Integration Services 13.0** へのアクセスを許可するには、 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 管理者が [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] をインストールした後で DCOM 構成ツール (Dcomcnfg.exe) を実行する必要があります。    
>     
>  アクセス許可を付与する方法については、「 [Grant Permissions to Integration Services Service](../../integration-services/service/grant-permissions-to-integration-services-service.md)」を参照してください。    
