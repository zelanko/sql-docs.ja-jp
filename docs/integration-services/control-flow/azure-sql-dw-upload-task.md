...
**Azure SQL DW アップロード タスク** は、SQL Server 2016 用の SQL Server Integration Services (SSIS) Feature Pack for Azure のコンポーネントです。 Feature Pack は [こちら](http://go.microsoft.com/fwlink/?LinkID=626967)からダウンロードしてください。
...
[ColumnDelimiter]|各列の終わりに印を付ける 1 つ以上の文字を指定します。 例: パイプの場合は &#124;、タブの場合は \t、パイプとタブが並ぶ場合は &#124;\t です。
