---
title: "WMI データ リーダー タスク |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
-   [[WMI データ リーダー タスク エディター] &#40;[WMI オプション] ページ&#41;](../../integration-services/control-flow/wmi-data-reader-task-editor-wmi-options-page.md)  
