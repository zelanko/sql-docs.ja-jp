...
helpviewer_keywords: 
  ...
  - "データ マイニング クエリ タスク [Integration Services]"
...
-   [[データ マイニング クエリ タスク エディター] &#40;[クエリ] タブ&#41;](../Topic/Data%20Mining%20Query%20Task%20Editor%20\(Query%20Tab\).md)  
