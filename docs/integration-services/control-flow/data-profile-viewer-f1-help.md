---
title: "Data Profile Viewer の F1 ヘルプ | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "データ プロファイル タスク [Integration Services], Viewer"
...
### プロファイルの種類 = 列の NULL 比プロファイル  
  
#### 列の NULL 比プロファイル - \<列> ペイン  
 **[NULL カウント]**  
...
### プロファイルの種類 = 候補キー プロファイル  
  
#### 候補キー プロファイル - \<テーブル> ペイン  
 **[キー列]**  
...
## 「  
 ...
 [データ プロファイル タスクとビューアー](../../integration-services/control-flow/data-profiling-task-and-viewer.md)  
