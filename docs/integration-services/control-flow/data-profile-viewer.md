---
title: "Data Profile Viewer (Data Profile Viewer) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "データ プロファイル タスク [Integration Services], 出力ビューアー"
...
-   [!INCLUDE[ssIS](../../includes/ssis-md.md)] デザイナーの **[データ プロファイル]** でタスクを右クリックし、**[編集]** をクリックします。 **データ プロファイル タスク エディター**の **[全般]** ページで、**[プロファイル ビューアーを開く]** をクリックします。  
