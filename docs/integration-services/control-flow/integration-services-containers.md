---
description: Integration Services コンテナー
...
|**説明**|コンテナーの説明です。 このプロパティに格納されるのは文字列で、空白にすることもできます。<br /><br /> 詳細については、「<xref:Microsoft.SqlServer.Dts.Runtime.DtsContainer.Description%2A>」を参照してください。|  
...
|**名前**|コンテナーの名前。<br /><br /> 詳細については、<xref:Microsoft.SqlServer.Dts.Runtime.DtsContainer.Name%2A> を参照してください。|  
