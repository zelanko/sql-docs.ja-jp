...
### <a name="32-bit-and-64-bit-providers-for-connection-managers"></a>接続マネージャーの 32 ビット プロバイダーと 64 ビット プロバイダー  
 ...
 どちらのバージョンのプロバイダーも ID は同じです。 指定するかどうか、[です。含める[ssISnoversion](/sql-docs/docs/integration-services/integration-services-ssis-development-and-management-tools)です。  
