---
title: "[データ マイニング モデル トレーニング エディター]\\ ([接続] タブ) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="see-also"></a>参照  
 ...
 [データ マイニング モデル トレーニング エディター & #40 です。[列] タブ &#41;](../../integration-services/data-flow/data-mining-model-training-editor-columns-tab.md)  
