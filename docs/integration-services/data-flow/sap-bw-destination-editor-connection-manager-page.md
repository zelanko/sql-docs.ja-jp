---
title: "[SAP BW 変換先エディター]\\ ([接続マネージャー] ページ) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="see-also"></a>参照  
 [SAP BW 変換先エディター & #40 です。[マッピング] ページ &#41;](../../integration-services/data-flow/sap-bw-destination-editor-mappings-page.md)   
