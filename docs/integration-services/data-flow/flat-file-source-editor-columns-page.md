...
## <a name="see-also"></a>参照  
 ...
 [フラット ファイル ソース エディターと &#40; です。接続マネージャー ページと &#41; です。](../../integration-services/data-flow/flat-file-source-editor-connection-manager-page.md)   
 [フラット ファイル ソース エディターと &#40; です。エラー出力 ページと &#41; です。](../../integration-services/data-flow/flat-file-source-editor-error-output-page.md)   
