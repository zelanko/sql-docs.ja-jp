...
## 参照  
 ...
 [あいまい参照変換エディター ([詳細設定] タブ)](../Topic/Fuzzy%20Lookup%20Transformation%20Editor%20\(Advanced%20Tab\).md)  
