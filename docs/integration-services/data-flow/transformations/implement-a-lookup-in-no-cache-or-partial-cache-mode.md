...
13. エラー出力を構成するには、**[エラー出力]** ページをクリックし、エラー処理オプションを設定します。 詳細については、「[[参照変換エディター] ([エラー出力] ページ)](../Topic/Lookup%20Transformation%20Editor%20\(Error%20Output%20Page\).md)」をご覧ください。  
