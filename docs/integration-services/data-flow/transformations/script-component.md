...
helpviewer_keywords: 
  - "スクリプト変換"
  - "スクリプト [Integration Services], 変換"
  - "スクリプト コンポーネント [Integration Services], スクリプト コンポーネントについて"
  - "スクリプト コンポーネント [Integration Services]"
...
## コンポーネントが使用するスクリプトの記述  
 スクリプト コンポーネントでは、スクリプトを記述する環境として [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] Tools for Applications (VSTA) を使用します。 **スクリプト変換エディター**から VSTA にアクセスします。 詳細については、「[スクリプト変換エディター ([スクリプト] ページ)](../Topic/Script%20Transformation%20Editor%20\(Script%20Page\).md)」を参照してください。  
...
-   [スクリプト変換エディター ([スクリプト] ページ)](../Topic/Script%20Transformation%20Editor%20\(Script%20Page\).md)  
