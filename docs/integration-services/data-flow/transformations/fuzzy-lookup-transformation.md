...
helpviewer_keywords: 
  ...
  - "あいまい参照変換"
  - "参照テーブル [Integration Services]"
  - "類似データの一致 [Integration Services]"
  - "不足値の置換"
  - "データの修正 [Integration Services]"
  - "キャッシュ [Integration Services]"
  - "データの標準化 [Integration Services]"
  - "参照 [Integration Services]"
  - "信頼スコア [Integration Services]"
  - "あいまい一致"
  - "不足値の置き換え [Integration Services]"
...
-   [あいまい参照変換エディター ([参照テーブル] タブ)](../Topic/Fuzzy%20Lookup%20Transformation%20Editor%20\(Reference%20Table%20Tab\).md)  
