...
# <a name="union-all-transformation-editor"></a>全体結合変換エディター
 ...
 全体結合変換の詳細については、「 [Union All Transformation](../../../integration-services/data-flow/transformations/union-all-transformation.md)」を参照してください。  
...
## <a name="see-also"></a>参照  
 ...
 [和集合のすべての変換を使用してデータをマージします。](../../../integration-services/data-flow/transformations/merge-data-by-using-the-union-all-transformation.md)   
