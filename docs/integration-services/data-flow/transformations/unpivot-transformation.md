...
helpviewer_keywords: 
  - "ピボット解除変換"
  - "正規化されたデータセット [Integration Services]"
  - "正規化されたデータ [Integration Services]"
  - "データセット [Integration Services]、正規化されたデータ"
...
# ピボット解除変換
 ...
 ![ピボット処理解除前のデータセット](../../../integration-services/data-flow/transformations/media/mw-dts-17.gif "ピボット処理解除前のデータセット")  
