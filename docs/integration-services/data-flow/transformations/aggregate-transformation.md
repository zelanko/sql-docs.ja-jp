...
-   [[集計変換エディター] ([集計] タブ)](../../../integration-services/data-flow/transformations/aggregate-transformation-editor-aggregations-tab.md)  
  
-   [[集計変換エディター] ([詳細設定] タブ)](../../../integration-services/data-flow/transformations/aggregate-transformation-editor-advanced-tab.md)  
