...
helpviewer_keywords: 
  - "条件分割変換"
  - "行を別の出力にルート [Integration Services]"
 ...
 **[条件分割変換エディター]** ダイアログ ボックスで設定できるプロパティの詳細については、「[[条件分割変換エディター]](../../../integration-services/data-flow/transformations/conditional-split-transformation-editor.md)」を参照してください。  
