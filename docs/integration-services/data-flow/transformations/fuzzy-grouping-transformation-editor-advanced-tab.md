...
## <a name="see-also"></a>参照  
 ...
 [あいまいグループ化変換を使用して、類似のデータ行を識別します。](../../../integration-services/data-flow/transformations/identify-similar-data-rows-by-using-the-fuzzy-grouping-transformation.md)  
