---
description: Balanced Data Distributor (BDD) 変換
...
> [!IMPORTANT]  
>   変換の使用方法を示すプレゼンテーションとして、TechNet ライブラリの [Balanced Data Distributor ビデオに関するページ](/previous-versions/dn912438(v=msdn.10)) を参照してください。  
