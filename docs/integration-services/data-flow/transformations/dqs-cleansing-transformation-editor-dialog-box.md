...
# [DQS クレンジング変換エディター] ダイアログ ボックス
 ...
 変換の詳細については、「[DQS クレンジング変換](../../../integration-services/data-flow/transformations/dqs-cleansing-transformation.md)」を参照してください。  
...
1.  [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)] で、DQS クレンジング変換を [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] パッケージに追加します。  
