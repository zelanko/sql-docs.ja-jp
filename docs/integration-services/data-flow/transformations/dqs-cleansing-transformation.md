---
title: "DQS クレンジング変換 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
-   [データ品質プロジェクトを開く、ロックを解除する、名前を変更する、削除する](/sql-docs/docs/data-quality-services/open-unlock-rename-and-delete-a-data-quality-project)  
