...
helpviewer_keywords: 
  - "単語の境界 [Integration Services]"
  - "データの抽出 [Integration Services]"
  - "文の境界"
  - "単語の抽出 [Integration Services]"
  - "用語抽出変換"
  - "単語のタグ付け"
  - "正規化されたデータ [Integration Services]"
  - "テキストのトークン化 [Integration Services]"
  - "品詞 [Integration Services]"
  - "テキストの抽出 [Integration Services]"
  - "用語の抽出 [Integration Services]"
  - "単語の語幹検索 [Integration Services]"
...
-   [[用語抽出変換エディター] &#40;[詳細設定] タブ&#41;](../Topic/Term%20Extraction%20Transformation%20Editor%20\(Advanced%20Tab\).md)  
