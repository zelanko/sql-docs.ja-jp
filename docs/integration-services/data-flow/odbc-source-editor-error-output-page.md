---
title: "[ODBC ソース エディター] ([エラー出力] ページ) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="see-also"></a>参照  
 [Odbc 入力元エディター & #40 です。接続マネージャーページ &#41;](../../integration-services/data-flow/odbc-source-editor-connection-manager-page.md)   
 [ODBC ソース エディターと &#40; です。[列] ページと &#41; です。](../../integration-services/data-flow/odbc-source-editor-columns-page.md)  
