---
title: "Integration Services のパス |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/04/2017
...
## <a name="configure-the-path"></a>パスを構成します。  
...
## <a name="set-the-properties-of-a-path-with-the-data-flow-path-editor"></a>データ フロー パス エディターでは、パスのプロパティを設定します。
...
## <a name="general-page---data-flow-path-editor"></a>[全般] ページのデータ フロー パス エディター
...
## <a name="metadata-page---data-flow-path-editor"></a>[メタデータ] ページのデータ フロー パス エディター
...
## <a name="data-viewers-page---data-flow-path-editor"></a>データ ビューアー ページのデータ フロー パス エディター
