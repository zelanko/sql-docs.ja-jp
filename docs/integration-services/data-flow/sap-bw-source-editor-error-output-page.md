 ...
 **列**  
 **[SAP BW 変換元エディター]** ダイアログ ボックスの **[列]** ページで選択した外部 (ソース) 列を表示します。 このダイアログ ボックスの詳細については、「[SAP BW Source Editor &#40;Columns Page&#41;](../../integration-services/data-flow/sap-bw-source-editor-columns-page.md)」(SAP BW 変換元エディター &#40;[列] ページ&#41;) をご覧ください。  
...
## 参照  
 [SAP BW 変換元エディター &#40;[接続マネージャー] ページ&#41;](../Topic/SAP%20BW%20Source%20Editor%20\(Connection%20Manager%20Page\).md)   
 [SAP BW 変換元エディター &#40;[列] ページ&#41;](../Topic/SAP%20BW%20Source%20Editor%20\(Columns%20Page\).md)   
 [SAP BW 変換元エディター &#40;[詳細設定] ページ&#41;](../Topic/SAP%20BW%20Source%20Editor%20\(Advanced%20Page\).md)   
