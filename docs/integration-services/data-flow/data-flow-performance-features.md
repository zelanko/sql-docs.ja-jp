...
helpviewer_keywords: 
  ...
  - "Integration Services パッケージ、パフォーマンス"
  - "パフォーマンス [Integration Services]"
  - "データ フロー [Integration Services]、トラブルシューティング"
  - "SQL Server Integration Services パッケージ、パフォーマンス"
  - "データの読み込み"
  - "制御フロー [Integration Services]、トラブルシューティング"
  - "SSIS パッケージ、パフォーマンス"
  - "パッケージ [Integration Services]、パフォーマンス"
  - "クエリ [Integration Services]、トラブルシューティング"
  - "データの並べ替え [Integration Services]"
  - "集計 [Integration Services]"
