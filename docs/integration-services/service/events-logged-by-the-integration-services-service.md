...
helpviewer_keywords: 
  ...
  - "イベント [Integration Services], サービス"
...
## 構成ファイルに関するメッセージ  
 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] サービスの設定は、変更可能な XML ファイルに格納されています。 詳細については、「[Integration Services サービスの構成 &#40;SSIS サービス&#41;](../../integration-services/service/configuring-the-integration-services-service-ssis-service.md)」を参照してください。  
...
## 関連タスク  
 ログ エントリを表示する方法については、「[[ログ イベント] ウィンドウでログ エントリを表示する](../Topic/View%20Log%20Entries%20in%20the%20Log%20Events%20Window.md)」を参照してください。  
