---
title: "[パッケージのエクスポート] ダイアログ ボックスの UI リファレンス | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# [パッケージのエクスポート] ダイアログ ボックスの UI リファレンス
 ...
 **保護レベル**  
 **[...]** ボタンを押して、**[パッケージの保護レベル]** ダイアログ ボックスで保護レベルを更新します。 詳細については、「[[パッケージの保護レベル] ダイアログ ボックス](../Topic/Package%20and%20Project%20Protection%20Level%20Dialog%20Box.md)」を参照してください。  
  
## 参照  
 [[パッケージのコピーの保存]](../Topic/Save%20Copy%20of%20Package.md)   
 [[パッケージのインポート] ダイアログ ボックスの UI リファレンス](../Topic/Import%20Package%20Dialog%20Box%20UI%20Reference.md)   
