...
ms.topic: "article"
helpviewer_keywords: 
  - "Integration Services サービス, Integration Services サービスについて"
  - "SQL Server Integration Services サービス"
  - "サービス [Integration Services], Integration Services サービスについて"
  - "サービス [Integration Services]"
  - "SQL Server Integration Services, サービス"
...
## Integration Services サービスのスタートアップの種類  
