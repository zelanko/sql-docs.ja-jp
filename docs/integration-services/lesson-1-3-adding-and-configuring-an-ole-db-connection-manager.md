---
title: "手順 3: 追加して、OLE DB 接続マネージャーの構成 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="lesson-1-3---adding-and-configuring-an-ole-db-connection-manager"></a>レッスン 1 ~ 3 を追加して、OLE DB 接続マネージャーの構成
