---
title: "手順 2: 追加して、フラット ファイル接続マネージャーの構成 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="lesson-1-2---adding-and-configuring-a-flat-file-connection-manager"></a>レッスン 1、2、追加して、フラット ファイル接続マネージャーの構成
