---
title: "&lt;= (等しいまたはそれよりも小さい) (SSIS 式) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="lt-less-than-or-equal-to-ssis-expression"></a>&lt;= (等しいまたはそれよりも小さい) (SSIS 式)
...
## <a name="expression-examples"></a>式の例  
 現在の日付が 2003 年 7 月 4 日以降の場合、この例の結果は TRUE に評価されます。 詳細については、「[GETDATE &#40;SSIS 式&#41;](../../integration-services/expressions/getdate-ssis-expression.md)」を参照してください。  
