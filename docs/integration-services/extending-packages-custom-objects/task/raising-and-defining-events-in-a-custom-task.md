---
title: "発生させると、カスタム タスクでイベントを定義する |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/04/2017
...
## <a name="sample"></a>サンプル  
 次の例でのカスタム イベントを定義するタスクを示しています、 **InitializeTask**メソッドにカスタム イベントを追加する、<xref:Microsoft.SqlServer.Dts.Runtime.EventInfos>コレクション、し中にカスタム イベントを発生させるとその**Execute**メソッドを呼び出して、<xref:Microsoft.SqlServer.Dts.Runtime.IDTSComponentEvents.FireCustomEvent%2A>メソッド。  
