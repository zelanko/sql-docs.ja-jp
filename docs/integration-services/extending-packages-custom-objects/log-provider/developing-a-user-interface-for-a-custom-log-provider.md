---
title: "カスタム ログ プロバイダー用ユーザー インターフェイスの開発 |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/14/2017
