...
helpviewer_keywords: 
  ...
  - "実行プロパティ [Integration Services]"
  - "パッケージ [Integration Services]、プロパティ"
  - "識別プロパティ [Integration Services]"
  - "パスワード [Integration Services]"
  - "SSIS パッケージ、プロパティ"
  - "トランザクション プロパティ [Integration Services]"
  - "パッケージのプロパティの更新"
  - "強制実行値プロパティ [Integration Services]"
  - "セキュリティ プロパティ [Integration Services]"
  - "バージョン プロパティ [Integration Services]"
...
-   [パッケージのプロパティを設定する](../Topic/Set%20the%20Properties%20of%20a%20Package.md)  
...
|**ID**|パッケージ GUID です。パッケージが作成されるときに割り当てられます。 このプロパティは読み取り専用です。 **ID** プロパティの新しい値をランダムに生成するには、ドロップダウン リストで **[\<Generate New ID>]** を選択します。|  
|**名前**|パッケージの名前です。|  
...
###  <a name="Security"></a> Security  
 このカテゴリのプロパティを使用すると、パッケージの保護レベルが設定されます。 詳しくは、「 [Access Control for Sensitive Data in Packages](../integration-services/packages/access-control-for-sensitive-data-in-packages.md)」をご覧ください。  
