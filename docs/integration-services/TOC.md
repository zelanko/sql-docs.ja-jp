...
## [ファイルの保存とファイル共有への接続](lift-shift/ssis-azure-files-file-shares.md)
## [Azure の SSIS カタログに接続する](lift-shift/ssis-azure-connect-to-catalog-database.md)
...
# [パッケージ](integration-services-ssis-packages.md)
...
## [パッケージ アップグレード ウィザードの F1 ヘルプ](ssis-package-upgrade-wizard-f1-help.md)
## [パッケージとプロジェクトのパラメーター](integration-services-ssis-package-and-project-parameters.md)

# [接続](../integration-services/connection-manager/integration-services-ssis-connections.md)
# [制御フロー](../integration-services/control-flow/control-flow.md)
# [データ フロー](../integration-services/data-flow/data-flow.md)

# [変数](integration-services-ssis-variables.md)
## [[変数] ウィンドウ](variables-window.md)
## [システム変数](system-variables.md)
# [式](../integration-services/expressions/integration-services-ssis-expressions.md)
# [イベント ハンドラー](integration-services-ssis-event-handlers.md)
...
### [レッスン 3: ログの追加](lesson-3-add-logging-with-ssis.md)
...
#### [レッスン 1-4 - パッケージ構成の追加](lesson-1-4-adding-package-configurations.md)
