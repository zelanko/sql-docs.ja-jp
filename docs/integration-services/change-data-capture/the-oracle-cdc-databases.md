...
|password|ログ マイニング Oracle データベース ユーザーのパスワードです。 **use_windows_authentication = 0**の場合のみ必須です。|  
...
|名前|Default|Min|Max|静的|説明|  
|----------|-------------|---------|---------|------------|-----------------|  
|trace|False|-|-|False|使用できる値は次のとおりです。<br /><br /> True<br /><br /> False<br /><br /> on<br /><br /> オフ|  
