---
title: "変更データ キャプチャ for Oracle by Attunity |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/02/2017
...
## <a name="get-the-change-data-capture-for-oracle-by-attunity-download"></a>Attunity のダウンロードで Oracle の変更データ キャプチャを取得します。
