...
-   [手順 1: レッスン 2 のパッケージのコピー](../integration-services/step-1-copying-the-lesson-2-package.md)  
  
-   [手順 2:ログ機能の追加と設定](../integration-services/step-2-adding-and-configuring-logging.md)  
  
-   [手順 3: レッスン 3 のチュートリアル パッケージのテスト](../integration-services/step-3-testing-the-lesson-3-tutorial-package.md)  
