...
1.  [手順 1: レッスン 5 のパッケージのコピー](../integration-services/step-1-copying-the-lesson-5-package.md)  
  
2.  [手順 2: プロジェクトをプロジェクト配置モデルに変換する](../integration-services/step-2-converting-the-project-to-the-project-deployment-model.md)  
  
3.  [手順 3: レッスン 6 のパッケージのテスト](../integration-services/step-3-testing-the-lesson-6-package.md)  
  
4.  [手順 4: レッスン 6 のパッケージの展開](../integration-services/step-4-deploying-the-lesson-6-package.md)  
  
## レッスンの開始  
[手順 1: レッスン 5 のパッケージのコピー](../integration-services/step-1-copying-the-lesson-5-package.md)  
