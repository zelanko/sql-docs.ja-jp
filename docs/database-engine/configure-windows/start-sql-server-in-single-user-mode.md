...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server の起動, シングル ユーザー モード"
  - "シングル ユーザー モード [SQL Server]"
