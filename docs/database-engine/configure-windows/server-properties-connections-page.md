...
## <a name="see-also"></a>参照  
 [オプション &#40;クエリ実行:SQL Server:[詳細設定] ページ&#41;](https://docs.microsoft.com/sql/ssms/f1-help/database-engine-query-editor-sql-server-management-studio)   
