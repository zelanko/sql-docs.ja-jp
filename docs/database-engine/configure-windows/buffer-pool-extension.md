...
## バッファー プール拡張の詳細  
 ...
 ![SSD バッファー プールの拡張機能アーキテクチャ](../../database-engine/configure-windows/media/ssdbufferpoolextensionarchitecture.gif "SSD バッファー プールの拡張機能アーキテクチャ")  
