...
ms.topic: "article"
helpviewer_keywords: 
  - "シングル ユーザー モード [SQL Server], スタートアップ オプション"
  - "既定のスタートアップ オプションの上書き"
  - "最小構成モード [SQL Server], スタートアップ オプション"
  - "既定のスタートアップ オプション"
  - "既定のスタートアップ オプションの一時的な上書き [SQL Server]"
  - "スタートアップ オプション [SQL Server]"
  - "SQL Server の起動, オプション"
...
## スタートアップ オプションについて  
 ...
 スタートアップ オプションは、[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 構成マネージャーを使用して設定できます。 詳しくは、「[サーバーのスタートアップ オプションの構成 &#40;SQL Server 構成マネージャー&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md)」を参照してください。  
