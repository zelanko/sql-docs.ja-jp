...
keywords: 
  - "サーバー構成 (SQL Server)"
helpviewer_keywords: 
  - "セキュリティ構成 [SQL Server], sp_configure"
  - "構成オプション [SQL Server], 有効になる場合"
  - "サーバー管理 [SQL Server], 構成オプション"
  - "SQL Server Management Studio [SQL Server], サーバー"
  - "サーバー [SQL Server], 構成"
  - "構成オプション [SQL Server], 設定"
  - "オプション [SQL Server], 構成"
  - "RECONFIGURE ステートメント"
  - "パフォーマンス [SQL Server], サーバー"
  - "構成オプション [SQL Server]"
  - "RECONFIGURE WITH OVERRIDE ステートメント"
  - "SQL Server、構成"
  - "sp_configure"
  - "ストアド プロシージャ [SQL Server], 構成オプション"
  - "サーバー構成 [SQL Server]"
  - "SQL Server の構成, 構成オプション"
