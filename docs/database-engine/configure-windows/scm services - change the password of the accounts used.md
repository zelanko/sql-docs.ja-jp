---
title: "SQL Server で使用されるアカウントのパスワードの変更 (SQL Server 構成マネージャー) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "期限切れのパスワード [SQL Server], SQL Server エージェント"
  - "パスワード [SQL Server], SQL Server エージェント サービス"
  - "パスワード [SQL Server], 変更"
  - "期限切れのパスワード [SQL Server], データベース エンジン"
  - "パスワード [SQL Server], SQL Server サービス"
  - "データベース エンジン [SQL Server], パスワード"
  - "SQL Server で使用されるパスワードの変更"
  - "パスワードの変更"
...
manager: "jhubbard"
---
# SQL Server で使用されるアカウントのパスワードの変更 (SQL Server 構成マネージャー)
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 認証のパスワードを変更するには、「[[パスワードの有効期限が切れました]](../../ssms/f1-help/password-expired.md)」を参照してください。  
