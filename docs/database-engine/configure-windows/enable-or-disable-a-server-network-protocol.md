...
ms.topic: "article"
helpviewer_keywords: 
  - "ネットワーク プロトコル [SQL Server], 無効化"
  - "リモート接続 [SQL Server], 構成マネージャーによる有効化"
  - "プロトコル [SQL Server], 構成マネージャーによる有効化"
  - "プロトコル [SQL Server], 構成マネージャーによる無効化"
  - "ネットワーク プロトコルの無効化, 構成マネージャー"
  - "ネットワーク プロトコル [SQL Server], 有効化"
  - "ネットワーク プロトコルの有効化, 構成マネージャー"
  - "セキュリティ構成 [SQL Server], 接続プロトコル"
  - "接続 [SQL Server], 構成マネージャーによるリモートの有効化"
