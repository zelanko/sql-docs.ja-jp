...
helpviewer_keywords: 
  - "包含データベース、有効化"
  - "contained database authentication オプション"
...
> [!NOTE] [!INCLUDE[ssSDS_md](../../includes/sssds-md.md)] と [!INCLUDE[ssSDW_md](../../includes/sssdw-md.md)] の場合、包含データベースは常に有効であり、無効にすることはできません。
