...
ms.topic: "article"
helpviewer_keywords: 
  - "サーバー管理 [SQL Server], 接続"
  - "管理者接続 [SQL Server]"
  - "ポート [SQL Server], DAC"
  - "DAC (DAC)"
  - "ネットワーク接続 [SQL Server], 専用管理者"
  - "診断接続 [SQL Server]"
  - "接続 [SQL Server], 専用管理者"
  - "ポート [SQL Server]"
  - "専用管理者接続 [SQL Server]"
