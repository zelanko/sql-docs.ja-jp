...
helpviewer_keywords: 
  - "SQL Server, ログイン"
  - "サービス [SQL Server], ログイン"
  - "TCP 接続文字列"
  - "データベース エンジンへの接続"
  - "ログイン [SQL Server], ログインについて"
  - "名前付きパイプ接続文字列"
  - "ログイン [SQL Server]"
  - "共有メモリ接続文字列"
  - "ログイン [SQL Server]"
...
|ピリオドを使用して、インスタンスがローカル コンピューター上で実行されていることを示す、同じコンピューター上の既定のインスタンスへの接続。|」を参照してください。|  
...
## 関連コンテンツ  
 ...
 [ログインの作成](../../t-sql/creating-a-login.md)  
