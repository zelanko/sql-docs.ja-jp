...
|ハッシュ アルゴリズム|MD2、MD4、MD5、SHA、SHA1 アルゴリズム。 これらは使用しないでください。|SHA2_256 または SHA2_512 を使用してください。|非推奨のハッシュ アルゴリズム||  
...
|[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]|でのソリューション エクスプローラーの統合 [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]||なし|なし|  
