...
ms.topic: "article"
helpviewer_keywords: 
  - "ログ配布 [SQL Server], AlwaysOn 可用性グループ"
...
manager: "jhubbard"
---
# ログ配布から AlwaysOn 可用性グループへの移行の前提条件 (SQL Server)
 ...
 **詳細:**  
 ...
 [可用性グループへのログ配布構成の変換](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/09/converting-a-logshipping-configuration-to-availability-group.aspx) (SQL Server ブログ)  
...
-   **ブログ:**  
     ...
     [可用性グループへのログ配布構成の変換](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/09/converting-a-logshipping-configuration-to-availability-group.aspx)  
