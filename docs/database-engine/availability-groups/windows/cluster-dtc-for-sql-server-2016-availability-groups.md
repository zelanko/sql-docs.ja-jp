...
[AlwaysOn 可用性グループ システム ビューの監視](https://msdn.microsoft.com/library/ff878305.aspx)

[可用性グループの作成の手順](https://msdn.microsoft.com/library/ff878307.aspx)
