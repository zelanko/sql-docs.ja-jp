---
title: "SQL Server 2016 へのアップグレード | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
-   [SQL Server 2016 の別のエディションへのアップグレード &#40;Setup&#41;](../../database-engine/install-windows/upgrade-to-a-different-edition-of-sql-server-2016-setup.md)  
...
## <a name="see-also"></a>参照  
 ...
 [レプリケートされたデータベースのアップグレード](../../database-engine/install-windows/upgrade-replicated-databases.md)   
 [マスター データ サービスのアップグレード](../../database-engine/install-windows/upgrade-master-data-services.md)   
 [SQL Server 2008 R2 ベスト プラクティス アナライザー](http://go.microsoft.com/fwlink/?LinkId=197135)   
