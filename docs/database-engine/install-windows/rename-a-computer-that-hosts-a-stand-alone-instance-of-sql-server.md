...
ms.topic: "article"
helpviewer_keywords: 
  - "リモート ログイン エラー [SQL Server]"
  - "スタンドアロン コンピューター名 [SQL Server]"
  - "名前 [SQL Server], SQL Server のスタンドアロン インスタンス"
  - "SQL Server のスタンドアロン インスタンス名の変更"
...
### スタンドアロン インスタンスをホストするコンピューターの名前を変更するには [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
