...
helpviewer_keywords: 
  - "データベースのアップグレード"
  - "データベース [Analysis Services], アップグレード"
  - "Analysis Services のインストール, サイド バイ サイド インストール"
  - "Analysis Services のアップグレード"
  - "Analysis Services のアップグレード, Analysis Services のアップグレードについて"
  - "SSAS, データベースの移行"
  - "Analysis Services のアップグレード"
  - "Analysis Services のインストール, アップグレード"
  - "SSAS, アップグレード"
...
---
# Analysis Services のアップグレード
  Analysis Services インスタンスを同じサーバー モードの SQL Server 2016 バージョンにアップグレードすると、「[Analysis Services の新機能](../../analysis-services/what-s-new-in-analysis-services.md)」で説明する、最新リリースで導入された機能を利用できます。  
...
-   「[SQL Server 2016 リリース ノート](http://go.microsoft.com/fwlink/?LinkID=398124)」には、既知の問題と回避策が記載されています。  
...
### インプレース アップグレード  
 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] の既存のインスタンスを [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] にアップグレードできます。さらに、アップグレード時には、古いインスタンスの既存のデータベースが新しいインスタンスへ自動的に移行されます。 メタデータおよびバイナリ データは 2 つのバージョン間で互換性があるため、アップグレード後もそのまま使用できます。手動でデータを移行する必要はありません。  
...
## DirectQuery モードの表形式モデルのアップグレード  
...
4.  **DirectQuery** を有効にします。 詳細については、「[DirectQuery for Tabular 1200 models](../Topic/DirectQuery%20for%20Tabular%201200%20models.md)」(表形式 1200 モデル用 DirectQuery) を参照してください。  
