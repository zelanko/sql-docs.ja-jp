...
ms.locfileid: "75252730"
---
# <a name="deprecated-database-engine-features-in-includesssqlv15-mdincludessssqlv15-mdmd"></a>[!INCLUDE[sssqlv15-md](../includes/sssqlv15-md.md)] のデータベース エンジンの非推奨機能
