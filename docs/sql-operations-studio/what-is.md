...
## <a name="transact-sql-t-sql-code-editor-with-intellisense"></a>IntelliSense を備えたTRANSACT-SQL (T-SQL)のコードエディタ
...
## <a name="smart-t-sql-code-snippets"></a>スマートなT-SQLのコード スニペット
