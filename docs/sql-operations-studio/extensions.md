...
[!INCLUDE[name-sos](../includes/name-sos-short.md)] の拡張機能は [!INCLUDE[name-sos](../includes/name-sos-short.md)] により多くの機能を簡単に追加する方法を提供します。
...
1. サーバーまたはデータベースを右クリックし、管理ダッシュ ボードに移動して**管理**を選択します。
