...
## <a name="remarks"></a>解説  
 **IsDescendant**だけで使われる[SELECT FROM &#60; モデル &#62;。コンテンツ (&) #40";"DMX"&"#41;](../dmx/select-from-model-content-dmx.md)と[SELECT FROM &#60; モデル &#62;。DIMENSION_CONTENT (&) #40";"DMX"&"#41;](../dmx/select-from-model-dimension-content-dmx.md)クエリ。  
