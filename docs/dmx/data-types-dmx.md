---
title: "データ型 (DMX) |Microsoft ドキュメント"
ms.custom: 
ms.date: 03/02/2016
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  データ マイニング拡張機能 (DMX) を使用して新しいマイニング モデルを定義するときに[!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]モデル内の各列のデータ型を指定する必要があります。 データ型は、モデルを作成するときにデータ マイニング アルゴリズムが使用するデータを説明します。  
  
 データ型はアルゴリズムによって異なります。 サポートするデータ型と、その使用方法は各アルゴリズムが判断します。 Microsoft のアルゴリズムでは、次のデータ型がサポートされています。  
...
-   日付  
 ...
 詳細については、データの種類を[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]サポートされておりを参照してください[データ型 (&) #40 です。 データ マイニング (&) #41;](../analysis-services/data-mining/data-types-data-mining.md)です。  
