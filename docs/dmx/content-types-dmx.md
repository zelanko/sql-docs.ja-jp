...
[!INCLUDE[ssas](../includes/applies-to-version/ssas.md)]
 ...
 がサポートするコンテンツの種類の詳細につい [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] ては、「 [コンテンツの種類 &#40;データマイニング&#41;](/analysis-services/data-mining/content-types-data-mining)」を参照してください。  
