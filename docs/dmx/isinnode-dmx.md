...
## <a name="remarks"></a>解説  
 **IsInNode**だけで使われる[SELECT FROM &#60; モデル &#62;。場合 &#40;DMX"&"#41;](../dmx/select-from-model-cases-dmx.md)と[SELECT FROM &#60; モデル &#62;。SAMPLE_CASES &#40;DMX"&"#41;](../dmx/select-from-model-sample-cases-dmx.md)クエリ。  
