---
title: '[オペレーター] ノード (SQL Server エージェントの F1 ヘルプ)'
ms.prod: sql
...
ここでは、**のオブジェクト エクスプローラーの**[オペレーター][!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] ノードに関する F1 ヘルプについて紹介します。