...
このトピックでは、[!INCLUDE[ssCurrent](../../includes/sscurrent_md.md)] で、予期しない停止時に [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] エージェントを自動的に再起動する方法について説明します。  
