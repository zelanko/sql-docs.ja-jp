---
description: プロジェクト (SQL Server Management Studio)
...
[ソリューション エクスプローラーのソース管理](https://docs.microsoft.com/sql/ssms/solution/solution-explorer)  
