...
## <a name="ssms-180-preview"></a>SSMS 18.0 (プレビュー)

**SSMS 18.0 パブリック プレビュー 4 を利用できます。これは *SQL Server Management Studio* の最新世代であり、[!INCLUDE[sql-server-2019](..\includes\sssqlv15-md.md)] をサポートしています。**

**[![ダウンロード](../ssdt/media/download.png) SQL Server Management Studio 18.0 (プレビュー 4) のダウンロード](https://go.microsoft.com/fwlink/?linkid=2014662)**

プレビュー 4 は、SSMS 18.0 の最初のパブリック プレビューです。

**バージョン情報**

- リリース番号: 18.0 (プレビュー 4)<br>
...
## <a name="available-languages-ssms-180-preview"></a>使用可能な言語 (SSMS 18.0 プレビュー)

SSMS の今回のリリースは、次の言語でインストールできます。

SQL Server Management Studio 18.0 (プレビュー 4):<br>
[中国語 (簡体字)](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x804) | [中国語 (繁体字)](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x404) | [英語 (米国)](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x409) | [フランス語](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x40c) | [ドイツ語](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x407) | [イタリア語](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x410) | [日本語](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x411) | [韓国語](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x412) | [ポルトガル語 (ブラジル)](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x416) | [ロシア語](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x419) | [スペイン語](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x40a)

SQL Server Management Studio 18.0 アップグレード パッケージ (18.0 へのアップグレード):<br>
現在、利用できるアップグレード オプションはありません。
...
## <a name="new-in-this-release-ssms-180-preview"></a>このリリース (SSMS 18.0 プレビュー) の新機能

SSMS 18.0 (プレビュー) は SQL Server Management Studio の最新バージョンです。 SSMS の 18.x 世代は、SQL Server 2008 から SQL Server 2019 プレビューまでのほぼすべての機能領域をサポートしています。
...
## <a name="supported-operating-systems-ssms-180-preview"></a>サポートされるオペレーティング システム (SSMS 18.0 プレビュー)
...
## <a name="ssms-installation-tips-and-issues-ssms-180-preview"></a>SSMS のインストールに関するヒントと問題 (SSMS 18.0 プレビュー)
...
## <a name="release-notes-ssms-180-preview"></a>リリース ノート(SSMS 18.0 プレビュー)
