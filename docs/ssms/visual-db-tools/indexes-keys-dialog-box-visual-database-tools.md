---
description: '[インデックス/キー] ダイアログ ボックス (Visual Database Tools)'
...
**[統計値を再計算する]**  
インデックスの作成時に、基になる [!INCLUDE[ssDE](../../includes/ssde_md.md)] で統計情報を新たに計算するかどうかを指定します。 統計情報の再計算により、インデックスの構築には前よりも時間がかかりますが、クエリのパフォーマンスは大幅に向上する可能性があります。  
