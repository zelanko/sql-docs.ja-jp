...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 結果セットは、**[結果]** ペインからタブ区切りテキストとしてコピーできます。 結果セット全体をコピーすることも、任意の数の連続する行やセル、または連続しない行やセルをコピーすることもできます。  
