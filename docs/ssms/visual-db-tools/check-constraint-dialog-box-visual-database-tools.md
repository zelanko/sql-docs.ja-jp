...
**[式]**  
選択した CHECK 制約の式を表示します。 新しい制約の場合は、このボックスを終了する前に式を入力する必要があります。 既存の CHECK 制約を編集することもできます。 詳細については、制約の使用に関するページ (https://msdn.microsoft.com/637098af-2567-48f8-90f4-b41df059833e) を参照してください。  
