...
オブジェクト エクスプローラーの各レベルで、オブジェクトに関してユーザーが最も必要としそうな情報が **[オブジェクト エクスプローラーの詳細]** ページに表示されます。 オブジェクトの項目数が多いと、情報の処理に時間がかかる場合があります **** 。  
...
[キーボード ショートカット スキームの選択](../../tools/sql-server-management-studio/lesson-1-6-select-the-keyboard-shortcut-scheme.md)  
