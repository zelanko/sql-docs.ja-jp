...
---
# <a name="lesson-2-4---using-comments"></a>レッスン 2-4 - コメントの使用
...
[コード ウィンドウを表示するその他の方法](../../tools/sql-server-management-studio/lesson-2-5-other-ways-of-viewing-the-code-window.md)  
