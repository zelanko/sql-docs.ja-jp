---
title: "[SSIS サーバーへの接続]([接続プロパティ]) | Microsoft Docs"
ms.custom: 
ms.date: 01/19/2017
...
**[ポート番号]**  
[!INCLUDE[ssIS](../../includes/ssis_md.md)]によって使用されるポート番号を入力します。  
...
**を登録するときには、**  
[!INCLUDE[ssIS](../../includes/ssis_md.md)] を **登録済みサーバー**に登録するときに、クリックして接続をテストします。  
